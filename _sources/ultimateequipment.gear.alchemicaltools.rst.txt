...
.. _`ultimateequipment.gear.alchemicaltools`:

.. contents:: \ 

.. _`ultimateequipment.gear.alchemicaltools#alchemical_tools`:

Alchemical Tools
#################

Alchemical tools are adventuring items that can prove extremely useful in a variety of situations, including battles, dungeon-delving, or crafting other alchemical items. All of these tools can be made by a character with the :ref:`Craft <corerulebook.skills.craft#craft>`\  (alchemy) skill.

.. _`ultimateequipment.gear.alchemicaltools#alchemical_tools_table`:
...
.. _`ultimateequipment.gear.alchemicaltools#alchemical_cement`:
...
.. _`ultimateequipment.gear.alchemicaltools#alchemical_glue`:
...
.. _`ultimateequipment.gear.alchemicaltools#alchemical_glue_accelerant`:
...
.. _`ultimateequipment.gear.alchemicaltools#alchemical_solvent`:
...
.. _`ultimateequipment.gear.alchemicaltools#blackfire_clay`:
...
.. _`ultimateequipment.gear.alchemicaltools#bloodblock`:
...
.. _`ultimateequipment.gear.alchemicaltools#buoyant_balloon`:
...
.. _`ultimateequipment.gear.alchemicaltools#candlerod`:
...
.. _`ultimateequipment.gear.alchemicaltools#casting_plaster`:
...
.. _`ultimateequipment.gear.alchemicaltools#chill_cream`:
...
.. _`ultimateequipment.gear.alchemicaltools#defoliant`:
...
.. _`ultimateequipment.gear.alchemicaltools#embalming_fluid`:
...
This fluid is used to preserve corpses, whether for later dissection, taxidermy, necromancy, or magic such as :ref:`raise dead <corerulebook.spells.raisedead#raise_dead>`\ . Embalming fluid is technically a poison, and using it makes a corpse unpalatable to most animals and vermin, though corpse-eating undead don't mind the taste. Treating a corpse with embalming fluid takes 1 hour and a successful DC 25 :ref:`Heal <corerulebook.skills.heal#heal>`\  check. The embalmed corpse decays at half the normal rate (each day dead counts as half a day for the purpose of :ref:`raise dead <corerulebook.spells.raisedead#raise_dead>`\ ).

.. _`ultimateequipment.gear.alchemicaltools#foaming_powder`:
...
Often extracted from phosphorescent insects, tiny marine plants, or subterranean fungi, glowing ink emits a faint but steady light (typically red or green) that allows you to read it in normal darkness—this includes darkness created by spells like :ref:`darkness <corerulebook.spells.darkness#darkness>`\ , but not the supernatural darkness created by :ref:`deeper darkness <corerulebook.spells.deeperdarkness#deeper_darkness>`\ . If there is glowing ink on an object, you have a +2 bonus on :ref:`Perception <corerulebook.skills.perception#perception>`\  checks to locate it. Mixing glowing ink with marker dye makes the dye glow in the dark until it fades. 

.. _`ultimateequipment.gear.alchemicaltools#impact_foam`:
...
.. _`ultimateequipment.gear.alchemicaltools#invisible_ink`:
...
Invisible ink is a staple of spies, rebels, and secret societies everywhere. Messages written with invisible ink only become visible under specific circumstances. Revealing the secret message with the proper triggering agent is a full-round action per page of text. A successful :ref:`Craft <corerulebook.skills.craft#craft>`\  (alchemy) check reveals the message without the proper trigger and takes 1 hour (the DC varies by ink quality).
...
.. _`ultimateequipment.gear.alchemicaltools#light_detector`:
...
.. _`ultimateequipment.gear.alchemicaltools#marker_dye`:
...
.. _`ultimateequipment.gear.alchemicaltools#mending_paste`:
...
.. _`ultimateequipment.gear.alchemicaltools#rusting_powder`:
...
.. _`ultimateequipment.gear.alchemicaltools#scent_cloak`:
...
.. _`ultimateequipment.gear.alchemicaltools#smoke_pellet`:
...
.. _`ultimateequipment.gear.alchemicaltools#smokestick`:
...
This alchemically treated wooden stick instantly creates thick, opaque smoke when burned. The smoke fills a 10-foot cube (treat the effect as a :ref:`fog cloud <corerulebook.spells.fogcloud>`\  spell, except that a moderate or stronger wind dissipates the smoke in 1 round). The stick is consumed after 1 round, and the smoke dissipates naturally after 1 minute. 

.. _`ultimateequipment.gear.alchemicaltools#sunrod`:
...
.. _`ultimateequipment.gear.alchemicaltools#tindertwig`:
...
.. _`ultimateequipment.gear.alchemicaltools#water_purification_sponge`:
...
.. _`ultimateequipment.gear.alchemicaltools#weapon_blanch`:
