...
.. _`ultimatecombat.classarchetypes.cavalier`:

.. contents:: \ 

.. _`ultimatecombat.classarchetypes.cavalier#cavalier`:
...
.. _`ultimatecombat.classarchetypes.cavalier#cavalier_orders`:
...
.. _`ultimatecombat.classarchetypes.cavalier#order_of_the_blue_rose`:
...
.. _`ultimatecombat.classarchetypes.cavalier#edicts`:
...
.. _`ultimatecombat.classarchetypes.cavalier#challenge`:
...
.. _`ultimatecombat.classarchetypes.cavalier#skills`:

\ **Skills**\ : An order of the blue rose cavalier adds :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (history) (Int) and :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nobility) (Int) to his list of class skills. Whenever an order of the blue rose cavalier uses :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  to try to mediate a dispute between two parties that do not include him, he receives a bonus on the check equal to 1/2 his cavalier level (minimum +1).

.. _`ultimatecombat.classarchetypes.cavalier#order_abilities`:
...
.. _`ultimatecombat.classarchetypes.cavalier#flat_of_the_blade`:
...
.. _`ultimatecombat.classarchetypes.cavalier#inner_peace`:
...
\ **Skills**\ : An order of the seal cavalier adds :ref:`Disable Device <corerulebook.skills.disabledevice#disable_device>`\  (Dex) and :ref:`Linguistics <corerulebook.skills.linguistics#linguistics>`\  (Int) to his list of class skills. Whenever the cavalier uses :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  to conceal information about his sworn charge, he receives a competence bonus equal to 1/2 his cavalier level (minimum +1).

\ **Order Abilities**\ : A cavalier belonging to the order of the seal gains the following abilities as he increases in level.

.. _`ultimatecombat.classarchetypes.cavalier#keeper`:
...
.. _`ultimatecombat.classarchetypes.cavalier#i_shall_not_be_moved`:
...
.. _`ultimatecombat.classarchetypes.cavalier#staggering_assault`:
...
.. _`ultimatecombat.classarchetypes.cavalier#order_of_the_tome`:

Order of the Tome
******************

:ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  is the stepping stone of both truth and power. The members of this order devote themselves to the preservation of knowledge. Most would protect written knowledge at all costs, but there are members that believe there is such thing as knowledge too dangerous to be allowed to exist, and seek to destroy it.
...
\ **Challenge**\ : Whenever an order of the tome cavalier issues a challenge, he receives a +2 bonus on all saving throws against spells or spell-like abilities cast by the subject of his challenge and a +2 bonus on all :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  and Sense motive checks involving the subject of his challenge.

\ **Skills**\ : An order of the tome cavalier adds :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana), :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (religion), and :ref:`Linguistics <corerulebook.skills.linguistics#linguistics>`\  to his list of class skills. Furthermore, he can use :ref:`Linguistics <corerulebook.skills.linguistics#linguistics>`\  untrained. If he has ranks in :ref:`Linguistics <corerulebook.skills.linguistics#linguistics>`\ , he receives a bonus on the check equal to 1/2 his cavalier level (minimum +1). 

\ **Order Abilities**\ : A cavalier belonging to the order of the tome gains the following abilities as he increases in level. 

.. _`ultimatecombat.classarchetypes.cavalier#specialized_knowledge`:

\ *Specialized Knowledge (Ex)*\ : At 2nd level, an order of the tome cavalier chooses either :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana) or :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (religion). He can make the chosen skill checks untrained. He cannot change his chosen skill later. If he has ranks in his chosen skill, he receives a bonus on the check equal to 1/2 his cavalier level (minimum +1) as long as that check involves a book, tome, scroll, or any other form of written knowledge.

.. _`ultimatecombat.classarchetypes.cavalier#powerful_knowledge`:

\ *Powerful Knowledge (Ex)*\ : At 8th level, the cavalier gains the ability to read scrolls and cast arcane or divine spells from a scroll as if he had a caster level of his cavalier level –4. He can decipher all scrolls, using his :ref:`Linguistics <corerulebook.skills.linguistics#linguistics>`\  skill in place of :ref:`Spellcraft <corerulebook.skills.spellcraft#spellcraft>`\ , and does not need to cast :ref:`read magic <corerulebook.spells.readmagic#read_magic>`\  in order to decipher a scroll. Which type of spell the cavalier can cast is based on the :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  skill he chose for specialized knowledge. If he chose :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana), he can cast any arcane spells from a scroll. If he chose :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (religion), he can cast any divine spells from a scroll. Furthermore, he gains a +1 bonus to an ability score for purposes of determining the level of spells he can cast from a scroll, and this bonus increases by +1 at 10th level and every 5 levels thereafter (to a maximum of +4 at 20th level). The ability score that gains the bonus is dependent on which skill the cavalier picked for his specialized knowledge ability. If the cavalier picked :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana), he gains the bonus to Intelligence. If he picked :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (religion), he gains the bonus to Wisdom. 

.. _`ultimatecombat.classarchetypes.cavalier#defensive_knowledge`:

\ *Defensive Knowledge (Ex)*\ : At 15th level, an order of the tome cavalier can grant nearby allies some of the boons of his cavalier challenge. While allies are adjacent to the cavalier, they gain a +2 bonus on all saving throws against spells or spell-like abilities cast by the subject of the cavalier's challenge. In addition, as an immediate action, a number of times per day equal to the cavalier's Intelligence modifier (minimum 1) or Wisdom modifier (minimum 1), the cavalier can allow an ally adjacent to him to reroll a single failed saving throw against a spell or spell-like ability from the target of his challenge. The ally must be able to see and hear the cavalier in order to gain this reroll. The ability score that determines how many times per day a cavalier can use this ability depends on which :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  skill the cavalier picked for specialized knowledge. If the cavalier picked :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana), the number of times per day this ability can be used is based on Intelligence. If he picked :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (religion) it is based on Wisdom. 

.. _`ultimatecombat.classarchetypes.cavalier#cavalier_archetypes`:
...
.. _`ultimatecombat.classarchetypes.cavalier#beast_rider_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.cavalier#armor_proficiency`:
...
.. _`ultimatecombat.classarchetypes.cavalier#exotic_mount`:
...
The beast rider does not take an armor check penalty on :ref:`Ride <corerulebook.skills.ride#ride>`\  checks while riding his mount. The mount is always considered combat trained, and begins play with :ref:`Endurance <corerulebook.feats#endurance>`\  as a bonus feat. A beast rider's mount does not gain the share spells special ability.
...
.. _`ultimatecombat.classarchetypes.cavalier#emissary_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.cavalier#bonus_feats`:

\ **Bonus Feats**\ : An emissary can select :ref:`Endurance <corerulebook.feats#endurance>`\ , :ref:`Fleet <corerulebook.feats#fleet>`\ , or :ref:`Run <corerulebook.feats#run>`\  in addition to the list of combat feats whenever he gains a bonus feat.

.. _`ultimatecombat.classarchetypes.cavalier#in_or_out_of_the_saddle`:

\ **In or Out of the Saddle (Ex)**\ : At 1st level, an emissary gains :ref:`Mounted Combat <corerulebook.feats#mounted_combat>`\  as a bonus feat. In addition, he can move at normal speed when wearing medium armor. This ability replaces tactician.

.. _`ultimatecombat.classarchetypes.cavalier#battlefield_agility`:

\ **Battlefield Agility (Ex)**\ : At 5th level, an emissary learns to be more aware of the threats that surround him in combat, and shares this awareness with his loyal steed. Both the emissary and his mount gain :ref:`Mobility <corerulebook.feats#mobility>`\  as a bonus feat. This ability replaces banner.

.. _`ultimatecombat.classarchetypes.cavalier#mounted_acrobatics`:

\ **Mounted Acrobatics (Ex)**\ : At 9th level, an emissary is even more adept at hopping on and off his steed, and even dropping alongside its flanks mid-gallop. He gains :ref:`Trick Riding <advancedplayersguide.advancedfeats#trick_riding_(combat)>`\  as a bonus feat, even if he does not meet the prerequisites. The emissary can employ this feat even when wearing medium armor. This ability replaces greater tactician.

.. _`ultimatecombat.classarchetypes.cavalier#mounted_dervish`:

\ **Mounted Dervish (Ex)**\ : At 14th level, an emissary becomes a fearsome, mobile foe on the battlefield. He gains :ref:`Mounted Skirmisher <advancedplayersguide.advancedfeats#mounted_skirmisher_(combat)>`\  as a bonus feat, even if he does not meet the prerequisites. In addition, whenever the emissary is mounted and takes the charge action, he adds 10 feet to his mount's speed. This ability replaces greater banner.

.. _`ultimatecombat.classarchetypes.cavalier#erratic_charge`:
...
.. _`ultimatecombat.classarchetypes.cavalier#gendarme_(archetype)`:
...
\ **Bonus Feats**\ : A gendarme trains to be a mounted terror, almost to the exclusion of all other abilities. He gains bonus feats at 1st level, 5th level, and then every three levels thereafter, but must select these bonus feats from the following list: :ref:`Improved Bull Rush <corerulebook.feats#improved_bull_rush>`\ , :ref:`Mounted Combat <corerulebook.feats#mounted_combat>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`\ , :ref:`Ride-By Attack <corerulebook.feats#ride_by_attack>`\ , :ref:`Spirited Charge <corerulebook.feats#spirited_charge>`\ , :ref:`Spring Attack <corerulebook.feats#spring_attack>`\ , and :ref:`Unseat <corerulebook.feats#unseat>`\ . If the gendarme has already selected all of the listed feats, then he may select his bonus feats from those feats listed as combat feats. This ability replaces tactician, greater tactician, master tactician, and the standard cavalier's selection of bonus feats.

.. _`ultimatecombat.classarchetypes.cavalier#transfixing_charge`:

\ **Transfixing Charge (Ex)**\ : At 20th level, a gendarme represents the epitome of mounted combat. Whenever he makes a charge attack while mounted, he deals triple the normal damage (quadruple if using a lance); this damage includes all increases from the :ref:`Spirited Charge <corerulebook.feats#spirited_charge>`\  feat and from the use of a lance. In addition, if the gendarme confirms a critical hit on a charge attack while mounted, the attack deals maximum damage for the weapon wielded. Additional damage from weapon properties, magic effects, precision-based bonuses, or other increases are rolled normally. This ability replaces supreme charge.

.. _`ultimatecombat.classarchetypes.cavalier#honor_guard_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.cavalier#sworn_defense`:
...
.. _`ultimatecombat.classarchetypes.cavalier#intercept`:

\ **Intercept (Ex)**\ : At 3rd level, an honor guard learns to better disrupt the attacks of his enemies. He gains :ref:`Bodyguard <advancedplayersguide.advancedfeats#bodyguard_(combat)>`\  (\ *Advanced Player's Guide*\  151) as a bonus feat, even if he does not meet the prerequisite. In addition, whenever the honor guard uses the aid another action to increase an ally's Armor Class, the bonus to Armor Class granted by the aid another action increases by +1. This ability replaces cavalier's charge.

.. _`ultimatecombat.classarchetypes.cavalier#warding_charge`:
...
.. _`ultimatecombat.classarchetypes.cavalier#defensive_challenge`:
...
.. _`ultimatecombat.classarchetypes.cavalier#luring_cavalier_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.cavalier#far_challenge`:
...
.. _`ultimatecombat.classarchetypes.cavalier#careful_aim`:
...
.. _`ultimatecombat.classarchetypes.cavalier#infuriating_aim`:
...
.. _`ultimatecombat.classarchetypes.cavalier#versatile_challenge`:
...
.. _`ultimatecombat.classarchetypes.cavalier#supreme_aim`:
...
.. _`ultimatecombat.classarchetypes.cavalier#musketeer_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.cavalier#weapon_and_armor_proficiency`:

\ **Weapon and Armor Proficiency**\ : A musketeer does not gain proficiency in heavy armor. Musketeers are proficient with all simple and martial weapons, and with firearms. A cavalier's levels stack with any fighter levels he possesses for the purpose of meeting the level prerequisite for feats that specifically select a firearm, such as :ref:`Weapon Specialization <corerulebook.feats#weapon_specialization>`\ .

.. _`ultimatecombat.classarchetypes.cavalier#gifted_firearm`:

\ **Gifted Firearm (Ex)**\ : At 1st level, a musketeer is gifted by his order with a firearm (either a pistol or a musket). This weapon is both a symbol of the cavalier's duty and a focus for much of his talent. He cannot sell this weapon. He also gains the :ref:`Gunsmithing <ultimatecombat.ultimatecombatfeats#gunsmithing>`\  feat. 
...
At 8th level, the cavalier gains the benefit of the :ref:`Improved Critical <corerulebook.feats#improved_critical>`\  feat. At 11th level, he can reduce the misfire chance of his weapon by 1 (to a minimum of 1), and at 17th level, the musketeer can double the range increment of his weapon. The reduction of the weapon's misfire chance and the doubled range increment abilities don't stack with the similar benefits of the :ref:`reliable <ultimatecombat.combat.firearms#reliable>`\  and :ref:`distance <corerulebook.magicitems.weapons#distance>`\  magic weapon special abilities.
...
.. _`ultimatecombat.classarchetypes.cavalier#swift_powder`:

\ **Swift Powder (Ex)**\ : At 4th level, the musketeer gains :ref:`Rapid Reload <ultimatecombat.ultimatecombatfeats#rapid_reload_(combat)>`\  (musket) or :ref:`Rapid Reload <ultimatecombat.ultimatecombatfeats#rapid_reload_(combat)>`\  (pistol) as a bonus feat. At 14th level, each time the musketeer issues a challenge, he may reload a wielded firearm as a free action. This ability replaces expert trainer.

.. _`ultimatecombat.classarchetypes.cavalier#standard_bearer_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.cavalier#banner`:
...
.. _`ultimatecombat.classarchetypes.cavalier#mount`:
...
.. _`ultimatecombat.classarchetypes.cavalier#banner_of_solace`:
...
.. _`ultimatecombat.classarchetypes.cavalier#awesome_pennon`:
...
.. _`ultimatecombat.classarchetypes.cavalier#strategist_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.cavalier#tactician`:
...
.. _`ultimatecombat.classarchetypes.cavalier#drill_instructor`:
...
.. _`ultimatecombat.classarchetypes.cavalier#tactical_advantage`:
...
.. _`ultimatecombat.classarchetypes.cavalier#strategic_supremacy`:
