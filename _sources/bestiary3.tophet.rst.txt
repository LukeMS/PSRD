...
\ **Melee**\  bite +21 (2d6+8 plus :ref:`grab <bestiary.universalmonsterrules#grab>`\ ), 2 slams +21 (1d6+8)

\ **Space**\  10 ft.; \ **Reach**\  5 ft.

\ **Special Attacks**\  swallow whole (no damage [see below], AC 18, 40 hp), :ref:`trample <bestiary.universalmonsterrules#trample>`\  (2d6+12, DC 25)

.. _`bestiary3.tophet#statistics`:
...
.. _`bestiary3.tophet#special_abilities`:
...
.. _`bestiary3.tophet#construction`:

Construction
#############

A tophet's hollow body is made of 3,000 pounds of iron or steel forged in heats comparable to those found in active volcanoes worth 2,000 gp. Tophets can be made of other metals as well, such as bronze or cold iron.
...
\ **Requirements**\  :ref:`Craft Construct <bestiary.monsterfeats#craft_construct>`\ , :ref:`bull's strength <corerulebook.spells.bullsstrength#bull_s_strength>`\ , :ref:`endure elements <corerulebook.spells.endureelements#endure_elements>`\ , creator must be CL 12th; \ **Skill**\  :ref:`Craft <corerulebook.skills.craft#craft>`\  (sculptures) DC 20; \ **Cost**\  23,500 gp.
