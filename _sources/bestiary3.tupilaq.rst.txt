...
\ **Melee**\  bite +15 (1d8+10/19–20 plus :ref:`grab <bestiary.universalmonsterrules#grab>`\ ), 2 claws +15 (1d4+5)

\ **Special Attacks**\  seek target, shearing jaws

\ **Spell-Like Abilities**\  (CL 7th; concentration +4)

 3/day—:ref:`invisibility <corerulebook.spells.invisibility#invisibility>`

.. _`bestiary3.tupilaq#statistics`:
...
\ **Skills**\  :ref:`Swim <corerulebook.skills.swim#swim>`\  +13

\ **SQ**\  scrimshaw magic

.. _`bestiary3.tupilaq#ecology`:
...
.. _`bestiary3.tupilaq#construction`:

Construction
#############

A tupilaq is built from 30 pounds of whale bones, bound together with sinew worth 750 gp. When the creature's creation is complete, the sinew falls away and the bones fuse together to create the animated creature.  
...
\ **Requirements**\  :ref:`Craft Construct <bestiary.monsterfeats#craft_construct>`\ , :ref:`geas/quest <corerulebook.spells.geasquest#geas_quest>`\ , :ref:`keen edge <corerulebook.spells.keenedge#keen_edge>`\ , :ref:`locate creature <corerulebook.spells.locatecreature#locate_creature>`\ , creator must be caster level 8th, creation must be done in complete secrecy; \ **Skill**\  :ref:`Craft <corerulebook.skills.craft#craft>`\  (scrimshaw) DC 20; \ **Cost**\  10,875 gp
