...
.. _`ultimateequipment.armsandarmor.materials`:

.. contents:: \ 

.. _`ultimateequipment.armsandarmor.materials#special_materials`:
...
.. _`ultimateequipment.armsandarmor.materials#adamantine`:
...
.. _`ultimateequipment.armsandarmor.materials#alchemical_silver`:
...
.. _`ultimateequipment.armsandarmor.materials#blood_crystal`:
...
.. _`ultimateequipment.armsandarmor.materials#cold_iron`:
...
.. _`ultimateequipment.armsandarmor.materials#darkleaf_cloth`:
...
.. _`ultimateequipment.armsandarmor.materials#darkwood`:
...
.. _`ultimateequipment.armsandarmor.materials#dragonhide`:
...
Dragonhide armor costs twice as much as masterwork armor of that type, but it takes no longer to make than ordinary armor of that type (double all :ref:`Craft <corerulebook.skills.craft#craft>`\  results).
...
.. _`ultimateequipment.armsandarmor.materials#eel_hide`:
...
.. _`ultimateequipment.armsandarmor.materials#elysian_bronze`:
...
.. _`ultimateequipment.armsandarmor.materials#fire_forged_steel`:
...
Weapons crafted from fire-forged steel similarly channel heat away from the wearer; this does not grant the wielder energy resistance. Instead, the blade absorbs and channels heat to the parts of the weapon that contact enemies. If the weapon is exposed to 10 points or more of fire damage (such as from an opponent's :ref:`fireball <corerulebook.spells.fireball#fireball>`\  or by holding it in a campfire for 1 full round), the weapon adds +1d4 points of fire damage to its attacks for the next 2 rounds. If the wielder is wearing fire-forged armor and using a fire-forged weapon, this bonus damage increases to 1d6 points of fire damage and lasts for 4 rounds. This bonus damage does not stack with fire damage from weapon enhancements such as :ref:`flaming <corerulebook.magicitems.weapons#weapons_flaming>`\ .
...
.. _`ultimateequipment.armsandarmor.materials#frost_forged_steel`:
...
.. _`ultimateequipment.armsandarmor.materials#greenwood`:
...
Greenwood can be altered or enhanced with wood-shaping magic such as :ref:`ironwood <corerulebook.spells.ironwood#ironwood>`\ , \ *shape wood*\ , and :ref:`warp wood <corerulebook.spells.warpwood#warp_wood>`\ . The duration of any such effect on a greenwood item is doubled.
...
.. _`ultimateequipment.armsandarmor.materials#living_steel`:
...
.. list-table::
   ...
   * - Type of Living Steel Item	Item
     - Price Modifier
   * - Ammunition
     - +10 gp per item
   * - Light armor
...
.. _`ultimateequipment.armsandarmor.materials#mithral`:
...
.. _`ultimateequipment.armsandarmor.materials#viridium`:
...
A creature carrying a viridium weapon must save every 24 hours or contract leprosy unless the weapon is kept inside an extradimensional space (such as an :ref:`efficient quiver <corerulebook.magicitems.wondrousitems#efficient_quiver>`\ ) or a scabbard lined with lead.
...
.. _`ultimateequipment.armsandarmor.materials#whipwood`:
...
.. _`ultimateequipment.armsandarmor.materials#wyroot`:
...
.. _`ultimateequipment.armsandarmor.materials#primitive_materials`:
...
.. _`ultimateequipment.armsandarmor.materials#bone`:
...
.. _`ultimateequipment.armsandarmor.materials#bronze`:
...
.. _`ultimateequipment.armsandarmor.materials#gold`:
...
.. _`ultimateequipment.armsandarmor.materials#obsidian`:
...
.. _`ultimateequipment.armsandarmor.materials#stone`:
