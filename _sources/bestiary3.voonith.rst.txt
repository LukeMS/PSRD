...
CN Small magical beast (:ref:`aquatic <bestiary.creaturetypes#aquatic_subtype>`\ )

\ **Init**\  +3; \ **Senses**\  darkvision 60 ft., low-light vision, :ref:`scent <bestiary.universalmonsterrules#scent>`\ ; :ref:`Perception <corerulebook.skills.perception#perception>`\  +8

.. _`bestiary3.voonith#defense`:
...
\ **Special Attacks**\  blood-freezing howl, :ref:`pounce <bestiary.universalmonsterrules#pounce>`

.. _`bestiary3.voonith#statistics`:
...
\ **Feats**\  :ref:`Ability Focus <bestiary.monsterfeats#ability_focus>`\  (blood-freezing howl), :ref:`Skill Focus <corerulebook.feats#skill_focus>`\  (:ref:`Perception <corerulebook.skills.perception#perception>`\ ), :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (bite)

\ **Skills**\  :ref:`Perception <corerulebook.skills.perception#perception>`\  +8, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +12, :ref:`Swim <corerulebook.skills.swim#swim>`\  +14

\ **SQ**\  amphibious

\ **Languages**\  Aklo

.. _`bestiary3.voonith#ecology`:
