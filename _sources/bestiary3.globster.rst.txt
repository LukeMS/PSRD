...
.. _`bestiary3.globster`:

.. contents:: \ 

.. _`bestiary3.globster#globster`:
...
\ **Immune**\  acid, bludgeoning and piercing damage, ooze traits; \ **Resist**\  :ref:`cold <bestiary.creaturetypes#cold_subtype>`\  10, electricity 10

.. _`bestiary3.globster#offense`:
...
\ **Melee**\ slam +9 (2d6+9 plus :ref:`grab <bestiary.universalmonsterrules#grab>`\  and nausea)

\ **Space**\  10 ft.; \ **Reach**\  5 ft.

\ **Special Attacks**\  create spawn, :ref:`constrict <bestiary.universalmonsterrules#constrict>`\  (2d6+9)

.. _`bestiary3.globster#statistics`:
...
\ **Skills**\  :ref:`Swim <corerulebook.skills.swim#swim>`\  +14

\ **SQ**\  decompose, :ref:`water <bestiary.creaturetypes#water_subtype>`\  dependency

.. _`bestiary3.globster#ecology`:
...
.. _`bestiary3.globster#special_abilities`:
...
\ **Nausea (Ex)**\  Any creature struck by a globster must make a DC 18 Fortitude save to avoid being nauseated for 1 round. Once a creature makes this saving throw, it is immune to further nausea effects from that particular globster for 24 hours. This is a :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\  effect. The save DC is Constitution-based.
