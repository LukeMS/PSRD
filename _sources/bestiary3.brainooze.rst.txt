...
.. _`bestiary3.brainooze`:

.. contents:: \ 

.. _`bestiary3.brainooze#brain_ooze`:
...
\ **Init**\  +6; \ **Senses**\  :ref:`blindsight <bestiary.universalmonsterrules#blindsight>`\  60 ft.; :ref:`Perception <corerulebook.skills.perception#perception>`\  +11

\ **Aura**\  psychic noise (10 ft., DC 19)

.. _`bestiary3.brainooze#defense`:
...
\ **Spell-Like Abilities**\  (CL 10th; concentration +14)
 ...
 Constant—:ref:`detect thoughts <corerulebook.spells.detectthoughts#detect_thoughts>`\ , :ref:`mage armor <corerulebook.spells.magearmor#mage_armor>`

 At will—:ref:`charm monster <corerulebook.spells.charmmonster#charm_monster>`\  (DC 18), :ref:`dominate animal <corerulebook.spells.dominateanimal#dominate_animal>`\  (DC 17), :ref:`dominate person <corerulebook.spells.dominateperson#dominate_person>`\  (DC 19)

 3/day—:ref:`dispel magic <corerulebook.spells.dispelmagic#dispel_magic>`\ , :ref:`modify memory <corerulebook.spells.modifymemory#modify_memory>`\  (DC 18)

.. _`bestiary3.brainooze#statistics`:
...
\ **Feats**\  :ref:`Defensive Combat Training <corerulebook.feats#defensive_combat_training>`\ , :ref:`Dodge <corerulebook.feats#dodge>`\ , :ref:`Iron Will <corerulebook.feats#iron_will>`\ , :ref:`Mobility <corerulebook.feats#mobility>`\ , :ref:`Weapon Finesse <corerulebook.feats#weapon_finesse>`

\ **Skills**\  :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  +10, :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  +5, :ref:`Fly <corerulebook.skills.fly#fly>`\  +25, :ref:`Perception <corerulebook.skills.perception#perception>`\  +11, :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  +11, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +15

\ **Languages**\  Aklo (cannot speak); telepathy 100 ft.

.. _`bestiary3.brainooze#ecology`:
...
.. _`bestiary3.brainooze#special_abilities`:
