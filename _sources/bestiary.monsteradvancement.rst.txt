...
.. _`bestiary.monsteradvancement`:

.. contents:: \ 

.. _`bestiary.monsteradvancement#monster_advancement`:
...
.. _`bestiary.monsteradvancement#templates`:
...
.. _`bestiary.monsteradvancement#simple_templates`:
...
.. _`bestiary.monsteradvancement#advanced_creature`: `bestiary.monsteradvancement#advanced_creature_(cr_+1)`_

.. _`bestiary.monsteradvancement#advanced_creature_(cr_+1)`:
...
.. _`bestiary.monsteradvancement#celestial_creature`: `bestiary.monsteradvancement#celestial_creature_(cr_+0_or_+1)`_

.. _`bestiary.monsteradvancement#celestial_creature_(cr_+0_or_+1)`:

Celestial Creature (CR +0 or +1)
*********************************

Celestial creatures dwell in the higher planes, but can be summoned using spells such as \ *summon monster*\  and :ref:`planar ally <corerulebook.spells.planarally#planar_ally>`\ . A celestial creature's CR increases by +1 only if the base creature has 5 or more HD. A celestial creature's quick and rebuild rules are the same.
...
.. list-table:: Celestial Creature Defenses
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto

   * - Hit Dice
     - Resist Cold, Acid, and Electricity
     - DR
   * - 1–4
     - 5
     - —
...
.. _`bestiary.monsteradvancement#degenerate_creature`: `bestiary.monsteradvancement#degenerate_creature_(cr_1)`_

.. _`bestiary.monsteradvancement#degenerate_creature_(cr_1)`:
...
.. _`bestiary.monsteradvancement#entropic_creature`: `bestiary.monsteradvancement#entropic_creature_(cr_+0_or_+1)`_

.. _`bestiary.monsteradvancement#entropic_creature_(cr_+0_or_+1)`:

Entropic Creature (CR +0 or +1)
********************************

Creatures with the entropic template live in planes where chaos is paramount. They can be summoned using spells such as :ref:`summon monster <advancedplayersguide.baseclasses.summoner#summon_monster_i>`\  and :ref:`planar ally <corerulebook.spells.planarally#planar_ally>`\ . An entropic creature's CR increases by +1 only if the base creature has 5 or more HD. An entropic creature's quick and rebuild rules are the same.
...
.. list-table:: Entropic Creature Defenses
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`bestiary.monsteradvancement#fiendish_creature`: `bestiary.monsteradvancement#fiendish_creature_(cr_+0_or_+1)`_

.. _`bestiary.monsteradvancement#fiendish_creature_(cr_+0_or_+1)`:

Fiendish Creature (CR +0 or +1)
********************************

Creatures with the fiendish template live in the Lower Planes, such as the Abyss and Hell, but can be summoned using spells such as \ *summon monster*\  and :ref:`planar ally <corerulebook.spells.planarally#planar_ally>`\ . A fiendish creature's CR increases by +1 only if the base creature has 5 or more HD. A fiendish creature's quick and rebuild rules are the same.
...
.. list-table:: Fiendish Creature Defenses
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`bestiary.monsteradvancement#giant_creature`: `bestiary.monsteradvancement#giant_creature_(+1)`_

.. _`bestiary.monsteradvancement#giant_creature_(+1)`:
...
.. _`bestiary.monsteradvancement#resolute_creature`: `bestiary.monsteradvancement#resolute_creature_(cr_+0_or_+1)`_

.. _`bestiary.monsteradvancement#resolute_creature_(cr_+0_or_+1)`:

Resolute Creature (CR +0 or +1)
********************************

Creatures with the resolute template live in planes where law is paramount. They can be summoned using spells such as :ref:`summon monster <advancedplayersguide.baseclasses.summoner#summon_monster_i>`\  and :ref:`planar ally <corerulebook.spells.planarally#planar_ally>`\ . A resolute creature's CR increases by +1 only if the base creature has 5 or more HD. A resolute creature's quick and rebuild rules are the same.
...
.. list-table:: Resolute Creature Defenses
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`bestiary.monsteradvancement#young_creature`: `bestiary.monsteradvancement#young_creature_(cr_–1)`_

.. _`bestiary.monsteradvancement#young_creature_(cr_–1)`:
...
.. _`bestiary.monsteradvancement#adding_racial_hit_dice`:
...
.. _`bestiary.monsteradvancement#step_1:_plan_the_monster`:
...
.. list-table:: Table: Monster Advancement
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`bestiary.monsteradvancement#step_2:_add_hit_dice`:
...
.. _`bestiary.monsteradvancement#table_2_2_size_changes`:

.. list-table:: Table: Size Changes
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`bestiary.monsteradvancement#table_2_3_size_bonuses_and_penalties`:

.. list-table:: Table: Size Bonuses and Penalties
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`bestiary.monsteradvancement#step_3:_ability_scores`:
...
.. _`bestiary.monsteradvancement#step_5:_statistics`:
...
.. _`bestiary.monsteradvancement#step_6:_comparison`:
...
.. _`bestiary.monsteradvancement#adding_class_levels`:
...
.. _`bestiary.monsteradvancement#step_1:_determine_creatures_role`:
...
\ **Skill**\ : Creatures of this type rely on skills (usually :ref:`Stealth <corerulebook.skills.stealth#stealth>`\ ) to ambush or take down their prey. This also includes creatures who take advantage of the environment or spells, such as fog or :ref:`invisibility <corerulebook.spells.invisibility#invisibility>`\ .
...
.. _`bestiary.monsteradvancement#table_2_4_monsters_with_class_levels`:

.. list-table:: Table: Monsters with Class Levels
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`bestiary.monsteradvancement#step_2:_add_class_levels`:
...
.. _`bestiary.monsteradvancement#step_3:_determine_cr`:
