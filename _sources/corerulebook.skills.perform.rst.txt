...
.. _`corerulebook.skills.perform`:

.. contents:: \ 

.. _`corerulebook.skills.perform#perform`:

Perform
########

.. _`corerulebook.skills.perform#(cha)`:
...
.. list-table::
   ...
   * - Perform DC
     - Performance
   * - 10
     - Routine performance. Trying to earn money by playing in public is akin to begging. You can earn 1d10 cp/day.
   * - 15
...
\ **Special**\ : A bard must have ranks in specific Perform categories to use some of his :ref:`Bardic Performance <corerulebook.classes.bard#bardic_performance>`\  abilities.
