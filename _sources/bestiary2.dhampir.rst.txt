...
CE Medium :ref:`humanoid <bestiary.creaturetypes#humanoid>`\  (dhampir)

\ **Init**\  +3; \ **Senses**\  darkvision 60 ft., low-light vision; :ref:`Perception <corerulebook.skills.perception#perception>`\  +1

.. _`bestiary2.dhampir#defense`:
...
\ **Fort**\  +2, \ **Ref**\  +3, \ **Will**\  –1 (+2 vs. :ref:`disease <bestiary.universalmonsterrules#disease_(ex_or_su)>`\  and mind-affecting effects)

\ **Defensive Abilities**\ :ref:`negative energy affinity <bestiary.universalmonsterrules#negative_energy_affinity>`\ , resist level drain

\ **Weakness**\ light sensitivity

.. _`bestiary2.dhampir#offense`:
...
\ **Spell-Like Abilities**\ (CL 1st)
 ...
 3/day—:ref:`detect undead <corerulebook.spells.detectundead#detect_undead>`

.. _`bestiary2.dhampir#statistics`:
...
\ **Feats**\  :ref:`Toughness <corerulebook.feats#toughness>`\ , :ref:`Weapon Finesse <corerulebook.feats#weapon_finesse>`

\ **Skills**\  :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  +5, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +7, :ref:`Perception <corerulebook.skills.perception#perception>`\  +1, :ref:`Ride <corerulebook.skills.ride#ride>`\  +5, :ref:`Survival <corerulebook.skills.survival#survival>`\  +3; \ **Racial Modifiers**\  +2 :ref:`Bluff <corerulebook.skills.bluff#bluff>`\ , +2 :ref:`Perception <corerulebook.skills.perception#perception>`

\ **Languages**\  Common 

.. _`bestiary2.dhampir#ecology`:
...
.. _`bestiary2.dhampir#special_abilities`:
...
.. _`bestiary2.dhampir#dhampir_characters`:
