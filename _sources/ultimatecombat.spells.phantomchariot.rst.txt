...
.. _`ultimatecombat.spells.phantomchariot`:

.. contents:: \ 

.. _`ultimatecombat.spells.phantomchariot#phantom_chariot`:
...
The chariot and team are essentially a single entity with an AC of 19 (–2 size, +6 natural armor, +5 Dex), and 10 hit points + 2 hit points per caster level (maximum 50). If the entity loses all its hit points, it disappears, possibly subjecting all aboard to a crash (treat as wrecked). The entity gains certain powers according to caster level, just like a mount does in the :ref:`phantom steed <corerulebook.spells.phantomsteed#phantom_steed>`\  spell.
