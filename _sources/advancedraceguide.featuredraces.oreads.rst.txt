...
.. _`advancedraceguide.featuredraces.oreads`:

.. contents:: \ 

.. _`advancedraceguide.featuredraces.oreads#oreads`:
...
.. _`advancedraceguide.featuredraces.oreads#oread_racial_traits`:

Oread Racial Traits
####################

.. _`advancedraceguide.featuredraces.oreads#+2_strength_+2_wisdom_2_charisma`:

\ **+2 Strength, +2 Wisdom, –2 Charisma**\ : Oreads are strong, solid, stable, and stoic.

.. _`advancedraceguide.featuredraces.oreads#native_outsider`:

\ **Native Outsider**\ : Oreads are outsiders with the native subtype.

.. _`advancedraceguide.featuredraces.oreads#medium`:

\ **Medium**\ : Oreads are Medium creatures and have no bonuses or penalties due to their size.

.. _`advancedraceguide.featuredraces.oreads#slow_speed`:

\ **Slow Speed**\ : Oreads have a base speed of 20 feet.

.. _`advancedraceguide.featuredraces.oreads#darkvision`:

\ **Darkvision**\ : Oreads can see in the dark up to 60 feet.

.. _`advancedraceguide.featuredraces.oreads#spell_like_ability`:

\ **Spell-Like Ability**\ : :ref:`Magic stone <corerulebook.spells.magicstone#magic_stone>`\  1/day (caster level equals the oread's total level; DC 11 + Charisma modifier).

.. _`advancedraceguide.featuredraces.oreads#energy_resistance`:

\ **Energy Resistance**\ : Oreads have acid resistance 5.

.. _`advancedraceguide.featuredraces.oreads#earth_affinity`:
...
.. _`advancedraceguide.featuredraces.oreads#languages`:
...
.. _`advancedraceguide.featuredraces.oreads#alternate_racial_traits`:
...
.. _`advancedraceguide.featuredraces.oreads#crystalline_form`:
...
.. _`advancedraceguide.featuredraces.oreads#earth_insight`:
...
.. _`advancedraceguide.featuredraces.oreads#ferrous_growth`:
...
.. _`advancedraceguide.featuredraces.oreads#fertile_soil`:
...
.. _`advancedraceguide.featuredraces.oreads#granite_skin`:
...
.. _`advancedraceguide.featuredraces.oreads#mountain_born`:

\ **Mountain-Born**\ : Oreads are drawn to mountains and other high places, and after many generations they've grown well suited to their environment. Oreads with this racial trait gain a +2 racial bonus on :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  checks made to cross narrow ledges and on saves against altitude fatigue and sickness. This racial trait replaces the spell-like ability racial trait.

.. _`advancedraceguide.featuredraces.oreads#stone_in_the_blood`:
...
.. _`advancedraceguide.featuredraces.oreads#treacherous_earth`:
...
.. _`advancedraceguide.featuredraces.oreads#favored_class_options`:
...
.. _`advancedraceguide.featuredraces.oreads#bard`:

\ **Bard**\ : Add +5 feet to the range of one of the bard's bardic performances (max +30 feet to any one performance).

.. _`advancedraceguide.featuredraces.oreads#cleric`:

\ **Cleric**\ : Add a +1/2 bonus on :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (planes) checks relating to the Plane of Earth and creatures with the earth subtype.

.. _`advancedraceguide.featuredraces.oreads#druid`:

\ **Druid**\ : Add a +1/2 bonus on :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nature) checks relating to plants and burrowing animals.

.. _`advancedraceguide.featuredraces.oreads#fighter`:

\ **Fighter**\ : Add +1 to the fighter's CMD when resisting a bull rush or drag attempt.

.. _`advancedraceguide.featuredraces.oreads#monk`:

\ **Monk**\ : Add +1/3 on critical hit confirmation rolls made with unarmed strikes (maximum bonus of +5). This bonus does not stack with :ref:`Critical Focus <corerulebook.feats#critical_focus>`\ .

.. _`advancedraceguide.featuredraces.oreads#paladin`:
...
.. _`advancedraceguide.featuredraces.oreads#ranger`:
...
.. _`advancedraceguide.featuredraces.oreads#summoner`:

\ **Summoner**\ : Add a +1/4 natural armor bonus to the AC of the summoner's eidolon.

.. _`advancedraceguide.featuredraces.oreads#racial_archetypes`:
...
.. _`advancedraceguide.featuredraces.oreads#shaitan_binder_(summoner)`:
...
.. _`advancedraceguide.featuredraces.oreads#base_form`:
...
.. _`advancedraceguide.featuredraces.oreads#shaitan_magic`:
...
At 8th level, it gains the major magic evolution  as a free evolution, and adds the following to the list of available spells for that evolution: :ref:`glitterdust <corerulebook.spells.glitterdust#glitterdust>`\  and :ref:`soften earth and stone <corerulebook.spells.softenearthandstone#soften_earth_and_stone>`\ .

At 12th level, it gains the ultimate magic evolution  as a free evolution, and adds the following to the list of available spells for that evolution: :ref:`meld into stone <corerulebook.spells.meldintostone#meld_into_stone>`\  and :ref:`stone shape <corerulebook.spells.stoneshape#stone_shape>`\ .
...
.. _`advancedraceguide.featuredraces.oreads#earth_glide`:
...
.. _`advancedraceguide.featuredraces.oreads#stone_curse`:
...
.. _`advancedraceguide.featuredraces.oreads#hard_as_stone`:
...
.. _`advancedraceguide.featuredraces.oreads#strength_of_stone`:
...
.. _`advancedraceguide.featuredraces.oreads#bonus_feat`:

\ **Bonus Feat**\ : At 6th level, a student of stone adds :ref:`Elemental Fist <advancedplayersguide.advancedfeats#elemental_fist>`\   to his list of available bonus feats. If the student of stone selects :ref:`Elemental Fist <advancedplayersguide.advancedfeats#elemental_fist>`\  as a bonus feat, he may only deal acid damage when using the feat. At 10th level, the student of stone adds Shaitan Style  to his list of bonus feats, at 14th level, he adds :ref:`Shaitan Skin <ultimatecombat.ultimatecombatfeats#shaitan_skin>`\  , and at 18th level, he adds :ref:`Shaitan Earthblast <ultimatecombat.ultimatecombatfeats#shaitan_earthblast>`\ . This otherwise functions as and alters the bonus feat ability.

.. _`advancedraceguide.featuredraces.oreads#bones_of_stone`:
...
.. _`advancedraceguide.featuredraces.oreads#body_of_stone`:

\ **Body of Stone (Ex)**\ : At 9th level, a student of stone gains the benefits of the :ref:`light <corerulebook.spells.light#light>`\  :ref:`fortification <corerulebook.magicitems.armor#armor_fortification>`\  armor property . This ability replaces improved evasion. 

.. _`advancedraceguide.featuredraces.oreads#soul_of_stone`:
...
.. _`advancedraceguide.featuredraces.oreads#stone_self`:
...
.. _`advancedraceguide.featuredraces.oreads#new_racial_rules`:
...
.. _`advancedraceguide.featuredraces.oreads#oread_equipment`:
...
.. _`advancedraceguide.featuredraces.oreads#oread_feats`:
...
.. _`advancedraceguide.featuredraces.oreads#dwarf_blooded`:
...
.. _`advancedraceguide.featuredraces.oreads#echoes_of_stone`:
...
\ **Benefit**\ : You gain a +4 racial bonus on :ref:`Perception <corerulebook.skills.perception#perception>`\  checks underground, and on :ref:`Survival <corerulebook.skills.survival#survival>`\  checks to avoid becoming lost in caverns and rocky areas.

.. _`advancedraceguide.featuredraces.oreads#murmurs_of_earth`:
...
.. _`advancedraceguide.featuredraces.oreads#oread_burrower`:
...
.. _`advancedraceguide.featuredraces.oreads#oread_earth_glider`:
...
.. _`advancedraceguide.featuredraces.oreads#stony_step`:
...
\ **Benefit**\ : Whenever you move, you may move through 5 feet of earth- or stone-based difficult terrain (rubble, stone stairs, and so on) each round as if it were normal terrain. The effects of this feat stack with similar feats such as :ref:`Acrobatic <corerulebook.feats#acrobatic>`\  Steps and :ref:`Nimble Moves <corerulebook.feats#nimble_moves>`\ . This feat allows you to take a 5-foot step into this kind of difficult terrain.

.. _`advancedraceguide.featuredraces.oreads#oread_magic_items`:
...
.. _`advancedraceguide.featuredraces.oreads#guarding_(shield_special_ability)`:
...
Moderate abjuration; CL 8th; :ref:`Craft Magic Arms and Armor <corerulebook.feats#craft_magic_arms_and_armor>`\ , shield other; Price +1 bonus.

.. _`advancedraceguide.featuredraces.oreads#guarding_greater_(shield_special_ability)`:
...
Strong abjuration; CL 12th; :ref:`Craft Magic Arms and Armor <corerulebook.feats#craft_magic_arms_and_armor>`\ , shield other; Price +2 bonus.

.. _`advancedraceguide.featuredraces.oreads#belt_of_stoneskin`:
...
.. _`advancedraceguide.featuredraces.oreads#description`:
...
.. _`advancedraceguide.featuredraces.oreads#construction`:

Construction
=============

\ **Requirements**\  :ref:`Craft Wondrous Item <corerulebook.feats#craft_wondrous_item>`\ , :ref:`stoneskin <corerulebook.spells.stoneskin#stoneskin>`\ , creator must be an oread or a creature with the :ref:`earth <bestiary.creaturetypes#earth_subtype>`\  subtype; \ **Cost**\  30,000 gp

.. _`advancedraceguide.featuredraces.oreads#earthbind_rod`:
...
\ **Requirements**\  :ref:`Craft Wondrous Item <corerulebook.feats#craft_wondrous_item>`\ , :ref:`innocence <advancedplayersguide.spells.innocence#innocence>`\  , :ref:`stone shape <corerulebook.spells.stoneshape#stone_shape>`\ ; \ **Cost**\  4,000 gp

.. _`advancedraceguide.featuredraces.oreads#oread_spells`:
...
.. _`advancedraceguide.featuredraces.oreads#binding_earth`:
...
.. _`advancedraceguide.featuredraces.oreads#binding_earth_mass`:
...
This spell functions as :ref:`binding <corerulebook.spells.binding#binding>`\  earth, except as noted above.

.. _`advancedraceguide.featuredraces.oreads#mighty_fist_of_the_earth`:
...
.. _`advancedraceguide.featuredraces.oreads#raging_rubble`:
...
\ **Effect**\  one :ref:`swarm <bestiary.creaturetypes#swarm_subtype>`\  of stones
...
.. _`advancedraceguide.featuredraces.oreads#stone_shield`:
...
A 1-inch-thick slab of stone springs up from the ground, interposing itself between you and an opponent of your choice. The stone :ref:`shield <corerulebook.spells.shield#shield>`\  provides you with cover from that enemy  until the beginning of your next turn, granting you a +4 bonus to Armor Class and a +2 bonus on Reflex saving throws. If the opponent's attack misses you by 4 or less, the attack strikes the shield instead. The stone :ref:`shield <corerulebook.spells.shield#shield>`\  has hardness 8 and 15 hit points. If the shield is destroyed, the spell ends and the shield crumbles away into nothingness. Spells and effects that damage an area deal damage to the shield.

You cannot use this spell if you are not adjacent to a large area of earth or stone such as the ground or a wall. At 4th level, a :ref:`qinggong monk <ultimatemagic.spellcastingclassoptions.monk#qinggong_monk_(archetype)>`\  may select this spell as a ki power costing 1 ki point to activate.
