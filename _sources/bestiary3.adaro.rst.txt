...
NE Medium monstrous humanoid (:ref:`aquatic <bestiary.creaturetypes#aquatic_subtype>`\ )

\ **Init**\  +3; \ **Senses**\  :ref:`blindsense <bestiary.universalmonsterrules#blindsense>`\  30 ft., darkvision 6o ft., low-light vision, keen :ref:`scent <bestiary.universalmonsterrules#scent>`\ ; :ref:`Perception <corerulebook.skills.perception#perception>`\  +8

.. _`bestiary3.adaro#defense`:
...
\ **Melee**\  spear +8 (1d8+4/×3 plus :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\ ), bite +2 (1d6+1)

\ **Ranged**\  spear +8 (1d8+3/×3 plus poison)

\ **Special Attacks**\  rain frenzy

.. _`bestiary3.adaro#statistics`:
...
\ **Feats**\  :ref:`Deadly Aim <corerulebook.feats#deadly_aim>`\ , :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (spear)

\ **Skills**\  :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +8, :ref:`Perception <corerulebook.skills.perception#perception>`\  +8, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +10, :ref:`Swim <corerulebook.skills.swim#swim>`\  +18

\ **Languages**\  Aquan, Common; speak with sharks

\ **SQ**\  amphibious, :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\  use

.. _`bestiary3.adaro#ecology`:
...
.. _`bestiary3.adaro#special_abilities`:

Special Abilities
==================

:ref:`Poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\  (Ex) Adaros favor a paralytic toxin secreted by the flying nettlefin pufferfish—a sticky venom that doesn't wash away in :ref:`water <bestiary.creaturetypes#water_subtype>`\ .
...
\ **Poison Use (Ex)**\  Adaros are skilled in the use of :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\  and never risk accidentally poisoning themselves.

\ **Rain Frenzy (Su)**\  Adaros revere storms, and their lust for blood is amplified exponentially while it is raining. While fighting in the rain or during other stormy weather, adaros act as though affected by the :ref:`rage <corerulebook.spells.rage#rage>`\  spell. An adaro gains this benefit even if it is underwater, but only as long as it remains within a move action away from the :ref:`water <bestiary.creaturetypes#water_subtype>`\ 's surface (50 feet for most adaros).
