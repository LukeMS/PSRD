...
.. _`bestiary3.sasquatch`:

.. contents:: \ 

.. _`bestiary3.sasquatch#sasquatch`:
...
\ **Init**\  +2; \ **Senses**\  darkvision 60 ft., low-light vision, :ref:`scent <bestiary.universalmonsterrules#scent>`\ ; :ref:`Perception <corerulebook.skills.perception#perception>`\  +5

.. _`bestiary3.sasquatch#defense`:
...
.. _`bestiary3.sasquatch#statistics`:

Statistics
===========
\ **Str**\  22, \ **Dex**\  15, \ **Con**\  16, \ **Int**\  9, \ **Wis**\  10, \ **Cha**\  11
\ **Base Atk**\  +2; \ **CMB**\  +8; \ **CMD**\  20
\ **Feats**\  :ref:`Self-Sufficient <corerulebook.feats#self_sufficient>`\ , :ref:`Skill Focus <corerulebook.feats#skill_focus>`\  (:ref:`Stealth <corerulebook.skills.stealth#stealth>`\ )
\ **Skills**\  :ref:`Heal <corerulebook.skills.heal#heal>`\  +2, :ref:`Perception <corerulebook.skills.perception#perception>`\  +5, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +10 (+14 in forested areas), :ref:`Survival <corerulebook.skills.survival#survival>`\  +10; \ **Racial Modifiers**\  +4 :ref:`Perception <corerulebook.skills.perception#perception>`\ , +4 :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  (+8 in forested areas), +4 :ref:`Survival <corerulebook.skills.survival#survival>`
\ **Languages**\  sasquatch
\ **SQ**\ pungency, woodland stride

.. _`bestiary3.sasquatch#ecology`:

Ecology
========
\ **Environment**\  temperate or :ref:`cold <bestiary.creaturetypes#cold_subtype>`\  forests
\ **Organization**\  solitary, pair, or family (3–7)
\ **Treasure**\  standard

.. _`bestiary3.sasquatch#special_abilities`:

Special Abilities
==================
\ **Pungency (Ex)**\ A sasquatch's odor is quite powerful, and can be detected at twice the normal distance by :ref:`scent <bestiary.universalmonsterrules#scent>`\ . 
