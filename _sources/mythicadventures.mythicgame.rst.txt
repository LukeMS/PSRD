...
.. _`mythicadventures.mythicgame#making_a_mythic_atmosphere`:
...
.. _`mythicadventures.mythicgame#different_scales_of_mythic_campaigns`:
...
.. _`mythicadventures.mythicgame#mythic_story_structure`:
...
.. _`mythicadventures.mythicgame#the_importance_of_failure`:
...
.. _`mythicadventures.mythicgame#contact`:
...
.. _`mythicadventures.mythicgame#starting_off_mythic`:
...
.. _`mythicadventures.mythicgame#awakening`:

Awakening
**********

The next step is for the PCs to receive the aid they need, in the form of mythic power. The actual means by which the PCs receive this power may vary (see :ref:`Mythic Themes <mythicadventures.mythicgame#mythic_themes>`\ ), even between PCs in the same game. By the end of this part of the story, the PCs have had their moment of ascension, whether together or separately, and are now mythic. They are not yet ready to face their primary challenge, but the first steps down the path to victory should be revealed at this point.
...
.. _`mythicadventures.mythicgame#journey`:
...
.. _`mythicadventures.mythicgame#return`:
...
.. _`mythicadventures.mythicgame#life_afterward`:
...
.. _`mythicadventures.mythicgame#elements_of_a_mythic_adventure`:
...
\ **Hard Consequences**\ : With all the incredible power at characters' fingertips, it's easy to forget that the heroes are still people—complicated and flawed. Mythic heroes suffer or witness dramatic consequences in stories all the time, and it's those moments that define a hero and help us connect with her. There are different ways to bring about consequences. Failure is one option, whether it is failing a combat or skill check or to failing to make the right decision (see :ref:`The Importance of Failure <mythicadventures.mythicgame#the_importance_of_failure>`\ ). There are other ways to bring about consequences, though, such as having something unforeseen happen because of the PCs' actions. Imagine watching the countryside burn because you used a mythic :ref:`fireball <corerulebook.spells.fireball#fireball>`\  to defeat a foe. And there is always the classic story moment of presenting a hard choice, where no option is without cost. It's through suffering and reacting to such consequences that the true nature of these mythic heroes emerges.
...
.. _`mythicadventures.mythicgame#the_worlds_reaction`:
...
.. _`mythicadventures.mythicgame#the_monomyth`:
...
.. _`mythicadventures.mythicgame#mythic_themes`:
...
.. _`mythicadventures.mythicgame#eldritch_magic`:
...
\ **Story**\ : Adventures using this theme are always tied to the source of power, either by those who wield it or those who seek to steal such power away for themselves. The PCs are drawn into this struggle and must prevent such power from falling into the wrong handsâ¦ possibly even realizing that those hands are their own.
...
.. _`mythicadventures.mythicgame#legendary_encounter`:
...
.. _`mythicadventures.mythicgame#lost_inheritance`:
...
.. _`mythicadventures.mythicgame#planar_might`:
...
.. _`mythicadventures.mythicgame#power_of_the_gods`:
...
.. _`mythicadventures.mythicgame#stolen_might`:
...
.. _`mythicadventures.mythicgame#designing_encounters`:
...
.. _`mythicadventures.mythicgame#high_cr_experience_point_awards_table`:

.. list-table:: High CR Experience Point Awards
   :header-rows: 1
...
.. _`mythicadventures.mythicgame#high_cr_treasure_per_encounter_table`:

.. list-table:: High CR Treasure per Encounter
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`mythicadventures.mythicgame#rewarding_mythic_characters`:
...
The \ *Core Rulebook*\  doesn't include XP rewards for encounters above CR 25 or treasure rewards for encounters above APL 20, but mythic characters might regularly face such challenges and gain such rewards. The :ref:`High CR Experience Point Awards table <mythicadventures.mythicgame#high_cr_experience_point_awards_table>`\  and :ref:`High CR Treasure per Encounter table <mythicadventures.mythicgame#high_cr_treasure_per_encounter_table>`\  give you the XP and treasure rewards for encounters up to CR and APL 30.

.. _`mythicadventures.mythicgame#adjusting_cr_and_level`:
...
To adjust a foe's CR, add half its tier or rank (minimum 1) to its CR. So a 2nd-rank minotaur is effectively a CR 6 monster, while a 6th-tier champion pit fiend would be CR 23. For :ref:`mythic monsters <mythicadventures.mythicmonsters>`\ , this calculation has already been made.

.. _`mythicadventures.mythicgame#mythic_trials`:
...
In addition, each trial should include at least three of the elements noted in :ref:`Elements of a Mythic Adventure <mythicadventures.mythicgame#elements_of_a_mythic_adventure>`\ . These elements define a trial as mythic and help the players understand that they're approaching a vital stage of their journey without directly telling them that a trial is forthcoming.

.. _`mythicadventures.mythicgame#sample_trials`:
...
.. _`mythicadventures.mythicgame#mythic_boons`:
...
\ **Calm Down**\ : The character ends or prevents a combat against a mythic foe with a single skill check, most likely :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  or :ref:`Bluff <corerulebook.skills.bluff#bluff>`\ .
...
\ **Outrageous Lie**\ : Using :ref:`Bluff <corerulebook.skills.bluff#bluff>`\ , the character convinces a creature of a nearly impossible lie (–20 modifier to the check).
...
\ **Tumbler**\ : In 1 round, the character uses :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  to move through the threatened areas of at least five foes without provoking any attacks of opportunity.
...
.. _`mythicadventures.mythicgame#recurring_mythic_villains`:
...
Noncombat encounters help players develop a connection between their PCs and the villain in a way that doesn't risk the villain's life (or the PCs'). Early on, she can appear as a harmless or even helpful NPC. Or, if the PCs have already fought the villain, she can leave notes or use magic to taunt them. Various mythic powers, the :ref:`Disguise <corerulebook.skills.disguise#disguise>`\  skill, or even simple magic like :ref:`disguise self <corerulebook.spells.disguiseself#disguise_self>`\ , :ref:`glibness <corerulebook.spells.glibness#glibness>`\ , or :ref:`nondetection <corerulebook.spells.nondetection#nondetection>`\  can be used to help a villain blend in and rub elbows with the heroes all while seeming innocuous. Later, once the villain is revealed, she can work behind the scenes, using minions and other allies to accomplish her ends, all the while making it plain to the PCs that she's continuing to thwart them.
...
Should the villain be killed, don't be afraid to have her revisit your campaign for a little posthumous mockery and mayhem. There are many ways to reintroduce a dead villain—sometimes it's as simple as having a minion cast :ref:`raise dead <corerulebook.spells.raisedead#raise_dead>`\  or :ref:`resurrection <corerulebook.spells.resurrection#resurrection>`\ , but there are other, more sophisticated options. You can introduce a new recurring villain who tracks down one of the PCs' dead foes and brings him to some semblance of life in the form of an undead minion or possessed item, or who uses :ref:`speak with dead <corerulebook.spells.speakwithdead#speak_with_dead>`\  to learn the deceased foe's secrets.

.. _`mythicadventures.mythicgame#mythic_flaws`:
...
.. _`mythicadventures.mythicgame#ideas_for_mythic_adventures`:
...
.. _`mythicadventures.mythicgame#moments_of_powerlessness`:
...
.. _`mythicadventures.mythicgame#eternal_gaze`:
...
.. _`mythicadventures.mythicgame#falling_stars`:
...
On the other hand, if the PCs do kill the phoenix, they could very well meet it again after its rebirth. Whether it will be grateful to the PCs for releasing it or angry at them is anyone's guessâ¦

.. _`mythicadventures.mythicgame#for_love_of_sport`:
...
.. _`mythicadventures.mythicgame#legacy_of_earth`:
...
.. _`mythicadventures.mythicgame#the_nascent_sphere`:
...
.. _`mythicadventures.mythicgame#unexpected_travels`:
