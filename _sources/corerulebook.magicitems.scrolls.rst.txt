...
.. _`corerulebook.magicitems.scrolls`:

.. contents:: \ 

.. _`corerulebook.magicitems.scrolls#scrolls`:

Scrolls
########

.. _`corerulebook.magicitems.scrolls#table_15_15_scrolls`:

.. list-table:: Table: Scrolls
   :header-rows: 1
...
\ **Physical Description**\ : A scroll is a heavy sheet of fine vellum or high-quality paper. An area about 8-1/2 inches wide and 11 inches long is sufficient to hold one spell. The sheet is reinforced at the top and bottom with strips of leather slightly longer than the sheet is wide. A scroll holding more than one spell has the same width (about 8-1/2 inches) but is an extra foot or so long for each additional spell. Scrolls that hold three or more spells are usually fitted with reinforcing rods at each end rather than simple strips of leather. A scroll has :ref:`AC <corerulebook.combat#armor_class>`\  9, 1 hit point, hardness 0, and a break DC of 8.
...
\ *Decipher the Writing*\ : The writing on a scroll must be deciphered before a character can use it or know exactly what spell it contains. This requires a :ref:`read magic <corerulebook.spells.readmagic#read_magic>`\  spell or a successful :ref:`Spellcraft <corerulebook.skills.spellcraft#spellcraft>`\  check (DC 20 + spell level). Deciphering a scroll is a full-round action.
...
If the user meets all the requirements noted above, and her caster level is at least equal to the spell's caster level, she can automatically activate the spell without a check. If she meets all three requirements but her own caster level is lower than the scroll spell's caster level, then she has to make a caster level check (DC = scroll's caster level + 1) to cast the spell successfully. If she fails, she must make a DC 5 :ref:`Wisdom <corerulebook.gettingstarted#wisdom>`\  check to avoid a mishap (see Scroll Mishaps). A natural roll of 1 always fails, whatever the modifiers. Activating a scroll is a standard action (or the spell's casting time, whichever is longer) and it provokes attacks of opportunity exactly as casting a spell does.
