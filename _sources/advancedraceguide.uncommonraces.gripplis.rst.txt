...
.. _`advancedraceguide.uncommonraces.gripplis`:

.. contents:: \ 

.. _`advancedraceguide.uncommonraces.gripplis#gripplis`:
...
.. _`advancedraceguide.uncommonraces.gripplis#grippli_racial_traits`:
...
\ **Small**\ : Gripplis are Small creatures and gain a +1 size bonus to their AC, a +1 size bonus on attack rolls, a –1 penalty to their CMB and CMD, and a +4 size bonus on :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  checks.
...
\ **Camouflage**\ : Gripplis receive a +4 racial bonus on :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  checks in marshes and forested areas.
...
.. _`advancedraceguide.uncommonraces.gripplis#alternate_racial_traits`:
...
\ **Jumper**\ : Gripplis with this trait are always considered to have a running start when making :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  checks to jump. This racial trait replaces camouflage.

\ **Princely**\ : The grippli gains proficiency with rapiers and a +2 racial bonus on :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  and :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks. This racial trait replaces swamp stride and weapon familiarity. 
...
.. _`advancedraceguide.uncommonraces.gripplis#favored_class_options`:
...
\ **Rogue**\ : Add a +1/2 bonus on :ref:`Perception <corerulebook.skills.perception#perception>`\  checks while in a forest or swamp.

\ **Ranger**\ : Add a +1 racial bonus on :ref:`Swim <corerulebook.skills.swim#swim>`\  skill checks. When this bonus reaches +8, the ranger gains a swim speed of 15 feet (this does not grant the ranger another +8 racial bonus on :ref:`Swim <corerulebook.skills.swim#swim>`\  checks).

.. _`advancedraceguide.uncommonraces.gripplis#racial_archetypes`:
...
.. _`advancedraceguide.uncommonraces.gripplis#bogborn_alchemist_(alchemist)`:
...
.. _`advancedraceguide.uncommonraces.gripplis#class_skills`:

\ **Class Skills**\ : A bogborn alchemist adds :ref:`Swim <corerulebook.skills.swim#swim>`\  to his list of class skills.
...
.. _`advancedraceguide.uncommonraces.gripplis#grippli_discoveries`:
...
\ **Chameleon (Su)**\ : An alchemist with this discovery can shift the colors of his skin and equipment to blend in with the surrounding terrain. He gains a +4 enhancement bonus on :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  checks. At 10th level, the bonus on :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  checks increases to +8.
...
.. _`advancedraceguide.uncommonraces.gripplis#underwater_demolition`:
...
.. _`advancedraceguide.uncommonraces.gripplis#new_racial_rules`:
...
.. _`advancedraceguide.uncommonraces.gripplis#grippli_equipment`:
...
.. _`advancedraceguide.uncommonraces.gripplis#black_marsh_spider_venom`:
...
.. _`advancedraceguide.uncommonraces.gripplis#grippli_feats`:
...
.. _`advancedraceguide.uncommonraces.gripplis#agile_tongue`:
...
\ **Benefit**\ : You have a prehensile tongue with a range of 10 feet. You can pick up items weighing no more than 5 pounds, make :ref:`Sleight of Hand <corerulebook.skills.sleightofhand#sleight_of_hand>`\  checks, perform the steal or disarm combat maneuvers, or make melee touch attacks with your tongue.

.. _`advancedraceguide.uncommonraces.gripplis#grippli_magic_items`:
...
.. _`advancedraceguide.uncommonraces.gripplis#bubble_vault`:
...
.. _`advancedraceguide.uncommonraces.gripplis#description`:
...
.. _`advancedraceguide.uncommonraces.gripplis#construction`:

Construction
=============

\ **Requirements**\  :ref:`Craft Wondrous Item <corerulebook.feats#craft_wondrous_item>`\ , :ref:`shrink item <corerulebook.spells.shrinkitem#shrink_item>`\ , :ref:`unseen servant <corerulebook.spells.unseenservant#unseen_servant>`\ ; \ **Cost**\  750 gp

.. list-table:: Grippli Poison
   :header-rows: 1
