...
.. _`ultimatecombat.classarchetypes.paladin`:

.. contents:: \ 

.. _`ultimatecombat.classarchetypes.paladin#paladin`:
...
.. _`ultimatecombat.classarchetypes.paladin#divine_hunter_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.paladin#precise_shot`:

:ref:`Precise Shot <corerulebook.feats#precise_shot>`\ : A divine hunter gains :ref:`Precise Shot <corerulebook.feats#precise_shot>`\  as a bonus feat at 1st level, even if she doesn't meet the prerequisites. This ability replaces her Heavy Armor Proficiency.

.. _`ultimatecombat.classarchetypes.paladin#shared_precision`:

\ **Shared Precision (Su)**\ : At 3rd level, when a divine hunter hits a creature with a ranged attack, she grants her allies within 10 feet of her the benefit of the :ref:`Precise Shot <corerulebook.feats#precise_shot>`\  feat against that target until the start of her next turn. Her allies must remain within 10 feet of her, and must be able both to see and hear the divine hunter to gain this benefit. This ability replaces aura of courage. 

.. _`ultimatecombat.classarchetypes.paladin#divine_bond`:

\ **Divine Bond (Su)**\ : At 5th level, a divine hunter forms a bond with her deity. This functions as the paladin's divine bond ability, except the bond must always take the form of a ranged or throwing weapon (excluding ammunition). In addition to the listed abilities, a divine hunter can add the :ref:`distance <corerulebook.magicitems.weapons#weapons_distance>`\ , :ref:`returning <corerulebook.magicitems.weapons#weapons_returning>`\ , or :ref:`seeking <corerulebook.magicitems.weapons#weapons_seeking>`\  special abilities to her weapon, but she cannot add the :ref:`defending <corerulebook.magicitems.weapons#weapons_defending>`\  or :ref:`disruption <corerulebook.magicitems.weapons#weapons_disruption>`\  special abilities. Special abilities added to throwing weapons function normally when the weapon is used in melee. This ability replaces the standard paladin's divine bond. 

.. _`ultimatecombat.classarchetypes.paladin#distant_mercy`:
...
.. _`ultimatecombat.classarchetypes.paladin#aura_of_care`:
...
.. _`ultimatecombat.classarchetypes.paladin#hunters_blessing`:

\ **Hunter's Blessing (Su)**\ : At 11th level, a divine hunter can expend a use of her smite evil ability as a swift action to grant herself and all allies within 10 feet the :ref:`Deadly Aim <corerulebook.feats#deadly_aim>`\ , :ref:`Precise Shot <corerulebook.feats#precise_shot>`\ , and :ref:`Improved Precise Shot <corerulebook.feats#improved_precise_shot>`\  feats, even if they lack the prerequisites. The effects last for 1 minute. Evil creatures gain no benefit from this ability. This ability replaces aura of justice.

.. _`ultimatecombat.classarchetypes.paladin#righteous_hunter`:
...
.. _`ultimatecombat.classarchetypes.paladin#empyreal_knight_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.paladin#voices_of_the_spheres`:
...
.. _`ultimatecombat.classarchetypes.paladin#celestial_heart`:
...
At 15th level, she gains truespeech, the ability to speak with any creature that has a language as though using a :ref:`tongues <corerulebook.spells.tongues#tongues>`\  spell. This ability functions with a caster level equal to her character level, and is always active.

At 18th level, as a swift action, the empyreal knight can manifest a protective aura against evil. Against abilities or effects created by evil creatures, this ability provides a +4 deflection bonus to AC and a +4 resistance bonus on saving throws to anyone within 20 feet of her. It otherwise functions as a :ref:`magic circle against evil <corerulebook.spells.magiccircleagainstevil#magic_circle_against_evil>`\ . She can use this ability for a maximum of 1 round per day per paladin level. These rounds do not need to be consecutive. These abilities replace mercy.

.. _`ultimatecombat.classarchetypes.paladin#celestial_ally`:

\ **Celestial Ally (Sp)**\ : At 4th level, an empyreal knight can summon a celestial ally as a full-round action. This functions as :ref:`summon monster I <corerulebook.spells.summonmonster#summon_monster_i>`\ , except it can only be used to summon celestial creatures, archons, and angels. At 6th level, this improves to :ref:`summon monster II <corerulebook.spells.summonmonster#summon_monster_ii>`\ , increasing by one spell level for every two levels thereafter, to a maximum of :ref:`summon monster IX <corerulebook.spells.summonmonster#summon_monster_ix>`\  at 20th level. This ability can be used a number of times per day equal to the empyreal knight's Charisma modifier (minimum 1), but only one ally can be summoned at a time. This ability replaces lay on hands and channel positive energy. 
...
.. _`ultimatecombat.classarchetypes.paladin#empyreal_champion`:
...
.. _`ultimatecombat.classarchetypes.paladin#holy_gun_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.paladin#weapon_and_armor_proficiency`:

\ **Weapon and Armor Proficiency**\ : Holy guns are proficient with all simple and martial weapons, firearms, and light armor. 

.. _`ultimatecombat.classarchetypes.paladin#have_gun`:

\ **Have Gun**\ : At 1st level, the holy gun gains the :ref:`Amateur Gunslinger <ultimatecombat.ultimatecombatfeats#amateur_gunslinger_(combat)>`\  feat and :ref:`Gunsmithing <ultimatecombat.ultimatecombatfeats#gunsmithing>`\  as a bonus feat. She also gains a battered gun identical to the one gained by the gunslinger. This ability replaces detect evil. 

.. _`ultimatecombat.classarchetypes.paladin#divine_deed`:
...
.. _`ultimatecombat.classarchetypes.paladin#smiting_shot`:
...
\ **Divine Bond**\ : At 5th level, a holy gun forms a bond with her deity. This functions as the paladin's divine bond ability, except the bond must always take the form of a firearm. In addition to the listed abilities, a holy gun can add the :ref:`distance <corerulebook.magicitems.weapons#weapons_distance>`\ , \ *reliable*\ , or :ref:`seeking <corerulebook.magicitems.weapons#weapons_seeking>`\  special abilities to her weapon, but she cannot add the :ref:`defending <corerulebook.magicitems.weapons#weapons_defending>`\  or :ref:`disruption <corerulebook.magicitems.weapons#weapons_disruption>`\  special abilities. This ability replaces the standard paladin's divine bond. 

.. _`ultimatecombat.classarchetypes.paladin#holy_grit`:
...
.. _`ultimatecombat.classarchetypes.paladin#holy_slinger`:

\ **Holy Slinger (Ex)**\ : This ability function like the holy champion paladin class feature, but the :ref:`banishment <corerulebook.spells.banishment#banishment>`\  occurs when she hits an evil outsider with the smiting shot deed.

.. _`ultimatecombat.classarchetypes.paladin#holy_tactician_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.paladin#weals_champion`:
...
.. _`ultimatecombat.classarchetypes.paladin#tactical_acumen`:
...
.. _`ultimatecombat.classarchetypes.paladin#battlefield_presence`:
...
.. _`ultimatecombat.classarchetypes.paladin#guide_the_battle`:
...
.. _`ultimatecombat.classarchetypes.paladin#weals_wrath`:
...
.. _`ultimatecombat.classarchetypes.paladin#masterful_presence`:
...
.. _`ultimatecombat.classarchetypes.paladin#knight_of_the_sepulcher_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.paladin#touch_of_the_crypt`:

\ **Touch of the Crypt (Ex)**\ : At 5th level, a knight of the sepulcher gains a +2 bonus on saving throws against mind-affecting effects, death effects, and poison. He is harmed by positive energy effects and healed by negative energy effects as though he were undead, although negative energy effects that don't heal undead (such as enervation) affect him normally. The knight of the sepulcher has a 25% chance of ignoring critical hits and the bonus damage from sneak attacks as though he were wearing armor of :ref:`light <corerulebook.spells.light#light>`\  :ref:`fortification <corerulebook.magicitems.armor#armor_fortification>`\ . This ability replaces the fiendish boon ability.

.. _`ultimatecombat.classarchetypes.paladin#fortitude_of_the_crypt`:
...
.. _`ultimatecombat.classarchetypes.paladin#cloak_of_the_crypt`:

\ **Cloak of the Crypt (Ex)**\ : At 10th level, the knight of the sepulcher gains immunity to energy drain and harmful negative energy effects. His chance of ignoring critical hits and sneak attacks increases to 50%, as though he were wearing armor of moderate :ref:`fortification <corerulebook.magicitems.armor#armor_fortification>`\ . This ability replaces the smite good use gained at 10th level.

.. _`ultimatecombat.classarchetypes.paladin#will_of_the_crypt`:
...
.. _`ultimatecombat.classarchetypes.paladin#weapons_of_sin`:
...
.. _`ultimatecombat.classarchetypes.paladin#crypt_lord`:

\ **Crypt Lord (Ex)**\ : At 15th level, a knight of the sepulcher's chance of ignoring critical hits and sneak attacks increases to 75%, as though he were wearing armor of heavy :ref:`fortification <corerulebook.magicitems.armor#armor_fortification>`\ . He gains immunity to death effects, paralysis, sleep effects, and stunning. He no longer sleeps. The knight of the sepulcher also gains immunity to effects that cause fatigue, and effects that would cause him to become exhausted instead cause him to become fatigued. This ability replaces cruelty.

.. _`ultimatecombat.classarchetypes.paladin#soul_of_the_crypt`:
...
.. _`ultimatecombat.classarchetypes.paladin#undying_champion`:
...
.. _`ultimatecombat.classarchetypes.paladin#sacred_shield_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.paladin#bastion_of_good`:
...
.. _`ultimatecombat.classarchetypes.paladin#improved_bastion`:
...
.. _`ultimatecombat.classarchetypes.paladin#perfect_bastion`:
