...
.. _`ultimatecombat.combat.introduction`:

.. contents:: \ 

.. _`ultimatecombat.combat.introduction#introduction`:
...
.. _`ultimatecombat.combat.introduction#eastern_armor_and_weapons`:
...
.. _`ultimatecombat.combat.introduction#firearms`:
...
.. _`ultimatecombat.combat.introduction#gladiator_weapons`:
...
.. _`ultimatecombat.combat.introduction#primitive_armor_and_weapons`:
...
.. _`ultimatecombat.combat.introduction#duels`:
...
.. _`ultimatecombat.combat.introduction#performance_combat`:
...
.. _`ultimatecombat.combat.introduction#siege_engines`:
