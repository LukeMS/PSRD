...
.. _`ultimateequipment.artifactsandothers.intelligentitems`:

.. contents:: \ 

.. _`ultimateequipment.artifactsandothers.intelligentitems#intelligent_items`:
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#designing_an_intelligent_item`:
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#intelligent_item_alignment`:
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#intelligent_item_alignment_table`:

.. list-table:: Intelligent Item Alignment
   :header-rows: 1
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#intelligent_item_ability_scores`:
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#intelligent_item_ability_scores_table`:

.. list-table:: Intelligent Item Ability Scores
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#languages_spoken_by_item`:
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#senses_and_communication`:
...
\ **Read Magic (Sp)**\ : An intelligent magic item with this ability can read magical writings and scrolls as if through :ref:`read magic <corerulebook.spells.readmagic#read_magic>`\ . This ability does not allow the magic item to activate scrolls or other items. An intelligent magic item can suppress and resume this ability as a free action. 

.. _`ultimateequipment.artifactsandothers.intelligentitems#intelligent_item_senses_and_communication_table`:

.. list-table:: Intelligent Item Senses and Communication
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#intelligent_item_powers`:
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#intelligent_item_powers_table`:

.. list-table:: Intelligent Item Powers
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
   ...
   * - 71–75
     ...
     - +2
   * - 76–80
     - Item can :ref:`fly <corerulebook.spells.fly>`\ , as the spell, at a speed of 30 feet
     - +10,000 gp
     - +2
   * - 81–85
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#special_purpose_items`:
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#intelligent_item_purpose_table`:

.. list-table:: Intelligent Item Purpose
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
   ...
   * - 41–50
     ...
     - +2
   * - 51–55
     - Defeat/slay a particular creature type (see the :ref:`bane <corerulebook.magicitems.weapons#weapons_bane>`\  special ability for choices)
     - +2
   * - 56–60
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#dedicated_powers`:
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#special_purpose_item_dedicated_powers_table`:

.. list-table:: Special Purpose Item Dedicated Powers
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#item_ego`:
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#ego_modifier_by_base_value_table`:

.. list-table:: Ego Modifier by Base Value
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#items_against_characters`:
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#intelligent_item_personality_quirks`:

.. list-table:: Intelligent Item Personality Quirks
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#specific_intelligent_items`:
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#armor_of_the_shadow_lord`:
...
:ref:`Craft Magic Arms and Armor <corerulebook.feats#craft_magic_arms_and_armor>`\ , :ref:`grease <corerulebook.spells.grease#grease>`\ , :ref:`invisibility <corerulebook.spells.invisibility#invisibility>`\ , :ref:`silence <corerulebook.spells.silence#silence>`\ , creator must have the sneak attack class feature

.. _`ultimateequipment.artifactsandothers.intelligentitems#chomper`:
...
\ **Alignment**\ chaotic evil; \ **Senses**\  30 ft., :ref:`blindsense <bestiary3.universalmonsterrules#blindsense>`
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#intended_magic_item`:

Intended Magic Item
====================

:ref:`bag of holding <corerulebook.magicitems.wondrousitems#bag_of_holding>`\  type III

.. _`ultimateequipment.artifactsandothers.intelligentitems#hammer_of_enemies`:
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#harbinger_rod`:
...
\ **Alignment**\ lawful :ref:`good <bestiary3.creaturetypes#good_subtype>`\ ; \ **Senses**\ 30 ft.

\ **Intelligence**\ 10; \ **Wisdom**\ 13; \ **Charisma**\ 12; \ **Ego**\ 10

\ **Language**\ telepathy (Celestial;\ *truespeech*\ )

This copper rod is made up of constantly grinding gearlike parts. It is believed that these rods may be some alternate or lesser form of harbinger archons. The rod can take may useful forms, and after 24 hours in the possession of a lawful good creature, the wielder can command it to take the form of any tool, including a :ref:`chime of opening <corerulebook.magicitems.wondrousitems#chime_of_opening>`\ . Very intelligent and witty, these rods communicate with their wielders in truespeech or Celestial. Furthermore, the rod has the following powers. 

* Three times per day, on command, the rod's wielder can use :ref:`dimension door <corerulebook.spells.dimensiondoor#dimension_door>`\ , as the spell.
...
Craft Rod, :ref:`dimension door <corerulebook.spells.dimensiondoor#dimension_door>`\ , :ref:`knock <corerulebook.spells.knock#knock>`\ , :ref:`explosive runes <corerulebook.spells.explosiverunes#explosive_runes>`\ , creator must be lawful good

.. _`ultimateequipment.artifactsandothers.intelligentitems#headband_of_the_sage`:
...
Craft Wondrous Item, :ref:`comprehend languages <corerulebook.spells.comprehendlanguages#comprehend_languages>`\ , :ref:`fox's cunning <corerulebook.spells.foxscunning#fox_s_cunning>`\ , \ *legend and lore*\ , :ref:`read magic <corerulebook.spells.readmagic#read_magic>`

.. _`ultimateequipment.artifactsandothers.intelligentitems#helmet_of_the_golden_general`:
...
\ **Alignment**\ neutral :ref:`good <bestiary3.creaturetypes#good_subtype>`\ ; \ **Senses**\ 30 ft.
...
* Three times per day, it can affect its wearer or an ally within 30 feet as the :ref:`true strike <corerulebook.spells.truestrike#true_strike>`\  spell.

* Three times per day, it can attempt to demoralize all enemies within 30 feet as a free action, as if using the :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  skill. The helmet's :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  is bonus +17.
...
Craft Wondrous Item, the item's performance and teamwork feat, :ref:`bless <corerulebook.spells.bless#bless>`\ , :ref:`eagle's splendor <corerulebook.spells.eaglessplendor#eagle_s_splendor>`\ , :ref:`prayer <corerulebook.spells.prayer#prayer>`\ , :ref:`scare <corerulebook.spells.scare#scare>`\ , :ref:`true strike <corerulebook.spells.truestrike#true_strike>`

.. _`ultimateequipment.artifactsandothers.intelligentitems#lightning_bow`:
...
* A \ *lightning bow*\  needs no ammunition. With the pull of a string, it creates a +3 :ref:`shock <corerulebook.magicitems.weapons#weapons_shock>`\  arrow or a +3 :ref:`brilliant energy <corerulebook.magicitems.weapons#weapons_brilliant_energy>`\  arrow (the wielder's choice with each shot).

* Three times per day, the wielder can cast :ref:`true strike <corerulebook.spells.truestrike#true_strike>`\  as a swift action. The :ref:`true strike <corerulebook.spells.truestrike#true_strike>`\  can only be used with attacks made with the \ *lightning bow*\ .

* Three times per day, the wielder can use :ref:`lightning bolt <corerulebook.spells.lightningbolt#lightning_bolt>`\  as a spell-like ability.
...
Craft Magic Arms and Armor, :ref:`call lightning <corerulebook.spells.calllightning#call_lightning>`\ , the willing service of one Huge lighting elemental for at least 100 years

.. _`ultimateequipment.artifactsandothers.intelligentitems#lute_of_discord`:
...
This lute is a masterwork instrument constructed of polished ebony, with mother of pearl embellishments and gold frets. It grants any creature playing it a +2 competence bonus on :ref:`Perform <corerulebook.skills.perform#perform>`\  (string instruments) checks as it gently telepathically whispers ways the creature can improve is current performance. It also grants those who can play the lute the following abilities. 

* Three times per day on command, a creature with at least 6 ranks in :ref:`Perform <corerulebook.skills.perform#perform>`\  (string instruments) can play a chord on the lute of discord to employ the :ref:`murderous command <ultimatemagic.spells.murderouscommand#murderous_command>`\  spell.

* Three times per day on command, a creature with at least 6 ranks in :ref:`Perform <corerulebook.skills.perform#perform>`\  (string instruments) can play a chord on the \ *lute of discord*\  to use the :ref:`distracting cacophony <ultimatemagic.spells.distractingcacophony#distracting_cacophony>`\  spell (3rd level).

* Once per day on command, a creature with at least 6 ranks in :ref:`Perform <corerulebook.skills.perform#perform>`\  (string instruments) can play a chord to use the :ref:`echolocation <ultimatemagic.spells.echolocation#echolocation>`\  spell (4th level caster)
...
Craft Wondrous Item, :ref:`distracting cacophony <ultimatemagic.spells.distractingcacophony#distracting_cacophony>`\ , :ref:`echolocation <ultimatemagic.spells.echolocation#echolocation>`\ , :ref:`murderous command <ultimatemagic.spells.murderouscommand#murderous_command>`\  

.. _`ultimateequipment.artifactsandothers.intelligentitems#metamagicians_apprentice`:
...
The rod can be used as a +1 :ref:`light <corerulebook.spells.light#light>`\  mace. On command, it transforms into a \ *+1/+1 quarterstaff*\  or back to its rod form.

A \ *metamagician's apprentice*\  knows four metamagic feats (limited to feats that use a spell slot one or two levels higher than the spell's actual level, such as :ref:`Silent Spell <corerulebook.feats#silent_spell>`\  and :ref:`Empower Spell <corerulebook.feats#empower_spell>`\ ) and acts as a \ *greater metamagic rod*\  for those feats. The rod can only apply one metamagic feat to a spell at a time, though (like a \ *metamagic rod*\ ) the wielder can use his own feats and the rod's on the same spell.

The rod can use :ref:`read magic <corerulebook.spells.readmagic#read_magic>`\  and :ref:`detect magic <corerulebook.spells.detectmagic#detect_magic>`\  at will. The \ *metamagician's apprentice*\  is never overwhelmed by powerful magic auras. These abilities do not trigger effects that require reading to activate (such as the :ref:`explosive runes <corerulebook.spells.explosiverunes#explosive_runes>`\  spell). The rod grants the wielder a +2 competence bonus on three :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  skills; these skills are determined when the rod is created (and require the apprentice to have ranks in that skill) and can never be changed. :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana) is almost always one of these three skills. 
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#obsession_ring`:
...
* The ring functions as a :ref:`ring of protection <corerulebook.magicitems.rings#ring_of_protection>`\  +5.
...
Forge Ring, :ref:`shield of faith <corerulebook.spells.shieldoffaith#shield_of_faith>`\ , creator must be 15th level (or 9th level if the creator is a gnome)

.. _`ultimateequipment.artifactsandothers.intelligentitems#rod_that_should_not_be_lesser`: `ultimateequipment.artifactsandothers.intelligentitems#rod_that_should_not_be_(lesser)`_

.. _`ultimateequipment.artifactsandothers.intelligentitems#rod_that_should_not_be_(lesser)`:
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#rod_that_should_not_be_greater`: `ultimateequipment.artifactsandothers.intelligentitems#rod_that_should_not_be_(greater)`_

.. _`ultimateequipment.artifactsandothers.intelligentitems#rod_that_should_not_be_(greater)`:
...
.. _`ultimateequipment.artifactsandothers.intelligentitems#shield_of_the_mage`:
...
This :ref:`caster's shield <corerulebook.magicitems.armor#caster_s_shield>`\  always has one arcane scroll and knows the same arcane spells as the wielder. When the spell on the scroll is cast, another scroll of a spell the wielder knows randomly manifests to replace it. The shield has no arcane spell failure. The shield can also :ref:`read magic <corerulebook.spells.readmagic#read_magic>`\ . It will often debate with its wielder for the most devastating course of action, but does what the wielder commands.
...
Craft Magic Arms and Armor, :ref:`Scribe Scroll <corerulebook.feats#scribe_scroll>`\ , creator must be an arcane spellcaster of at least 14th level

.. _`ultimateequipment.artifactsandothers.intelligentitems#singing_sword`:
...
This +2 :ref:`keen <corerulebook.magicitems.weapons#weapons_keen>`\  :ref:`dancing <corerulebook.magicitems.weapons#weapons_dancing>`\  longsword is infused with the soul of a bard who chose to instill his consciousness into a weapon rather than to see his voice die. The sword constantly sings. The only way to silence it to a whisper is with a DC 15 :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  or :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  check, and even this only quiets the sword for 10 minutes plus another 10 minutes for every 5 points by which the DC is exceeded. The sword speaks, though it typically communicates through song. A \ *singing sword*\  has the following powers. 
...
* Three times per day, the \ *singing sword*\  can use the :ref:`heroic finale <advancedplayersguide.spells.heroicfinale#heroic_finale>`\  spell.
...
Craft Arms and Armor, :ref:`keen edge <corerulebook.spells.keenedge#keen_edge>`\ , \ *animate object*\ , the soul of a willing bard of at least 8th level
