...
.. _`bestiary.homunculus`:

.. contents:: \ 

.. _`bestiary.homunculus#homunculus`:
...
Any alignment (same as creator) Tiny :ref:`construct <bestiary.creaturetypes#construct>`\  

\ **Init**\  +2; \ **Senses**\  darkvision 60 ft., low-light vision; :ref:`Perception <corerulebook.skills.perception#perception>`\  +3

.. _`bestiary.homunculus#defense`:
...
\ **Defensive Abilities**\  :ref:`construct traits <bestiary.universalmonsterrules#construct_traits>`

.. _`bestiary.homunculus#offense`:
...
\ **Melee**\  1 bite +3 (1d4–1 plus :ref:`poison <bestiary.universalmonsterrules#poison>`\ ) 

\ **Space**\  2-1/2 ft.; \ **Reach**\  0 ft.

.. _`bestiary.homunculus#statistics`:
...
\ **Skills**\  :ref:`Fly <corerulebook.skills.fly#fly>`\  +10, :ref:`Perception <corerulebook.skills.perception#perception>`\  +3, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +12

\ **Languages**\  Common (cannot speak); telepathic link

.. _`bestiary.homunculus#ecology`:
...
.. _`bestiary.homunculus#special_abilities`:
...
.. _`bestiary.homunculus#construction`:
...
\ **Requirements**\  :ref:`Craft Construct <bestiary.monsterfeats#craft_construct>`\ , :ref:`arcane eye <corerulebook.spells.arcaneeye#arcane_eye>`\ , :ref:`mirror image <corerulebook.spells.mirrorimage#mirror_image>`\ , :ref:`mending <corerulebook.spells.mending#mending>`\ ; \ **Skill**\  :ref:`Craft <corerulebook.skills.craft#craft>`\  (leather) or :ref:`Craft <corerulebook.skills.craft#craft>`\  (sculptures) DC 12; \ **Cost**\  1,050 gp. 
