...
.. _`ultimatecampaign.campaignsystems.alignment`:

.. contents:: \ 

.. _`ultimatecampaign.campaignsystems.alignment#alignment`:
...
.. _`ultimatecampaign.campaignsystems.alignment#lawful_good`:
...
.. _`ultimatecampaign.campaignsystems.alignment#neutral_good`:
...
.. _`ultimatecampaign.campaignsystems.alignment#chaotic_good`:
...
.. _`ultimatecampaign.campaignsystems.alignment#lawful_neutral`:
...
.. _`ultimatecampaign.campaignsystems.alignment#neutral`:
...
.. _`ultimatecampaign.campaignsystems.alignment#chaotic_neutral`:
...
.. _`ultimatecampaign.campaignsystems.alignment#lawful_evil`:
...
.. _`ultimatecampaign.campaignsystems.alignment#neutral_evil`:
...
.. _`ultimatecampaign.campaignsystems.alignment#chaotic_evil`:
...
.. _`ultimatecampaign.campaignsystems.alignment#changing_alignment`:
...
Using an :ref:`atonement <corerulebook.spells.atonement#atonement>`\  spell moves the character's position on the alignment track the minimum amount to return the character to his previous alignment. For example, a fallen paladin using :ref:`atonement <corerulebook.spells.atonement#atonement>`\  to become good again shifts her position on the good-evil track to 3, even if she originally was at 2 or 1. The spell is a means of reversing the worst of an indiscretion, not for gaining a safe buffer within an alignment zone on the track, and this gives the character an incentive to work toward entrenching herself within the tenets of the restored alignment. Using the "reverse magical alignment change" option of :ref:`atonement <corerulebook.spells.atonement#atonement>`\  does not give the target the normal alignment-change penalty on attack rolls, saving throws, and checks, but accepting the "redemption or temptation" option does.
...
.. _`ultimatecampaign.campaignsystems.alignment#forced_alignment_change`:
...
.. _`ultimatecampaign.campaignsystems.alignment#table_changing_alignment`:

.. list-table:: Changing Alignment
   :header-rows: 1
