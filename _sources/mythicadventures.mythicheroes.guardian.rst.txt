...
.. _`mythicadventures.mythicheroes.guardian`:

.. contents:: \ 

.. _`mythicadventures.mythicheroes.guardian#guardian`:
...
.. _`mythicadventures.mythicheroes.guardian#guardian_features`:
...
\ *Absorb Blow (Su)*\ : As an immediate action, whenever you take hit point damage from a single source (such as a dragon's breath, a spell, or a weapon), you can expend one use of mythic power to reduce the damage you take from that source by 5 per tier (to a minimum of 0 points of damage taken). If you have another ability or effect that reduces damage (such as :ref:`protection from energy <corerulebook.spells.protectionfromenergy#protection_from_energy>`\ ), reduce the damage with the absorb blow ability before applying any other damage-reducing effects. For every 10 points of damage that this ability prevents, for 1 minute you gain DR 1/epic and 5 points of resistance against acid, cold, electricity, fire, and sonic damage. The DR and resistances stack with any other DR and resistances that you have.
...
\ **Path Ability**\ : At 1st tier and every tier thereafter, select one new path ability from the guardian path abilities lists or from the :ref:`universal path abilities lists <mythicadventures.mythicheroes#universal_path_abilities>`\ . Once you select an ability, it can't be changed. Unless otherwise noted, each ability can be selected only once. Some abilities have requirements, such as a class ability or minimum mythic tier, that you must meet before you select them.
...
.. _`mythicadventures.mythicheroes.guardian#1st_tier_guardian_path_abilities`:

1st-Tier Guardian Path Abilities
=================================
You can select these path abilities at any tier.

.. _`mythicadventures.mythicheroes.guardian#adamantine_mind`:
...
.. _`mythicadventures.mythicheroes.guardian#additional_call`:

\ **Additional Call (Ex)**\ : You learn an additional guardian's call ability. You can select this ability twice.

.. _`mythicadventures.mythicheroes.guardian#armor_master`:
...
.. _`mythicadventures.mythicheroes.guardian#armored_might`:
...
.. _`mythicadventures.mythicheroes.guardian#avenging_maneuver`:
...
.. _`mythicadventures.mythicheroes.guardian#borrow_elements`:
...
.. _`mythicadventures.mythicheroes.guardian#burst_through`:
...
.. _`mythicadventures.mythicheroes.guardian#draw_fire`:
...
.. _`mythicadventures.mythicheroes.guardian#empathic_healing`:
...
.. _`mythicadventures.mythicheroes.guardian#ever_ready`:
...
.. _`mythicadventures.mythicheroes.guardian#fast_healing`:
...
.. _`mythicadventures.mythicheroes.guardian#guardians_shout`:
...
.. _`mythicadventures.mythicheroes.guardian#immovable`:
...
.. _`mythicadventures.mythicheroes.guardian#imprinting_hand`:
...
.. _`mythicadventures.mythicheroes.guardian#knowledgeable_guardian`:

\ **Knowledgeable Guardian (Su)**\ : Add double your tier as a bonus on :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  checks you attempt to identify monsters, including checks made to learn any special powers and vulnerabilities. As a free action, you can expend one use of mythic power to telepathically communicate the knowledge you obtain from this check to all allies within 100 feet.

.. _`mythicadventures.mythicheroes.guardian#lesson_learned`:
...
.. _`mythicadventures.mythicheroes.guardian#mythic_companion`:
...
.. _`mythicadventures.mythicheroes.guardian#partial_transformation`:
...
.. _`mythicadventures.mythicheroes.guardian#quick_recovery`:

\ **Quick Recovery (Ex)**\ : Whenever you are dazed, dazzled, deafened, sickened, or stunned, reduce the duration of that condition by half (minimum 1 round). Any other effects relating to the source of that condition are unaffected; for example, if you are panicked and sickened from an :ref:`eyebite <corerulebook.spells.eyebite#eyebite>`\  spell, the panicked effect has the normal duration even though you are sickened for only half as long. You can select this ability twice. The second time you select it, you also reduce the duration of the blinded, nauseated, and paralyzed conditions by half.

.. _`mythicadventures.mythicheroes.guardian#raise_animal`:

\ **Raise Animal (Su)**\ : By burying the corpse of a dead animal (at least its bones) and expending one use of mythic power, you raise it from the dead overnight. You can use this ability on an animal companion, familiar, or bonded mount even if it is not a creature of the animal type. At 1st tier, this functions like :ref:`raise dead <corerulebook.spells.raisedead#raise_dead>`\ . At 3rd tier, this functions like :ref:`resurrection <corerulebook.spells.resurrection#resurrection>`\ . At 6th tier, this functions like :ref:`true resurrection <corerulebook.spells.trueresurrection#true_resurrection>`\ .

.. _`mythicadventures.mythicheroes.guardian#ranged_disarm`:
...
.. _`mythicadventures.mythicheroes.guardian#relentless_healing`:
...
.. _`mythicadventures.mythicheroes.guardian#retributive_reach`:
...
.. _`mythicadventures.mythicheroes.guardian#sacrificial_shield`:
...
.. _`mythicadventures.mythicheroes.guardian#supreme_tracker`:
...
.. _`mythicadventures.mythicheroes.guardian#3rd_tier_guardian_path_abilities`:

3rd-Tier Guardian Path Abilities
=================================
You must be at least 3rd tier to select these path abilities.

.. _`mythicadventures.mythicheroes.guardian#cage_enemy`:
...
.. _`mythicadventures.mythicheroes.guardian#dimensional_grappler`:

\ **Dimensional Grappler (Su)**\ : When you have an opponent grappled or pinned and it attempts to use a teleportation effect, you can attempt a Will save against the effect, even if it would not normally allow a save. If you succeed, you learn the type of teleportation effect (such as :ref:`dimension door <corerulebook.spells.dimensiondoor#dimension_door>`\ ) and the creature's intended destination, and then may prevent the effect (as if using a quickened :ref:`dimensional anchor <corerulebook.spells.dimensionalanchor#dimensional>`\ , using your character level as your caster level) or accompany the opponent as if you were part of its gear with negligible weight.

.. _`mythicadventures.mythicheroes.guardian#drive_back`:
...
.. _`mythicadventures.mythicheroes.guardian#earth_protection`:
...
.. _`mythicadventures.mythicheroes.guardian#impervious_body`:
...
.. _`mythicadventures.mythicheroes.guardian#impervious_companion`:
...
.. _`mythicadventures.mythicheroes.guardian#incredible_parry`:
...
.. _`mythicadventures.mythicheroes.guardian#parry_spell`:

\ **Parry Spell (Su)**\ : As an immediate action, you can expend one use of mythic power to block a spell targeting you or an ally adjacent to you. The spell must be a ray, a single-target spell, or a spell that creates an effect targeting one creature (such as :ref:`acid arrow <corerulebook.spells.acidarrow#acid_arrow>`\ ), and the level of the spell's spell slot must be equal to or lower than your tier. Make an attack roll as if making an attack of opportunity. If the result of the attack roll is greater than the spell's attack roll or save DC, the spell has no effect on the intended target (though other targets from the same spell, such as multiple targets of :ref:`scorching ray <corerulebook.spells.scorchingray#scorching_ray>`\ , are affected normally). A spell that has neither a DC nor an attack roll (such as :ref:`magic missile <corerulebook.spells.magicmissile#magic_missile>`\ ) can't be affected by this ability. You must declare using spell parry after the spellcaster's target is announced, but before the target's saving throw or attack roll is made.

.. _`mythicadventures.mythicheroes.guardian#possess_companion`:

\ **Possess Companion (Su)**\ : You can expend one use of mythic power to project your soul from your body and into your animal companion, cohort, eidolon, familiar, or bonded mount as if possessing that creature with the :ref:`magic jar <corerulebook.spells.magicjar#magic_jar>`\  spell\ *.*\ Unlike with :ref:`magic jar <corerulebook.spells.magicjar#magic_jar>`\ , the companion creature's soul remains within its body, allowing you to know what it knows and share its memories. This effect lasts until you end it as a standard action.

.. _`mythicadventures.mythicheroes.guardian#shrug_it_off`:
...
.. _`mythicadventures.mythicheroes.guardian#to_the_death`:
...
.. _`mythicadventures.mythicheroes.guardian#turn_the_tables`:
...
.. _`mythicadventures.mythicheroes.guardian#indomitable`:
...
.. _`mythicadventures.mythicheroes.guardian#invincible_stand`:
...
.. _`mythicadventures.mythicheroes.guardian#mythic_resolve`:
...
.. _`mythicadventures.mythicheroes.guardian#take_the_hit`:
...
.. _`mythicadventures.mythicheroes.guardian#guardian_builds`:
