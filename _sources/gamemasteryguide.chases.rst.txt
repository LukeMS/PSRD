...
.. _`gamemasteryguide.chases`:

.. contents:: \ 

.. _`gamemasteryguide.chases#chases`:
...
.. _`gamemasteryguide.chases#building_a_chase`:
...
.. _`gamemasteryguide.chases#sudden_start`:
...
.. _`gamemasteryguide.chases#head_start`:
...
.. _`gamemasteryguide.chases#long_shot`:
...
.. _`gamemasteryguide.chases#chase_obstacles`:
...
As a general rule, obstacles should be overcome by physical skill checks, such as :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\ , :ref:`Climb <corerulebook.skills.climb#climb>`\ , :ref:`Escape Artist <corerulebook.skills.escapeartist#escape_artist>`\ , :ref:`Ride <corerulebook.skills.ride#ride>`\ , or :ref:`Swim <corerulebook.skills.swim#swim>`\ . :ref:`Perception <corerulebook.skills.perception#perception>`\  can be used for obstacles like short cuts, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  can be rolled for obstacles requiring someone to move through a square quietly, or :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  might be required to navigate a square by convincing a city guard you should be allowed to pass. You can even use saving throws to resolve obstacles (a Fortitude save to avoid being sickened by passing through a pool of filth, for example, or a Will save to evade the strange wailing spirits haunting that area). Be creative! It's okay to reuse obstacles, but try to vary them between cards and remember not to get bogged down with repetitive DCs or certain types of checks!

.. _`gamemasteryguide.chases#running_a_chase`:
