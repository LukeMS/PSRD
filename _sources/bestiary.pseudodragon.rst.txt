...
.. _`bestiary.pseudodragon`:

.. contents:: \ 

.. _`bestiary.pseudodragon#pseudodragon`:
...
NG Tiny :ref:`dragon <bestiary.creaturetypes#dragon>`\  

\ **Init**\  +2; \ **Senses**\  :ref:`blindsense <bestiary.universalmonsterrules#blindsense>`\  60 ft., darkvision 60 ft., low-light vision; :ref:`Perception <corerulebook.skills.perception#perception>`\  +6

.. _`bestiary.pseudodragon#defense`:
...
.. _`bestiary.pseudodragon#offense`:
...
\ **Melee**\  sting +6 (1d3–2 plus :ref:`poison <bestiary.universalmonsterrules#poison>`\ ), bite +6 (1d2–2) 

\ **Space**\  2-1/2 ft.; \ **Reach**\  0 ft. (5 ft. with tail)

.. _`bestiary.pseudodragon#statistics`:
...
\ **Skills**\  :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  +5, :ref:`Fly <corerulebook.skills.fly#fly>`\  +15, :ref:`Perception <corerulebook.skills.perception#perception>`\  +6, :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  +6, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +19 (+23 in forests), :ref:`Survival <corerulebook.skills.survival#survival>`\  +6; \ **Racial Modifiers**\  +4 :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  (improves to +8 in forests)

\ **Languages**\  Draconic; :ref:`telepathy <bestiary.universalmonsterrules#telepathy>`\  (60 ft.)

.. _`bestiary.pseudodragon#ecology`:
...
.. _`bestiary.pseudodragon#special_abilities`:
