...
.. _`ultimatecombat.spells.fieryshuriken`:

.. contents:: \ 

.. _`ultimatecombat.spells.fieryshuriken#fiery_shuriken`:

Fiery Shuriken
===============

\ **School**\  conjuration (creation) [:ref:`fire <bestiary.creaturetypes#fire_subtype>`\ ]; \ **Level**\  sorcerer/wizard 2
