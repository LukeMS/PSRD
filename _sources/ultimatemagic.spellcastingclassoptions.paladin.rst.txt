...
.. _`ultimatemagic.spellcastingclassoptions.paladin`:

.. contents:: \ 

.. _`ultimatemagic.spellcastingclassoptions.paladin#paladin`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#oathbound_paladin_(archetype)`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#deity`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#code_of_conduct`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#oath_spells`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#oaths`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#oath_against_corruption`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#aura_of_purity`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#cleansing_flame`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#cast_into_the_void`:
...
Whenever the paladin uses lay on hands to heal a creature, she heals the maximum possible amount. This ability replaces holy champion.
...
\ **Oath Spells**\ : 1st—:ref:`true strike <corerulebook.spells.truestrike#true_strike>`\ ; 2nd—:ref:`acute senses <ultimatemagic.spells.acutesenses#acute_senses>`\ ; 3rd—:ref:`touch of idiocy <corerulebook.spells.touchofidiocy#touch_of_idiocy>`\ ; 4th—:ref:`spell immunity <corerulebook.spells.spellimmunity#spell_immunity>`\ .

.. _`ultimatemagic.spellcastingclassoptions.paladin#oath_against_fiends`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#anchoring_aura`:

\ **Anchoring Aura (Su)**\ : At 8th level, a paladin's aura hampers extradimensional travel by evil outsiders. The aura extends 20 feet from the paladin. Evil outsiders attempting to use abilities such as :ref:`dimension door <corerulebook.spells.dimensiondoor#dimension_door>`\ , :ref:`plane shift <corerulebook.spells.planeshift#plane_shift>`\ , or :ref:`teleport <corerulebook.spells.teleport#teleport>`\  to leave or enter the aura must succeed at a Will save (DC 10 + 1/2 the paladin's level + the paladin's Charisma modifier); failure means the ability does not function, as if the outsider were affected by :ref:`dimensional anchor <corerulebook.spells.dimensionalanchor#dimensional>`\ . The aura functions only while the paladin is conscious, not if she is unconscious or dead.

Alternatively, as an immediate action, the paladin can expend one use of her smite evil ability to target an evil outsider within 30 feet with :ref:`dimensional anchor <corerulebook.spells.dimensionalanchor#dimensional>`\ . A targeted :ref:`dimensional anchor <corerulebook.spells.dimensionalanchor#dimensional>`\  persists even if the paladin is unconscious or dead.

This ability replaces aura of resolve.

.. _`ultimatemagic.spellcastingclassoptions.paladin#holy_vessel`:

\ **Holy Vessel (Su)**\ : At 9th level, a paladin whose divine bond is with a weapon can also use her divine bond to augment her armor or shield with enhancement bonuses, or add any of the following armor or shield properties: :ref:`bashing <corerulebook.magicitems.armor#armor_bashing>`\ , :ref:`fortification <corerulebook.magicitems.armor#armor_fortification>`\ , and :ref:`spell resistance <corerulebook.magicitems.armor#armor_spell_resistance>`\ . Adding these properties consumes an amount of bonus equal to the property's cost (see the :ref:`armor special abilities <corerulebook.magicitems.armor#table_15_4_armor_special_abilities>`\  and :ref:`shield special abilities <corerulebook.magicitems.armor#table_15_5_shield_special_abilities>`\  tables). She can divide her bonuses from the divine bond ability among her weapon, armor, and shield as she sees fit. This ability has no effect for a paladin whose divine bond is with a mount. This ability replaces the mercy gained at 9th level.
...
\ **Oath Spells**\ : 1st—:ref:`resist energy <corerulebook.spells.resistenergy#resist_energy>`\ ; 2nd—:ref:`detect thoughts <corerulebook.spells.detectthoughts#detect_thoughts>`\ ; 3rd—:ref:`invisibility purge <corerulebook.spells.invisibilitypurge#invisibility_purge>`\ ; 4th—:ref:`plane shift <corerulebook.spells.planeshift#plane_shift>`\ .

.. _`ultimatemagic.spellcastingclassoptions.paladin#oath_against_savagery`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#holy_reach`:

\ **Holy Reach (Su)**\ : At 2nd level, an oathbound paladin can expend one use of her smite evil ability to extend her natural reach by 5 feet for 1 minute. This does not stack with the :ref:`Lunge <corerulebook.feats#lunge>`\  feat. This ability replaces divine grace.

.. _`ultimatemagic.spellcastingclassoptions.paladin#hordebreaker`:

\ **Hordebreaker (Su)**\ : At 11th level, when the paladin hits an evil humanoid with an attack of opportunity, she deals an additional 1d6 points of damage. When using holy reach, the paladin may make a number of additional attacks of opportunity per round equal to her Charisma bonus. This increase stacks with similar increases from other sources such as :ref:`Combat Reflexes <corerulebook.feats#combat_reflexes>`\ . This ability replaces aura of justice.
...
\ **Oath Spells**\ : 1st—:ref:`deathwatch <corerulebook.spells.deathwatch#deathwatch>`\ ; 2nd—:ref:`protection from arrows <corerulebook.spells.protectionfromarrows#protection_from_arrows>`\ ; 3rd—:ref:`haste <corerulebook.spells.haste#haste>`\ ; 4th—:ref:`divine power <corerulebook.spells.divinepower#divine_power>`\ .

.. _`ultimatemagic.spellcastingclassoptions.paladin#oath_against_undeath`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#detect_undead`:

\ **Detect Undead (Su)**\ : This ability works like the standard paladin ability to detect evil, except as :ref:`detect undead <corerulebook.spells.detectundead#detect_undead>`\  instead of :ref:`detect evil <corerulebook.spells.detectevil#detect_evil>`\ . This ability replaces :ref:`detect evil <corerulebook.spells.detectevil#detect_evil>`\ .

.. _`ultimatemagic.spellcastingclassoptions.paladin#ghost_touch_aura`:

\ **Ghost Touch Aura (Su)**\ : At 3rd level, the paladin's armor is treated as if it had the :ref:`ghost touch <corerulebook.magicitems.armor#armor_ghost_touch>`\  armor property. This does not affect the cost or effect of any other abilities of the armor. At 9th level, this ability also applies to the paladin's shield. This ability replaces the paladin's 3rd-level and 9th-level mercies.

.. _`ultimatemagic.spellcastingclassoptions.paladin#aura_of_life`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#superior_channeler`:
...
\ **Oath Spells**\ : 1st—:ref:`sanctify corpse <ultimatemagic.spells.sanctifycorpse#sanctify_corpse>`\ ; 2nd—:ref:`darkvision <corerulebook.spells.darkvision#darkvision>`\ ; 3rd—:ref:`searing light <corerulebook.spells.searinglight#searing_light>`\ ; 4th—:ref:`halt undead <corerulebook.spells.haltundead#halt_undead_copy>`\ .

.. _`ultimatemagic.spellcastingclassoptions.paladin#oath_against_the_wyrm`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#breath_evasion`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#divine_bond`:

\ **Divine Bond (Sp)**\ : This works like the paladin's normal divine bond ability, except as follows. If the paladin's bond is with a weapon, she cannot use that ability to add the :ref:`brilliant energy <corerulebook.magicitems.weapons#weapons_brilliant_energy>`\ , :ref:`disruption <corerulebook.magicitems.weapons#weapons_disruption>`\ , or :ref:`merciful <corerulebook.magicitems.weapons#weapons_merciful>`\  weapon properties, but she can add the :ref:`bane <corerulebook.magicitems.weapons#weapons_bane>`\  weapon property (but only against dragons). If the paladin's bond is with her steed, the steed gains the paladin's aura-based immunities and her aura does not affect allies. This replaces the standard divine bond ability.

.. _`ultimatemagic.spellcastingclassoptions.paladin#dragon_slaying_strike`:

\ **Dragon-Slaying Strike (Su)**\ : At 20th level, an oathbound paladin becomes a conduit of holy power. Her DR increases to 10/evil. Whenever she uses smite evil and successfully strikes a dragon, the dragon is also subject to a single-target :ref:`holy word <corerulebook.spells.holyword#holy_word>`\ , using her paladin level +10 as the caster level. After the banishment effect and the damage from the attack are resolved, the smite immediately ends. In addition, whenever she channels positive energy or uses lay on hands to heal a creature, she heals the maximum possible amount. This ability replaces holy champion.
...
\ **Oath Spells**\ : 1st—:ref:`enlarge person <corerulebook.spells.enlargeperson#enlarge_person>`\ ; 2nd—:ref:`bear's endurance <corerulebook.spells.bearsendurance#bear_s_endurance>`\ ; 3rd—:ref:`fly <corerulebook.spells.fly>`\ ; 4th—:ref:`stoneskin <corerulebook.spells.stoneskin#stoneskin>`\ .

.. _`ultimatemagic.spellcastingclassoptions.paladin#oath_of_charity`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#charitable_hands`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#charitable_mercy`:
...
\ **Oath Spells**\ : 1st—:ref:`magic stone <corerulebook.spells.magicstone#magic_stone>`\ ; 2nd—:ref:`make whole <corerulebook.spells.makewhole#make_whole>`\ ; 3rd—:ref:`magic vestment <corerulebook.spells.magicvestment#magic_vestment>`\ ; 4th—:ref:`imbue with spell ability <corerulebook.spells.imbuewithspellability#imbue_with_spell_ability>`\ .

.. _`ultimatemagic.spellcastingclassoptions.paladin#oath_of_chastity`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#pure_of_mind`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#pure_of_body`:

\ **Pure of Body (Su)**\ : Upon reaching 8th level, the paladin has a 50% chance to turn any critical hit or sneak attack against her into a normal hit, as if she were wearing :ref:`fortification <corerulebook.magicitems.armor#armor_fortification>`\  armor. This ability replaces aura of resolve. 

\ **Code of Conduct**\ : Never engage in a romantic relationship or a sexual act.

\ **Oath Spells**\ : 1st—:ref:`remove fear <corerulebook.spells.removefear#remove_fear>`\ ; 2nd—:ref:`confess <advancedplayersguide.spells.confess#confess>`\ ; 3rd—:ref:`heroism <corerulebook.spells.heroism#heroism>`\ ; 4th—:ref:`freedom of movement <corerulebook.spells.freedomofmovement#freedom_of_movement>`\ .

.. _`ultimatemagic.spellcastingclassoptions.paladin#oath_of_loyalty`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#loyal_oath`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#loyal_guardian`:
...
\ **Oath Spells**\ : 1st—:ref:`wrath <advancedplayersguide.spells.wrath#wrath>`\ ; 2nd—:ref:`aid <corerulebook.spells.aid#aid>`\ ; 3rd—:ref:`helping hand <corerulebook.spells.helpinghand#helping_hand>`\ ; 4th—:ref:`sending <corerulebook.spells.sending#sending>`\ .

.. _`ultimatemagic.spellcastingclassoptions.paladin#oath_of_vengeance`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#channel_wrath`:
...
.. _`ultimatemagic.spellcastingclassoptions.paladin#powerful_justice`:
...
\ **Oath Spells**\ : 1st—:ref:`wrath <advancedplayersguide.spells.wrath#wrath>`\ ; 2nd—:ref:`confess <advancedplayersguide.spells.confess#confess>`\ ; 3rd—:ref:`blessing of fervor <advancedplayersguide.spells.blessingoffervor#blessing_of_fervor>`\ ; 4th—:ref:`order's wrath <corerulebook.spells.orderswrath#order_s_wrath>`\ .
