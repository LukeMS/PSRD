...
\ **Init**\  +2; \ **Senses**\  low-light vision, :ref:`scent <bestiary.universalmonsterrules#scent>`\ ; :ref:`Perception <corerulebook.skills.perception#perception>`\  +6

.. _`bestiary.horse#defense`:
...
\ **Feats**\  :ref:`Endurance <corerulebook.feats#endurance>`\ , :ref:`Run <corerulebook.feats#run>`\ \ :sup:`B`

\ **Skills**\  :ref:`Perception <corerulebook.skills.perception#perception>`\  +6

\ **SQ**\  docile

.. _`bestiary.horse#ecology`:
...
.. _`bestiary.horse#special_abilities`:

Special Abilities
==================

\ **Docile (Ex)**\  Unless specifically trained for combat (see the :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  skill, a horse's hooves are treated as secondary attacks.
