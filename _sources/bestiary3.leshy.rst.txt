...
Leshys begin their existence as sentient though bodiless spirits of nature of the sort contacted by spells such as :ref:`commune with nature <corerulebook.spells.communewithnature#commune_with_nature>`\ . These spirits normally have no way to directly manipulate the physical world, but a skilled spellcaster (typically a druid) can grow a special plant body for one of these spirits, giving the spirit a home to animate.
...
.. _`bestiary3.leshy#growing_a_leshy`:

Growing a Leshy
################
The process of growing a leshy has some similarities to making a construct, but doesn't require the :ref:`Craft Construct <bestiary.monsterfeats#craft_construct>`\  feat. Typically, the creator of a leshy must be a powerful druid, but anyone capable of making the required :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  checks and casting the required spells may attempt the process.
Growing a leshy body takes 2 weeks per Hit Die, during which the nascent form must be well fertilized, watered as needed, and kept safe from harm. During this period of growth, certain rare nutrients and fertilizer must be used to prime the leshy's transformation from a normal plant into a sentient one—the cost of these components varies according to the leshy, but is never less than 500 gp. The cultivator must make a successful :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  check at this time (usually a :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  [nature] check) in order for the plant body to be properly formed—the exact check as well as the required DC varies according to the leshy. If the check fails, the plant withers and dies and the cultivator must begin anew.
...
Plant creatures are particularly adept at growing leshys. Such creators gain a +5 racial bonus on their :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  checks, halve the time required to grow the leshy, and reduce the cost to create the creature by 25%. A plant creature is always successful in luring a spirit into the body, and need not make the final percentile roll for success.
Leshys with more Hit Dice than normal can be created. Each additional Hit Die adds 2,250 gp to the cost of creating the leshy (and thus 4,500 gp to the overall price), increases the DC of the :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  check by +2, and requires an additional 2 weeks of growth. Attempts to create leshys larger than Small always fail—the strange spiritual energies that animate these creatures are only capable of doing so to a body no larger than that of a human child.

.. _`bestiary3.leshy#leshy_fungus`:
...
.. _`bestiary3.leshy#fungus_leshy`:
...
**CR 2** 
XP 600
N Small plant (leshy, :ref:`shapechanger <bestiary.creaturetypes#shapechanger_subtype>`\ )
\ **Init**\  +2; \ **Senses**\  darkvision 60 ft., low-light vision; :ref:`Perception <corerulebook.skills.perception#perception>`\  +2

.. _`bestiary3.leshy#defense`:
...
.. _`bestiary3.leshy#statistics`:

Statistics
===========
\ **Str**\  10, \ **Dex**\  15, \ **Con**\  16, \ **Int**\  7, \ **Wis**\  14, \ **Cha**\  15
\ **Base Atk**\  +1; \ **CMB**\  +0; \ **CMD**\  12
\ **Feats**\  :ref:`Blind-Fight <corerulebook.feats#blind_fight>`
\ **Skills**\  :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +10 (+14 in swamps and underground), :ref:`Survival <corerulebook.skills.survival#survival>`\  +3 (+7 in swamps and underground); \ **Racial Modifiers**\  +4 :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  and :ref:`Survival <corerulebook.skills.survival#survival>`\  in swamps and underground
\ **Languages**\  Druidic, Sylvan; plantspeech (fungi)
\ **SQ**\  :ref:`change shape <bestiary.universalmonsterrules#change_shape>`\  (Small fungus; :ref:`tree shape <corerulebook.spells.treeshape#tree_shape>`\ ), verdant burst

.. _`bestiary3.leshy#ecology`:
...
.. _`bestiary3.leshy#special_abilities`:
...
\ **Spores (Ex)**\  A fungus leshy is riddled with molds and spores. Anytime a fungus leshy takes damage, a cloud of spores bursts from its body, forcing all adjacent creatures to make a DC 14 Fortitude save or have their vision reduced to 10 feet for 1 minute. Spending a full-round action to wash one's eyes with :ref:`water <bestiary.creaturetypes#water_subtype>`\  ends this effect. The save DC is Constitution-based.
...
.. _`bestiary3.leshy#growing_a_fungus_leshy`:
...
.. _`bestiary3.leshy#ritual`:

Ritual
=======
\ **Requirements**\  :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nature) 5 ranks, :ref:`obscuring mist <corerulebook.spells.obscuringmist#obscuring_mist>`\ , :ref:`plant growth <corerulebook.spells.plantgrowth#plant_growth>`\ , :ref:`summon nature's ally II <corerulebook.spells.summonnaturesally#summon_nature_s_ally_ii>`\ ; \ **Skill**\  :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (dungeoneering or nature) DC 14; \ **Cost**\  1,250 gp

.. _`bestiary3.leshy#leshy_gourd`:

Leshy, Gourd
*************
This little plant man walks on legs like tangled vines and has a pumpkin carved with eyes and a mouth for a head.

.. _`bestiary3.leshy#gourd_leshy`:
...
XP 400
N Small plant (leshy, :ref:`shapechanger <bestiary.creaturetypes#shapechanger_subtype>`\ )
\ **Init**\  +2; \ **Senses**\  darkvision 60 ft., low-light vision; :ref:`Perception <corerulebook.skills.perception#perception>`\  +4
...
\ **Skills**\  :ref:`Perception <corerulebook.skills.perception#perception>`\  +4, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +6 (+10 in plains and undergrowth), :ref:`Survival <corerulebook.skills.survival#survival>`\  +0 (+4 in plains and undergrowth); \ **Racial Modifiers**\  +4 :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  and :ref:`Survival <corerulebook.skills.survival#survival>`\  in plains and undergrowth
\ **Languages**\  Druidic, Sylvan; plantspeech (gourds)
\ **SQ**\  :ref:`change shape <bestiary.universalmonsterrules#change_shape>`\  (Small gourd; :ref:`tree shape <corerulebook.spells.treeshape#tree_shape>`\ ), keepsake, verdant burst
...
\ **Keepsake (Su)**\  Gourd leshys can pop off the top of their heads and store a single Fine-sized object such as a dagger or potion inside. While within the leshy's head, the item is warded by :ref:`nondetection <corerulebook.spells.nondetection#nondetection>`\ . In addition, after 24 hours, the item within is cleaned and polished, and, if damaged, repaired as if by a :ref:`mending <corerulebook.spells.mending#mending>`\  spell. Both spell effects have a caster level equal to twice the leshy's Hit Dice (CL 2nd for most gourd leshys).
...
.. _`bestiary3.leshy#growing_a_gourd_leshy`:
...
Ritual
=======
\ **Requirements**\  :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nature) 5 ranks, :ref:`entangle <corerulebook.spells.entangle#entangle>`\ , :ref:`plant growth <corerulebook.spells.plantgrowth#plant_growth>`\ , :ref:`summon nature's ally I <corerulebook.spells.summonnaturesally#summon_nature_s_ally_i>`\ ; \ **Skill**\  :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nature) DC 13; \ **Cost**\  750 gp

.. _`bestiary3.leshy#leshy_leaf`:

Leshy, Leaf
************
This little plant person is clad in a winglike leaf cloak and pinecone armor, wielding a twig as a makeshift spear.

.. _`bestiary3.leshy#leaf_leshy`:
...
XP 200
N Small plant (leshy, :ref:`shapechanger <bestiary.creaturetypes#shapechanger_subtype>`\ )
\ **Init**\  +1; \ **Senses**\  darkvision 60 ft., low-light vision; :ref:`Perception <corerulebook.skills.perception#perception>`\  +1
...
\ **Skills**\  :ref:`Fly <corerulebook.skills.fly#fly>`\  –1, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +5 (+9 in forests and jungles), :ref:`Survival <corerulebook.skills.survival#survival>`\  +1 (+5 in forests and jungles); \ **Racial Modifiers**\  +4 :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  and :ref:`Survival <corerulebook.skills.survival#survival>`\  in forests and jungles
\ **Languages**\  Druidic, Sylvan; plantspeech (trees)
\ **SQ**\  :ref:`change shape <bestiary.universalmonsterrules#change_shape>`\  (Small tree; :ref:`tree shape <corerulebook.spells.treeshape#tree_shape>`\ ), verdant burst
...
Ritual
=======
\ **Requirements**\  :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nature) 5 ranks, :ref:`magic stone <corerulebook.spells.magicstone#magic_stone>`\ , :ref:`plant growth <corerulebook.spells.plantgrowth#plant_growth>`\ , :ref:`summon nature's ally I <corerulebook.spells.summonnaturesally#summon_nature_s_ally_i>`\ ; \ **Skill**\  :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nature) DC 12; \ **Cost**\  500 gp

.. _`bestiary3.leshy#leshy_seaweed`:

Leshy, Seaweed
***************
This vaguely humanoid plant creature has a body formed of soggy green seaweed and wears crude armor made from seashells.

.. _`bestiary3.leshy#seaweed_leshy`:
...
**CR 3** 
XP 800
N Small plant (:ref:`aquatic <bestiary.creaturetypes#aquatic_subtype>`\ , leshy, :ref:`shapechanger <bestiary.creaturetypes#shapechanger_subtype>`\ )
\ **Init**\  +1; \ **Senses**\  darkvision 60 ft., low-light vision; :ref:`Perception <corerulebook.skills.perception#perception>`\  +7
...
\ **Melee**\  slam +4 (1d6)
\ **Ranged**\  :ref:`water <bestiary.creaturetypes#water_subtype>`\  :ref:`jet <bestiary.universalmonsterrules#jet>`\  +5 touch (1 plus blind)
\ **Special Attack**\  sneak attack +1d6
\ **Spell-Like Abilities**\  (CL 8th; concentration +9)
 Constant—:ref:`pass without trace <corerulebook.spells.passwithouttrace#pass_without_trace>`
 1/day—:ref:`entangle <corerulebook.spells.entangle#entangle>`\  (in water only, DC 12)

Statistics
===========
\ **Str**\  10, \ **Dex**\  13, \ **Con**\  14, \ **Int**\  9, \ **Wis**\  15, \ **Cha**\  12
\ **Base Atk**\  +3; \ **CMB**\  +2; \ **CMD**\  13
\ **Feats**\  :ref:`Ability Focus <bestiary.monsterfeats#ability_focus>`\  (:ref:`water <bestiary.creaturetypes#water_subtype>`\  :ref:`jet <bestiary.universalmonsterrules#jet>`\ ), :ref:`Toughness <corerulebook.feats#toughness>`
\ **Skills**\  :ref:`Perception <corerulebook.skills.perception#perception>`\  +7, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +9 (+13 in :ref:`water <bestiary.creaturetypes#water_subtype>`\ ), :ref:`Survival <corerulebook.skills.survival#survival>`\  +3 (+7 in :ref:`water <bestiary.creaturetypes#water_subtype>`\ ), :ref:`Swim <corerulebook.skills.swim#swim>`\  +8; \ **Racial Modifiers**\  +4 :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  and :ref:`Survival <corerulebook.skills.survival#survival>`\  in :ref:`water <bestiary.creaturetypes#water_subtype>`
\ **Languages**\  Druidic, Sylvan; plantspeech (seaweed)
\ **SQ**\  :ref:`air <bestiary.creaturetypes#air_subtype>`\  cyst, amphibious, :ref:`change shape <bestiary.universalmonsterrules#change_shape>`\  (Small seaweed; :ref:`tree shape <corerulebook.spells.treeshape#tree_shape>`\ ), verdant burst
...
Special Abilities
==================
:ref:`Air <bestiary.creaturetypes#air_subtype>`\  Cyst (Su) Seaweed leshys constantly grow small bulbs filled with :ref:`air <bestiary.creaturetypes#air_subtype>`\ . As a move action, they can detach a bulb and give it to another creature. If consumed as a standard action, this :ref:`air <bestiary.creaturetypes#air_subtype>`\  cyst grants :ref:`water breathing <corerulebook.spells.waterbreathing#water_breathing>`\  (as the spell) for 10 minutes. Seaweed leshys can have a maximum of four usable :ref:`air <bestiary.creaturetypes#air_subtype>`\  cysts at any one time, and :ref:`air <bestiary.creaturetypes#air_subtype>`\  cysts regrow at a rate of one per 24 hours.
:ref:`Water <bestiary.creaturetypes#water_subtype>`\  :ref:`Jet <bestiary.universalmonsterrules#jet>`\  (Ex) A seaweed leshy can expel a high-pressure :ref:`jet <bestiary.universalmonsterrules#jet>`\  of :ref:`water <bestiary.creaturetypes#water_subtype>`\  from its mouth to a range of 30 feet. It must make a ranged touch attack to strike a target—if it hits, the blast deals 1 point of bludgeoning damage (this damage is not modified by Strength). In addition, the creature hit must make a DC 15 Fortitude save or be blinded by the :ref:`water <bestiary.creaturetypes#water_subtype>`\  for 1 round. The save DC is Dexterity-based.
...
.. _`bestiary3.leshy#growing_a_seaweed_leshy`:
...
Ritual
=======
\ **Requirements**\  :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nature) 5 ranks, :ref:`plant growth <corerulebook.spells.plantgrowth#plant_growth>`\ , :ref:`summon nature's ally III <corerulebook.spells.summonnaturesally#summon_nature_s_ally_iii>`\ , :ref:`water breathing <corerulebook.spells.waterbreathing#water_breathing>`\ ; \ **Skill**\  :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nature) DC 16; \ **Cost**\  2,250 gp
