...
.. _`ultimateequipment.artifactsandothers.artifacts`:

.. contents:: \ 

.. _`ultimateequipment.artifactsandothers.artifacts#artifacts`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#minor_artifacts`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#beacon_of_true_faith`:
...
Chaotic (violet flame): :ref:`Word of chaos <corerulebook.spells.wordofchaos#word_of_chaos>`\  once per day on command.

\ *Good (white flame):*\  Allies within 30 feet of the beacon gain the benefits of :ref:`protection from evil <corerulebook.spells.protectionfromevil#protection_from_evil>`\  and :ref:`heroism <corerulebook.spells.heroism#heroism>`\ .

\ *Evil (black flame):*\  Bearer is constantly under the effect of :ref:`protection from good <corerulebook.spells.protectionfromgood#protection_from_good>`\  and may use :ref:`harm <corerulebook.spells.harm#harm>`\  twice per day.

Lawful (golden flame): :ref:`Dictum <corerulebook.spells.dictum#dictum>`\  once per day on command.

.. _`ultimateequipment.artifactsandothers.artifacts#destruction`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#book_of_infinite_spells`:
...
The \ *book of infinite spells*\ can be destroyed when the current page contains the :ref:`erase <corerulebook.spells.erase#erase>`\  spell, by casting the spell on the book itself.

.. _`ultimateequipment.artifactsandothers.artifacts#branch_of_life`:
...
This verdant branch glows with a soothing, pale green light. Carefully pruned from the world's first tree, this artifact hums with energy. Full of everlasting life, it needs time to transfer its magic. It can cast :ref:`heal <corerulebook.spells.heal#heal>`\  at will, but needs a full hour to do so. Once a day, it can cast :ref:`resurrection <corerulebook.spells.resurrection#resurrection>`\ , but it takes the full day to do so. 
...
.. _`ultimateequipment.artifactsandothers.artifacts#crown_of_the_iron_king`:
...
Once a creature becomes a thrall of the crown's user, it must do everything the user commands, as per the spell :ref:`dominate person <corerulebook.spells.dominateperson#dominate_person>`\ —though the crown's dominance is not limited to humanoids, lasts as long the creature is wearing the crown, and allows no saving throw.
...
.. _`ultimateequipment.artifactsandothers.artifacts#deck_of_many_things`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#deck_of_many_things_table`:
...
.. list-table:: Deck of Many Things
   ...
   * - Throne
     - Four of wands
     - King of hearts
     - Gain a +6 bonus on :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  checks plus a small castle.
   * - Vizier
     - IX. The Hermit
     - Ace of diamonds
...
.. _`ultimateequipment.artifactsandothers.artifacts#hammer_of_thunderbolts`:
...
This +3 Large :ref:`returning <corerulebook.magicitems.weapons#weapons_returning>`\  warhammer deals 2d6 points of damage on a successful hit. In the hands of a wielder who wears a :ref:`belt of giant strength <corerulebook.magicitems.wondrousitems#belt_of_giant_strength>`\  and knows the weapon is a \ *hammer of thunderbolts*\  (not just the \ *+3 warhammer*\  it appears to be), it becomes a +5 Large giant-bane :ref:`returning <corerulebook.magicitems.weapons#weapons_returning>`\  :ref:`thundering <corerulebook.magicitems.weapons#thundering>`\  warhammer with the following two properties. One, when the bearer hits with the hammer as a thrown attack, it emits a powerful clap of thunder, causing all creatures within 90 feet to be stunned for 1 round (DC 15 Fortitude negates); the wielder is not immune to this effect. Two, the hammer's range increment increases to 30 feet.
...
.. _`ultimateequipment.artifactsandothers.artifacts#knucklebone_of_fickle_fortune`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#knucklebone_of_fickle_fortune_table`:

.. list-table:: Knucklebone of Fickle Fortune
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
   ...
   * - 2
     - Bvu
     - The character is subject to a powerful compulsion never to roll the \ *knucklebone of fickle fortune*\  again. He can shake this compulsion only by succeeding a DC 25 Will saving throw. He can attempt this saving throw only once per day. 
   * - 3
     - Eij
     - The character is affected by a :ref:`harm <corerulebook.spells.harm#harm>`\  spell (caster level 15th). 
   * - 4
     - Hor
     - The character is subject to a powerful compulsion to roll the \ *knucklebone*\  three more times immediately (Will DC 25 negates). All three of these rolls are made with a –5 penalty on the \ *knucklebone's*\  die roll (minimum 1).
   * - 5 
     - Veh
     - The character is blinded as with :ref:`blindness/deafness <corerulebook.spells.blindnessdeafness#blindness_deafness>`\  (no saving throw).
   * - 6 
     - Chu 
     - The character takes 5d10 points of cold damage (DC 25 Fort save for half) and moves at half speed for the next hour (a successful saving throw does not negate the reduced speed).
   * - 7 
     - Roh
     - For the next 24 hours, the character suffers a –2 penalty on all skill and ability checks.
   * - 8 
     - Seh
     - The character is paralyzed for 2d12 hours, as with :ref:`hold monster <corerulebook.spells.holdmonster#hold_monster>`\ , except he cannot attempt new saving throws to overcome the effect.
   * - 9 
     - Kog
     - For the next week, the character emits a horrible smell. He suffers a –4 penalty on :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  and :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  checks. 
   * - 10 
     - Vis
     - Once, during the next 24 hours, the character can reroll a single die roll he has just made and take the second result, as if using the good fortune ability from the Luck domain.
   * - 11 
     - Fyeh
     - The character gains 100 points of fire immunity, as if using :ref:`protection from energy <corerulebook.spells.protectionfromenergy#protection_from_energy>`\ .
   * - 12 
     - Xal
     - The character gains the benefits of a :ref:`heroism <corerulebook.spells.heroism#heroism>`\  spell for the next 200 minutes.
   * - 13 
     - Yaq
     - For the next 24 hours, when the character hits a target he is flanking with a melee weapon, the attack does +1d6 points of precision damage.
   * - 14 
     - Gib
     - Once in the next 24 hours, the character can cast :ref:`faerie fire <corerulebook.spells.faeriefire#faerie_fire>`\  (caster level equal to his character level). This ability is lost if the character rolls this result again with the \ *knucklebone of fickle fortune*\  before the 24 hours is concluded.
   * - 15 
     - Xku
     - The character is immune to fear for the next 24 hours. 
   * - 16 
     - Lev
     - Once in the next 24 hours, the character can cast a :ref:`lightning bolt <corerulebook.spells.lightningbolt#lightning_bolt>`\  (caster level equal to his character level). This ability islost if the character rolls this result again with the \ *knucklebone of fickle fortune*\  before the  24 hours is concluded.
   * - 17 
     - Nhi
     - For the next 7 days, when the character is the target of healing magic, he heals an additional 2d8 hit points. This effect is lost if the character rolls the \ *knucklebone of fickle fortune*\  again before the 7 days are concluded.
   * - 18 
     - Zmi
     - For the next 24 hours, whenever the character succeeds on a saving throw against a harmful effect that does half damage or partial effect on a failed save, the \ *knucklebone's*\  character takes no damage or suffers no effect.
   * - 19 
     - Tem
     - For the next 24 hours, the character automatically confirms all critical hits. 
   * - 20 
     - Eha-Zah
     - The next time the character dies, he comes back from the dead the very next morning as if the subject of a :ref:`resurrection <corerulebook.spells.resurrection#resurrection>`\  spell. This effect is negated if the character rolls the \ *knucklebone of fickle fortune*\  again before he dies.

.. _`ultimateequipment.artifactsandothers.artifacts#monkeys_paw`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#perfect_golden_lute`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#philosophers_stone`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#runescarred_dragonship`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#sphere_of_annihilation`:
...
The \ *spindle of perfect knowledge*\  is large, bright, and flawless marquise-cut diamond :ref:`ioun stone <corerulebook.magicitems.wondrousitems#ioun_stones>`\  the size of a halfling's fist. The gemstone would be a treasure in itself if it lacked magic, but it is also a powerful :ref:`ioun stone <corerulebook.magicitems.wondrousitems#ioun_stones>`\ . The \ *spindle of perfect knowledge*\  functions like a :ref:`headband of mental superiority <corerulebook.magicitems.wondrousitems#headband_of_mental_superiority>`\  +4 and grants 5 ranks in two random :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  skills. The wearer can communicate and understand languages as if using :ref:`comprehend languages <corerulebook.spells.comprehendlanguages#comprehend_languages>`\ , :ref:`tongues <corerulebook.spells.tongues#tongues>`\ , and telepathy with a range of 100 feet.
...
.. _`ultimateequipment.artifactsandothers.artifacts#staff_of_the_magi`:
...
A \ *staff of the magi*\  gives the wielder spell resistance 23. If this is willingly lowered, however, the staff can also be used to absorb arcane spell energy directed at its wielder, as a :ref:`rod of absorption <corerulebook.magicitems.rods#rod_of_absorption>`\  does. Unlike the rod, this staff converts spell levels into charges rather than retaining them as spell energy usable by a spellcaster. If the staff absorbs enough spell levels to exceed its limit of 50 charges, it explodes as if a retributive strike had been performed (see below). The wielder has no idea how many spell levels are cast at her, for the staff does not communicate this knowledge as a \ *rod of absorption*\  does. (Thus, absorbing spells can be risky.)
...
.. _`ultimateequipment.artifactsandothers.artifacts#talisman_of_pure_good`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#talisman_of_reluctant_wishes`:
...
If the check succeeds, the talisman remains with the character for 5d6 hours, or until a :ref:`wish <corerulebook.spells.wish#wish>`\  is made with it, whichever comes first. It then disappears.
...
The artifact grants one :ref:`wish <corerulebook.spells.wish#wish>`\  for every 6 points of the character's Charisma (round down). It grows warm and throbs whenever its possessor comes within 20 feet of a mechanical or magic trap. (If the talisman is not held, its warning heat and pulses are of no avail.)
...
A \ *talisman of reluctant wishes*\  can be destroyed by wishing it so, using either one of the stone's \ *wishes*\  or a :ref:`wish <corerulebook.spells.wish#wish>`\  spell from another source. The stone then explodes, causing 5d6 points of damage to the holder.

.. _`ultimateequipment.artifactsandothers.artifacts#talisman_of_the_sphere`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#talisman_of_ultimate_evil`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#weird_queens_magpie`:
...
Furthermore, the :ref:`weird <corerulebook.spells.weird#weird>`\  queen's magpie has the following abilities. 

* Three times per day on command, and while in contact with the artifact, the bird's bearer can use it as a :ref:`pearl of power <corerulebook.magicitems.wondrousitems#pearl_of_power>`\ , but the spell recalled can be of any level.

* At will and on command, the bird's master can make it go forth and send messages, as if it were the subject of an :ref:`animal messenger <corerulebook.spells.animalmessenger#animal_messenger>`\  spell. 

* Three times per day on command, the bird's master can have the magpie cast :ref:`breath of life <corerulebook.spells.breathoflife#breath_of_life>`\ .

Destruction
============

The :ref:`weird <corerulebook.spells.weird#weird>`\  queen's magpie is destroyed if it enters the Positive Energy Plane.

.. _`ultimateequipment.artifactsandothers.artifacts#major_artifacts`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#axe_of_the_dwarvish_lords`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#bottle_of_the_bound`:
...
The \ *Bottle of the Bound*\  can be destroyed only if every creature bound within is slain or banished, and the empty container is then smashed with a :ref:`holy <corerulebook.magicitems.weapons#weapons_holy>`\  weapon.

.. _`ultimateequipment.artifactsandothers.artifacts#brazen_egg`:
...
This Huge, egg-shaped, intelligent, plane-shifting vessel is constructed almost entirely of brass. The exterior appears to be one crafted and polished sheet of metal, but it does have a door that can be opened. The \ *Brazen Egg's*\  inside has enough room to transport no more than eight Medium creatures, two Large creatures, or one Huge creature (as long as the Huge creature is squeezing). The egg has two methods in which it can move itself. The first is by a method similar to the :ref:`dimension door <corerulebook.spells.dimensiondoor#dimension_door>`\  spell, but the egg and all creatures within the egg are teleported. The second method is similar to the :ref:`plane shift <corerulebook.spells.planeshift#plane_shift>`\  spell, though the egg can move to any plane it desires (it needs no focus) and when the egg \ *plane shifts*\  so do all creatures currently within it.

The egg has its own quirky, unabashed personality and can telepathically communicate with all creatures inside it or within 100 feet, regardless of language. The \ *Brazen Egg's*\  chief goal is to disrupt that plans of Hell's archdevils, but it requires the help of other creatures to do so. It often trades its ability to teleport and :ref:`plane shift <corerulebook.spells.planeshift#plane_shift>`\  in order to gain such aid, but in dire circumstances it has the ability to enchant creatures in order to achieve its goals—and when it is close to reaching its goals it has little compunction in doing so. Once per day, the egg can affect a single creature within it as per the spell :ref:`dominate person <corerulebook.spells.dominateperson#dominate_person>`\  (though it is not limited to humanoids and can affect any living creature). Additionally up to three times per day it can affect creatures within it as per the spell :ref:`mass charm monster <corerulebook.spells.charmmonster#charm_monster_mass>`\ . 

Destruction
============

The \ *Brazen Egg*\  implodes if a devil with 20 or more Hit Dice ever enters the egg's interior. The devil and all other creatures within the egg are utterly destroyed in the implosion and cannot come back to existence with any effect short of a :ref:`wish <corerulebook.spells.wish#wish>`\  or :ref:`miracle <corerulebook.spells.miracle#miracle>`\ .

.. _`ultimateequipment.artifactsandothers.artifacts#celestial_lens`:
...
In order to fully take control of the castle, a creature must be at least 17th level, and must have the :ref:`Leadership <corerulebook.feats#leadership>`\  feat and 17 ranks in :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana). If the castle already has a master, that master must be defeated before another can take her place. The castle's movement is controlled by way of a control chamber located at the heart (a central chamber on its 4th floor). There, a font of pure elemental water serves as a scrying device for the castle's master, though it can view only places inside the castle or within 100 feet of it. The master (or a person she designates) can direct the castle's motion from within the chamber. It has a fly speed of 250 feet (clumsy) and uses the :ref:`Fly <corerulebook.skills.fly#fly>`\  skill modifier of the person controlling its motion; the castle can hover without needing to make a :ref:`Fly <corerulebook.skills.fly#fly>`\  check and never risks falling due to a failed check. When not being controlled, the castle moves randomly, sometimes changing direction every minute, sometimes holding the same course for days at a time, but always avoiding the ground or other hazards. It has the ability to travel to other planes, though no master other than the Storm King is known to have invoked this power. The master of the castle gains the following spell-like abilities.

* :ref:`Call lightning storm <corerulebook.spells.calllightningstorm#call_lightning_storm>`\  1/day. The master must be in the control chamber or one of the towers to use this ability.
...
.. _`ultimateequipment.artifactsandothers.artifacts#codex_of_the_infinite_planes`:
...
.. list-table::
   ...
   * - d%
     - Catastrophe
   * - 01–25
     - \ *Natural Fury:*\  An :ref:`earthquake <corerulebook.spells.earthquake#earthquake>`\  spell centered on the reader strikes every round for 1 minute, and an intensified \ *storm of vengeance*\  spell is centered and targeted on the reader.
   * - 26–50
   ...
   * - 51–75
     - Ultimate :ref:`Imprisonment <corerulebook.spells.imprisonment#imprisonment>`\ : Reader's soul is captured (as \ *trap the soul ;*\ no save allowed) in a random gem somewhere on the plane while his or her body is entombed beneath the earth (as \ *imprisonment*\ ).
   * - 76–100
...
.. _`ultimateequipment.artifactsandothers.artifacts#demon_prince_armor`:
...
This armor looks like a more massive and dangerous suit of \ *demon armor*\ . It is a suit of +5 heavy :ref:`fortification <corerulebook.magicitems.armor#armor_fortification>`\  full plate that allows its wearer to make claw attacks that deal 2d10 points of damage, and strike as +3 weapons that are treated as chaotic and evil for the purposes of overcoming damage reduction. Additionally, those struck by the claws must succeed at a DC 20 Fortitude save or be affected as per the spell :ref:`contagion <corerulebook.spells.contagion#contagion>`\ . The armor's claws are built into the armor so these weapons cannot be disarmed. While wearing the armor, the wearer benefits from the following demonic traits.
...
.. _`ultimateequipment.artifactsandothers.artifacts#flame_of_guidance`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#fork_of_the_forgotten_one`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#jar_of_dragons_teeth`:
...
* The user is immediately polymorphed into a dragon, as if subject to :ref:`form of the dragon I <corerulebook.spells.formofthedragon#form_of_the_dragon_i>`\ , \ *II*\ , or \ *III*\ , depending on the user's Hit Dice. If the creature swallowing the tooth has 12 HD or fewer, it is affected as per :ref:`form of the dragon I <corerulebook.spells.formofthedragon#form_of_the_dragon_i>`\ . Those with 13 to 18 HD are affected as per :ref:`form of the dragon II <corerulebook.spells.formofthedragon#form_of_the_dragon_ii>`\ , and those 19 or more Hit Dice are affected as per :ref:`form of the dragon III <corerulebook.spells.formofthedragon#form_of_the_dragon_iii>`\ . The type of dragon is chosen by the user based on its alignment.  \ *Lawful good*\ : bronze dragon, gold dragon, or silver dragon  \ *Neutral good*\ : any metallic dragon  \ *Chaotic good*\ : brass dragon or copper dragon  \ *Lawful neutral*\ : any chromatic or metallic dragon  \ *Neutral*\ : any chromatic or metallic dragon  \ *Chaotic neutral*\ : any chromatic or metallic dragon  \ *Lawful evil*\ : blue dragon or green dragon  \ *Neutral evil*\ : any chromatic dragon  \ *Chaotic evil*\ : black dragon, red dragon, or white dragon
...
* The user gains a +4 competence bonus on :ref:`Fly <corerulebook.skills.fly#fly>`\  checks.

* The user gains a +4 competence bonus on :ref:`Bluff <corerulebook.skills.bluff#bluff>`\ , :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\ , :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\ , and :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  checks made against or involving dragons.
...
.. _`ultimateequipment.artifactsandothers.artifacts#horns_of_naraga`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#the_moaning_diamond`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#the_orbs_of_dragonkind`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#perfections_key`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#the_shadowstaff`:
...
* :ref:`Shadow <corerulebook.magicitems.armor#armor_shadow>`\  Form: Three times per day the wielder can become a living shadow, with all the movement powers granted by \ *gaseous form*\ . 

* :ref:`Shadow <corerulebook.magicitems.armor#armor_shadow>`\  Bolt: Three times per day the staff can project a ray attack that deals 10d6 points of cold damage to a single target. The shadow bolt has a range of 100 feet.
...
.. _`ultimateequipment.artifactsandothers.artifacts#the_shield_of_the_sun`:
...
.. _`ultimateequipment.artifactsandothers.artifacts#skullsoul`:
...
The \ *Skullsoul*\  cannot be destroyed but it can be contained. As long as the \ *Skullsoul*\  stays pierced by either a weapon with the :ref:`vorpal <corerulebook.magicitems.weapons#vorpal>`\  special ability or a :ref:`holy avenger <corerulebook.magicitems.weapons#holy_avenger>`\ , it is contained and entirely inert until the sword is removed.
