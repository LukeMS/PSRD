...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor`:

.. contents:: \ 

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#inquisitor`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#inquisitions`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#anger_inquisition`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#hateful_retort`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#divine_anger`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#conversion_inquisition`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#charm_of_wisdom`:

\ *Charm of Wisdom (Ex)*\ : You use your Wisdom modifier instead of your Charisma modifier when making :ref:`Bluff <corerulebook.skills.bluff#bluff>`\ , :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\ , and :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#swaying_word`:

\ *Swaying Word (Sp)*\ : At 8th level, once per day you may speak a word of divinely inspired wisdom that causes a single creature to switch its alliance to you. The target must be within line of sight and able to hear you. If he fails his Will save, he is affected by :ref:`dominate person <corerulebook.spells.dominateperson#dominate_person>`\ , except the duration is only 1 minute.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#fate_inquisition`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#augury`:

\ *Augury (Sp)*\ : Once per day, you can use :ref:`augury <corerulebook.spells.augury#augury>`\  as a spell-like ability.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#agent_of_fate`:

\ *Agent of Fate (Su)*\ : At 8th level, when you use your :ref:`augury <corerulebook.spells.augury#augury>`\  spell-like ability, you gain a benefit that lasts until the end of your next combat. If the result was "weal," all curing effects used on you cure an additional +1d10 hit points. If the result was "woe," your melee attacks deal an additional +1d6 points of damage. If the result is "weal and woe" or "nothing," you gain a +2 insight bonus to your Armor Class.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#fervor_inquisition`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#fire_of_belief`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#fervent_action`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#heresy_inquisition`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#righteous_infiltration`:

\ *Righteous Infiltration (Ex)*\ : You use your Wisdom modifier instead of your Charisma modifier when making :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  and :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#blessed_infiltration`:

\ *Blessed Infiltration (Ex)*\ : At 4th level, when you make a :ref:`Bluff <corerulebook.skills.bluff#bluff>`\ , :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\ , or :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  check, you may roll twice and take the more favorable result. You can use this ability a number of times per day equal to your Wisdom bonus.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#word_of_anathema`:

\ *Word of Anathema (Sp)*\ : At 8th level, once per day, you can speak a word of anathema against a single creature within 60 feet (Will negates). This acts as :ref:`bestow curse <corerulebook.spells.bestowcurse#bestow_curse>`\  and lasts for 1 minute, giving the target a –4 penalty on attack rolls, saves, ability checks, and skill checks.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#imprisonment_inquisition`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#caging_strike`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#divine_prison`:

\ *Divine Prison*\ : At 8th level, once per day upon making a successful melee attack, you can affect your target with :ref:`hold monster <corerulebook.spells.holdmonster#hold_monster>`\  (Will negates).

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#illumination_inquisition`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#illuminating_touch`:

\ *Illuminating Touch (Sp)*\ : You cause your hand to shimmer with divine radiance, allowing you to touch a creature as a standard action and give it a bonus equal to 1/2 your inquisitor level on a single Will saving throw, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  check, :ref:`Perception <corerulebook.skills.perception#perception>`\  check, or :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  check. This ability lasts for 1 hour or until the creature chooses to apply the bonus to a roll. You can use this ability to grant the bonus a number of times per day equal to 3 + your Wisdom modifier.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#aura_of_enlightenment`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#justice_inquisition`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#judicious_force`:

\ *Judicious Force (Su)*\ : If you or an ally within 10 feet makes a critical threat with a melee or ranged attack, as an immediate action you may add +4 to the confirmation roll. This does not stack with the :ref:`Critical Focus <corerulebook.feats#critical_focus>`\  feat. You may use this ability a number of times per day equal to your Wisdom bonus.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#chains_of_justice`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#oblivion_inquisition`:

Oblivion Inquisition
*********************

\ **Granted Powers**\ : Some inquisitors believe that without faith there is only oblivion. But there are some divine servants who know enough about the darkness that lies beyond faith to use it as a toolâ¦ and a weapon.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#life`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#stare_of_oblivion`:

\ *Stare of Oblivion (Sp)*\ : At 8th level, you can use :ref:`feeblemind <corerulebook.spells.feeblemind#feeblemind>`\  as a gaze attack against one creature (Will negates). This effect lasts 1d4 rounds. You can use this ability once per day at 8th level, and one additional time per day for every four levels beyond 8th.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#order_inquisition`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#mantle_against_chaos`:

\ *Mantle against Chaos (Sp)*\ : You can use :ref:`protection from chaos <corerulebook.spells.protectionfromchaos#protection_from_chaos>`\  on yourself or another creature as a spell-like ability. You can use this ability for a number of minutes per day equal to your inquisitor level (minimum 1). This duration does not need to be consecutive, but it must be used in 1 minute increments.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#commanding_order`:

\ *Commanding Order (Sp)*\ : At 8th level, you can use :ref:`greater command <corerulebook.spells.command#command_greater>`\ , except it only affects a single target. You can use this ability a number of times per day equal to 3 + your Wisdom bonus.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#persistence_inquisition`:

Persistence Inquisition
************************

\ **Granted Powers**\ : Your deity chose you for your persistence. You have vowed to pursue the enemies of the faith to the world's end if necessary. You receive :ref:`Step Up <corerulebook.feats#step_up>`\  as a bonus feat.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#relentless_footing`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#inner_strength`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#tactics_inquisition`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#inquisitors_direction`:

\ *Inquisitor's Direction (Su)*\ : At the start of your turn, you can choose to enter a tranquil, reflective state and forgo all actions (standard, move, swift, immediate, and free actions, including attacks of opportunity) for that round; one ally of your choice within 30 feet gains the benefit of :ref:`haste <corerulebook.spells.haste#haste>`\  for 1 round. You can use this ability a number of times per day equal to your 3 + Wisdom bonus (minimum 1).

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#grant_the_initiative`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#torture_inquisition`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#torturers_presence`:

\ *Torturer's Presence (Ex)*\ : You gain a +2 bonus when using the :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  skill. This is in addition to your bonus for Stern Gaze.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#torturers_touch`:

\ *Torturer's Touch (Sp)*\ : You may use :ref:`touch of fatigue <corerulebook.spells.touchoffatigue#touch_of_fatigue>`\  as a spell-like ability. Creatures that are immune to pain effects are immune to this touch. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#critical_precision`:

\ *Critical Precision (Ex)*\ : At 8th level, when you roll a critical threat, you may expend one use of your torturer's touch ability to add +4 on your critical confirmation roll. This does not stack with :ref:`Critical Focus <corerulebook.feats#critical_focus>`\ .

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#truth_inquisition`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#justices_true_path`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#grasp_of_honesty`:

\ *Grasp of Honesty (Su)*\ : At 8th level, any creature you are grappling or pinning is affected by :ref:`zone of truth <corerulebook.spells.zoneoftruth#zone_of_truth>`\  (Will negates). Outside of combat, you may use this ability by touching a target with both hands. You can use this ability a number of rounds per day equal to your inquisitor level. These rounds do not need to be consecutive. The effect ends if you stop grappling, pinning, or touching the target.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#valor_inquisition`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#touch_of_resolve`:

\ *Touch of Resolve (Sp)*\ : You may use :ref:`remove fear <corerulebook.spells.removefear#remove_fear>`\  on a single creature a number of times per day equal to your 3 + your Wisdom bonus.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#fearless`:

\ *Fearless (Su)*\ : At 8th level, you become immune to fear.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#vengeance_inquisition`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#zealous_surge`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#scourge_of_the_enemy`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#exorcist_(archetype)`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#verdict_of_exorcism`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#verdict_of_exile`:

\ **Verdict of Exile (Su)**\ : At 16th level, an inquisitor using judgment can unleash the verdict of exile on a creature. When she does, her judgment ends, but the creature subject to that judgment is dazed for 1 round (Will negates, DC of 10 + 1/2 inquisitor level + Wisdom bonus). If the creature is possessed or an outsider, the possessing entity or the outsider is affected by :ref:`dismissal <corerulebook.spells.dismissal#dismissal>`\  (Will negates). This ability replaces third judgment.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#closed_mind`:

\ **Closed Mind (Su)**\ : An exorcist inquisitor must close off her mind to deny her enemies even a foothold. At 17th level, the inquisitor becomes immune to compulsion effects and possession attempts (including :ref:`magic jar <corerulebook.spells.magicjar#magic_jar>`\ ). This ability replaces slayer.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#verdict_of_anathema`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#heretic_(archetype)`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#judgment`:

\ **Judgment (Su)**\ : A heretic gains the following judgment in addition to the normal list of inquisitor judgments.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#escape`:

\ *Escape (Su)*\ : Each time the inquisitor using this judgment hits an opponent with a melee or ranged attack, she can use a move action attempt to create a diversion to hide (see the :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  skill).

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#lore_of_escape`:

\ **Lore of Escape (Ex)**\ : At 1st level, the heretic uses every trick she knows to escape those now pursuing her. She adds her Wisdom modifier on :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  and :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  skill checks in addition to the normal ability score modifiers. This ability replaces monster lore.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#hide_tracks`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#ex_inquisitors`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#infiltrator_(archetype)`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#misdirection`:

\ **Misdirection (Sp)**\ : At 1st level, each day when the infiltrator prepares spells, she may choose an alignment. She detects as that alignment as if she had used :ref:`misdirection <corerulebook.spells.misdirection#misdirection>`\  on a creature with that alignment (this does not change any divination results about her other than her alignment). This power replaces stern gaze.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#guileful_lore`:

\ **Guileful Lore (Ex)**\ : At 1st level, the infiltrator's will is bent toward subterfuge and deception. She adds her Wisdom modifier on :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  and :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  skill checks in addition to the normal ability score modifiers. This ability replaces monster lore.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#forbidden_lore`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#necessary_lies`:

\ **Necessary Lies (Su)**\ : An infiltrator adds her class level on saving throws against abilities that detect lies or reveal or force the truth, such as \ *detect lies*\  and :ref:`zone of truth <corerulebook.spells.zoneoftruth#zone_of_truth>`\ . This power replaces discern lies.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#preacher_(archetype)`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#determination`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#aggression`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#defense`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#warning`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#sin_eater_(archetype)`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#eat_sin`:
...
.. _`ultimatemagic.spellcastingclassoptions.inquisitor#speak_with_dead`:

\ **Speak with Dead (Sp)**\ : At 6th level, when the inquisitor eats an enemy's sins, within 10 minutes of doing so, she can ask the remnants of the enemy's soul questions as if using :ref:`speak with dead <corerulebook.spells.speakwithdead#speak_with_dead>`\ , with a caster level equal to her inquisitor level. She does not need the enemy's corpse to use this ability (she can eat sin, move away from the corpse, then use :ref:`speak with dead <corerulebook.spells.speakwithdead#speak_with_dead>`\ ), though the soul gets a saving throw just as a corpse would. This ability replaces the bonus teamwork feat gained at 6th level.

.. _`ultimatemagic.spellcastingclassoptions.inquisitor#burden_of_sin`:

\ **Burden of Sin (Sp)**\ : At 14th level, a sin eater may spend a full-round action to transfer one harmful affliction, condition, or spell effect from another creature to herself (this includes curses, possessions, and permanent effects such as petrification, or any condition that :ref:`break enchantment <corerulebook.spells.breakenchantment#break_enchantment>`\  can end or reverse). The effect to be transferred is chosen by the sin eater and affects her as if she were the original target, continuing its duration (if any) and preventing any further effect on the original bearer. For example, the inquisitor could transfer a lethal disease to herself, or petrify herself to restore a petrified comrade. The sin eater can use this ability as often as desired, even using it multiple times on the same creature. This ability replaces exploit weakness.
