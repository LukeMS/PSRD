...
.. _`ultimatemagic.magic.spellduels`:

.. contents:: \ 

.. _`ultimatemagic.magic.spellduels#spell_duels`:
...
.. _`ultimatemagic.magic.spellduels#starting_a_duel`:
...
* 	The duel lasts until one of the casters has been knocked unconscious or otherwise prevented from continuing. Spells such as :ref:`hold person <corerulebook.spells.holdperson#hold_person>`\  do not end duels, but :ref:`flesh to stone <corerulebook.spells.fleshtostone#flesh_to_stone>`\  certainly does, assuming the target fails her saving throw. Some duels go to the death and are only ended when one duelist or team is a smoking pile of ash.

.. _`ultimatemagic.magic.spellduels#duel_combat`:
...
Each participant in a duel can act normally on her turn, but if she casts a spell, that spell must affect or target either herself or one of the other duel participants (whether this participant is an ally or an opponent). For example, a dueling mage could not cast :ref:`haste <corerulebook.spells.haste#haste>`\  on her allies and exclude herself, but she could cast it on herself and her allies. The same goes for offensive spells, such as :ref:`fireball <corerulebook.spells.fireball#fireball>`\ —the dueling caster must include one of her opponents in the duel among the targets of the spell, and could not affect some nearby creatures to the exclusion of her opponent.
...
.. _`ultimatemagic.magic.spellduels#dueling_counter`:
...
When a dueling opponent tries to cast a spell, the targeted spellcaster can make a :ref:`Spellcraft <corerulebook.skills.spellcraft#spellcraft>`\  check (DC 15 + the spell's level) as a free action. If the check succeeds, she identifies her opponent's spell and can attempt a dueling counter. If it fails, she cannot attempt a dueling counter against that spell. 
...
Alternatively, a spellcaster can use :ref:`dispel magic <corerulebook.spells.dispelmagic#dispel_magic>`\  or :ref:`greater dispel magic <corerulebook.spells.dispelmagic#dispel_magic_greater>`\  as a dueling counter. When a dueling spellcaster does so, she does not need to identify the spell being cast, can counter a spell of any level, and must succeed at a caster level check against a DC of 11 + the spell's caster level. When :ref:`dispel magic <corerulebook.spells.dispelmagic#dispel_magic>`\  is used as a dueling counter, it is not modified by any of the circumstances in Table 2–3.
...
.. list-table:: Table: Dueling Counter Modifiers
   ...
   * - Spell is of the same school, but not the same spell
     - +2
   * - Spell is of a higher level than the spell being counterer
     - +1 per level higher
   * - Spell is the same as the spell being countered
     - +10

.. _`ultimatemagic.magic.spellduels#duel_results`:
