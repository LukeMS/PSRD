...
.. _`corerulebook.spells.rustinggrasp`:

.. contents:: \ 

.. _`corerulebook.spells.rustinggrasp#rusting_grasp`:
...
You may employ \ *rusting grasp*\ in combat with a successful melee touch attack. \ *Rusting grasp*\ used in this way instantaneously destroys 1d6 points of :ref:`AC <corerulebook.combat#armor_class>`\  gained from metal armor (to the maximum amount of protection the armor offers) through corrosion. 
