...
\ **Melee**\  2 tentacles +6 (1d4+3 plus :ref:`grab <bestiary.universalmonsterrules#grab>`\ )

\ **Space**\  5 ft.; \ **Reach**\  10 ft.

\ **Special Attacks**\  :ref:`constrict <bestiary.universalmonsterrules#constrict>`\  (1d4+3), strangle, grab (Large)

.. _`bestiary.choker#statistics`:
...
\ **Skills**\  :ref:`Climb <corerulebook.skills.climb#climb>`\  +16, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +13

\ **Language**\  Undercommon

\ **SQ**\  quickness

.. _`bestiary.choker#ecology`:
...
.. _`bestiary.choker#special_abilities`:
