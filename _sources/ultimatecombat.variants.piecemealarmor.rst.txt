...
.. _`ultimatecombat.variants.piecemealarmor`:

.. contents:: \ 

.. _`ultimatecombat.variants.piecemealarmor#piecemeal_armor`:
...
.. _`ultimatecombat.variants.piecemealarmor#armor_pieces_and_armor_suits`:
...
.. _`ultimatecombat.variants.piecemealarmor#armor_pieces_and_proficiency`:
...
.. _`ultimatecombat.variants.piecemealarmor#half_plate_suit_pieces`:

.. list-table:: Table: Half-Plate Suit Pieces
   :header-rows: 1
...
.. _`ultimatecombat.variants.piecemealarmor#masterwork_special_material_and_magic_armor`:
...
.. _`ultimatecombat.variants.piecemealarmor#adamantine`:
...
.. _`ultimatecombat.variants.piecemealarmor#table_adamantine`:

.. list-table:: Table: Adamantine Item Costs
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`ultimatecombat.variants.piecemealarmor#dragonhide`:
...
.. _`ultimatecombat.variants.piecemealarmor#mithral`:
...
.. _`ultimatecombat.variants.piecemealarmor#table_mithral`:

.. list-table:: Table: Mithral Item Costs
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`ultimatecombat.variants.piecemealarmor#getting_into_and_out_of_armor_pieces`:
...
.. _`ultimatecombat.variants.piecemealarmor#remove`:

\ **Remove**\ : This column tells how long it takes a character to remove the armor piece.

.. _`ultimatecombat.variants.piecemealarmor#table_donning_armor_pieces`:

.. list-table:: Table: Donning Armor Pieces
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto

   * - Armor Piece Type and Protective Area
     - Don
     - Don Hastily
     - Remove
   * - Light arm armor piece
     - 2 rounds
     - 1 round
     - 2 rounds\ :sup:`1`
   * - Light leg armor piece
     - 3 rounds
     - 2 rounds
     - 2 rounds\ :sup:`1`
   * - Light torso armor piece
     - 5 rounds
     - 2 rounds
     - 5 rounds\ :sup:`1`
   * - Medium arm armor piece
...
* \ :sup:`1`\ If the character has some help, this time is halved. A single character doing nothing else can help one or two adjacent creatures. Two characters can't help each other don or remove armor pieces at the same time. \ :sup:`2`\ The wearer must have help to don this armor piece. Without help, it can only be donned hastily.

.. _`ultimatecombat.variants.piecemealarmor#armor_pieces_for_unusual_creatures`:

Armor Pieces for Unusual Creatures
###################################

Armor pieces for unusually big creatures, unusually little creatures, and non-humanoid creatures (such as horses) have different costs and weights from those given in the Arm Armor, Leg Armor and Torso Armor tables. Refer to the appropriate line in the :ref:`Armor for Unusal Creatures table <corerulebook.equipment#table_6_8_armor_for_unusual_creatures>`\  and apply the multipliers to cost and weight. For animals with four or more legs, the armor for half of the legs counts as the leg armor piece, and the armor for the other half counts as the arm armor piece.

.. _`ultimatecombat.variants.piecemealarmor#armor_and_armor_piece_hit_points_and_hardness`:

Armor and Armor Piece hit Points and hardness
##############################################

To determine the hit points and hardness of your armor, use the hardness for the weakest material, and to determine hit points, add the total armor bonus (including the +1 for wearing a complete suit of armor) and multiply that value by 5. If you need to determine the hardness and hit points for a single armor piece, it has the hardness of its main material and hit points equal to its armor bonus (treat as +1 for armor pieces with a +0 armor bonus) × 5. Hardness for substances can be found in the :ref:`Substance Hardness and Hit Points table <corerulebook.additionalrules#table_7_13_substance_hardness_and_hit_points>`\ . 

.. _`ultimatecombat.variants.piecemealarmor#armor_piece_descriptions`:
...
.. _`ultimatecombat.variants.piecemealarmor#arms`:

Arms
*****

.. _`ultimatecombat.variants.piecemealarmor#table_arm_armor_pieces`:

.. list-table:: Table: Arm Armor Pieces
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
* \ :sup:`1`\ Weight figures are for armor pieces sized to fit Medium characters. Armor pieces fitted for Small characters weigh half as much, and armor pieces fitted for Large characters weigh twice as much.
...
.. _`ultimatecombat.variants.piecemealarmor#chain_arm_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#hide_arm_armor_piece:`:
...
.. _`ultimatecombat.variants.piecemealarmor#horn_lamellar_arm_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#iron_lamellar_arm_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#kikko_arm_armor_piece`:

\ **Kikko Arm Armor Piece**\ : This arm armor piece consists of sleeves of leather reinforced by hexagonal plates made from iron. 

.. _`ultimatecombat.variants.piecemealarmor#kusari_gusoku_arm_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#leather_arm_armor_piece`:

\ **Leather Arm Armor Piece**\ : This arm armor piece consists of sleeves of hard-boiled leather that are carefully sewn together.

.. _`ultimatecombat.variants.piecemealarmor#leather_lamellar_arm_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#mountain_pattern_arm_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#o_yoroi_arm_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#padded_arm_armor_piece`:

\ **Padded Arm Armor Piece**\ : These sleeves are made of heavy or quilted cloth. 

.. _`ultimatecombat.variants.piecemealarmor#plate_arm_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#quilted_cloth_arm_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#scale_arm_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#splint_arm_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#steel_lamellar_arm_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#studded_leather_arm_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#tatami_do_arm_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#wooden_arm_armor_piece`:

\ **Wooden Arm Armor Piece**\ : These sleeves are constructed of fire-treated wood sewn over leather. 

.. _`ultimatecombat.variants.piecemealarmor#legs`:

Legs
*****

.. _`ultimatecombat.variants.piecemealarmor#table_leg_armor_pieces`:

.. list-table:: Table: Leg Armor Pieces
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
* \ :sup:`1`\ Weight figures are for armor pieces sized to fit Medium characters. Armor pieces fitted for Small characters weigh half as much, and armor pieces fitted for Large characters weigh twice as much. \ :sup:`2`\ When running while wearing this armor piece, you move at only triple your speed, not quadruple.
...
.. _`ultimatecombat.variants.piecemealarmor#banded_leg_armor_piece`:

\ **Banded Leg Armor Piece**\ : These overlapping strips of metal on leather usually take the form of leggings or a skirt. 

.. _`ultimatecombat.variants.piecemealarmor#chain_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#hide_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#horn_lamellar_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#iron_lamellar_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#kikko_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#kusari_gusoku_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#leather_lamellar_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#leather_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#mountain_pattern_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#o_yoroi_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#padded_leg_armor_piece`:

\ **Padded Leg Armor Piece**\ : This armor piece consists of leggings or a skirt made of heavy or quilted cloth.

.. _`ultimatecombat.variants.piecemealarmor#plate_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#quilted_cloth_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#scale_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#splint_leg_armor_piece`:

\ **Splint Leg Armor Piece**\ : These thigh guards and leggings are constructed of metal strips and chainmail.

.. _`ultimatecombat.variants.piecemealarmor#steel_lamellar_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#studded_leather_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#tatami_do_leg_armor_piece`:

\ **Tatami-Do Leg Armor Piece**\ : This armor piece is constructed of light lamellar thigh guards and leggings. 

.. _`ultimatecombat.variants.piecemealarmor#wooden_leg_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#torso`:

Torso
******

.. _`ultimatecombat.variants.piecemealarmor#table_torso_armor_pieces`:

.. list-table:: Table: Torso Armor Pieces
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
* \ :sup:`1`\ Weight figures are for armor pieces sized to fit Medium characters. Armor pieces fitted for Small characters weigh half as much, and armor pieces fitted for Large characters weigh twice as much. \ :sup:`2`\ When running while wearing this armor piece, you move only triple your speed, not quadruple. \ :sup:`3`\ These armor pieces are considered to be one weight category lower when worn with no other armor pieces. A chain torso armor piece worn alone is a chain shirt (light armor), and a plate or agile plate torso armor piece is a breastplate (medium armor).

The torso armor piece provides the most protection, but also usually provides the most hindrances to the wearer. 

.. _`ultimatecombat.variants.piecemealarmor#agile_plate_torso_armor_piece`:

\ **Agile Plate Torso Armor Piece**\ : This breastplate is designed to allow its wearer extra flexibility. When worn alone, the wearer's armor check penalty for the :ref:`Climb <corerulebook.skills.climb#climb>`\  and jump checks is only –1 (masterwork and mithral versions of this armor reduce this penalty as well as the normal penalty).

Alternatively, when worn with an agile lamellar arm armor piece and a chain leg armor piece (or lighter armor), the armor check penalty for :ref:`Climb <corerulebook.skills.climb#climb>`\  and jump checks is only –4 (masterwork and mithral versions of this armor and the above armor piece combination reduce this penalty as well as the normal penalty). 
...
.. _`ultimatecombat.variants.piecemealarmor#armored_coat`:
...
.. _`ultimatecombat.variants.piecemealarmor#banded_torso_armor_piece`:

\ **Banded Torso Armor Piece**\ : This armor piece is a shirt of overlapping metal plates reinforcing leather. 

.. _`ultimatecombat.variants.piecemealarmor#chain_torso_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#do_maru`:

\ **Do-Maru**\ : This light-weight armor piece wraps around the body like a short armored coat made of lamellar.

.. _`ultimatecombat.variants.piecemealarmor#four_mirror_armor`:
...
.. _`ultimatecombat.variants.piecemealarmor#haramaki`:
...
.. _`ultimatecombat.variants.piecemealarmor#hide_torso_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#horn_lamellar_torso_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#iron_lamellar_torso_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#kikko_torso_armor_piece`:

\ **Kikko Torso Armor Piece**\ : This armor piece is a shirt of hexagonal iron plates sewn into cloth or leather.

.. _`ultimatecombat.variants.piecemealarmor#kusari_gusoku_torso_armor_piece`:

\ **Kusari Gusoku Torso Armor Piece**\ : This chain jacket is worn in place of heavier chest armor. 

.. _`ultimatecombat.variants.piecemealarmor#lamellar_cuirass`:
...
.. _`ultimatecombat.variants.piecemealarmor#leather_lamellar_torso_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#leather_torso_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#mountain_pattern_torso_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#o_yoroi_torso_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#padded_torso_armor_piece`:

\ **Padded Torso Armor Piece**\ : This shirt or jacket is made of heavy or quilted cloth.

.. _`ultimatecombat.variants.piecemealarmor#plate_torso_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#quilted_cloth_torso_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#scale_torso_armor_piece`:

\ **Scale Torso Armor Piece**\ : This shirt or cuirass is made up of dozens of small overlapping metal plates. 

.. _`ultimatecombat.variants.piecemealarmor#silken_ceremonial_armor`:
...
.. _`ultimatecombat.variants.piecemealarmor#splint_torso_armor_piece`:

\ **Splint Torso Armor Piece**\ : This shirt or cuirass is constructed of metal strips reinforced with chain mail. 

.. _`ultimatecombat.variants.piecemealarmor#steel_lamellar_torso_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#stone_coat`:
...
.. _`ultimatecombat.variants.piecemealarmor#studded_leather_torso_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#tatami_do_torso_armor_piece`:
...
.. _`ultimatecombat.variants.piecemealarmor#wooden_torso_armor_piece`:
