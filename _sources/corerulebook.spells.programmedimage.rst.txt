...
.. _`corerulebook.spells.programmedimage`:

.. contents:: \ 

.. _`corerulebook.spells.programmedimage#programmed_image`:
...
This spell functions like :ref:`silent image <corerulebook.spells.silentimage#silent_image>`\ , except that this spell's figment activates when a specific condition occurs. The figment includes visual, auditory, olfactory, and thermal elements, including intelligible speech.
