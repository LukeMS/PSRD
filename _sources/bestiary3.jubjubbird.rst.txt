...
.. _`bestiary3.jubjubbird`:

.. contents:: \ 

.. _`bestiary3.jubjubbird#jubjub_bird`:
...
\ **Init**\  +2; \ **Senses**\  darkvision 60 ft., low-light vision, :ref:`scent <bestiary.universalmonsterrules#scent>`\ ; :ref:`Perception <corerulebook.skills.perception#perception>`\  +24

.. _`bestiary3.jubjubbird#defense`:
...
.. _`bestiary3.jubjubbird#offense`:
...
\ **Melee**\  bite +31 (3d6+19/19–20/×3 plus :ref:`grab <bestiary.universalmonsterrules#grab>`\ ), 2 talons +31 (1d8+13)
...
.. _`bestiary3.jubjubbird#statistics`:
...
\ **Feats**\  :ref:`Blind-Fight <corerulebook.feats#blind_fight>`\ , :ref:`Cleave <corerulebook.feats#cleave>`\ , :ref:`Combat Reflexes <corerulebook.feats#combat_reflexes>`\ , :ref:`Dodge <corerulebook.feats#dodge>`\ , :ref:`Improved Critical <corerulebook.feats#improved_critical>`\  (bite), :ref:`Iron Will <corerulebook.feats#iron_will>`\ , :ref:`Mobility <corerulebook.feats#mobility>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`\ , :ref:`Run <corerulebook.feats#run>`\ , :ref:`Spring Attack <corerulebook.feats#spring_attack>`

\ **Skills**\  :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  +14 (+22 when jumping), :ref:`Fly <corerulebook.skills.fly#fly>`\  +7, :ref:`Perception <corerulebook.skills.perception#perception>`\  +24; \ **Racial Modifiers**\  +12 :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\ , +8 :ref:`Perception <corerulebook.skills.perception#perception>`

\ **SQ**\  planar acclimation

.. _`bestiary3.jubjubbird#ecology`:
...
.. _`bestiary3.jubjubbird#special_abilities`:

Special Abilities
==================

\ **Adaptive Defense (Su)**\  When first encountered, a jubjub bird has no energy :ref:`resistance <bestiary.universalmonsterrules#resistance>`\ . When damaged by an attack that causes :ref:`cold <bestiary.creaturetypes#cold_subtype>`\ , electricity, :ref:`fire <bestiary.creaturetypes#fire_subtype>`\ , or sonic damage, it gains :ref:`resistance <bestiary.universalmonsterrules#resistance>`\  30 to that energy type until the end of its next turn. If an attack causes more than one type of energy damage, the jubjub bird gains :ref:`resistance <bestiary.universalmonsterrules#resistance>`\  30 to all the types of energy damage dealt.
...
\ **Planar Acclimation (Ex)**\  A jubjub bird is always considered to be on its home plane, regardless of what plane it finds itself upon. It never gains the :ref:`extraplanar <bestiary.creaturetypes#extraplanar_subtype>`\  subtype.
