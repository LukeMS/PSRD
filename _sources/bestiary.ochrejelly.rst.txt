...
.. _`bestiary.ochrejelly`:

.. contents:: \ 

.. _`bestiary.ochrejelly#ochre_jelly`:
...
\ **Defensive Abilities**\  split; \ **Immune**\  electricity, mind-affecting effects, :ref:`ooze traits <bestiary.creaturetypes#ooze>`\ , slashing and piercing damage

.. _`bestiary.ochrejelly#offense`:
...
\ **Melee**\  slam +5 (2d4+3 plus 1d4 acid and :ref:`grab <bestiary.universalmonsterrules#grab>`\ )

\ **Space**\  10 ft.; \ **Reach**\  5 ft.

\ **Special Attacks**\  :ref:`constrict <bestiary.universalmonsterrules#constrict>`\  (2d4+3 plus 1d4 acid)

.. _`bestiary.ochrejelly#statistics`:
...
\ **Skills**\  :ref:`Climb <corerulebook.skills.climb#climb>`\  +10

.. _`bestiary.ochrejelly#ecology`:
...
.. _`bestiary.ochrejelly#special_abilities`:
