...
.. _`advancedraceguide.coreraces.humans`:

.. contents:: \ 

.. _`advancedraceguide.coreraces.humans#humans`:
...
.. _`advancedraceguide.coreraces.humans#human_racial_traits`:
...
.. _`advancedraceguide.coreraces.humans#alternate_racial_rules`:
...
.. _`advancedraceguide.coreraces.humans#alternate_racial_traits`:
...
.. _`advancedraceguide.coreraces.humans#adoptive_parentage`:

\ **Adoptive Parentage**\ : Humans are sometimes orphaned and adopted by other races. Choose one humanoid race without the human subtype. You start play with that race's languages and gain that race's weapon familiarity racial trait (if any). If the race does not have weapon familiarity, you gain either :ref:`Skill Focus <corerulebook.feats#skill_focus>`\  or :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  as a bonus feat that is appropriate for that race instead. This racial trait replaces the bonus feat trait.

.. _`advancedraceguide.coreraces.humans#dual_talent`:

\ **Dual Talent**\ : Some humans are uniquely skilled at maximizing their natural gifts. These humans pick two ability scores and gain a +2 racial bonus in each of those scores. This racial trait replaces the +2 bonus to any one ability score, the bonus feat, and the skilled traits.

.. _`advancedraceguide.coreraces.humans#eye_for_talent`:

\ **Eye for Talent**\ : Humans have great intuition for hidden potential. They gain a +2 racial bonus on :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  checks. In addition, when they acquire an animal companion, bonded mount, cohort, or familiar, that creature gains a +2 bonus to one ability score of the character's choice. This racial trait replaces the bonus feat trait.

.. _`advancedraceguide.coreraces.humans#focused_study`:

\ **Focused Study**\ : All humans are skillful, but some, rather than being generalists, tend to specialize in a handful of skills. At 1st, 8th, and 16th level, such humans gain :ref:`Skill Focus <corerulebook.feats#skill_focus>`\  in a skill of their choice as a bonus feat. This racial trait replaces the bonus feat trait.

.. _`advancedraceguide.coreraces.humans#heart_of_the_fields`:

\ **Heart of the Fields**\ : Humans born in rural areas are used to hard labor. They gain a racial bonus equal to half their character level to any one :ref:`Craft <corerulebook.skills.craft#craft>`\  or :ref:`Profession <corerulebook.skills.profession#profession>`\  skill, and once per day they may ignore an effect that would cause them to become fatigued or exhausted. This racial trait replaces skilled.

.. _`advancedraceguide.coreraces.humans#heart_of_the_mountains`:

\ **Heart of the Mountains**\ : Humans born in the mountains are skilled at negotiating heights and precipices. They gain a +2 racial bonus on :ref:`Climb <corerulebook.skills.climb#climb>`\  checks and :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  checks to move on narrow surfaces and uneven ground. Furthermore, they are considered acclimated to the effects of high altitude. This racial trait replaces skilled. 

.. _`advancedraceguide.coreraces.humans#heart_of_the_sea`:

\ **Heart of the Sea**\ : Humans born near the sea are always drawn to it. They gain a +2 racial bonus on :ref:`Profession <corerulebook.skills.profession#profession>`\  (sailor) and :ref:`Swim <corerulebook.skills.swim#swim>`\  checks, and these are always class skills for them. They can hold their breath twice as long as normal, and spellcasters gain a +4 racial bonus on concentration checks when attempting to cast spells underwater. This racial trait replaces skilled.

.. _`advancedraceguide.coreraces.humans#heart_of_the_slums`:

\ **Heart of the Slums**\ : Humans who eke out a life in a city's teeming slums must be quick and clever. They gain a +2 racial bonus on :ref:`Sleight of Hand <corerulebook.skills.sleightofhand#sleight_of_hand>`\  and :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  checks, and a +4 racial bonus on :ref:`Survival <corerulebook.skills.survival#survival>`\  checks in urban and underground settings. In addition, they may roll twice when saving against disease, taking the better roll. This racial trait replaces skilled.

.. _`advancedraceguide.coreraces.humans#heart_of_the_snows`:

\ **Heart of the Snows**\ : Humans born in chilly climes treat cold climates as one category less severe. They gain a +2 racial bonus on Fortitude saving throws against the effects of cold climates, on any check or saving throw to avoid slipping and falling, and to CMD against trip combat maneuvers. This bonus applies on :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  and :ref:`Climb <corerulebook.skills.climb#climb>`\  checks made in slippery conditions. This racial trait replaces skilled.

.. _`advancedraceguide.coreraces.humans#heart_of_the_streets`:
...
.. _`advancedraceguide.coreraces.humans#heart_of_the_sun`:
...
.. _`advancedraceguide.coreraces.humans#heart_of_the_wilderness`:

\ **Heart of the Wilderness**\ : Humans raised in the wild learn the hard way that only the strong survive. They gain a racial bonus equal to half their character level on :ref:`Survival <corerulebook.skills.survival#survival>`\  checks. They also gain a +5 racial bonus on Constitution checks to stabilize when dying and add half their character level to their Constitution score when determining the negative hit point total necessary to kill them. This racial trait replaces skilled.

.. _`advancedraceguide.coreraces.humans#heroic`:
...
.. _`advancedraceguide.coreraces.humans#mixed_heritage`:
...
.. _`advancedraceguide.coreraces.humans#silver_tongued`:

\ **Silver Tongued**\ : Human are often adept at subtle manipulation and putting even sworn foes at ease. Humans with this trait gain a +2 bonus on :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  and :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  checks. In addition, when they use :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  to shift a creature's attitude, they can shift up to three steps up rather than just two. This racial trait replaces skilled. 

.. _`advancedraceguide.coreraces.humans#racial_subtypes`:
...
.. _`advancedraceguide.coreraces.humans#cosmopolitan`:
...
.. _`advancedraceguide.coreraces.humans#country_folk`:
...
.. _`advancedraceguide.coreraces.humans#gutter_rat`:
...
.. _`advancedraceguide.coreraces.humans#imperious_human`:
...
.. _`advancedraceguide.coreraces.humans#trailblazer`:
...
.. _`advancedraceguide.coreraces.humans#versatile_human`:
...
.. _`advancedraceguide.coreraces.humans#favored_class_options`:
...
\ **Druid**\ : Add a +1/2 bonus on :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  and :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks to change a creature's attitude.
...
.. _`advancedraceguide.coreraces.humans#racial_archetypes_&_bloodlines`:
...
.. _`advancedraceguide.coreraces.humans#buccaneer_(gunslinger)`:
...
.. _`advancedraceguide.coreraces.humans#deeds`:

\ **Deeds**\ : A buccaneer swaps four of the normal gunslinger deeds for the following deeds.

.. _`advancedraceguide.coreraces.humans#seadogs_gait`:

 \ *Seadog's Gait (Ex)*\ : At 1st level, the buccaneer gains :ref:`Sea Legs <ultimatecombat.ultimatecombatfeats#sea_legs>`\  as a bonus feat. If she spends 1 grit point, she can ignore difficult terrain until the end of her turn. This replaces the quick clear deed.

.. _`advancedraceguide.coreraces.humans#pirates_jargon`:

 \ *Pirate's Jargon (Ex)*\ : At 3rd level, the buccaneer's baffling palaver of nautical jargon and piratical cant provides a +2 bonus on :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  and :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks. Furthermore, she can spend a swift action and 1 grit point to cause a single living creature within 30 feet to make a Will saving throw (DC = 10 + 1/2 her buccaneer level + her Charisma modifier) or become confused for 1 round. This is a mind-affecting language-dependent effect. This replaces the pistol whip deed. 

.. _`advancedraceguide.coreraces.humans#rope_swing_(ex):`:

 \ *Rope Swing (Ex):*\ At 7th level, as long as the buccaneer has at least 1 grit point, she gains a bonus on :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  and :ref:`Climb <corerulebook.skills.climb#climb>`\  checks equal to her gunslinger level when climbing or swinging on a rope. If she spends 1 grit point, her move while climbing or swinging on a rope does not provoke attacks of opportunity. This replaces the dead shot deed. 

.. _`advancedraceguide.coreraces.humans#captains_curse_(sp):`:
...
.. _`advancedraceguide.coreraces.humans#grit`:
...
.. _`advancedraceguide.coreraces.humans#liquid_courage`:
...
.. _`advancedraceguide.coreraces.humans#bonus_feat`:

\ **Bonus Feat**\ : In addition to combat and grit feats, a buccaneer can select from the following feats as her bonus feats: :ref:`Expert Driver <ultimatecombat.ultimatecombatfeats#expert_driver>`\  (water vehicles only), :ref:`Master Siege Engineer <ultimatecombat.ultimatecombatfeats#master_siege_engineer>`\ , :ref:`Siege Engineer <ultimatecombat.ultimatecombatfeats#siege_engineer>`\ , :ref:`Siege Gunner <ultimatecombat.ultimatecombatfeats#siege_gunner>`\ , :ref:`Skilled Driver <ultimatecombat.ultimatecombatfeats#skilled_driver>`\  (water vehicles only).

.. _`advancedraceguide.coreraces.humans#exotic_pet`:
...
.. _`advancedraceguide.coreraces.humans#sword_and_pistol`:

\ **Sword and Pistol**\ : At 9th level, a buccaneer gains :ref:`Sword and Pistol <ultimatecombat.ultimatecombatfeats#sword_and_pistol>`\  as a bonus feat even if she does not meet the prerequisites. This ability replaces gun training 2.

.. _`advancedraceguide.coreraces.humans#gun_training`:

\ **Gun Training (Ex)**\ : A buccaneer gains this ability only at 13th level with a single type of firearm. 

.. _`advancedraceguide.coreraces.humans#raiders_riposte`:
...
.. _`advancedraceguide.coreraces.humans#feral_child_(druid)`:
...
.. _`advancedraceguide.coreraces.humans#weapon_and_armor_proficiency`:

\ **Weapon and Armor Proficiency**\ : A feral child loses proficiency with the scimitar, scythe, and sickle and with shields. 

.. _`advancedraceguide.coreraces.humans#class_skills`:

\ **Class Skills**\ : A feral child adds :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  to her list of class skills and removes :ref:`Fly <corerulebook.skills.fly#fly>`\  and :ref:`Profession <corerulebook.skills.profession#profession>`\  from her list of class skills. 

.. _`advancedraceguide.coreraces.humans#illiteracy:`:

\ **Illiteracy:**\ At 1st level, a feral child is unable to read and write, though she may learn by taking 1 rank of :ref:`Linguistics <corerulebook.skills.linguistics#linguistics>`\ . She does not gain Druidic as a free language and cannot select Sylvan as a bonus language.

.. _`advancedraceguide.coreraces.humans#improved_unarmed_strike`:

\ **Improved Unarmed Strike**\ : At 1st level, a feral child gains :ref:`Improved Unarmed Strike <corerulebook.feats#improved_unarmed_strike>`\  as a bonus feat.

.. _`advancedraceguide.coreraces.humans#beast_family`:

\ **Beast Family (Ex)**\ : At 1st level, a feral child may choose one specific type of animal as the type that raised her. She gains a +2 circumstance bonus on :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  and wild empathy checks with animals of that type, and she can communicate with them as if using a continual :ref:`speak with animals <corerulebook.spells.speakwithanimals#speak_with_animals>`\  spell-like ability, but this ability is nonmagical. 

.. _`advancedraceguide.coreraces.humans#nature_bond`:

\ **Nature Bond (Ex)**\ : At 1st level, a feral child must select an animal companion as her nature bond. 

.. _`advancedraceguide.coreraces.humans#favored_terrain`:
...
.. _`advancedraceguide.coreraces.humans#native_cunning`:

\ **Native Cunning (Ex)**\ : At 3rd level, a feral child gains trap sense as a barbarian of equal level, and in her favored terrain, she immediately receives a :ref:`Perception <corerulebook.skills.perception#perception>`\  check to notice traps within 10 feet, as the trap spotter rogue talent. In addition, at 3rd level and every three levels thereafter, she may choose one combat maneuver, and gains a bonus equal to her trap sense bonus to her CMD against that maneuver. This ability replaces wild shape.

.. _`advancedraceguide.coreraces.humans#native_fortitude`:
...
.. _`advancedraceguide.coreraces.humans#native_call`:
...
.. _`advancedraceguide.coreraces.humans#imperious_bloodline_(sorcerer)`:
...
.. _`advancedraceguide.coreraces.humans#class_skill`:

\ **Class Skill**\ : :ref:`Perform <corerulebook.skills.perform#perform>`\  (oratory).

.. _`advancedraceguide.coreraces.humans#bonus_spells`:

\ **Bonus Spells**\ : :ref:`moment of greatness <ultimatecombat.spells.momentofgreatness#moment_of_greatness>`\  , :ref:`eagle's splendor <corerulebook.spells.eaglessplendor#eagle_s_splendor>`\  (5th), :ref:`heroism <corerulebook.spells.heroism#heroism>`\  (7th), :ref:`threefold aspect <advancedplayersguide.spells.threefoldaspect#threefold_aspect>`\  (9th), :ref:`greater command <corerulebook.spells.command#command_greater>`\  (11th), :ref:`repulsion <corerulebook.spells.repulsion#repulsion>`\  (13th), :ref:`greater age resistance <ultimatemagic.spells.ageresistance#age_resistance_greater>`\ , :ref:`prediction of failure <ultimatemagic.spells.predictionoffailure#prediction_of_failure>`\  , :ref:`overwhelming presence <ultimatemagic.spells.overwhelmingpresence#overwhelming_presence>`\  (19th).

.. _`advancedraceguide.coreraces.humans#bonus_feats`:

\ **Bonus Feats**\ : Diehard, :ref:`Endurance <corerulebook.feats#endurance>`\ , :ref:`Heroic Defiance <advancedplayersguide.advancedfeats#heroic_defiance>`\ , :ref:`Heroic Recovery <advancedplayersguide.advancedfeats#heroic_recovery>`\ , :ref:`Improved Initiative <corerulebook.feats#improved_initiative>`\ , :ref:`Lingering Spell <advancedplayersguide.advancedfeats#lingering_spell>`\ , :ref:`Magical Aptitude <corerulebook.feats#magical_aptitude>`\ , :ref:`Persuasive <corerulebook.feats#persuasive>`\ .

.. _`advancedraceguide.coreraces.humans#bloodline_arcana`:

\ **Bloodline Arcana**\ : Whenever you cast a harmful spell, you gain a bonus equal to the spell's level on :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks made against any creature adversely effected by that spell until the end of your next turn. Adversely effected typically means damage, but it can also mean debilitating effects or conditions. 

.. _`advancedraceguide.coreraces.humans#bloodline_powers`:

\ **Bloodline Powers**\ : You draw upon ancestors both legendary and forgotten. 

.. _`advancedraceguide.coreraces.humans#student_of_humanity`:

 \ *Student of Humanity (Ex)*\ : At 1st level, you gain :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\ , :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (history), :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (local), :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nobility), and :ref:`Linguistics <corerulebook.skills.linguistics#linguistics>`\  as class skills. In addition, when using these skills to learn, study, or gather information about humans, you add an insight bonus equal to your Charisma bonus on such checks.

.. _`advancedraceguide.coreraces.humans#heroic_echo`:
...
.. _`advancedraceguide.coreraces.humans#heroic_legends`:
...
.. _`advancedraceguide.coreraces.humans#immortal_legend`:
...
.. _`advancedraceguide.coreraces.humans#wanderer_(monk)`:
...
\ **Class Skills**\ : The wanderer adds :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\ , :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (geography), :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (local), :ref:`Linguistics <corerulebook.skills.linguistics#linguistics>`\ , and :ref:`Survival <corerulebook.skills.survival#survival>`\  to his list of class skills. 

.. _`advancedraceguide.coreraces.humans#far_traveler`:
...
.. _`advancedraceguide.coreraces.humans#long_walk`:

\ **Long Walk (Ex)**\ : At 3rd level, the wanderer gains :ref:`Endurance <corerulebook.feats#endurance>`\  as a bonus feat, and the feat bonus doubles when he makes Constitution checks because of a forced march. In addition, a wanderer gains a +2 bonus on saving throws against  spells and effects that cause exhaustion and fatigue. This ability replaces still mind.

.. _`advancedraceguide.coreraces.humans#light_step`:

\ **Light Step (Su)**\ : At 5th level, a wanderer leaves no trail and cannot be tracked, though he can leave a trail if desired. By spending 1 point from his \ *ki*\ pool, he can use :ref:`ant haul <advancedplayersguide.spells.anthaul#ant_haul>`\ , :ref:`feather step <advancedplayersguide.spells.featherstep#feather_step>`\ ,  :ref:`pass without trace <corerulebook.spells.passwithouttrace#pass_without_trace>`\ , or :ref:`tireless pursuit <advancedplayersguide.spells.tirelesspursuit#tireless_pursuit>`\   as a spell-like ability (with a caster level equal to his monk level). This ability replaces slow fall.

.. _`advancedraceguide.coreraces.humans#inscrutable`:

\ **Inscrutable (Su)**\ : At 5th level, the wanderer gains a supernatural air of mystery. The DC to gain information or insight into the wanderer with :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\ , :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  skills, or :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  increases by 5. In addition, by spending 1 point from his \ *ki*\ pool, the wanderer gains :ref:`nondetection <corerulebook.spells.nondetection#nondetection>`\  for 24 hours with a caster level equal to his monk level. This ability replaces high jump.

.. _`advancedraceguide.coreraces.humans#wanderers_wisdom`:
...
.. _`advancedraceguide.coreraces.humans#disappear_unnoticed`:

\ **Disappear Unnoticed (Ex)**\ : At 12th level, the wanderer may use :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  to hide even while being directly observed or when no cover or concealment is available, as long as he is adjacent to at least one creature of his size or larger, by spending 1 point from his \ *ki*\ pool. This effect lasts until the beginning of the wanderer's next turn and may be continued in consecutive rounds by spending 1 \ *ki*\  point each round. This ability replaces abundant step. 

.. _`advancedraceguide.coreraces.humans#free_step`:

\ **Free Step (Su)**\ : At 13th level, the wanderer gains continuous :ref:`freedom of movement <corerulebook.spells.freedomofmovement#freedom_of_movement>`\  as a continuous spell-like ability\ *.*\  This ability replaces diamond soul. 

.. _`advancedraceguide.coreraces.humans#new_racial_rules`:
...
.. _`advancedraceguide.coreraces.humans#human_equipment`:
...
.. _`advancedraceguide.coreraces.humans#training_harness`:

\ **Training Harness**\ : This specialized gear must be tailored to a specific type of animal. A training harness provides a +2 bonus on :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  checks made with an animal wearing it. 

.. _`advancedraceguide.coreraces.humans#whip_training`:

\ **Whip, Training**\ : This short lash has a reach of only 10 feet, but is otherwise identical to a normal whip. The wielder gains a +2 circumstance bonus on :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  checks to push a trained animal and on :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks made to demoralize any animal as long as the animal is within the whip's reach. When using the whip to demoralize a trained animal, the wielder may choose to fascinate the animal rather than causing it to become shaken for the same duration as the shaken condition, but the fascinate effect ends if line of sight between the wielder and the animal is broken.

.. list-table:: Human Equipment
   :header-rows: 1
...
.. _`advancedraceguide.coreraces.humans#human_feats`:
...
.. _`advancedraceguide.coreraces.humans#bestow_luck`:
...
.. _`advancedraceguide.coreraces.humans#critical_versatility_(combat)`:
...
.. _`advancedraceguide.coreraces.humans#dauntless_destiny`:
...
.. _`advancedraceguide.coreraces.humans#fast_learner`:
...
.. _`advancedraceguide.coreraces.humans#fearless_curiosity`:
...
.. _`advancedraceguide.coreraces.humans#heroic_will`:
...
\ **Prerequisites**\ : :ref:`Iron Will <corerulebook.feats#iron_will>`\ , base Will save +4, human. 
...
.. _`advancedraceguide.coreraces.humans#huntmaster`:
...
\ **Prerequisites**\ : :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  1 rank; either the animal companion, divine bond (mount), or mount class feature; human. 
...
You gain a +2 bonus on :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  and :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nature) checks with creatures of that type of animal. Furthermore, you are treated as one level higher when determining the abilities of your animal companion or mount, as long as it is of the chosen type.

.. _`advancedraceguide.coreraces.humans#improved_improvisation`:
...
.. _`advancedraceguide.coreraces.humans#improvisation`:
...
.. _`advancedraceguide.coreraces.humans#inexplicable_luck`:
...
.. _`advancedraceguide.coreraces.humans#intimidating_confidence`:
...
\ **Prerequisites**\ : Cha 13, Fearless Curiosity, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  5 ranks, human.

\ **Benefit**\ : You gain a +1 bonus on saving throws against effects with the emotion descriptor; this bonus stacks with the bonus granted by Fearless Curiosity. When you confirm a critical hit, as a free action you can make an :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  check to demoralize one creature you threaten. If you have the Dazzling Display feat, you can make :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks to demoralize all creatures you threaten instead. You gain a +2 bonus on this check if your weapon has a ×3 critical modifier, or +4 if it has a ×4 critical modifier.

.. _`advancedraceguide.coreraces.humans#martial_mastery_(combat)`:
...
\ **Benefit**\ : Each combat feat you have that applies to a specific weapon (e.g., :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\ ) can be used with all weapons in the same weapon group. 

.. _`advancedraceguide.coreraces.humans#martial_versatility_(combat)`:
...
\ **Benefit**\ : Choose one combat feat you know that applies to a specific weapon (e.g., :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\ ). You can use that feat with any weapon within the same weapon group.

\ **Special**\ : You may take this feat more than once. Each time it applies to a different feat. 

.. _`advancedraceguide.coreraces.humans#surge_of_success`:
...
.. _`advancedraceguide.coreraces.humans#human_magic_items`:
...
.. _`advancedraceguide.coreraces.humans#belt_of_foraging`:
...
.. _`advancedraceguide.coreraces.humans#description`:

Description
============

This belt allows its wearer to easily forage while in the wilderness. As long as the wearer of this belt has at least 1 rank in :ref:`Survival <corerulebook.skills.survival#survival>`\ , he need not make a check to get along in the wild; he always succeeds at that :ref:`Survival <corerulebook.skills.survival#survival>`\  check as long as he moves at half his overland speed. He can still choose to make that check to provide food and water for one other creature for every 2 points by which his result exceeds DC 10. Furthermore, he can instead make a DC 20 :ref:`Survival <corerulebook.skills.survival#survival>`\  check to get along in the wild while moving at full speed instead of half speed. While doing so, he can provide food and water for one other creature for every 2 points by which his check result exceeds 20. 

.. _`advancedraceguide.coreraces.humans#construction`:

Construction
=============

\ **Requirements**\  :ref:`Craft Wondrous Item <corerulebook.feats#craft_wondrous_item>`\ , \ *detect animals and plants*\ , creator must have at least 1 rank in :ref:`Survival <corerulebook.skills.survival#survival>`\ ; \ **Cost**\  3,000 gp

.. _`advancedraceguide.coreraces.humans#crown_of_conquest`:
...
\ **Requirements**\  :ref:`Craft Wondrous Item <corerulebook.feats#craft_wondrous_item>`\ , :ref:`bless <corerulebook.spells.bless#bless>`\ , :ref:`eagle's splendor <corerulebook.spells.eaglessplendor#eagle_s_splendor>`\ , :ref:`prayer <corerulebook.spells.prayer#prayer>`\ ; \ **Cost**\  12,300 gp

.. _`advancedraceguide.coreraces.humans#crown_of_swords`:
...
\ **Requirements**\  :ref:`Craft Wondrous Item <corerulebook.feats#craft_wondrous_item>`\ , :ref:`spiritual weapon <corerulebook.spells.spiritualweapon#spiritual_weapon>`\ ; \ **Cost**\  3,000 gp 

.. _`advancedraceguide.coreraces.humans#rod_of_steadfast_resolve`:
...
This rod functions as a +2 :ref:`light <corerulebook.spells.light#light>`\  mace. It takes the form of a light mace with a head in the shape of a clenched fist. While a creature wields this rod, it grants all its allies within a 20-foot-radius burst a +2 morale bonus on saving throws against fear and emotion effects, or a +4 morale bonus on such saves if the ally has the human subtype. 
...
\ **Requirements**\  :ref:`Craft Rod <corerulebook.feats#craft_rod>`\ , :ref:`bless <corerulebook.spells.bless#bless>`\ , \ *calm emotion*\ , the creator must have the :ref:`human <bestiary.creaturetypes#human_subtype>`\  subtype; \ **Cost**\  19,305 gp

.. _`advancedraceguide.coreraces.humans#human_spells`:
...
.. _`advancedraceguide.coreraces.humans#bestow_insight`:
...
.. _`advancedraceguide.coreraces.humans#black_mark`:

Black Mark
===========

\ **School**\  necromancy [:ref:`curse <bestiary.universalmonsterrules#curse>`\ , :ref:`fear <bestiary.universalmonsterrules#fear_(su_or_sp)>`\ ]; \ **Level**\  druid 7, witch 7
...
You mark the target with a black marking on its skin; the mark's exact appearance determined by you, but can be no larger than your hand. The \ *black mark*\ functions as a :ref:`mark of justice <corerulebook.spells.markofjustice#mark_of_justice>`\ , and when the mark is activated, the target becomes shaken anytime it is on or in the water more than a 5 feet from shore. In addition, as long as the \ *black mark*\ is active, the target is affected as if subject to :ref:`nature's exile <advancedplayersguide.spells.naturesexile#natures_exile>`\  , but all creatures with the aquatic or water subtype or with a swim speed are made hostile, even those not of the animal type, though non-aquatic animals are not. 

.. _`advancedraceguide.coreraces.humans#old_salts_curse`:

Old Salt's Curse
=================

\ **School**\  necromancy [:ref:`curse <bestiary.universalmonsterrules#curse>`\ ]; \ **Level**\  druid 5, witch 5
...
You inflict a curse of the roiling sea upon the target, making it permanently sickened. Anytime the target is on or in the water more than a mile from shore, it also becomes staggered with seasickness. This curse cannot be dispelled, though :ref:`remove curse <corerulebook.spells.removecurse#remove_curse>`\  or :ref:`break enchantment <corerulebook.spells.breakenchantment#break_enchantment>`\  can negate it. 
