...
.. _`ultimatecampaign.campaignsystems.exploration`:

.. contents:: \ 

.. _`ultimatecampaign.campaignsystems.exploration#exploration`:
...
.. _`ultimatecampaign.campaignsystems.exploration#sandbox_exploration`:
...
.. _`ultimatecampaign.campaignsystems.exploration#movement`:
...
A typical wilderness hex is trackless (:ref:`see the Terrain and Overland Movement table <corerulebook.additionalrules#local_movement>`\ ). Though no humanoid-created roads or trails pass through it, trails by game animals might. If a hex contains more than one terrain type, treat it as the most prevalent terrain for the purpose of travel times.

.. _`ultimatecampaign.campaignsystems.exploration#table_travel_time`:

.. list-table:: Travel Time (1 Hex)
   :header-rows: 1
...
.. _`ultimatecampaign.campaignsystems.exploration#table_exploration_time`:

.. list-table:: Exploration Time (1 Hex)
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`ultimatecampaign.campaignsystems.exploration#tracking_travel`:
...
.. _`ultimatecampaign.campaignsystems.exploration#exploration_rewards`:
...
.. _`ultimatecampaign.campaignsystems.exploration#keep_things_interesting`:
...
.. _`ultimatecampaign.campaignsystems.exploration#getting_lost`:
...
.. _`ultimatecampaign.campaignsystems.exploration#random_encounters`:
...
.. _`ultimatecampaign.campaignsystems.exploration#planned_encounters`:
...
.. _`ultimatecampaign.campaignsystems.exploration#hex_terrain_types`:
...
.. _`ultimatecampaign.campaignsystems.exploration#desert`:
...
\ **Difficult**\ : A difficult desert is a treacherous place, full of sand dunes, sinkholes, rubble, sandstorms, or numerous ravines. Rare seasonal rains might cause flash floods, sweeping away or drowning any creature in their path. :ref:`Survival <corerulebook.skills.survival#survival>`\  checks to avoid getting lost or to become un-lost in this hex gain a +1 bonus. :ref:`Survival <corerulebook.skills.survival#survival>`\  checks to get along in the wild increase by 5.
...
.. _`ultimatecampaign.campaignsystems.exploration#forest`:
...
\ **Resource**\ : This hex contains valuable lumber, medicinal herbs, or plentiful sources of game meat. :ref:`Survival <corerulebook.skills.survival#survival>`\  checks to get along in the wild gain a +5 bonus.
...
.. _`ultimatecampaign.campaignsystems.exploration#hill`:
...
\ **Difficult**\ : Full of short cliffs and jagged stones, a difficult hill hex requires extra caution to avoid dangerous falls. For the purposes of travel and exploration times, treat the party's speed as :ref:`one category slower <ultimatecampaign.campaignsystems.exploration#terrain>`\ .

\ **Feature**\ : The hex might be the site of a famous historical battle or the burial mound of long-dead chieftains. It provides a commanding view of the surrounding region and is useful as a waypoint. :ref:`Survival <corerulebook.skills.survival#survival>`\  checks to avoid getting lost or to become un-lost in this hex gain a +1 bonus.
...
\ **Secret**\ : Hidden caverns provide shelter and lairs for monsters. Locating these caverns requires a successful DC 10 :ref:`Perception <corerulebook.skills.perception#perception>`\  or :ref:`Survival <corerulebook.skills.survival#survival>`\  check. PCs who take shelter here suffer no effect from storms and similar hazards, but the chance of random encounters increases by 10%.

.. _`ultimatecampaign.campaignsystems.exploration#marsh`:

Marsh
======

Marshes, swamps, and bogs are challenging ground to traverse. :ref:`Survival <corerulebook.skills.survival#survival>`\  check DCs to avoid getting lost increase by 1 in a marsh hex.

\ **Difficult**\ : A difficult marsh hex is a deadly place, replete with quicksand, poisonous plants, and treacherous water. The DCs for :ref:`Survival <corerulebook.skills.survival#survival>`\  checks to get along in the wild increase by 5. For the purposes of travel and exploration times, treat the party's speed as :ref:`one category slower <ultimatecampaign.campaignsystems.exploration#terrain>`\ .
...
\ **Secret**\ : Unfortunate explorers died in the marsh and left behind all their gear. With a successful DC 25 :ref:`Survival <corerulebook.skills.survival#survival>`\  check, the PCs can each salvage equipment worth 10 gp per character level.

.. _`ultimatecampaign.campaignsystems.exploration#mountain`:
...
\ **Difficult**\ : All :ref:`Climb <corerulebook.skills.climb#climb>`\  DCs in a difficult mountain hex increase by 2. For the purposes of travel and exploration times, treat the party's speed as :ref:`one category slower <ultimatecampaign.campaignsystems.exploration#terrain>`\ .
...
\ **Secret**\ : Hidden pathways carved through the mountains offer speedier paths. If the PCs succeed at a DC 20 :ref:`Perception <corerulebook.skills.perception#perception>`\  check to find the pathways, they can ignore the default travel time increase for the mountain hex.

.. _`ultimatecampaign.campaignsystems.exploration#plain`:
...
\ **Difficult**\ : Dangerous plains tend to be filled with small sinkholes and pits that can twist or break the legs of the unwary. For the purposes of travel and exploration times, treat the party's speed as :ref:`one category slower <ultimatecampaign.campaignsystems.exploration#terrain>`\ .
...
\ **Secret**\ : Stolen goods are buried in the hex and marked with an innocuous sign, such as an out-of-place river rock. With a successful DC 25 :ref:`Perception <corerulebook.skills.perception#perception>`\  check, the PCs recognize the marker and can each salvage treasure or nonmagical gear worth 10 gp per character level.

.. _`ultimatecampaign.campaignsystems.exploration#settlement`:
...
.. _`ultimatecampaign.campaignsystems.exploration#water`:
...
\ **Difficult**\ : Whitewater rapids, strong tides, or underwater vortexes mean this water is more challenging to cross. The :ref:`Swim <corerulebook.skills.swim#swim>`\  DCs to cross these waters increase by 5.
...
.. _`ultimatecampaign.campaignsystems.exploration#random_map_generation`:
...
.. _`ultimatecampaign.campaignsystems.exploration#terrain`:
...
.. _`ultimatecampaign.campaignsystems.exploration#hazards`:
...
.. _`ultimatecampaign.campaignsystems.exploration#bad_weather_(any)`:

Bad Weather (Any)
==================

Bad weather can range from minor precipitation to a :ref:`serious storm <corerulebook.environment#weather>`\ . The weather can include lightning strikes and cause floods, landslides, and other natural hazards.

.. _`ultimatecampaign.campaignsystems.exploration#blight_(any)`:

Blight (Any)
=============

Whether from a lack of water, a plague, or hostile magic, the plants and wildlife in the hex are suffering. A blight affects the hex and all adjacent unexplored hexes, and lasts for 1d4+2 weeks. During a blight, :ref:`Survival <corerulebook.skills.survival#survival>`\  DCs to get along in the wild increase by 5.

.. _`ultimatecampaign.campaignsystems.exploration#deadly_gas_(desert_marsh)`:
...
In a marsh, PCs can attempt a DC 15 :ref:`Perception <corerulebook.skills.perception#perception>`\  check to notice the smell and swelling before it erupts. The eruption deals 2d6 points of bludgeoning damage in a 20-foot radius, or 4d6 points of fire damage if the area contains open flame.

In a desert, PCs can attempt a DC 15 :ref:`Perception <corerulebook.skills.perception#perception>`\  check to notice the fumes and get out of their path before coming to harm. Otherwise, they must succeed at a DC 15 Fortitude save or take 1d4 points of Constitution damage  and be nauseated for 10 minutes.

.. _`ultimatecampaign.campaignsystems.exploration#dust_devil_(desert_hill_plain)`:
...
.. _`ultimatecampaign.campaignsystems.exploration#grass_fire_(hill_plain)`:
...
.. _`ultimatecampaign.campaignsystems.exploration#volcanic_tremor_(hill_mountain)`:

Volcanic Tremor (Hill, Mountain)
=================================

Though active volcanoes are rare, even dormant volcanoes can produce tremors. Tremors last anywhere from 1d4 rounds to 2d6 minutes and increase :ref:`Climb <corerulebook.skills.climb#climb>`\  DCs by 2. The tremors might start an avalanche or collapse a cave or cliff (similar to an :ref:`earthquake <corerulebook.spells.earthquake#earthquake>`\  spell).
