...
.. _`advancedraceguide.coreraces`:

.. contents:: \ 

.. _`advancedraceguide.coreraces#core_races`:
...
.. _`advancedraceguide.coreraces#racial_traits`:
...
.. _`advancedraceguide.coreraces#alternate_racial_rules`:
...
.. _`advancedraceguide.coreraces#alternate_racial_traits`:

\ **Alternate Racial Traits**\ : This section lists alternate racial traits for each of the seven core races. Many of them play on racial themes not reflected in the standard racial traits, like the elven alternate racial trait fleet-footed, which grants the :ref:`Run <corerulebook.feats#run>`\  feat and a bonus on initiative checks instead of the normal keen senses and weapon familiarity traits, reflecting the grace and uncanny reflexes of that race. To take one of these alternate racial traits, you must exchange one or more of the existing standard racial traits available to the race. You can exchange one or several of the standard racial traits, but you cannot exchange the same racial trait more than once. For example, an elf who takes the fleet-footed racial trait cannot take the urbanite racial trait, because the latter trait also replaces keen senses. 

.. _`advancedraceguide.coreraces#racial_subtypes`:
...
.. _`advancedraceguide.coreraces#favored_class_options`:
...
.. _`advancedraceguide.coreraces#racial_archetypes`:
...
\ **Dwarves**\ : :ref:`Exarch (inquisitor) <advancedraceguide.coreraces.dwarves#exarch_(inquisitor)>`\ , :ref:`forgemaster (cleric) <advancedraceguide.coreraces.dwarves#forgemaster_(cleric)>`\ , :ref:`stonelord (paladin) <advancedraceguide.coreraces.dwarves#stonelord_(paladin)>`\ .

\ **Elves**\ : :ref:`Ancient lorekeeper (oracle) <advancedraceguide.coreraces.elves#ancient_lorekeeper_(oracle)>`\ , :ref:`spell dancer (magus) <advancedraceguide.coreraces.elves#spell_dancer_(magus)>`\ , :ref:`spellbinder (wizard) <advancedraceguide.coreraces.elves#spellbinder_(wizard)>`\ , :ref:`treesinger (druid) <advancedraceguide.coreraces.elves#treesinger_(druid)>`\ . 

\ **Gnomes**\ : :ref:`Experimental gunsmith (gunslinger) <advancedraceguide.coreraces.gnomes#experimental_gunsmith_(gunslinger)>`\ , :ref:`prankster (bard) <advancedraceguide.coreraces.gnomes#prankster_(bard)>`\ , :ref:`saboteur (alchemist) <advancedraceguide.coreraces.gnomes#saboteur_(alchemist)>`\ .

\ **Half-Elves**\ : :ref:`Bramble brewer (alchemist) <advancedraceguide.coreraces.halfelves#bramble_brewer_(alchemist)>`\ , :ref:`bonded witch (witch) <advancedraceguide.coreraces.halfelves#bonded_witch_(witch)>`\ , :ref:`wild caller (summoner) <advancedraceguide.coreraces.halfelves#wild_caller_(summoner)>`\ , :ref:`wild shadow (ranger) <advancedraceguide.coreraces.halfelves#wild_shadow_(ranger)>`\ . 

\ **Half-Orcs**\ : :ref:`Blood god disciple (summoner) <advancedraceguide.coreraces.halforcs#blood_god_disciple_(summoner)>`\ , :ref:`hateful rager (barbarian) <advancedraceguide.coreraces.halforcs#hateful_rager_(barbarian)>`\ , :ref:`redeemer (paladin) <advancedraceguide.coreraces.halforcs#redeemer_(paladin)>`\ , :ref:`skulking slayer (rogue) <advancedraceguide.coreraces.halforcs#skulking_slayer_(rogue)>`\ . 

\ **Halflings**\ : :ref:`Community guardian (oracle) <advancedraceguide.coreraces.halflings#community_guardian_(oracle>`\ , :ref:`filcher (rogue) <advancedraceguide.coreraces.halflings#filcher_(rogue)>`\ , :ref:`order of the paw (cavalier) <advancedraceguide.coreraces.halflings#order_of_the_paw_(cavalier)>`\ , :ref:`underfoot adept (monk) <advancedraceguide.coreraces.halflings#underfoot_adept_(monk)>`\ .

\ **Humans**\ : :ref:`Buccaneer (gunslinger) <advancedraceguide.coreraces.humans#buccaneer_(gunslinger)>`\ , :ref:`feral child (druid) <advancedraceguide.coreraces.humans#feral_child_(druid)>`\ , :ref:`imperious bloodline (sorcerer) <advancedraceguide.coreraces.humans#imperious_bloodline_(sorcerer)>`\ , :ref:`wanderer (monk) <advancedraceguide.coreraces.humans#wanderer_(monk)>`\ .

.. _`advancedraceguide.coreraces#new_racial_rules`:
