...
.. _`ultimateequipment.wondrousitems.chest`:

.. contents:: \ 

.. _`ultimateequipment.wondrousitems.chest#chest_slot_wondrous_items`:
...
.. list-table:: Chest Slot Wondrous Items
   :header-rows: 1
...
.. _`ultimateequipment.wondrousitems.chest#all_tools_vest`:
...
This well-made leather vest bears numerous shiny metal buttons, which stud a number of bulging  pockets. Once per day, as a standard action, the wearer can speak the vest's command word and order it to bring forth all the standard tools required to make checks for any one :ref:`Craft <corerulebook.skills.craft#craft>`\  skill. These tools appear in the countless pockets of the vest or, if too heavy, on the floor, on a nearby shelf, on a workbench, or in a toolbox or cupboard that appears nearby. Once summoned, they remain for 24 hours or until another creature touches them, whichever comes first.

.. _`ultimateequipment.wondrousitems.chest#construction_requirements`:
...
Craft Wondrous Item, :ref:`summon instrument <corerulebook.spells.summoninstrument#summon_instrument>`

.. _`ultimateequipment.wondrousitems.chest#bandages_of_rapid_recovery`:
...
Craft Wondrous Item, :ref:`cure light wounds <corerulebook.spells.curelightwounds#cure_light_wounds>`\ , :ref:`lesser restoration <corerulebook.spells.restoration#restoration_lesser>`\ , :ref:`stabilize <corerulebook.spells.stabilize#stabilize>`

.. _`ultimateequipment.wondrousitems.chest#bane_baldric`:
...
Craft Wondrous Item, :ref:`summon monster I <corerulebook.spells.summonmonster#summon_monster_i>`\ , creator must be an inquisitor

.. _`ultimateequipment.wondrousitems.chest#cackling_hags_blouse`:
...
This loose-fitting blouse is adorned with grotesque fetishes and trophies, granting the wearer a +2 competence bonus on :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks. If the wearer is a witch, she gains the cackle hex. If the wearer already has the cackle hex, twice per day she can use her cackle ability as a swift action instead of a move action.
...
Craft Wondrous Item, :ref:`hideous laughter <corerulebook.spells.hideouslaughter#hideous_laughter>`\  or the cackle hex, creator must have 5 ranks in :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`

.. _`ultimateequipment.wondrousitems.chest#deadshot_vest`:
...
In addition, once per day when the wearer reduces a creature to 0 or fewer hit points with a firearm she can use :ref:`death knell <corerulebook.spells.deathknell#death_knell>`\  (Will DC 13 negates) against that target as a swift action. She does not have to touch the target to activate this ability, but her range increment penalty for shooting the target also applies to the saving throw DC of the :ref:`death knell <corerulebook.spells.deathknell#death_knell>`\  (for example, if the range increment penalty is –2, the DC is 11).
...
Craft Wondrous Item, :ref:`death knell <corerulebook.spells.deathknell#death_knell>`\ , :ref:`true strike <corerulebook.spells.truestrike#true_strike>`

.. _`ultimateequipment.wondrousitems.chest#endless_bandolier`:
...
.. _`ultimateequipment.wondrousitems.chest#mantle_of_faith`:
...
.. _`ultimateequipment.wondrousitems.chest#mantle_of_immortality`:
...
Craft Wondrous Item, :ref:`greater age resistance <ultimatemagic.spells.ageresistance#age_resistance_greater>`

.. _`ultimateequipment.wondrousitems.chest#mantle_of_spell_resistance`:
...
Craft Wondrous Item, :ref:`spell resistance <corerulebook.magicitems.armor#armor_spell_resistance>`

.. _`ultimateequipment.wondrousitems.chest#merciful_baldric`:
...
Craft Wondrous Item, :ref:`Extra Mercy <corerulebook.feats#extra_mercy>`\ , :ref:`remove disease <corerulebook.spells.removedisease#remove_disease>`\ , :ref:`remove curse <corerulebook.spells.removecurse#remove_curse>`\ , creator must be lawful good

.. _`ultimateequipment.wondrousitems.chest#poisoners_jacket_greater`:
...
Craft Wondrous Item, :ref:`major creation <corerulebook.spells.majorcreation#major_creation>`\ , :ref:`poison <corerulebook.spells.poison#poison>`

.. _`ultimateequipment.wondrousitems.chest#poisoners_jacket_lesser`:
...
Craft Wondrous Item, :ref:`minor creation <corerulebook.spells.minorcreation#minor_creation>`\ , :ref:`poison <corerulebook.spells.poison#poison>`

.. _`ultimateequipment.wondrousitems.chest#prophets_pectoral`:
...
The sacred stones, graven star-patterns, and wisdom-writings of the ancients on this chestplate increase the wearer's chance of success with :ref:`augury <corerulebook.spells.augury#augury>`\ , :ref:`divination <corerulebook.spells.divination#divination>`\ , and :ref:`contact other plane <corerulebook.spells.contactotherplane#contact_other_plane>`\ . The wearer adds 1d6 to the d% roll each time she uses such a spell. When casting :ref:`commune <corerulebook.spells.commune#commune>`\  or :ref:`commune with nature <corerulebook.spells.communewithnature#commune_with_nature>`\ , the wearer may ask one additional question or gain one additional piece of information.
...
Craft Wondrous Item, :ref:`divination <corerulebook.spells.divination#divination>`\ , :ref:`guidance <corerulebook.spells.guidance#guidance>`

.. _`ultimateequipment.wondrousitems.chest#quick_runners_shirt`:
...
.. _`ultimateequipment.wondrousitems.chest#resplendent_uniform_coat`:
...
.. _`ultimateequipment.wondrousitems.chest#sash_of_the_war_champion`:
...
Craft Wondrous Item, :ref:`cat's grace <corerulebook.spells.catsgrace#cat_s_grace>`\ , :ref:`remove fear <corerulebook.spells.removefear#remove_fear>`

.. _`ultimateequipment.wondrousitems.chest#shirt_of_immolation`:
...
Craft Wondrous Item, :ref:`fire shield <corerulebook.spells.fireshield#fire_shield>`

.. _`ultimateequipment.wondrousitems.chest#sipping_jacket`:
...
Craft Wondrous Item, :ref:`amplify elixir <advancedplayersguide.spells.amplifyelixir#amplify_elixir>`

.. _`ultimateequipment.wondrousitems.chest#snakeskin_tunic`:
...
Craft Wondrous Item, :ref:`cat's grace <corerulebook.spells.catsgrace#cat_s_grace>`\ , :ref:`delay poison <corerulebook.spells.delaypoison#delay_poison>`

.. _`ultimateequipment.wondrousitems.chest#spectral_shroud`:
...
Craft Wondrous Item, :ref:`hide from undead <corerulebook.spells.hidefromundead#hide_from_undead>`\ , :ref:`see invisibility <corerulebook.spells.seeinvisibility#see_invisibility>`

.. _`ultimateequipment.wondrousitems.chest#tunic_of_careful_casting`:
...
Craft Wondrous Item, :ref:`Combat Casting <corerulebook.feats#combat_casting>`

.. _`ultimateequipment.wondrousitems.chest#tunic_of_deadly_might`:
...
This tunic is crafted from golden thread, and has silver-hemmed sleeves. The wearer gains a +2 bonus to Combat Maneuver Defense against disarm and sunder combat maneuvers. If the wearer is a samurai, twice per day as a swift action he can apply the effects of the :ref:`thundering <corerulebook.magicitems.weapons#thundering>`\  weapon special ability  to a successful critical hit against the target of his challenge.
...
Craft Wondrous Item, :ref:`blindness/deafness <corerulebook.spells.blindnessdeafness#blindness_deafness>`\ , :ref:`mage armor <corerulebook.spells.magearmor#mage_armor>`

.. _`ultimateequipment.wondrousitems.chest#unfettered_shirt`:
...
Once per day on command, the wearer can gain the benefits of :ref:`freedom of movement <corerulebook.spells.freedomofmovement#freedom_of_movement>`\  for 10 minutes.
...
Craft Wondrous Item, :ref:`cat's grace <corerulebook.spells.catsgrace#cat_s_grace>`\ , :ref:`freedom of movement <corerulebook.spells.freedomofmovement#freedom_of_movement>`

.. _`ultimateequipment.wondrousitems.chest#vest_of_escape`:
...
This simple silk vest looks nondescript, but is actually studded with numerous secret pockets sewn into its lining. Hidden inside these are magic lockpicks that provide a +4 competence bonus on :ref:`Disable Device <corerulebook.skills.disabledevice#disable_device>`\  checks. The vest also grants its wearer a +6 competence bonus on :ref:`Escape Artist <corerulebook.skills.escapeartist#escape_artist>`\  checks.
...
Craft Wondrous Item, :ref:`knock <corerulebook.spells.knock#knock>`\ , :ref:`grease <corerulebook.spells.grease#grease>`

.. _`ultimateequipment.wondrousitems.chest#vest_of_stable_mutation`:
...
Craft Wondrous Item, :ref:`eagle's splendor <corerulebook.spells.eaglessplendor#eagle_s_splendor>`\ , :ref:`fox's cunning <corerulebook.spells.foxscunning#fox_s_cunning>`\ , :ref:`owl's wisdom <corerulebook.spells.owlswisdom#owl_s_wisdom>`\ , creator must be an alchemist

.. _`ultimateequipment.wondrousitems.chest#vest_of_surgery`:
...
This emerald vest has four prominent and bulging pockets along its front. The wearer is always treated as if using a healer's kit when making :ref:`Heal <corerulebook.skills.heal#heal>`\  checks . Once per day, the wearer can make a DC 20 :ref:`Heal <corerulebook.skills.heal#heal>`\  check as if attempting to treat deadly wounds. If the check is successful, it cures 1d4 points of ability damage instead of hit point damage.
...
Craft Wondrous Item, :ref:`lesser restoration <corerulebook.spells.restoration#restoration_lesser>`\ , creator must have 5 ranks in :ref:`Heal <corerulebook.skills.heal#heal>`

.. _`ultimateequipment.wondrousitems.chest#vest_of_the_cockroach`:
...
Craft Wondrous Item, :ref:`false life <corerulebook.spells.falselife#false_life>`

.. _`ultimateequipment.wondrousitems.chest#vest_of_the_vengeful_tracker`:
...
Craft Wondrous Item, :ref:`commune with nature <corerulebook.spells.communewithnature#commune_with_nature>`
