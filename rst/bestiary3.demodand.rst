...
.. _`bestiary3.demodand`:

.. contents:: \ 

.. _`bestiary3.demodand#demodand`:
...
**CR 18** 
XP 153,600
CE Medium outsider (:ref:`chaotic <bestiary.creaturetypes#chaotic_subtype>`\ , :ref:`demodand <bestiary.creaturetypes#demodand_subtype>`\ , :ref:`evil <bestiary.creaturetypes#evil_subtype>`\ , :ref:`extraplanar <bestiary.creaturetypes#extraplanar_subtype>`\ )
\ **Init**\  +11; \ **Senses**\  :ref:`blindsense <bestiary.universalmonsterrules#blindsense>`\  30 ft., darkvision 60 ft., :ref:`detect good <corerulebook.spells.detectgood#detect_good>`\ , :ref:`detect magic <corerulebook.spells.detectmagic#detect_magic>`\ , :ref:`see invisibility <corerulebook.spells.seeinvisibility#see_invisibility>`\ ; :ref:`Perception <corerulebook.skills.perception#perception>`\  +36

.. _`bestiary3.demodand#defense`:
...
\ **DR**\  15/good and magic; \ **Immune**\  acid, :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\ ; \ **Resist**\  :ref:`cold <bestiary.creaturetypes#cold_subtype>`\  10, :ref:`fire <bestiary.creaturetypes#fire_subtype>`\  10; \ **SR**\  29

.. _`bestiary3.demodand#offense`:

Offense
========
\ **Speed**\  40 ft., fly 50 ft. (average)
\ **Melee**\  +2 :ref:`unholy <corerulebook.magicitems.weapons#unholy>`\  morningstar +36/+31/+26/+21 (1d8+11), bite +32 (2d6+4), claw +32 (1d6+4) or
bite +34 (2d6+9), 2 claws +34 (1d6+9)
\ **Special Attacks**\  faith-stealing strike (DC 27)
\ **Spell-Like Abilities**\  (CL 20th; concentration +25)
 Constant—:ref:`detect good <corerulebook.spells.detectgood#detect_good>`\ , :ref:`detect magic <corerulebook.spells.detectmagic#detect_magic>`\ , :ref:`see invisibility <corerulebook.spells.seeinvisibility#see_invisibility>`
 At will—:ref:`detect thoughts <corerulebook.spells.detectthoughts#detect_thoughts>`\  (DC 17), :ref:`fear <corerulebook.spells.fear#fear>`\  (DC 19), :ref:`gaseous form <corerulebook.spells.gaseousform#gaseous_form>`\ , :ref:`greater dispel magic <corerulebook.spells.dispelmagic#dispel_magic_greater>`\ , :ref:`invisibility <corerulebook.spells.invisibility#invisibility>`\  (self only), :ref:`magic circle against good <corerulebook.spells.magiccircleagainstgood#magic_circle_against_good>`
 3/day—empowered :ref:`cloudkill <corerulebook.spells.cloudkill#cloudkill>`\  (DC 20), :ref:`fog cloud <corerulebook.spells.fogcloud>`\ , quickened :ref:`ray of enfeeblement <corerulebook.spells.rayofenfeeblement#ray_of_enfeeblement>`\  (DC 16), :ref:`stinking cloud <corerulebook.spells.stinkingcloud#stinking_cloud>`\  (DC 18)
 1/day—:ref:`blasphemy <corerulebook.spells.blasphemy#blasphemy>`\  (DC 22), :ref:`chaos hammer <corerulebook.spells.chaoshammer#chaos_hammer>`\  (DC 19), :ref:`mass charm monster <corerulebook.spells.charmmonster#charm_monster_mass>`\  (DC 23), summon (level 6, 1d6 tarry demodands or 1d4 slimy demodands 60%)

.. _`bestiary3.demodand#statistics`:

Statistics
===========
\ **Str**\  29, \ **Dex**\  24, \ **Con**\  21, \ **Int**\  19, \ **Wis**\  18, \ **Cha**\  20
\ **Base Atk**\  +25; \ **CMB**\  +34; \ **CMD**\  51
\ **Feats**\  :ref:`Alertness <corerulebook.feats#alertness>`\ , Cleave, :ref:`Combat Casting <corerulebook.feats#combat_casting>`\ , :ref:`Combat Reflexes <corerulebook.feats#combat_reflexes>`\ , :ref:`Empower Spell-Like Ability <bestiary.monsterfeats#empower_spell_like_ability>`\  (:ref:`cloudkill <corerulebook.spells.cloudkill#cloudkill>`\ ), :ref:`Flyby Attack <bestiary.monsterfeats#flyby_attack>`\ , :ref:`Great Cleave <corerulebook.feats#great_cleave>`\ , :ref:`Improved Initiative <corerulebook.feats#improved_initiative>`\ , :ref:`Intimidating Prowess <corerulebook.feats#intimidating_prowess>`\ , :ref:`Lightning Reflexes <corerulebook.feats#lightning_reflexes>`\ , :ref:`Multiattack <bestiary.monsterfeats#multiattack>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`\ , :ref:`Quicken Spell-Like Ability <bestiary.monsterfeats#quicken_spell_like_ability>`\  (:ref:`ray of enfeeblement <corerulebook.spells.rayofenfeeblement#ray_of_enfeeblement>`\ )
\ **Skills**\  :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  +35 (+39 when jumping), :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  +28, :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  +28, :ref:`Fly <corerulebook.skills.fly#fly>`\  +35, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +42, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana) +23, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (planes) +15, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (religion) +15, :ref:`Perception <corerulebook.skills.perception#perception>`\  +36, :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  +36, :ref:`Spellcraft <corerulebook.skills.spellcraft#spellcraft>`\  +29, :ref:`Use Magic Device <corerulebook.skills.usemagicdevice#use_magic_device>`\  +30
\ **Languages**\  Abyssal, Celestial, Common
\ **SQ**\  heretical soul

.. _`bestiary3.demodand#ecology`:

Ecology
========
\ **Environment**\  any (Abyss)
\ **Organization**\  solitary or warband (1 shaggy :ref:`demodand <bestiary.creaturetypes#demodand_subtype>`\  plus 2–5 tarry demodands)
\ **Treasure**\  double (+2 :ref:`unholy <corerulebook.magicitems.weapons#unholy>`\  morningstar, other treasure)
...
XP 76,800
CE Medium outsider (:ref:`chaotic <bestiary.creaturetypes#chaotic_subtype>`\ , :ref:`demodand <bestiary.creaturetypes#demodand_subtype>`\ , :ref:`evil <bestiary.creaturetypes#evil_subtype>`\ , :ref:`extraplanar <bestiary.creaturetypes#extraplanar_subtype>`\ )
\ **Init**\  +4; \ **Senses**\  darkvision 120 ft., :ref:`detect good <corerulebook.spells.detectgood#detect_good>`\ , :ref:`detect magic <corerulebook.spells.detectmagic#detect_magic>`\ , :ref:`see invisibility <corerulebook.spells.seeinvisibility#see_invisibility>`\ ; :ref:`Perception <corerulebook.skills.perception#perception>`\  +2
...
\ **DR**\  10/good and magic; \ **Immune**\  acid, :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\ ; \ **Resist**\  :ref:`cold <bestiary.creaturetypes#cold_subtype>`\  10, :ref:`fire <bestiary.creaturetypes#fire_subtype>`\  10; \ **SR**\  27

Offense
========
\ **Speed**\  30 ft., fly 60 ft. (average), 20 ft., fly 40 ft. (average) in armor
\ **Melee**\  bite +30 (1d10+9 plus 2d6 acid), 2 claws +30 (2d6+13/19–20 plus 2d6 acid and :ref:`grab <bestiary.universalmonsterrules#grab>`\ )
\ **Special Attacks**\  acid, dread claws, faith-stealing strike (DC 23)
\ **Spell-Like Abilities**\  (CL 16th; concentration +19)
 Constant—:ref:`detect good <corerulebook.spells.detectgood#detect_good>`\ , :ref:`detect magic <corerulebook.spells.detectmagic#detect_magic>`\ , :ref:`see invisibility <corerulebook.spells.seeinvisibility#see_invisibility>`
 At will—:ref:`detect thoughts <corerulebook.spells.detectthoughts#detect_thoughts>`\  (DC 15), :ref:`fear <corerulebook.spells.fear#fear>`\  (DC 17)
 3/day—:ref:`acid fog <corerulebook.spells.acidfog#acid_fog>`\ , :ref:`greater dispel magic <corerulebook.spells.dispelmagic#dispel_magic_greater>`
...
\ **Feats**\  :ref:`Bleeding Critical <corerulebook.feats#bleeding_critcial>`\ , :ref:`Blind-Fight <corerulebook.feats#blind_fight>`\ , :ref:`Critical Focus <corerulebook.feats#critical_focus>`\ , :ref:`Flyby Attack <bestiary.monsterfeats#flyby_attack>`\ , Greater :ref:`Vital Strike <corerulebook.feats#vital_strike>`\ , :ref:`Improved Critical <corerulebook.feats#improved_critical>`\  (claw), :ref:`Improved Vital Strike <corerulebook.feats#improved_vital_strike>`\ , :ref:`Intimidating Prowess <corerulebook.feats#intimidating_prowess>`\ , :ref:`Lightning Reflexes <corerulebook.feats#lightning_reflexes>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`\ , :ref:`Vital Strike <corerulebook.feats#vital_strike>`
\ **Skills**\  :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  +8, :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  +27, :ref:`Climb <corerulebook.skills.climb#climb>`\  +16, :ref:`Fly <corerulebook.skills.fly#fly>`\  +25, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +36, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana) +13, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (planes) +13, :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  +26, :ref:`Spellcraft <corerulebook.skills.spellcraft#spellcraft>`\  +20, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +25, :ref:`Survival <corerulebook.skills.survival#survival>`\  +20
\ **Languages**\  Abyssal, Celestial, Common
\ **SQ**\  heretical soul
...
.. _`bestiary3.demodand#special_abilities`:

Special Abilities
==================
\ **Acid (Su)**\  A slimy :ref:`demodand <bestiary.creaturetypes#demodand_subtype>`\  is coated in an ever-dripping layer of acid that deals an extra 2d6 points of acid damage on a successful natural attack. In addition, opponents that successfully strike a slimy :ref:`demodand <bestiary.creaturetypes#demodand_subtype>`\  with an unarmed strike or natural attack take 2d6 points of acid damage.
\ **Dread Claws (Ex)**\  A slimy :ref:`demodand <bestiary.creaturetypes#demodand_subtype>`\  adds 1-1/2 times its strength bonus on all attack rolls made when using its claws.
...
XP 25,600
CE Medium outsider (:ref:`chaotic <bestiary.creaturetypes#chaotic_subtype>`\ , :ref:`demodand <bestiary.creaturetypes#demodand_subtype>`\ , :ref:`evil <bestiary.creaturetypes#evil_subtype>`\ , :ref:`extraplanar <bestiary.creaturetypes#extraplanar_subtype>`\ )
\ **Init**\  +9; \ **Senses**\  darkvision 120 ft., :ref:`detect good <corerulebook.spells.detectgood#detect_good>`\ , :ref:`detect magic <corerulebook.spells.detectmagic#detect_magic>`\ ; :ref:`Perception <corerulebook.skills.perception#perception>`\  +22
...
\ **DR**\  10/good and magic; \ **Immune**\  acid, :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\ ; \ **Resist**\  :ref:`cold <bestiary.creaturetypes#cold_subtype>`\  10, :ref:`fire <bestiary.creaturetypes#fire_subtype>`\  10; \ **SR**\  24

Offense
========
\ **Speed**\  60 ft., fly 60 ft. (average); 20 ft., fly 40 ft. (average) in armor
\ **Melee**\  mwk short sword +27/+22/+17/+12 (1d6+9/19â20), mwk short sword +27/+22/+17 (1d6+4/19â20), bite +22 (1d8+4)
...
\ **Spell-Like Abilities**\  (CL 13th; concentration +16)
 ...
 3/day—:ref:`dispel magic <corerulebook.spells.dispelmagic#dispel_magic>`
 1/day—:ref:`chaos hammer <corerulebook.spells.chaoshammer#chaos_hammer>`\  (DC 17), summon (level 4, 1d2 tarry demodands 40%)

Statistics
===========
\ **Str**\  28, \ **Dex**\  21, \ **Con**\  18, \ **Int**\  12, \ **Wis**\  13, \ **Cha**\  17
\ **Base Atk**\  +18; \ **CMB**\  +27; \ **CMD**\  42 (46 vs. disarm)
\ **Feats**\  :ref:`Combat Reflexes <corerulebook.feats#combat_reflexes>`\ , :ref:`Greater Two-Weapon Fighting <corerulebook.feats#greater_two_weapon_fighting>`\ , :ref:`Improved Bull Rush <corerulebook.feats#improved_bull_rush>`\ , :ref:`Improved Initiative <corerulebook.feats#improved_initiative>`\ , :ref:`Improved Two-Weapon Fighting <corerulebook.feats#improved_two_weapon_fighting>`\ , :ref:`Lunge <corerulebook.feats#lunge>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`\ , :ref:`Two-Weapon Fighting <corerulebook.feats#two_weapon_fighting>`\ , :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (short sword)
\ **Skills**\  :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  +16, :ref:`Climb <corerulebook.skills.climb#climb>`\  +19, :ref:`Fly <corerulebook.skills.fly#fly>`\  +23, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +24, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana) +14, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (planes) +14, :ref:`Perception <corerulebook.skills.perception#perception>`\  +22, :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  +14, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +17, :ref:`Survival <corerulebook.skills.survival#survival>`\  +14
\ **Languages**\  Abyssal, Celestial, Common
\ **SQ**\  heretical soul
...
Special Abilities
==================
\ **Adhesion (Ex)**\  A creature striking a tarry :ref:`demodand <bestiary.creaturetypes#demodand_subtype>`\  with a manufactured weapon must make a DC 23 Reflex save; failure means the weapon sticks to the :ref:`demodand <bestiary.creaturetypes#demodand_subtype>`\  and cannot be used to make attacks until freed. Freeing a stuck weapon requires a successful grapple check. This adhesion grants a +4 racial bonus to CMD against disarm attempts.
