...
.. _`corerulebook.skills.bluff`:

.. contents:: \ 

.. _`corerulebook.skills.bluff#bluff`:

Bluff
######

.. _`corerulebook.skills.bluff#(cha)`:
...
.. _`corerulebook.skills.bluff#feint`:

\ *Feint*\ : You can use Bluff to feint in combat, causing your opponent to be denied his :ref:`Dexterity <corerulebook.gettingstarted#dexterity>`\  bonus to his :ref:`AC <corerulebook.combat#armor_class>`\  against your next attack. The DC of this check is equal to 10 + your opponent's base attack bonus + your opponent's :ref:`Wisdom <corerulebook.gettingstarted#wisdom>`\  modifier. If your opponent is trained in Sense Motive, the DC is instead equal to 10 + your opponent's Sense Motive bonus, if higher. For more information on feinting in combat, see :ref:`Combat <corerulebook.combat>`\ .

.. _`corerulebook.skills.bluff#secret_messages`:
...
If you have the :ref:`Deceitful <corerulebook.feats#deceitful>`\  feat, you get a bonus on Bluff checks (see :ref:`Feats <corerulebook.feats>`\ ).
