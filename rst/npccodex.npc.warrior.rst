...
.. _`npccodex.npc.warrior`:

.. contents:: \ 

.. _`npccodex.npc.warrior#warriors`:

Warriors
#########

.. _`npccodex.npc.warrior#recruit`:
...
.. _`npccodex.npc.warrior#defense`:
...
.. _`npccodex.npc.warrior#offense`:
...
.. _`npccodex.npc.warrior#tactics`:
...
.. _`npccodex.npc.warrior#statistics`:
...
\ **Feats**\  :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (dwarven waraxe)

\ **Skills**\  :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +2, Perception +1 (+3 to notice unusual stonework)
...
.. _`npccodex.npc.warrior#brigand`:
...
\ **Feats**\  :ref:`Point-Blank Shot <corerulebook.feats#point_blank_shot>`\ , :ref:`Skill Focus <corerulebook.feats#skill_focus>`\  (:ref:`Stealth <corerulebook.skills.stealth#stealth>`\ )

\ **Skills**\  :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +4, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +6

\ **Languages**\  Common

\ **Combat Gear**\  potion of :ref:`cure light wounds <corerulebook.spells.curelightwounds#cure_light_wounds>`\ , masterwork arrows (5), tanglefoot bags (2), thunderstone (2); \ **Other Gear**\  leather armor, longbow with 20 arrows, longsword, sap, 48 gp
...
\ **Feats**\  :ref:`Alertness <corerulebook.feats#alertness>`\ , :ref:`Toughness <corerulebook.feats#toughness>`\ , :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (guisarme)

\ **Skills**\  :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +6, Perception +5, :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  +4
...
.. _`npccodex.npc.warrior#veteran_buccaneer`:
...
\ **Feats**\  :ref:`Dodge <corerulebook.feats#dodge>`\ , Mobility, :ref:`Toughness <corerulebook.feats#toughness>`

\ **Skills**\  :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  +6, :ref:`Climb <corerulebook.skills.climb#climb>`\  +6, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +6, :ref:`Profession <corerulebook.skills.profession#profession>`\  (sailor) +3, :ref:`Swim <corerulebook.skills.swim#swim>`\  +17

\ **Languages**\  Common, Orc

\ **Combat Gear**\  :ref:`elixir of swimming <corerulebook.magicitems.wondrousitems#elixir_of_swimming>`\ , potion of :ref:`bull's strength <corerulebook.spells.bullsstrength#bull_s_strength>`\ , potions of :ref:`cure light wounds <corerulebook.spells.curelightwounds#cure_light_wounds>`\  (2), potion of :ref:`jump <corerulebook.spells.jump#jump>`\ , alchemist's fire; \ **Other Gear**\  studded leather, masterwork heavy crossbow with 10 bolts, masterwork scimitar, throwing axe, 231 gp
...
.. _`npccodex.npc.warrior#tavern_champion`:
...
\ **During Combat**\  The warrior makes nonlethal unarmed strikes unless an opponent draws a weapon. She uses Improved Bull Rush to throw opponents into tables or through windows. If sorely pressed, she drinks her potion of :ref:`enlarge person <corerulebook.spells.enlargeperson#enlarge_person>`\ .
...
\ **Feats**\  :ref:`Combat Reflexes <corerulebook.feats#combat_reflexes>`\ , Improved Bull Rush, :ref:`Improved Unarmed Strike <corerulebook.feats#improved_unarmed_strike>`

\ **Skills**\  :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +9, Perception +0

\ **Languages**\  Common, Orc

\ **SQ**\  orc blood, weapon familiarity

\ **Combat Gear**\  potions of :ref:`cure light wounds <corerulebook.spells.curelightwounds#cure_light_wounds>`\  (2), potion of :ref:`enlarge person <corerulebook.spells.enlargeperson#enlarge_person>`\ ; \ **Other Gear**\  chain shirt, sap, warhammer, :ref:`amulet of natural armor <corerulebook.magicitems.wondrousitems#amulet_of_natural_armor>`\  +1, 137 gp
...
.. _`npccodex.npc.warrior#grizzled_mercenary`:
...
\ **Feats**\  Diehard, :ref:`Endurance <corerulebook.feats#endurance>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`\ , :ref:`Toughness <corerulebook.feats#toughness>`

\ **Skills**\  :ref:`Climb <corerulebook.skills.climb#climb>`\  +0, :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  +3, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +6, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (local) +0, Perception +4, :ref:`Swim <corerulebook.skills.swim#swim>`\  +0

\ **Languages**\  Common

\ **Combat Gear**\  potion of :ref:`barkskin <corerulebook.spells.barkskin#barkskin>`\ , potion of :ref:`cure moderate wounds <corerulebook.spells.curemoderatewounds#cure_moderate_wounds>`\ , alchemist's fire (2), holy water; \ **Other Gear**\  masterwork half-plate, cold iron kukri, javelins (4), longspear, masterwork halberd, masterwork heavy flail, morningstar, :ref:`cloak of resistance <corerulebook.magicitems.wondrousitems#cloak_of_resistance>`\  +1, antitoxin, sunrod, 325 gp
...
.. _`npccodex.npc.warrior#expert_bodyguard`:
...
\ **Melee**\  \ *+1 longsword*\  +10/+5 (1d8+2/19â20) or kukri +8/+3 (1d4+1/18â20)
...
\ **During Combat**\  If she sees an enemy approaching, the warrior fires her :ref:`screaming bolt <corerulebook.magicitems.weapons#screaming_bolt>`\  before entering melee. In melee, she uses Stand Still to prevent enemies from getting past her, giving her employer time to escape.
...
\ **Feats**\  :ref:`Combat Reflexes <corerulebook.feats#combat_reflexes>`\ , :ref:`Improved Initiative <corerulebook.feats#improved_initiative>`\ , :ref:`Iron Will <corerulebook.feats#iron_will>`\ , Stand Still, :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (longsword)

\ **Skills**\  :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +9, Perception +8, :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  +8

\ **Languages**\  Common

\ **Combat Gear**\  potion of :ref:`barkskin <corerulebook.spells.barkskin#barkskin>`\ , potion of :ref:`bear's endurance <corerulebook.spells.bearsendurance#bear_s_endurance>`\ , potion of :ref:`cure moderate wounds <corerulebook.spells.curemoderatewounds#cure_moderate_wounds>`\ , :ref:`screaming bolt <corerulebook.magicitems.weapons#screaming_bolt>`\ , tanglefoot bag (2); \ **Other Gear**\  masterwork banded mail, masterwork light steel shield, \ *+1 longsword*\ , kukri, masterwork light crossbow with 20 bolts, masterwork manacles, 114 gp
...
.. _`npccodex.npc.warrior#aloof_archer`:
...
\ **Ranged**\  \ *+1 composite longbow*\  +12/+7 (1d8+3/Ã3)

Tactics
========

\ **During Combat**\  The warrior uses her +1 :ref:`flaming <corerulebook.magicitems.weapons#weapons_flaming>`\  arrows on dangerous targets like spellcasters. She falls backs and keeps firing as foes approach her, avoiding melee as long as possible.
...
\ **Feats**\  :ref:`Deadly Aim <corerulebook.feats#deadly_aim>`\ , :ref:`Point-Blank Shot <corerulebook.feats#point_blank_shot>`\ , Rapid Shot, :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (composite longbow)

\ **Skills**\  Perception +10, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +5

\ **Languages**\  Common, Elven

\ **SQ**\  elven magic, weapon familiarity

\ **Combat Gear**\  :ref:`elixir of hiding <corerulebook.magicitems.wondrousitems#elixir_of_hiding>`\ , +1 :ref:`flaming <corerulebook.magicitems.weapons#weapons_flaming>`\  arrows (6), potion of :ref:`cure moderate wounds <corerulebook.spells.curemoderatewounds#cure_moderate_wounds>`\ , potion of :ref:`divine favor <corerulebook.spells.divinefavor#divine_favor>`\ ; \ **Other Gear**\  masterwork full plate, \ *+1 composite longbow*\  (+2 Str) with 40 arrows, elven curve blade, 72 gp
...
.. _`npccodex.npc.warrior#cavalry_soldier`:
...
\ **Melee**\  \ *+1 lance*\  +13/+8 (1d8+5/Ã3) or mwk heavy pick +13/+8 (1d6+3/Ã4)
...
\ **Feats**\  :ref:`Iron Will <corerulebook.feats#iron_will>`\ , Mounted Archery, :ref:`Mounted Combat <corerulebook.feats#mounted_combat>`\ , Ride-By Attack, :ref:`Skill Focus <corerulebook.feats#skill_focus>`\  (Perception), Spirited Charge

\ **Skills**\  :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  +8, Perception +8, :ref:`Ride <corerulebook.skills.ride#ride>`\  +6

\ **Languages**\  Common, Elven

\ **SQ**\  elf blood

\ **Combat Gear**\  potions of :ref:`cure moderate wounds <corerulebook.spells.curemoderatewounds#cure_moderate_wounds>`\  (2), potion of :ref:`heroism <corerulebook.spells.heroism#heroism>`\ , cold iron arrows (10), silver arrows (10); \ **Other Gear**\  masterwork full plate, masterwork heavy steel shield, \ *+1 lance*\ , masterwork composite shortbow (+3 Str) with 40 arrows, masterwork heavy pick, bit and bridle, heavy horse (combat trained), masterwork chainmail barding, military saddle, saddlebags, 259 gp
...
.. _`npccodex.npc.warrior#gladiator_champion`:
...
\ **Feats**\  Dazzling Display, :ref:`Dodge <corerulebook.feats#dodge>`\ , :ref:`Toughness <corerulebook.feats#toughness>`\ , Two-Weapon Defense, :ref:`Two-Weapon Fighting <corerulebook.feats#two_weapon_fighting>`\ , :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (short sword)

\ **Skills**\  :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  +12, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +8, Perception +4, :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  +9

\ **Languages**\  Common

\ **Combat Gear**\  potion of :ref:`cure moderate wounds <corerulebook.spells.curemoderatewounds#cure_moderate_wounds>`\ , potion of :ref:`heroism <corerulebook.spells.heroism#heroism>`\ ; \ **Other Gear**\  studded leather, \ *+1 short sword*\ , darts (10), net, masterwork light mace, trident, :ref:`belt of giant strength <corerulebook.magicitems.wondrousitems#belt_of_giant_strength>`\  +2, :ref:`ring of protection <corerulebook.magicitems.rings#ring_of_protection>`\  +1, antitoxin, 240 gp
