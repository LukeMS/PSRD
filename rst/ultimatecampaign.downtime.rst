...
.. _`ultimatecampaign.downtime`:

.. contents:: \ 

.. _`ultimatecampaign.downtime#downtime`:

Downtime
#########

:ref:`Downtime Activities <ultimatecampaign.downtime.downtimeactivities>`\  :ref:`Managers <ultimatecampaign.downtime.managers>`\  :ref:`Rooms and Teams <ultimatecampaign.downtime.roomsandteams>`\  :ref:`Buildings and Organizations <ultimatecampaign.downtime.buildingsandorganizations>`\  :ref:`Downtime Events <ultimatecampaign.downtime.downtimeevents>`
...
Even if you don't want to use the rules to earn extra gold or throw your weight around in town as a business owner, there are campaign and roleplaying benefits for using the downtime system. For example, if you build or buy a house, you have a comfortable, private place to rest between adventures. By adding a few more rooms, you can easily convert a house into a base of operations for your adventuring party; it would count as "very familiar" for the purpose of your :ref:`teleport <corerulebook.spells.teleport#teleport>`\  spells, and if it includes an altar to your deity, you can use it as the destination for a :ref:`word of recall <corerulebook.spells.wordofrecall#word_of_recall>`\ .
...
.. _`ultimatecampaign.downtime#overview`:
...
.. _`ultimatecampaign.downtime#downtime_terminology`:
...
\ **Followers**\ : Followers are a type of Labor gained from the :ref:`Leadership <corerulebook.feats#leadership>`\  feat or other methods. Followers can be used like Labor, but aren't expended like capital because they are loyal to you and don't leave as soon as an activity is completed. For more information, see Using Followers on page 80.
...
\ **Gold Pieces**\ : Gold pieces (or gp) constitute the normal money your character has, such as from looting monsters or earning a living with :ref:`Craft <corerulebook.skills.craft#craft>`\  or :ref:`Profession <corerulebook.skills.profession#profession>`\  checks. Many downtime activities require you to spend gp.
...
.. _`ultimatecampaign.downtime#gaining_capital`:
...
\ **Skilled Work**\ : If you have ranks in a useful skill, you can spend 1 day working in a settlement to earn more capital than you would doing unskilled work. Note that this method includes both legal and illegal means of earning capital—for example, a day spent using :ref:`Sleight of Hand <corerulebook.skills.sleightofhand#sleight_of_hand>`\  to earn money could be a day spent performing as a street magician or a day spent pickpocketing.
...
If you chose Goods, Influence, Labor, or Magic, consult the following table to see how much of that type of capital you earn. You must pay the Earned Cost to buy this capital, although if you can't afford to buy all of it or don't need more than a certain amount, you can choose to earn less capital than your check indicates. See the :ref:`Capital Values table <ultimatecampaign.downtime#table_capital_values>`\  for the Earned Cost of each type of capital.
...
.. list-table::
   ...
   * - Skill Check Result
     - Capital Earned \* (Goods, Influence, Labor, or Magic)
   * - 10
     - 1
   * - 20
     - 2
...
If you are using this option to earn Goods, Influence, Labor, or Magic, the skill you're using must be suitable for earning the chosen type of capital; if the GM deems it is not, using that skill reduces the amount generated by half (minimum 1). For example, :ref:`Perform <corerulebook.skills.perform#perform>`\  might earn you Influence as a musician, but it's not as useful for earning Labor. The GM should inform you of this before you attempt the skill check. In general, the appropriate skills for each type of capital are as follows.

\ *Goods*\ : :ref:`Appraise <corerulebook.skills.appraise#appraise>`\ , :ref:`Bluff <corerulebook.skills.bluff#bluff>`\ , :ref:`Craft <corerulebook.skills.craft#craft>`\ , :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\ , :ref:`Disable Device <corerulebook.skills.disabledevice#disable_device>`\ , :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\ , :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\ , :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (dungeoneering, engineering, geography, history, local, nature, nobility, religion), :ref:`Profession <corerulebook.skills.profession#profession>`\ , :ref:`Sleight of Hand <corerulebook.skills.sleightofhand#sleight_of_hand>`\ , :ref:`Stealth <corerulebook.skills.stealth#stealth>`\ .

\ *Influence*\ : :ref:`Appraise <corerulebook.skills.appraise#appraise>`\ , :ref:`Bluff <corerulebook.skills.bluff#bluff>`\ , :ref:`Craft <corerulebook.skills.craft#craft>`\ , :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\ , :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\ , :ref:`Heal <corerulebook.skills.heal#heal>`\ , :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\ , :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (any), :ref:`Linguistics <corerulebook.skills.linguistics#linguistics>`\ , :ref:`Perform <corerulebook.skills.perform#perform>`\ , :ref:`Profession <corerulebook.skills.profession#profession>`\ , :ref:`Ride <corerulebook.skills.ride#ride>`\ .

\ *Labor*\ : :ref:`Bluff <corerulebook.skills.bluff#bluff>`\ , :ref:`Climb <corerulebook.skills.climb#climb>`\ , :ref:`Craft <corerulebook.skills.craft#craft>`\ , :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\ , :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\ , :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\ , :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (local), :ref:`Profession <corerulebook.skills.profession#profession>`\ , :ref:`Ride <corerulebook.skills.ride#ride>`\ , :ref:`Survival <corerulebook.skills.survival#survival>`\ , :ref:`Swim <corerulebook.skills.swim#swim>`\ .

\ *Magic*\ : :ref:`Appraise <corerulebook.skills.appraise#appraise>`\ , :ref:`Craft <corerulebook.skills.craft#craft>`\ , :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\ , :ref:`Heal <corerulebook.skills.heal#heal>`\ , :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana, dungeoneering, nature, planes, religion), :ref:`Linguistics <corerulebook.skills.linguistics#linguistics>`\ , :ref:`Profession <corerulebook.skills.profession#profession>`\ , :ref:`Spellcraft <corerulebook.skills.spellcraft#spellcraft>`\ , :ref:`Use Magic Device <corerulebook.skills.usemagicdevice#use_magic_device>`\ .

The value of a particular skill for a given type of capital can vary from settlement to settlement. For example, in a frontier settlement with a tradition of serious hard work, a day of humorous performances using :ref:`Perform <corerulebook.skills.perform#perform>`\  (comedy) might not earn you much capital, but inspirational public speeches about the city's heroes using :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (history) or :ref:`Perform <corerulebook.skills.perform#perform>`\  (oratory) could. The GM should tell you this before you attempt the skill check, or allow you to assess the inhabitants' preferences with a successful DC 15 :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (local) or :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  check.
...
.. _`ultimatecampaign.downtime#converting_capital`:
...
.. _`ultimatecampaign.downtime#moving_capital`:
...
.. _`ultimatecampaign.downtime#spending_limits`:
...
.. _`ultimatecampaign.downtime#downtime_phases`:
...
\ **Phase 2—Activity**\ : :ref:`Perform <corerulebook.skills.perform#perform>`\  downtime activities, such as constructing a building, recruiting an organization, or retraining.
...
.. _`ultimatecampaign.downtime#upkeep_phase`:
...
Because adventuring is dangerous work, if you're away from a settlement for 30 days or more, you risk losing control of your businesses there as employees begin to wonder whether you're dead. Upon your return, you must attempt a leadership check (1d20 + your :ref:`Leadership <corerulebook.feats#leadership>`\  score) against a DC equal to the number of days since you last had contact with that businesses — 10 (so if you've been gone for 30 days, the DC is 20). Having contact with the business requires visiting it personally, sending a qualified representative on your behalf (such as a cohort or manager; see page 88), or sending a formal letter or magical communication (such as :ref:`dream <corerulebook.spells.dream#dream>`\ , :ref:`sending <corerulebook.spells.sending#sending>`\ , or :ref:`whispering wind <corerulebook.spells.whisperingwind#whispering_wind>`\ ); doing so resets your number of days away to 0.
...
.. _`ultimatecampaign.downtime#activity_phase`:
...
\ *Example*\ : Patrick's character has been crafting a wand of :ref:`fireball <corerulebook.spells.fireball#fireball>`\ , but had to interrupt the process just short of completion to have a short adventure that didn't give him any time to work on the item. When he returns to town and begins a downtime session, he sells some loot in Step 1 (which doesn't use any downtime days), then proceeds to Step 2. In Step 2, he decides to spend downtime finishing the work on the wand, which takes him 1 day of downtime. The next day, he has no ongoing downtime activities, so he proceeds to Step 3 and starts spending Influence to recruit an Apprentice wizard.

.. _`ultimatecampaign.downtime#income_phase`:
...
.. _`ultimatecampaign.downtime#event_phase`:
...
.. _`ultimatecampaign.downtime#downtime_and_kingdom_building`:
