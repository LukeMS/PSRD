...
.. _`corerulebook.skills.sleightofhand`:

.. contents:: \ 

.. _`corerulebook.skills.sleightofhand#sleight_of_hand`:

Sleight of Hand
################

.. _`corerulebook.skills.sleightofhand#(dex;_armor_check_penalty;_trained_only)`:
...
\ **Untrained**\ : An untrained Sleight of Hand check is simply a :ref:`Dexterity <corerulebook.gettingstarted#dexterity>`\  check. Without actual training, you can't succeed on any Sleight of Hand check with a DC higher than 10, except for hiding an object on your body.

\ **Special**\ : If you have the :ref:`Deft Hands <corerulebook.feats#deft_hands>`\  feat, you get a bonus on Sleight of Hand checks (see :ref:`Feats <corerulebook.feats>`\ ).
