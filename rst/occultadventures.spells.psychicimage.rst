...
.. _`occultadventures.spells.psychicimage`:

.. contents:: \ 

.. _`occultadventures.spells.psychicimage#psychic_image`:
...
Objects are affected by the \ *psychic image*\  as if they had succeeded at their Will saves. You need not maintain line of effect to your \ *psychic image*\ , but if you cross into another plane even for an instant, such as via :ref:`blink <corerulebook.spells.blink>`\ , :ref:`dimension door <corerulebook.spells.dimensiondoor#dimension_door>`\ , or similar spells, the spell ends.
