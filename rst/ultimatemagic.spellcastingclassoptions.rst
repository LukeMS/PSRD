...
.. _`ultimatemagic.spellcastingclassoptions`:

.. contents:: \ 

.. _`ultimatemagic.spellcastingclassoptions#spellcasting_class_options`:
...
.. _`ultimatemagic.spellcastingclassoptions#alternate_class_features`:
...
.. _`ultimatemagic.spellcastingclassoptions#adapting_existing_characters`:
...
.. _`ultimatemagic.spellcastingclassoptions#class_archetypes`: `ultimatemagic.spellcastingclassoptions#spellcaster_class_archetypes`_

.. _`ultimatemagic.spellcastingclassoptions#spellcaster_class_archetypes`:
...
:ref:`Alchemist <ultimatemagic.spellcastingclassoptions.alchemist>`\ : This section includes the chirurgeon, clone master, internal alchemist, mindchemist, preservationist, psychonaut, reanimator, and vivisectionist archetypes.

.. _`ultimatemagic.spellcastingclassoptions#bard`:

:ref:`Bard <ultimatemagic.spellcastingclassoptions.bard>`\ : This section introduces masterpieces—unusual bardic performances with special requirements—and includes the animal speaker, celebrity, demagogue, dirge bard, geisha, songhealer, and sound striker archetypes.

.. _`ultimatemagic.spellcastingclassoptions#cleric`:

:ref:`Cleric <ultimatemagic.spellcastingclassoptions.cleric>`\ : This section introduces variant abilities for channeled energy, as well as the cloistered cleric, separatist, theologian, and undead lord cleric archetypes.

.. _`ultimatemagic.spellcastingclassoptions#druid`:

:ref:`Druid <ultimatemagic.spellcastingclassoptions.druid>`\ : This section introduces new animal and terrain domains, and rules and base statistics for vermin companions. It also includes the dragon shaman, menhir savant, mooncaller, pack lord, reincarnated druid, saurian shaman, shark shaman, and storm druid archetypes.

.. _`ultimatemagic.spellcastingclassoptions#inquisitor`:

:ref:`Inquisitor <ultimatemagic.spellcastingclassoptions.inquisitor>`\ : This section introduces domainlike inquisitions, and includes the exorcist, heretic, infiltrator, preacher, and sin eater archetypes.

.. _`ultimatemagic.spellcastingclassoptions#magus`:

:ref:`Magus <ultimatemagic.spellcastingclassoptions.magus>`\ : This section includes the bladebound, hexcrafter, spellblade, and staff magus archetypes.

.. _`ultimatemagic.spellcastingclassoptions#monk`:

:ref:`Monk <ultimatemagic.spellcastingclassoptions.monk>`\ : This section features monk vows and the high-fantasy qinggong monk archetype.

.. _`ultimatemagic.spellcastingclassoptions#oracle`:

:ref:`Oracle <ultimatemagic.spellcastingclassoptions.oracle>`\ : In addition to new mysteries, this section also includes the dual-cursed oracle, enlightened philosopher, planar oracle, possessed oracle, seer, and stargazer archetypes.

.. _`ultimatemagic.spellcastingclassoptions#paladin`:

:ref:`Paladin <ultimatemagic.spellcastingclassoptions.paladin>`\ : This section presents the oathbound paladin archetype, along with many oaths that customize the archetype's abilities.

.. _`ultimatemagic.spellcastingclassoptions#ranger`:

:ref:`Ranger <ultimatemagic.spellcastingclassoptions.ranger>`\ : This section presents a category of simple magical traps that characters can easily build, as well as the trapper archetype.

.. _`ultimatemagic.spellcastingclassoptions#sorcerer`:

:ref:`Sorcerer <ultimatemagic.spellcastingclassoptions.sorcerer>`\ : In addition to new bloodlines, this section also includes the crossblooded and wildblooded archetypes.

.. _`ultimatemagic.spellcastingclassoptions#summoner`:

:ref:`Summoner <ultimatemagic.spellcastingclassoptions.summoner>`\ : This section presents the aquatic eidolon base form, eidolon models to quickly build thematic creatures, and new evolutions. It also includes the broodmaster, evolutionist, master summoner, and synthesist archetypes.

.. _`ultimatemagic.spellcastingclassoptions#witch`:

:ref:`Witch <ultimatemagic.spellcastingclassoptions.witch>`\ : This section presents new hexes and new patron themes, as well as the beast-bonded, gravewalker, hedge witch, and sea witch archetypes.

.. _`ultimatemagic.spellcastingclassoptions#wizard`:

:ref:`Wizard <ultimatemagic.spellcastingclassoptions.wizard>`\ : This section introduces arcane discoveries—special magical abilities wizards can discover—as well as the metal elementalist and wood elementalist wizard schools and the scrollmaster wizard archetype.
