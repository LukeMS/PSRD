...
.. _`corerulebook.skills.knowledge`:

.. contents:: \ 

.. _`corerulebook.skills.knowledge#knowledge`:

Knowledge
##########

.. _`corerulebook.skills.knowledge#(int;_trained_only)`:
...
.. _`corerulebook.skills.knowledge#table_4_6_knowledge_skill_dcs`:

.. list-table:: Table: Knowledge Skill DCs
   :header-rows: 1
