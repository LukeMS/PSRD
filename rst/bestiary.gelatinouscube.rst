...
.. _`bestiary.gelatinouscube`:

.. contents:: \ 

.. _`bestiary.gelatinouscube#gelatinous_cube`:
...
.. _`bestiary.gelatinouscube#defense`:
...
\ **Immune**\  electricity, :ref:`ooze traits <bestiary.creaturetypes#ooze>`

.. _`bestiary.gelatinouscube#offense`:
...
.. _`bestiary.gelatinouscube#statistics`:
...
.. _`bestiary.gelatinouscube#ecology`:
...
.. _`bestiary.gelatinouscube#special_abilities`:
...
\ **Transparent (Ex)**\  Due to its lack of coloration, a gelatinous cube is difficult to discern. A DC 15 :ref:`Perception <corerulebook.skills.perception#perception>`\  check is required to notice a motionless gelatinous cube. Any creature that fails to notice a gelatinous cube and walks into it is automatically engulfed.
