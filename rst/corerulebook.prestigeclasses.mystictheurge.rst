...
.. _`corerulebook.prestigeclasses.mystictheurge`:

.. contents:: \ 

.. _`corerulebook.prestigeclasses.mystictheurge#mystic_theurge`:
...
.. _`corerulebook.prestigeclasses.mystictheurge#requirements`:
...
\ **Skills**\ : :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana) 3 ranks, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (religion) 3 ranks.

\ **Spells**\ : Able to cast 2nd-level divine spells and 2nd-level arcane spells.

.. _`corerulebook.prestigeclasses.mystictheurge#class_skills`:

Class Skills
*************

The mystic theurge's class skills (and the key ability for each skill) are :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana) (:ref:`Int <corerulebook.gettingstarted#intelligence>`\ ), :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (religion) (:ref:`Int <corerulebook.gettingstarted#intelligence>`\ ), :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  (:ref:`Wis <corerulebook.gettingstarted#wisdom>`\ ), and :ref:`Spellcraft <corerulebook.skills.spellcraft#spellcraft>`\  (:ref:`Int <corerulebook.gettingstarted#intelligence>`\ ). 

\ **Skill Ranks at Each Level**\ : 2 + :ref:`Int <corerulebook.gettingstarted#intelligence>`\  modifier.

.. _`corerulebook.prestigeclasses.mystictheurge#table_11_8_mystic_theurge`:

.. list-table:: Table: Mystic Theurge
   :header-rows: 1
   ...
   * - 1st
     ...
     - +0
     - +1
     - :ref:`Combined spells <corerulebook.prestigeclasses.mystictheurge#combined_spells>`\  (1st)
   ...
   * - 3rd
     ...
     - +1
     - +2
     - :ref:`Combined spells <corerulebook.prestigeclasses.mystictheurge#combined_spells>`\  (2nd)
     - +1 level of existing arcane spellcasting class/ +1 level of existing divine spellcasting class
   * - 4th
     - +2
     - +1
   ...
   * - 5th
     ...
     - +2
     - +3
     - :ref:`Combined spells <corerulebook.prestigeclasses.mystictheurge#combined_spells>`\  (3rd)
     - +1 level of existing arcane spellcasting class/ +1 level of existing divine spellcasting class
   * - 6th
     - +3
     - +2
   ...
   * - 7th
     ...
     - +2
     - +4
     - :ref:`Combined spells <corerulebook.prestigeclasses.mystictheurge#combined_spells>`\  (4th)
     - +1 level of existing arcane spellcasting class/ +1 level of existing divine spellcasting class
   * - 8th
     - +4
     - +3
   ...
   * - 9th
     ...
     - +3
     - +5
     - :ref:`Combined spells <corerulebook.prestigeclasses.mystictheurge#combined_spells>`\  (5th)
     - +1 level of existing arcane spellcasting class/ +1 level of existing divine spellcasting class
   * - 10th
     - +5
     - +3
     - +3
     - +5
     - :ref:`Spell synthesis <corerulebook.prestigeclasses.mystictheurge#spell_synthesis>`
     - +1 level of existing arcane spellcasting class/ +1 level of existing divine spellcasting class

.. _`corerulebook.prestigeclasses.mystictheurge#class_features`:
...
.. _`corerulebook.prestigeclasses.mystictheurge#combined_spells`:
...
Spontaneous spellcasters can only select spells that they have prepared that day using non-spontaneous classes for this ability, even if the spells have already been cast. For example, a cleric/sorcerer/mystic theurge can use this ability to spontaneously cast a :ref:`bless <corerulebook.spells.bless#bless>`\  spell using a 2nd-level sorcerer spell slot, if the character had a prepared :ref:`bless <corerulebook.spells.bless#bless>`\  spell using a 1st-level cleric spell slot, even if that spell had already been cast that day.

.. _`corerulebook.prestigeclasses.mystictheurge#spell_synthesis`:
