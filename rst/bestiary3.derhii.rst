...
\ **Init**\  +3; \ **Senses**\  darkvision 60 ft., :ref:`scent <bestiary.universalmonsterrules#scent>`\ ; :ref:`Perception <corerulebook.skills.perception#perception>`\  +14

.. _`bestiary3.derhii#defense`:
...
\ **Melee**\  mwk falchion +12/+7 (2d6+7/18–20) or2 slams +11 (1d6+5)
...
\ **Feats**\  :ref:`Acrobatic <corerulebook.feats#acrobatic>`\ , :ref:`Combat Reflexes <corerulebook.feats#combat_reflexes>`\ , :ref:`Iron Will <corerulebook.feats#iron_will>`\ , :ref:`Skill Focus <corerulebook.feats#skill_focus>`\  (:ref:`Perception <corerulebook.skills.perception#perception>`\ )

\ **Skills**\  :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  +12, :ref:`Climb <corerulebook.skills.climb#climb>`\  +13, :ref:`Fly <corerulebook.skills.fly#fly>`\  +9, :ref:`Perception <corerulebook.skills.perception#perception>`\  +14

\ **Languages**\  Auran, Common

\ **SQ**\  booming voice

.. _`bestiary3.derhii#ecology`:
...
.. _`bestiary3.derhii#special_abilities`:
...
\ **Booming Voice (Ex)**\  A derhii can use its own booming voice as a signal. The sound can be heard up to 12 miles away as a thrumming in the :ref:`air <bestiary.creaturetypes#air_subtype>`\  that conveys 20 words of information in 5 minutes.
