...
.. _`ultimateequipment.gear.foodanddrink`:

.. contents:: \ 

.. _`ultimateequipment.gear.foodanddrink#food_and_drink`:
...
.. _`ultimateequipment.gear.foodanddrink#food_and_drink_table`:

.. list-table:: Food and Drink
   :header-rows: 1
...
.. _`ultimateequipment.gear.foodanddrink#absinthe`:
...
.. _`ultimateequipment.gear.foodanddrink#ale`:
...
.. _`ultimateequipment.gear.foodanddrink#applejack`:
...
.. _`ultimateequipment.gear.foodanddrink#baijiu`:
...
.. _`ultimateequipment.gear.foodanddrink#banquet`:
...
.. _`ultimateequipment.gear.foodanddrink#bread`:
...
.. _`ultimateequipment.gear.foodanddrink#bufo`:
...
.. _`ultimateequipment.gear.foodanddrink#cauim`:
...
.. _`ultimateequipment.gear.foodanddrink#caviar`:
...
.. _`ultimateequipment.gear.foodanddrink#cheese`:
...
.. _`ultimateequipment.gear.foodanddrink#chocolate`:
...
.. _`ultimateequipment.gear.foodanddrink#coffee`:
...
.. _`ultimateequipment.gear.foodanddrink#dwarven_stout`:
...
.. _`ultimateequipment.gear.foodanddrink#dwarven_trail_rations`:
...
.. _`ultimateequipment.gear.foodanddrink#elven_trail_rations`:
...
Elves favor soft trail bread made of oats mixed with other grains, berries, and nuts and sweetened with honey. They supplement this trail bread with dried fruits and nuts. If you are an elf who subsists on nothing but these rations for at least 1 week, you receive a +2 bonus on checks and saves that benefit from the :ref:`Endurance <corerulebook.feats#endurance>`\  feat. This benefit lasts until you eat a meal other than the rations or go for a full day without eating a day's worth.

.. _`ultimateequipment.gear.foodanddrink#fortune_cookie`:
...
.. _`ultimateequipment.gear.foodanddrink#gnome_trail_rations`:
...
Almost any preserved food can be found in gnome trail rations, which are designed to keep a wandering gnome from needing to dine on the same meal twice in a week. If you are a gnome who subsists on nothing but these rations for at least 1 week, you are treated as being 1 Hit Die higher for the purposes of spells and supernatural abilities that have variable effects based on Hit Dice, such as :ref:`color spray <corerulebook.spells.colorspray#color_spray>`\  and :ref:`sleep <corerulebook.spells.sleep#sleep>`\ . This does not actually improve your caster level, character level, or Hit Dice in any other way. This benefit lasts until you eat a meal other than the rations or go for a full day without eating a day's worth.

.. _`ultimateequipment.gear.foodanddrink#grog`:
...
.. _`ultimateequipment.gear.foodanddrink#haggis`:
...
.. _`ultimateequipment.gear.foodanddrink#halfling_trail_rations`:
...
.. _`ultimateequipment.gear.foodanddrink#honey`:
...
.. _`ultimateequipment.gear.foodanddrink#ice_cream`:
...
.. _`ultimateequipment.gear.foodanddrink#jungle_coffee`:
...
.. _`ultimateequipment.gear.foodanddrink#kahve`:
...
.. _`ultimateequipment.gear.foodanddrink#kumis`:
...
.. _`ultimateequipment.gear.foodanddrink#maple_syrup`:
...
.. _`ultimateequipment.gear.foodanddrink#mead`:
...
.. _`ultimateequipment.gear.foodanddrink#meals`:
...
.. _`ultimateequipment.gear.foodanddrink#meat`:
...
.. _`ultimateequipment.gear.foodanddrink#milk`:
...
.. _`ultimateequipment.gear.foodanddrink#oldlaw_whiskey`:
...
.. _`ultimateequipment.gear.foodanddrink#orc_trail_rations`:
...
.. _`ultimateequipment.gear.foodanddrink#pulque`:
...
.. _`ultimateequipment.gear.foodanddrink#rumboozle`:
...
.. _`ultimateequipment.gear.foodanddrink#sealord_wine`:
...
.. _`ultimateequipment.gear.foodanddrink#street_meat`:
...
.. _`ultimateequipment.gear.foodanddrink#tea`:
...
.. _`ultimateequipment.gear.foodanddrink#tea_ceremony_set`:
...
.. _`ultimateequipment.gear.foodanddrink#trail_rations`:
...
.. _`ultimateequipment.gear.foodanddrink#travel_cake_mix`:
...
.. _`ultimateequipment.gear.foodanddrink#wandermeal`:
...
.. _`ultimateequipment.gear.foodanddrink#whiskey`:
...
.. _`ultimateequipment.gear.foodanddrink#wine`:
...
.. _`ultimateequipment.gear.foodanddrink#yogurt`:
