...
.. _`advancedplayersguide.advancedraces#racial_favored_classes`:
...
.. _`advancedplayersguide.advancedraces#dwarves`:
...
.. _`advancedplayersguide.advancedraces#dwarf_adventurers`:
...
.. _`advancedplayersguide.advancedraces#alternate_racial_traits`:
...
.. _`advancedplayersguide.advancedraces#ancient_enmity`:
...
.. _`advancedplayersguide.advancedraces#craftsman`:

\ **Craftsman**\ : Dwarves are known for their superior craftsmanship when it comes to metal and stone works. Dwarves with this racial trait receive a +2 racial bonus on all :ref:`Craft <corerulebook.skills.craft#craft>`\  or :ref:`Profession <corerulebook.skills.profession#profession>`\  checks that create objects from metal or stone. This racial trait replaces the greed racial trait.

.. _`advancedplayersguide.advancedraces#deep_warrior`:
...
.. _`advancedplayersguide.advancedraces#lorekeeper`:

\ **Lorekeeper**\ : Dwarves keep extensive records about their history and the world around them. Dwarves with this racial trait receive a +2 racial bonus on :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (history) skill checks that pertain to dwarves or their enemies. They can make such skill checks untrained. This racial trait replaces the greed racial trait.

.. _`advancedplayersguide.advancedraces#magic_resistant`:
...
.. _`advancedplayersguide.advancedraces#relentless`:
...
.. _`advancedplayersguide.advancedraces#stonesinger`:
...
.. _`advancedplayersguide.advancedraces#stubborn`:
...
.. _`advancedplayersguide.advancedraces#favored_class_options`:
...
\ **Oracle**\ : Reduce the non-proficient penalty for one weapon by 1. When the non-proficient penalty for a weapon becomes 0 because of this ability, the oracle is treated as having the appropriate Martial or :ref:`Exotic Weapon Proficiency <corerulebook.feats#exotic_weapon_proficiency>`\  feat with that weapon.
...
.. _`advancedplayersguide.advancedraces#elves`:
...
.. _`advancedplayersguide.advancedraces#elf_adventurers`:
...
.. _`advancedplayersguide.advancedraces#desert_runner`:
...
.. _`advancedplayersguide.advancedraces#dreamspeaker`:

\ **Dreamspeaker**\ : A few elves have the ability to tap into the power of sleep, dreams, and prescient reverie. Elves with this racial trait add +1 to saving throw DCs for spells of the divination school and sleep effects they cast. In addition, elves with a Charisma of 15 or higher may use :ref:`dream <corerulebook.spells.dream#dream>`\  once per day as a spell-like ability (caster level is equal to the elf's character level). This racial trait replaces the elven immunities racial trait. 

.. _`advancedplayersguide.advancedraces#eternal_grudge`:
...
.. _`advancedplayersguide.advancedraces#spirit_of_the_waters`:
...
\ **Ranger**\ : Choose a weapon from the following list: longbow, longsword, rapier, shortbow, short sword, or any weapon with "elven" in its name. Add a +1/2 circumstance bonus on critical hit confirmation rolls with that weapon (maximum bonus of +4). This bonus does not stack with :ref:`Critical Focus <corerulebook.feats#critical_focus>`\ .
\ **Sorcerer**\ : Select one bloodline power at 1st level that is normally usable a number of times per day equal to 3 + the sorcerer's Charisma modifier. The sorcerer adds +1/2 to the number of uses per day of that bloodline power.
\ **Wizard**\ : Select one arcane school power at 1st level that is normally usable a number of times per day equal to 3 + the wizard's Intelligence modifier. The wizard adds +1/2 to the number of uses per day of that arcane school power.

.. _`advancedplayersguide.advancedraces#gnomes`:
...
.. _`advancedplayersguide.advancedraces#gnome_adventurers`:
...
.. _`advancedplayersguide.advancedraces#academician`:

\ **Academician**\ : Some gnomes are more academically inclined than their kin. Gnomes with this racial trait gain a +2 bonus on any one :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  skill. This racial trait replaces the obsessive racial trait.

.. _`advancedplayersguide.advancedraces#eternal_hope`:
...
.. _`advancedplayersguide.advancedraces#gift_of_tongues`:

\ **Gift of Tongues**\ : Gnomes love languages and learning about those they meet. Gnomes with this racial trait gain a +1 bonus on :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  and :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  checks, and they learn one additional language every time they put a rank in the :ref:`Linguistics <corerulebook.skills.linguistics#linguistics>`\  skill. This racial trait replaces the defensive training and hatred racial traits.

.. _`advancedplayersguide.advancedraces#magical_linguist`:
...
.. _`advancedplayersguide.advancedraces#master_tinker`:

\ **Master Tinker**\ : Gnomes experiment with all manner of mechanical devices. Gnomes with this racial trait gain a +1 bonus on :ref:`Disable Device <corerulebook.skills.disabledevice#disable_device>`\  and :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (engineering) checks. They are treated as proficient with any weapon they have personally crafted. This racial trait replaces the defensive training and hatred racial traits.

.. _`advancedplayersguide.advancedraces#pyromaniac`:
...
.. _`advancedplayersguide.advancedraces#warden_of_nature`:
...
\ **Rogue**\ : Gnome rogues gain a +1 bonus on :ref:`Disable Device <corerulebook.skills.disabledevice#disable_device>`\  and :ref:`Use Magic Device <corerulebook.skills.usemagicdevice#use_magic_device>`\  checks related to glyphs, symbols, scrolls, and other magical writings each time they gain a level of rogue.
...
.. _`advancedplayersguide.advancedraces#half_elves`:
...
.. _`advancedplayersguide.advancedraces#half_elf_adventurers`:
...
.. _`advancedplayersguide.advancedraces#ancestral_arms`:

\ **Ancestral Arms**\ : Some half-elves receive training in an unusual weapon. Half-elves with this racial trait receive :ref:`Exotic Weapon Proficiency <corerulebook.feats#exotic_weapon_proficiency>`\  or :ref:`Martial Weapon Proficiency <corerulebook.feats#martial_weapon_proficiency>`\  with one weapon as a bonus feat at 1st level. This racial trait replaces the adaptability racial trait.

.. _`advancedplayersguide.advancedraces#arcane_training`:
...
.. _`advancedplayersguide.advancedraces#dual_minded`:
...
.. _`advancedplayersguide.advancedraces#integrated`:

\ **Integrated**\ : Many half-elves are skilled in the art of ingratiating themselves into a community as if they were natives. Half-elves with this racial trait gain a +1 bonus on :ref:`Bluff <corerulebook.skills.bluff#bluff>`\ , :ref:`Disguise <corerulebook.skills.disguise#disguise>`\ , and :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (local) checks. This racial trait replaces the adaptability racial trait.

.. _`advancedplayersguide.advancedraces#sociable`:

\ **Sociable**\ : Half-elves are skilled at charming others and recovering from faux pas. If half-elves with this racial trait attempt to change a creature's attitude with a :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  check and fail by 5 or more, they can try to influence the creature a second time even if 24 hours have not passed. This racial trait replaces the adaptability racial trait.

.. _`advancedplayersguide.advancedraces#water_child`:

\ **Water Child**\ : Some half-elves are born of elves adapted to life on or near the water. These half-elves gain a +4 racial bonus on :ref:`Swim <corerulebook.skills.swim#swim>`\  checks, can always take 10 while swimming, and may choose Aquan as a bonus language. This racial trait replaces the half-elf's adaptability and multitalented racial traits.
...
\ **Rogue**\ : Add a +1/2 bonus on :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  checks to feint and :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  checks to gather information.
\ **Summoner**\ : Add +1/4 to the eidolon's evolution pool.
\ **Witch**\ : Add one spell from the witch spell list to the witch's familiar. This spell must be at least one level below the highest spell level she can cast. If the witch ever replaces her familiar, the new familiar knows these bonus spells.

.. _`advancedplayersguide.advancedraces#half_orcs`:
...
.. _`advancedplayersguide.advancedraces#half_orc_adventurers`:
...
.. _`advancedplayersguide.advancedraces#beastmaster`:

\ **Beastmaster**\ : Some half-orcs have a spiritual kinship with fantastical beasts, capturing them for sport or living and hunting with them. A half-orc with this trait treats whip and net as martial weapons and gains a +2 bonus on :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  checks. This racial trait replaces the orc ferocity racial trait.

.. _`advancedplayersguide.advancedraces#bestial`:

\ **Bestial**\ : The orc blood of some half-orcs manifests in the form of particularly prominent orc features, exacerbating their bestial appearances but improving their already keen senses. They gain a +2 racial bonus on :ref:`Perception <corerulebook.skills.perception#perception>`\  checks. This racial trait replaces the orc ferocity racial trait.

.. _`advancedplayersguide.advancedraces#cavewight`:

\ **Cavewight**\ : Some half-orcs live far from the surface, seeking solace in winding cave complexes. Half-orcs with this racial trait gain a +1 bonus on :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (dungeoneering) and :ref:`Survival <corerulebook.skills.survival#survival>`\  checks made underground. This racial trait replaces the intimidating racial trait.

.. _`advancedplayersguide.advancedraces#chain_fighter`:
...
.. _`advancedplayersguide.advancedraces#gatecrasher`:
...
.. _`advancedplayersguide.advancedraces#plagueborn`:
...
.. _`advancedplayersguide.advancedraces#rock_climber`:

\ **Rock Climber**\ : Half-orcs from mountainous regions are excellent climbers, and sometimes ambush prey by leaping down from above. Half-orcs with this racial trait gain a +1 bonus on :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  and :ref:`Climb <corerulebook.skills.climb#climb>`\  checks. This racial trait replaces the intimidating trait.

.. _`advancedplayersguide.advancedraces#sacred_tattoo`:
...
.. _`advancedplayersguide.advancedraces#scavenger`:

\ **Scavenger**\ : Some half-orcs eke out a leaving picking over the garbage heaps of society, and must learn to separate rare finds from the inevitable dross. Half-orcs with this racial trait receive a +2 racial bonus on :ref:`Appraise <corerulebook.skills.appraise#appraise>`\  checks and on :ref:`Perception <corerulebook.skills.perception#perception>`\  checks to find hidden objects (including traps and secret doors), determine if food is spoiled, or identify a potion by taste. This racial trait replaces the intimidating racial trait.

.. _`advancedplayersguide.advancedraces#toothy`:
...
\ **Inquisitor**\ : Add +1/2 on :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks and :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  checks to identify creatures.
...
.. _`advancedplayersguide.advancedraces#halflings`:
...
.. _`advancedplayersguide.advancedraces#halfling_adventurers`:
...
.. _`advancedplayersguide.advancedraces#craven`:
...
.. _`advancedplayersguide.advancedraces#low_blow`:
...
.. _`advancedplayersguide.advancedraces#outrider`:

\ **Outrider**\ : Some halflings specialize in mounted combat. Halflings with this racial trait gain a +2 bonus on :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  and :ref:`Ride <corerulebook.skills.ride#ride>`\  checks. This racial trait replaces the sure-footed racial trait.

.. _`advancedplayersguide.advancedraces#practicality`:

\ **Practicality**\ : Halflings are grounded in hard work and common sense. Halflings with this racial trait gain a +2 bonus on any one :ref:`Craft <corerulebook.skills.craft#craft>`\  or :ref:`Profession <corerulebook.skills.profession#profession>`\  skill, as well as on :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  checks and saves against illusions. This racial trait replaces the fearless and sure-footed racial traits.

.. _`advancedplayersguide.advancedraces#swift_as_shadows`:

\ **Swift as Shadows**\ : Halflings possess incredible stealth even while moving through obstructed areas. Halflings with this racial trait reduce the penalty for using :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  while moving by 5, and reduce the :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  check penalty for sniping by 10. This racial trait replaces the sure-footed racial trait.

.. _`advancedplayersguide.advancedraces#underfoot`:
...
.. _`advancedplayersguide.advancedraces#wanderlust`:
...
.. _`advancedplayersguide.advancedraces#warslinger`:
...
\ **Rogue**\ : Choose a weapon from the following list: sling, dagger, or any weapon with "halfling" in its name. Add a +1/2 circumstance bonus on critical hit confirmation rolls with that weapon (maximum bonus of +4). This bonus does not stack with :ref:`Critical Focus <corerulebook.feats#critical_focus>`\ .
\ **Summoner**\ : Add +1 skill rank to the summoner's eidolon.

.. _`advancedplayersguide.advancedraces#humans`:
...
.. _`advancedplayersguide.advancedraces#human_adventurers`:
...
.. _`advancedplayersguide.advancedraces#eye_for_talent`:

\ **Eye for Talent**\ : Humans have great intuition for hidden potential. They gain a +2 bonus on :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  checks. In addition, when they acquire an animal companion, bonded mount, cohort, or familiar, that creature gains a +2 bonus to one ability score of the character's choice. This racial trait replaces the bonus feat racial trait.

.. _`advancedplayersguide.advancedraces#heart_of_the_fields`:

\ **Heart of the Fields**\ : Humans born in rural areas are used to hard labor. They gain a bonus equal to half their character level to any one :ref:`Craft <corerulebook.skills.craft#craft>`\  or :ref:`Profession <corerulebook.skills.profession#profession>`\  skill, and once per day they may ignore an effect that would cause them to become fatigued or exhausted. This racial trait replaces the skilled racial trait. 

.. _`advancedplayersguide.advancedraces#heart_of_the_streets`:
...
.. _`advancedplayersguide.advancedraces#heart_of_the_wilderness`:

\ **Heart of the Wilderness**\ : Humans raised in the wild learn the hard way that only the strong survive. They gain a bonus equal to half their character level on :ref:`Survival <corerulebook.skills.survival#survival>`\  checks. They also gain a +5 bonus on Constitution checks to stabilize when dying and add half their character level to their Constitution score when determining the negative hit point total necessary to kill them. This racial trait replaces the skilled racial trait.
