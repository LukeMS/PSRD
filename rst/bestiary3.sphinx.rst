...
These elder sphinxes may be androsphinxes or gynosphinxes, or very rarely criosphinxes. They have at minimum the advanced template, many additional Hit Dice, and a size of at least Huge (and more often Gargantuan or Colossal). They can use :ref:`commune <corerulebook.spells.commune#commune>`\ , :ref:`contact other plane <corerulebook.spells.contactotherplane#contact_other_plane>`\ , and :ref:`legend lore <corerulebook.spells.legendlore#legend_lore>`\  as spell-like abilities once each per day (CL equals the sphinx's CR), and frequently possess other powers and special attacks. Many such sphinxes can enter a state of stony suspended animation that resembles the freeze special ability, though they cannot easily rouse themselves from such slumber. Other sphinxes, even the bestial hieracosphinxes, defer to elder sphinxes in all matters, treating them almost as gods.

.. _`bestiary3.sphinx#sphinx_androsphinx`:

Sphinx, Androsphinx
********************
This regal, bird-winged lion has a human's head, clad in the golden raiment of a powerful pharaoh.

.. _`bestiary3.sphinx#androsphinx`:
...
\ **Init**\  +0; \ **Senses**\  darkvision 60 ft., low-light vision; :ref:`Perception <corerulebook.skills.perception#perception>`\  +23

.. _`bestiary3.sphinx#defense`:
...
.. _`bestiary3.sphinx#offense`:

Offense
========
\ **Speed**\  40 ft., fly 60 ft. (poor)
\ **Melee**\  2 claws +20 (2d6+8/19–20 plus :ref:`grab <bestiary.universalmonsterrules#grab>`\ )
\ **Space**\  10 ft.; \ **Reach**\  5 ft.
\ **Special Attacks**\  :ref:`pounce <bestiary.universalmonsterrules#pounce>`\ , :ref:`rake <bestiary.universalmonsterrules#rake>`\  (2 claws +20, 2d6+8), roar
\ **Spells Prepared**\  (CL 6th; concentration +9)
 3rd—:ref:`bestow curse <corerulebook.spells.bestowcurse#bestow_curse>`\  (DC 16), :ref:`searing light <corerulebook.spells.searinglight#searing_light>`\ , :ref:`speak with dead <corerulebook.spells.speakwithdead#speak_with_dead>`
 2nd—:ref:`bull's strength <corerulebook.spells.bullsstrength#bull_s_strength>`\ , :ref:`calm emotions <corerulebook.spells.calmemotions#calm_emotions>`\  (DC 15), :ref:`cure moderate wounds <corerulebook.spells.curemoderatewounds#cure_moderate_wounds>`\ , :ref:`resist energy <corerulebook.spells.resistenergy#resist_energy>`
 1st—:ref:`comprehend languages <corerulebook.spells.comprehendlanguages#comprehend_languages>`\ , :ref:`divine favor <corerulebook.spells.divinefavor#divine_favor>`\ , :ref:`remove fear <corerulebook.spells.removefear#remove_fear>`\ , :ref:`shield of faith <corerulebook.spells.shieldoffaith#shield_of_faith>`
 0—:ref:`detect magic <corerulebook.spells.detectmagic#detect_magic>`\ , :ref:`guidance <corerulebook.spells.guidance#guidance>`\ , :ref:`purify food and drink <corerulebook.spells.purifyfoodanddrink#purify_food_and_drink>`\ , :ref:`stabilize <corerulebook.spells.stabilize#stabilize>`

.. _`bestiary3.sphinx#statistics`:

Statistics
===========
\ **Str**\  27, \ **Dex**\  10, \ **Con**\  18, \ **Int**\  16, \ **Wis**\  17, \ **Cha**\  17
\ **Base Atk**\  +13; \ **CMB**\  +22; \ **CMD**\  32 (36 vs. trip)
\ **Feats**\  :ref:`Alertness <corerulebook.feats#alertness>`\ , Cleave, :ref:`Flyby Attack <bestiary.monsterfeats#flyby_attack>`\ , Great Cleave, :ref:`Hover <bestiary.monsterfeats#hover>`\ , :ref:`Improved Critical <corerulebook.feats#improved_critical>`\  (claw), :ref:`Power Attack <corerulebook.feats#power_attack>`
\ **Skills**\  :ref:`Fly <corerulebook.skills.fly#fly>`\  +5, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +13, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (any one) +16, :ref:`Perception <corerulebook.skills.perception#perception>`\  +23, :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  +13, :ref:`Survival <corerulebook.skills.survival#survival>`\  +16
\ **Languages**\  Common, Draconic, Sphinx

.. _`bestiary3.sphinx#ecology`:
...
.. _`bestiary3.sphinx#special_abilities`:
...
\ **Init**\  +0; \ **Senses**\  darkvision 60 ft., low-light vision; :ref:`Perception <corerulebook.skills.perception#perception>`\  +10
...
\ **Feats**\  Improved Bull Rush, :ref:`Improved Critical <corerulebook.feats#improved_critical>`\  (gore), :ref:`Power Attack <corerulebook.feats#power_attack>`\ , :ref:`Skill Focus <corerulebook.feats#skill_focus>`\  (:ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\ ), :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (gore)
\ **Skills**\  :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  +10, :ref:`Fly <corerulebook.skills.fly#fly>`\  +1, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +16, :ref:`Perception <corerulebook.skills.perception#perception>`\  +10
\ **Languages**\  Common, Sphinx; :ref:`speak with animals <corerulebook.spells.speakwithanimals#speak_with_animals>`
...
Some criosphinxes set themselves as soothsayers of the desert, trading upon the storied wisdom of androsphinxes and gynosphinxes to deceive gullible travelers. Like their more blustering brethren, they seek wealth from passersby, but for the purposes of dispersing information rather than in exchange for safe passage. Such reliable information as they possess usually comes from idle conversation with the creatures of the desert, with criosphinxes using their inborn ability to :ref:`speak with animals <corerulebook.spells.speakwithanimals#speak_with_animals>`\ . A criosphinx lacking in sound information usually fabricates a pleasing lie.
...
\ **Init**\  +2; \ **Senses**\  darkvision 60 ft., low-light vision; :ref:`Perception <corerulebook.skills.perception#perception>`\  +16
...
\ **Space**\  10 ft.; \ **Reach**\  5 ft.
\ **Special Attack**\  :ref:`pounce <bestiary.universalmonsterrules#pounce>`\ , shriek

Statistics
===========
\ **Str**\  19, \ **Dex**\  14, \ **Con**\  15, \ **Int**\  6, \ **Wis**\  15, \ **Cha**\  10
\ **Base Atk**\  +8; \ **CMB**\  +13; \ **CMD**\  25 (29 vs. trip)
\ **Feats**\  Cleave, :ref:`Flyby Attack <bestiary.monsterfeats#flyby_attack>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`\ , :ref:`Skill Focus <corerulebook.feats#skill_focus>`\  (:ref:`Perception <corerulebook.skills.perception#perception>`\ )
\ **Skills**\  :ref:`Fly <corerulebook.skills.fly#fly>`\  +3, :ref:`Perception <corerulebook.skills.perception#perception>`\  +16; \ **Racial Modifiers**\  +4 :ref:`Perception <corerulebook.skills.perception#perception>`
\ **Languages**\  Sphinx
