...
.. _`advancedraceguide.featuredraces.ifrits`:

.. contents:: \ 

.. _`advancedraceguide.featuredraces.ifrits#ifrits`:
...
.. _`advancedraceguide.featuredraces.ifrits#ifrit_racial_traits`:

Ifrit Racial Traits
####################

.. _`advancedraceguide.featuredraces.ifrits#+2_dexterity_+2_charisma_2_wisdom`:

\ **+2 Dexterity, +2 Charisma, –2 Wisdom**\ : Ifrits are passionate and quick, but impetuous and destructive.

.. _`advancedraceguide.featuredraces.ifrits#native_outsider`:

\ **Native Outsider**\ : Ifrits are outsiders with the native subtype.

.. _`advancedraceguide.featuredraces.ifrits#medium`:

\ **Medium**\ : Ifrits are Medium creatures and receive no bonuses or penalties due to their size.

.. _`advancedraceguide.featuredraces.ifrits#normal_speed`:

\ **Normal Speed**\ : Ifrits have a base speed of 30 feet.

.. _`advancedraceguide.featuredraces.ifrits#darkvision`:

\ **Darkvision**\ : Ifrits can see in the dark up to 60 feet.

.. _`advancedraceguide.featuredraces.ifrits#spell_like_ability`:

\ **Spell-Like Ability**\ : :ref:`Burning hands <corerulebook.spells.burninghands#burning_hands>`\  1/day (caster level equals the ifrit's level; DC 11 + Charisma modifier).

.. _`advancedraceguide.featuredraces.ifrits#energy_resistance`:

\ **Energy Resistance**\ : Ifrits have fire resistance 5.

.. _`advancedraceguide.featuredraces.ifrits#fire_affinity`:
...
.. _`advancedraceguide.featuredraces.ifrits#languages`:
...
.. _`advancedraceguide.featuredraces.ifrits#alternate_racial_traits`:
...
.. _`advancedraceguide.featuredraces.ifrits#desert_mirage`:

\ **Desert Mirage**\ : Ifrits thrive in the deserts of the world, where their keen instincts and resistance to heat give them a huge edge over their competitors. Those with this trait gain a +2 racial bonus on :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  checks in desert environments and on saves to resist starvation and thirst. This racial trait replaces fire affinity.

.. _`advancedraceguide.featuredraces.ifrits#efreeti_magic`:

\ **Efreeti Magic**\ : Some ifrits inherit an efreeti ancestor's ability to magically change a creature's size. They can cast either :ref:`enlarge person <corerulebook.spells.enlargeperson#enlarge_person>`\  or :ref:`reduce person <corerulebook.spells.reduceperson#reduce_person>`\  (the ifrit chooses when using this ability) once per day as a spell-like ability (caster level equals the ifrit's level). The ifrit can use this ability to affect other ifrits as though they were humanoid creatures. This racial trait replaces the spell-like ability racial trait.

.. _`advancedraceguide.featuredraces.ifrits#fire_in_the_blood`:
...
.. _`advancedraceguide.featuredraces.ifrits#fire_insight`:
...
.. _`advancedraceguide.featuredraces.ifrits#fire_starter`:
...
.. _`advancedraceguide.featuredraces.ifrits#forge_hardened`:

\ **Forge-Hardened**\ : Not all ifrits are descended from efreet—some instead descend from azers or even salamanders. Such ifrits gain a +2 racial bonus on :ref:`Craft <corerulebook.skills.craft#craft>`\  (armor and weapons) checks and saves to resist fatigue and exhaustion. This racial trait replaces the spell-like ability racial trait.

.. _`advancedraceguide.featuredraces.ifrits#hypnotic`:
...
.. _`advancedraceguide.featuredraces.ifrits#wildfire_heart`:
...
.. _`advancedraceguide.featuredraces.ifrits#favored_class_options`:
...
.. _`advancedraceguide.featuredraces.ifrits#alchemist`:

\ **Alchemist**\ : Add +1/2 to the alchemist's bomb damage.

.. _`advancedraceguide.featuredraces.ifrits#bard`:

\ **Bard**\ : Add +1/6 to the number of people the bard can affect with the fascinate bardic performance.

.. _`advancedraceguide.featuredraces.ifrits#cleric`:

\ **Cleric**\ : Add a +1/2 bonus on :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (planes) checks relating to the Plane of Fire and creatures with the fire subtype.

.. _`advancedraceguide.featuredraces.ifrits#gunslinger`:

\ **Gunslinger**\ : Add +1/2 to the bonus on initiative checks the gunslinger makes while using her gunslinger initiative deed.

.. _`advancedraceguide.featuredraces.ifrits#inquisitor`:

\ **Inquisitor**\ : Add a +1/2 bonus on :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks made against creatures with the fire subtype and a +1/2 bonus on :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (planes) checks relating to the Plane of Fire.

.. _`advancedraceguide.featuredraces.ifrits#oracle`:

\ **Oracle**\ : Add +1/6 to the oracle's level for the purpose of determining the effects of one revelation.

.. _`advancedraceguide.featuredraces.ifrits#rogue`:

\ **Rogue**\ : Add a +1/2 bonus on :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  checks to jump and a +1/2 bonus on :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks to demoralize enemies.

.. _`advancedraceguide.featuredraces.ifrits#sorcerer`:
...
.. _`advancedraceguide.featuredraces.ifrits#racial_archetypes`:
...
.. _`advancedraceguide.featuredraces.ifrits#immolator_(inquisitor)`:
...
.. _`advancedraceguide.featuredraces.ifrits#servant_of_the_flame`:
...
.. _`advancedraceguide.featuredraces.ifrits#judgment`:

\ **Judgment (Su)**\ : An immolator gains the following judgment instead of the smiting judgment.

.. _`advancedraceguide.featuredraces.ifrits#immolation`:
...
.. _`advancedraceguide.featuredraces.ifrits#burnt_offering`:

\ **Burnt Offering (Su)**\ : At 5th level, as a swift action, an immolator can imbue one of her weapons with the :ref:`flaming <corerulebook.magicitems.weapons#weapons_flaming>`\  weapon special ability. Any creature slain by this weapon burns with magical flame; its body turns to ash, though its equipment is not harmed. This special ability only functions while the immolator wields the weapon. This ability lasts for a number of rounds per day equal to the immolator's level. These rounds do not need to be consecutive. At 12th level, this ability gives the immolator's weapon the :ref:`flaming burst <corerulebook.magicitems.weapons#weapons_flaming_burst>`\  weapon special ability. This ability replaces bane and greater bane.

.. _`advancedraceguide.featuredraces.ifrits#judgment_by_fire`:
...
.. _`advancedraceguide.featuredraces.ifrits#wishcrafter_(sorcerer)`:
...
.. _`advancedraceguide.featuredraces.ifrits#twisted_wish`:
...
.. _`advancedraceguide.featuredraces.ifrits#perfect_wishcraft`:
...
.. _`advancedraceguide.featuredraces.ifrits#new_racial_rules`:
...
.. _`advancedraceguide.featuredraces.ifrits#ifrit_equipment`:
...
.. _`advancedraceguide.featuredraces.ifrits#fire_ink`:

\ **Fire Ink**\ : This rich yellow ink reacts with a creature's body heat to create a flickering, flamelike glow. It takes 10 minutes to apply fire ink, and 1 dose covers an approximately hand-sized area. Once applied, the ink glows as a candle for 24 hours. Four or more doses applied to the same part of the body glow as a torch for 24 hours. The alchemical reaction of the ink to the target's skin and body heat is painful and irritating, giving the target the sickened condition while the glow lasts. A DC 15 :ref:`Heal <corerulebook.skills.heal#heal>`\  check can temporarily soothe these sensations, negating the sickened condition for 1 hour. Creatures immune or resistant to fire are immune to this sickening effect. Ifrits are especially known for their fondness for fire ink, and ifrit fire-dancers often decorate their skin with flaming designs before performing. A concentrated version of the ink costs 10 times as much and can be used to make permanently glowing tattoos.

.. _`advancedraceguide.featuredraces.ifrits#ifrits_blood`:
...
.. _`advancedraceguide.featuredraces.ifrits#ifrit_feats`:
...
.. _`advancedraceguide.featuredraces.ifrits#blazing_aura_(combat)`:
...
.. _`advancedraceguide.featuredraces.ifrits#blistering_feint_(combat)`:
...
\ **Prerequisites**\ : :ref:`Combat Expertise <corerulebook.feats#combat_expertise>`\ , Improved Feint, ifrit.
...
.. _`advancedraceguide.featuredraces.ifrits#elemental_jaunt`:
...
\ **Benefit**\ : Once per day, you can cast :ref:`plane shift <corerulebook.spells.planeshift#plane_shift>`\  as a spell-like ability with a caster level equal to your level to transport yourself and willing targets to an elemental plane that is appropriate to your race (ifrits to the Plane of Fire, oreads to the Plane of Earth, sylphs to the Plane of Air, and undines to the Plane of Water). While on that plane, you (but not anyone transported with you) are treated as though under the effect of the spell :ref:`planar adaptation <advancedplayersguide.spells.planaradaptation#planar_adaptation>`\ .

.. _`advancedraceguide.featuredraces.ifrits#firesight`:
...
.. _`advancedraceguide.featuredraces.ifrits#inner_flame_(combat)`:
...
.. _`advancedraceguide.featuredraces.ifrits#scorching_weapons_(combat)`:
...
.. _`advancedraceguide.featuredraces.ifrits#igniting_(weapon_special_ability)`:

\ **Igniting (weapon special ability)**\ : An \ *igniting*\  weapon functions as a :ref:`flaming <corerulebook.magicitems.weapons#weapons_flaming>`\  weapon that also causes foes to catch fire  upon striking a successful critical hit. The target does not get a saving throw to avoid catching fire, but can make a save each round on its turn to put out the fire. The :ref:`flaming <corerulebook.magicitems.weapons#weapons_flaming>`\  ability must be active for the weapon to set enemies on fire.

Strong evocation; CL 12th; :ref:`Craft Magic Arms and Armor <corerulebook.feats#craft_magic_arms_and_armor>`\ , flame blade, flame strike, or fireball; Price +2 bonus. 

.. _`advancedraceguide.featuredraces.ifrits#cloak_of_fiery_vanishing`:
...
.. _`advancedraceguide.featuredraces.ifrits#description`:
...
.. _`advancedraceguide.featuredraces.ifrits#construction`:

Construction
=============

\ **Requirements**\  :ref:`Craft Wondrous Item <corerulebook.feats#craft_wondrous_item>`\ , :ref:`invisibility <corerulebook.spells.invisibility#invisibility>`\ , :ref:`silent image <corerulebook.spells.silentimage#silent_image>`\ ; \ **Cost**\  1,300 gp

.. _`advancedraceguide.featuredraces.ifrits#ifrit_spells`:
...
.. _`advancedraceguide.featuredraces.ifrits#chains_of_fire`:
...
This spell functions like :ref:`chain lightning <corerulebook.spells.chainlightning#chain_lightning>`\ , except as noted above, and the spell deals fire damage instead of electricity damage.

.. _`advancedraceguide.featuredraces.ifrits#death_candle`:

Death Candle
=============

\ **School**\  necromancy [death, :ref:`evil <bestiary.creaturetypes#evil_subtype>`\ , :ref:`fire <bestiary.creaturetypes#fire_subtype>`\ ]; \ **Level**\  antipaladin 1, cleric 2, inquisitor 2, witch 2
...
This spell functions like :ref:`death knell <corerulebook.spells.deathknell#death_knell>`\ , except instead of using the slain target's life energy to enhance yourself, you use it to summon a Small fire elemental resembling a burning, howling version of the slain creature. The elemental acts immediately on your turn and otherwise behaves as if you had summoned it with :ref:`summon monster II <corerulebook.spells.summonmonster#summon_monster_ii>`\ . The elemental remains for a number of rounds equal to the Hit Dice of the slain creature.

.. _`advancedraceguide.featuredraces.ifrits#firestream`:
...
.. _`advancedraceguide.featuredraces.ifrits#fury_of_the_sun`:

Fury of the Sun
================

\ **School**\  transmutation [:ref:`curse <bestiary.universalmonsterrules#curse>`\ , :ref:`fire <bestiary.creaturetypes#fire_subtype>`\ ]; \ **Level**\  druid 2, witch 2
...
You curse the target to suffer unbearable heat. On a failed saving throw, the target is immediately subjected to severe heat , takes 1d4 points of nonlethal damage, and is suffering from heatstroke (fatigued). The target must save every 10 minutes as normal for severe heat (starting at DC 15 rather than the DC of this spell). Because this heat is internal, the target cannot avoid it using the normal methods for escaping heat dangers such as :ref:`Survival <corerulebook.skills.survival#survival>`\  checks or finding shade. 

.. _`advancedraceguide.featuredraces.ifrits#healing_warmth`:
...
This spell functions like :ref:`gaseous form <corerulebook.spells.gaseousform#gaseous_form>`\ , except the target becomes a visible swirl of hot ash and smoke instead of harmless translucent gas. The target gains the fire subtype. Any creature that begins its turn sharing a space with the target takes 2d6 points of fire damage and must make a Fortitude save (DC 15, + 1 per previous check) or suffer the effects of smoke inhalation .

.. _`advancedraceguide.featuredraces.ifrits#touch_of_combustion`:
