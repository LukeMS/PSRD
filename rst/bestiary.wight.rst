...
\ **Defensive Abilities**\  :ref:`undead traits <bestiary.universalmonsterrules#undead_traits>`

\ **Weaknesses**\  resurrection vulnerability

.. _`bestiary.wight#offense`:
...
\ **Melee**\  slam +4 (1d4+1 plus :ref:`energy drain <bestiary.universalmonsterrules#energy_drain>`\ )

\ **Special Attacks**\  create spawn, :ref:`energy drain <bestiary.universalmonsterrules#energy_drain>`\  (1 level, DC 14)

.. _`bestiary.wight#statistics`:
...
\ **Feats**\  :ref:`Blind-Fight <corerulebook.feats#blind_fight>`\ , :ref:`Skill Focus <corerulebook.feats#skill_focus>`\  (:ref:`Perception <corerulebook.skills.perception#perception>`\ )

\ **Skills**\  :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +9, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (religion) +7, :ref:`Perception <corerulebook.skills.perception#perception>`\  +11, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +16; \ **Racial Modifier**\  +8 :ref:`Stealth <corerulebook.skills.stealth#stealth>`

\ **Languages**\  Common

\ **SQ**\  create spawn

.. _`bestiary.wight#ecology`:
...
.. _`bestiary.wight#special_abilities`:
...
\ **Resurrection Vulnerability (Su)**\  A :ref:`raise dead <corerulebook.spells.raisedead#raise_dead>`\  or similar spell cast on a wight destroys it (Will negates). Using the spell in this way does not require a material component.
