...
.. _`ultimatecampaign.campaignsystems.reputationandfame`:

.. contents:: \ 

.. _`ultimatecampaign.campaignsystems.reputationandfame#reputation_and_fame`:
...
.. _`ultimatecampaign.campaignsystems.reputationandfame#fame`:
...
.. _`ultimatecampaign.campaignsystems.reputationandfame#sphere_of_influence`:
...
Outside your Sphere of Influence, your Fame is 0. You can attempt to expand your Sphere of Influence into a new settlement by attempting a DC 30 Charisma, :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\ , or :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  check. If you succeed, you treat the settlement as being within your Sphere of Influence for 1d4 days, though your Fame is effectively halved for that settlement. After this time, the settlement reverts to being outside your sphere.

The following actions and conditions alter your Charisma, :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\ , or :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  check modifier for the purpose of expanding your Sphere of Influence.

.. _`ultimatecampaign.campaignsystems.reputationandfame#table_sphere_of_influence_modifiers`:

.. list-table:: Sphere of Influence Modifiers
   :header-rows: 1
   ...
   * - Action
     - Check Modifier
   * - Allies or minions spread tales of your deeds before you arrive
     - +5
   * - A bard spreads tales or songs of your deeds before you arrive
     - + 1/2 bard level
   * - You have NPC contacts in the settlement
     - +1
   * - You have enemies in the settlement
     - +1
   * - Distance from your Sphere of Influence
     - —1 per 10 miles
   * - Settlement's primary language is different from yours
     - —5

.. _`ultimatecampaign.campaignsystems.reputationandfame#prestige_points`:
...
.. _`ultimatecampaign.campaignsystems.reputationandfame#awards`:

Awards
*******

Spending Prestige Points earns you awards—temporary bonuses or favors. Each time you want to use an award, you must spend the Prestige Points for that award. Unless otherwise stated, bonuses from spending Prestige Points do not stack (for example, you can't combine the Hero's Luck award with the Lore of Ages award to gain a +9 bonus on a :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  check). Spending Prestige Points on a reward is not an action. You may only spend Prestige Points within your Sphere of Influence.
...
.. _`ultimatecampaign.campaignsystems.reputationandfame#fame_1`:
...
\ **Palm Greaser (Title, 4 PP)**\ : In any settlement of at least 5,000 inhabitants, you may locate a corrupt official. If you're imprisoned or fined for crimes committed in the settlement's jurisdiction, you may take advantage of this contact. You pay no fines and escape sentencing if you can make a :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  check (DC 15 for petty crimes, 20 for serious crimes, or 25 for capital crimes). You can use this ability once per game session. You may select this title once for each settlement in your Sphere of Influence; each time you select it, choose one settlement where you may use the award.

\ **Planar Pact (5 PP)**\ : You gain the services of an imp, mephit, quasit, or similar extraplanar creature from the :ref:`Improved Familiar <corerulebook.feats#improved_familiar>`\  list on page 127 of the \ *Core Rulebook*\ . You can choose a creature with an alignment up to 1 step away from yours on each alignment axis. The creature acts as your willing servant for a number of encounters equal to your Intelligence, Wisdom, or Charisma bonus (whichever is highest), but remains for no more than 24 hours. The creature is a called outsider and automatically returns to its home plane at the end of this service.

.. _`ultimatecampaign.campaignsystems.reputationandfame#fame_10`:
...
\ **Lore of Ages (1 PP)**\ : You may secure the assistance of a dedicated sage, librarian, or other knowledgeable individual, granting you a +5 bonus on any single :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  check after 1 hour of research. You make this :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  check as if you were trained in that skill.

\ **Wanderer (Title, 1 PP)**\ : The long time you've spent on the road with fellow travelers has enhanced your knack for picking up local customs. :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (local) becomes a class skill for you as long as you have this title.

.. _`ultimatecampaign.campaignsystems.reputationandfame#fame_20`:
...
\ **Sacrifice (0 PP)**\ : Make a significant sacrifice to gain 1d3 Prestige Points. If you are a heroic character, you must spend 375 gp Ã your character level to use this award, representing a great feast in your name, charitable giving, or other expenses that improve your reputation. If you are a villainous character, you must kill or sacrifice allies and minions whose total Hit Dice equal your character level, representing callous evil toward your friends and underlings. You can use this award once per month.

\ **Sage (Title, 5 PP)**\ : Select one :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  skill. You can make untrained checks with this skill up to a maximum of DC 20 instead of the normal limit of DC 10. You may select this title multiple times, each time selecting a different :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  skill.

\ **Temporary Cohort (1 PP)**\ : Gain a cohort as if you had the :ref:`Leadership <corerulebook.feats#leadership>`\  feat. This character remains in your service for 24 hours.
...
.. _`ultimatecampaign.campaignsystems.reputationandfame#fame_30`:
...
\ **Officer (Title, PP 5)**\ : You can select this title only if you have selected the initiate title. Your rank within your chosen organization increases. You gain an appellation appropriate to the organization and a +4 bonus on :ref:`Bluff <corerulebook.skills.bluff#bluff>`\ , :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\ , :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\ , and :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  checks made to interact with anyone within the organization. If you belong to multiple organizations, you may select this title multiple times.
...
.. _`ultimatecampaign.campaignsystems.reputationandfame#fame_40`:
...
.. _`ultimatecampaign.campaignsystems.reputationandfame#disrepute_and_infamy`:
...
If an event would increase your Fame, you may choose to increase your Fame (bringing it closer to 0) or decrease your Fame (making it a larger negative number). For example, if your Fame is —20 and you publicly roll a 30 on a :ref:`Craft <corerulebook.skills.craft#craft>`\  check to create a masterwork sword (normally worth +2), you may increase your Fame to —18 or decrease it to —22. Negative events that decrease your Fame always count as negative (a villain attacking innocent people doesn't make the public like him more).
...
.. _`ultimatecampaign.campaignsystems.reputationandfame#shared_fame`:
...
.. _`ultimatecampaign.campaignsystems.reputationandfame#alter_egos_aliases_and_secret_identities`:
...
.. _`ultimatecampaign.campaignsystems.reputationandfame#table_fame_events`:

.. list-table:: Fame Events
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
   ...
   * - \ *Positive Events*
     - 
   * - Acquire a noteworthy treasure from a worthy foe\ :sup:`1`
     - +1
   * - Confirm two successive critical hits in a CR-appropriate encounter
     - +1
   * - Consecrate a temple to your deity
     - +1
   * - :ref:`Craft <corerulebook.skills.craft#craft>`\  a powerful magic item
     - +1\ :sup:`2`
   * - Gain a level in a PC class
     - +1
   * - Locate and disarm three or more CR-appropriate traps in a row
     - +1
   * - Make a noteworthy historical, scientific, or magical discovery\ :sup:`3`
     - +1
   * - Own a legendary item or artifact
     -  +1\ :sup:`4`
   * - Receive a medal or similar honor from a public figure
     - +1
   * - Return a significant magic item or relic to its owner
     - +1
   * - Sack the stronghold of a powerful noble
     - +1
   * - Single-handedly defeat an opponent with a CR higher than your level
     - +1\ :sup:`5`
   * - Win a combat encounter with a CR of your APL + 3 or more
     - +1
   * - Defeat in combat a person who publicly defamed you
     - +2
   * - Succeed at a DC 30 or higher :ref:`Craft <corerulebook.skills.craft#craft>`\  check to create a work of art or masterwork item\ :sup:`6`
     - +2
   * - Succeed at a DC 30 or higher public :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  or :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  check\ :sup:`6`
     - +2
   * - Succeed at a DC 30 or higher public :ref:`Perform <corerulebook.skills.perform#perform>`\  check\ :sup:`6`
     - +2
   * - Complete an adventure with a CR appropriate for your APL\ :sup:`7`
     - +3
   * - Earn a formal title (lady, lord, knight, and so on)
     - +3
   * - Defeat a key rival in combat
     - +5
   ...
   * - Be convicted of a petty crime
     - —1
   * - Keep company with someone of disreputable character
     - —1\ :sup:`8`
   * - Be convicted of a serious nonviolent crime
     - —2
   * - Publicly flee an encounter of a CR lower than your APL
     - —3
   * - Attack innocent people
     - —5
   * - Be convicted of a serious violent crime
     - —5
   * - Publicly lose an encounter of a CR equal to or lower than your APL
     - —5
...
* \ :sup:`1`\ This includes claiming a treasure from a defeated monster or rival. A villainous character may include stealing such an item instead of obtaining it fairly. \ :sup:`2`\ Per 40,000 gp of the item's price. \ :sup:`3`\ Such as finding the ruins of a lost city, recovering forgotten lore, or creating a useful new spell. \ :sup:`4`\ Per 40,000 gp of the item's price. Artifacts with no price count as 200,000 gp (5 PP) for this purpose. \ :sup:`5`\ Per CR the opponent is above your level. \ :sup:`6`\ You may increase your Fame in this way no more than once per month. \ :sup:`7`\ Approximately the length of a Pathfinder Module or Pathfinder Adventure Path adventure. \ :sup:`8`\ Per week of close association.

.. _`ultimatecampaign.campaignsystems.reputationandfame#table_negative_fame_reactions`:

.. list-table:: Negative Fame Reactions
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
   ...
   * - Fame
     - Reaction
   * - —5
     - Merchants, hirelings, and innkeepers overcharge you by 10% to discourage you from doing business in their community.
   * - —8
     - Merchants, hirelings, and innkeepers refuse to accept your business. If you enter a business, you are immediately asked to leave. If you refuse, the owner calls for the authorities or locals to throw you out.
   * - —10
     - When you approach, businesses shutter their windows and bar their doors. Most citizens refuse to speak with you. Others request that you leave immediately. If you remain for longer than 24 hours or act out against the citizens, your Fame decreases by 5 and the citizens form a mob to run you out of town.
   * - —15
     - Incensed that you display the gall to enter their community, an angry mob gathers. If you do not leave within a few minutes, the mob starts pelting you with fruit, sticks, and rocks.
   * - —20
     - An angry mob forms shortly after you enter town. Not willing to wait for a potentially corrupt trial, they attempt to capture you and execute you for your crimes.
   * - —25
     - An authority figure has issued a warrant for your arrest, including a reward to anyone who captures you. This is well known and many are eager to collect it.
   * - —30
     - An authority figure has issued a bounty for your head. This is well known and many are eager to collect it.
