...
.. _`ultimatecampaign.characterbackground.storyfeats`:

.. contents:: \ 

.. _`ultimatecampaign.characterbackground.storyfeats#story_feats`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#common_rules`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#story_feats_and_stacking`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#accursed_(story)`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#arisen_(story)`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#battlefield_healer_(story)`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#champion_(story)`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#damned_(story)`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#deny_the_reaper_(story)`:
...
\ **B**\ \ **enefit**\ : You gain a +2 bonus on :ref:`Heal <corerulebook.skills.heal#heal>`\  checks. If you have 10 or more ranks in :ref:`Heal <corerulebook.skills.heal#heal>`\ , this bonus increases to +4. You can apply first aid as a move action and don't take a penalty when treating deadly wounds without a healing kit.

\ **Goal**\ : Bring an ally back from the dead, including by using :ref:`breath of life <corerulebook.spells.breathoflife#breath_of_life>`\  or :ref:`reincarnate <corerulebook.spells.reincarnate#reincarnate>`\ .

\ **Completion Benefit**\ : You and each ally within 10 feet of you gain a +2 bonus on saves against death effects. In addition, once per day you can spontaneously convert any 5th-level or higher conjuration (healing) spell into :ref:`breath of life <corerulebook.spells.breathoflife#breath_of_life>`\ .

.. _`ultimatecampaign.characterbackground.storyfeats#eldritch_researcher_(story)`:
...
\ **Benefit**\ : When casting a spell you've created, add 1 to your caster level. In addition, you gain a +2 bonus on :ref:`Spellcraft <corerulebook.skills.spellcraft#spellcraft>`\  checks. If you have 10 or more ranks in :ref:`Spellcraft <corerulebook.skills.spellcraft#spellcraft>`\ , this bonus increases to +4.
...
\ **Special**\ : For a self-created spell to benefit from this feat, it must be a truly novel spell. Spells slightly altered from the original (for example, :ref:`delayed blast fireball <corerulebook.spells.delayedblastfireball#delayed_blast_fireball>`\  as compared to :ref:`fireball <corerulebook.spells.fireball#fireball>`\ ) gain no benefit. Alchemists can benefit from this feat as though their formulae and extracts were spells.

.. _`ultimatecampaign.characterbackground.storyfeats#fearless_zeal_(story)`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#feral_heart_(story)`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#foeslayer_(story)`:
...
\ **Completion Benefit**\ : You gain the benefits of the :ref:`Improved Critical <corerulebook.feats#improved_critical>`\  feat on attacks made against members of your chosen race. Your dodge bonus to AC against such foes increases to +2.

.. _`ultimatecampaign.characterbackground.storyfeats#forgotten_past_(story)`:
...
\ **Special**\ : Restoration of memories by means less significant than :ref:`miracle <corerulebook.spells.miracle#miracle>`\  or :ref:`wish <corerulebook.spells.wish#wish>`\  does not qualify for the prerequisite.

.. _`ultimatecampaign.characterbackground.storyfeats#glimpse_beyond_(story)`:
...
\ **Benefit**\ : You gain a +2 bonus on :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (dungeoneering) checks to identify the vulnerabilities and powers of aberrations, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (planes) checks to identify the vulnerabilities and powers of evil outsiders, and :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (religion) checks to identify the vulnerabilities and powers of undead, and you can make such checks untrained. If you have 10 or more ranks in any of these :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  skills, the bonus increases to +4 for the appropriate skill. In addition, you gain a +2 bonus on saves against fear effects.
...
.. _`ultimatecampaign.characterbackground.storyfeats#innocent_blood_(story)`:
...
\ **Benefit**\ : You gain a +2 bonus on :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks. If you have 10 or more ranks in :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\ , this bonus increases to +4. Each time you slay an intelligent creature, you gain a +1 bonus on attack rolls and caster level checks for 1 minute (this bonus does not stack with itself).
...
.. _`ultimatecampaign.characterbackground.storyfeats#liberator_(story)`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#lost_legacy_(story)`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#magnum_opus_(story)`:
...
\ **Prerequisite**\ : You must either have sold five or more self-created works of art worth a total of at least 5,000 gp, have performed at least five performances for audiences of 50 or more while achieving a great performance result or better on your :ref:`Perform <corerulebook.skills.perform#perform>`\  check, or have the Virtuoso background.

\ **Benefit**\ : Choose a single :ref:`Craft <corerulebook.skills.craft#craft>`\  or :ref:`Perform <corerulebook.skills.perform#perform>`\  skill. Whenever you take 10 with this skill, treat your die result as a 15 instead.
...
\ **Completion Benefit**\ : You gain a +5 bonus on skill checks made with your chosen skill, and a +2 bonus on all other :ref:`Craft <corerulebook.skills.craft#craft>`\  and :ref:`Perform <corerulebook.skills.perform#perform>`\  checks for which you have at least 1 rank.

.. _`ultimatecampaign.characterbackground.storyfeats#monument_builder_(story)`:
...
\ **Prerequisites**\ : :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (engineering) 1 rank, and you must have built a structure worth at least 5,000 gp.

\ **Benefit**\ : When you supervise a construction project or do the construction yourself, reduce your raw material costs by 10%. You gain a +2 bonus on :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (engineering) checks. If you have 10 or more ranks in :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (engineering), this bonus increases to +4.
...
.. _`ultimatecampaign.characterbackground.storyfeats#nation_builder_(story)`:
...
\ **Benefit**\ : When in either unclaimed wilderness or land under your own control, you receive a +2 bonus on :ref:`Perception <corerulebook.skills.perception#perception>`\  checks, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  checks, and :ref:`Survival <corerulebook.skills.survival#survival>`\  checks. If you have 10 or more ranks in one of these skills, the bonus on that skill increases to +4.
...
.. _`ultimatecampaign.characterbackground.storyfeats#nemesis_(story)`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#prophet_(story)`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#redemption_(story)`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#shamed_(story)`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#stronghold_(story)`:
...
\ **Prerequisites**\ : You must have the :ref:`Leadership <corerulebook.feats#leadership>`\  feat and must lead at least 10 combat-capable followers (such as fighters or rangers).
...
.. _`ultimatecampaign.characterbackground.storyfeats#thief_of_legend_(story)`:
...
\ **Benefit**\ : Once per day when you attempt a :ref:`Disable Device <corerulebook.skills.disabledevice#disable_device>`\  check to open a lock or :ref:`Sleight of Hand <corerulebook.skills.sleightofhand#sleight_of_hand>`\  check to pick a pocket, you can roll twice and take the better result.
...
\ **Prerequisites**\ : You must have 5 ranks in :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  and a personal motivation to clean up a particular town (such as an old friend calling in a favor, or seeking a place to settle down), or you must have the Bounty Hunter or Champion of the People background.

\ **Benefit**\ : Choose a particular settlement. When you're in your chosen settlement, the DC of :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks made against you increases by 10. You gain a +1 bonus on attack rolls and a +1 dodge bonus to AC against undesirable elements like criminals or ruffians in your chosen settlement. This bonus increases to +2 for combat maneuver checks.
...
.. _`ultimatecampaign.characterbackground.storyfeats#true_love_(story)`:
...
\ **Benefit**\ : You add 1 to the save DC and caster level of your spells and spell-like abilities with the emotion descriptor. In addition, you gain a +2 bonus on :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  checks. If you have 10 or more ranks in :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\ , this bonus increases to +4.
...
.. _`ultimatecampaign.characterbackground.storyfeats#unforgotten_(story)`:
...
.. _`ultimatecampaign.characterbackground.storyfeats#vengeance_(story)`:
