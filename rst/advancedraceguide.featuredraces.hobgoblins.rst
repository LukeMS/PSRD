...
.. _`advancedraceguide.featuredraces.hobgoblins`:

.. contents:: \ 

.. _`advancedraceguide.featuredraces.hobgoblins#hobgoblins`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#hobgoblin_racial_traits`:

Hobgoblin Racial Traits
########################

.. _`advancedraceguide.featuredraces.hobgoblins#+2_dexterity_+2_constitution`:

\ **+2 Dexterity, +2 Constitution**\ : Hobgoblins are fast and hardy.

.. _`advancedraceguide.featuredraces.hobgoblins#goblinoid`:

\ **Goblinoid**\ : Hobgoblins are humanoids with the goblinoid subtype.

.. _`advancedraceguide.featuredraces.hobgoblins#medium`:

\ **Medium**\ : Hobgoblins are Medium creatures and have no bonuses or penalties due to their size.

.. _`advancedraceguide.featuredraces.hobgoblins#normal_speed`:

\ **Normal Speed**\ : Hobgoblins have a base speed of 30 feet.

.. _`advancedraceguide.featuredraces.hobgoblins#darkvision`:

\ **Darkvision**\ : Hobgoblins can see in the dark up to 60 feet.

.. _`advancedraceguide.featuredraces.hobgoblins#sneaky`:

\ **Sneaky**\ : Hobgoblins receive a +4 racial bonus on :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  checks.

.. _`advancedraceguide.featuredraces.hobgoblins#languages`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#alternate_racial_traits`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#bandy_legged`:

\ **Bandy-Legged**\ : Bandy-legged hobgoblins have an even more exaggerated stature than other hobgoblins, with bowed legs and massive shoulders. Hobgoblins with this racial trait gain a +2 racial bonus on :ref:`Climb <corerulebook.skills.climb#climb>`\  and :ref:`Ride <corerulebook.skills.ride#ride>`\  checks, and a +2 racial bonus to their CMD against bull rush or trip attempts while on solid ground. The base speed of bandy-legged hobgoblins is reduced to 20 feet.

.. _`advancedraceguide.featuredraces.hobgoblins#battle_hardened`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#engineer`:

\ **Engineer**\ : Hobgoblin engineers tinker endlessly with fire, explosives, and the engines of war. Hobgoblins with this racial trait gain a +2 racial bonus on :ref:`Craft <corerulebook.skills.craft#craft>`\  (alchemy) and :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (engineering) checks. This racial trait replaces sneaky.

.. _`advancedraceguide.featuredraces.hobgoblins#fearsome`:

\ **Fearsome**\ : Some hobgoblins scorn caution and subtlety for swagger and bluster. Hobgoblins with this racial trait gain a +4 racial bonus on :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks. This racial trait replaces sneaky.

.. _`advancedraceguide.featuredraces.hobgoblins#magehunter`:

\ **Magehunter**\ : Hobgoblins hate and fear arcane casters. A magehunter gains a +2 racial bonus on :ref:`Spellcraft <corerulebook.skills.spellcraft#spellcraft>`\  checks made to identify a spell being cast and a +1 racial bonus on attack rolls against arcane spellcasters. He only gains this bonus against creatures that use spells, and not against those that only use spell-like abilities. This racial trait replaces sneaky.

.. _`advancedraceguide.featuredraces.hobgoblins#pit_boss`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#scarred`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#slave_hunter`:

\ **Slave Hunter**\ : Hobgoblin slavers excel at tracking down runaway slaves and surviving in filthy conditions. Hobgoblins with this racial trait gain a +2 racial bonus on :ref:`Survival <corerulebook.skills.survival#survival>`\  checks and a +2 racial bonus on Fortitude saves against disease. This racial trait replaces sneaky.

.. _`advancedraceguide.featuredraces.hobgoblins#unfit`:

\ **Unfit**\ : Hobgoblins who failed to secure a position in the military hold the lowest status in hobgoblin society, and quickly learn the value of currying favor with their betters. Hobgoblins with this racial trait gain proficiency in a single martial weapon and +1 racial bonus on :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  and :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  checks. This racial trait replaces sneaky.

.. _`advancedraceguide.featuredraces.hobgoblins#favored_class_options`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#alchemist`:

\ **Alchemist**\ : Add +1/2 to the number of bombs per day the alchemist can create.

.. _`advancedraceguide.featuredraces.hobgoblins#cavalier`:

\ **Cavalier**\ : Add a +1/2 bonus on :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks and :ref:`Ride <corerulebook.skills.ride#ride>`\  checks.

.. _`advancedraceguide.featuredraces.hobgoblins#cleric`:

\ **Cleric**\ : Add +1/2 to negative energy spell damage, including inflict spells.

.. _`advancedraceguide.featuredraces.hobgoblins#fighter`:

\ **Fighter**\ : Add a +1/2 circumstance bonus on critical hit confirmation rolls with a weapon of the fighter's choice (maximum bonus +4). This bonus does not stack with :ref:`Critical Focus <corerulebook.feats#critical_focus>`\ .

.. _`advancedraceguide.featuredraces.hobgoblins#gunslinger`:

\ **Gunslinger**\ : Add +1/4 to the gunslinger's grit points.

.. _`advancedraceguide.featuredraces.hobgoblins#inquisitor`:

\ **Inquisitor**\ : Add a +1 bonus on concentration checks made to cast inquisitor spells.

.. _`advancedraceguide.featuredraces.hobgoblins#monk`:

\ **Monk**\ : Add a +1/4 bonus on combat maneuver checks made to grapple or trip.

.. _`advancedraceguide.featuredraces.hobgoblins#ranger`:

\ **Ranger**\ : Add +1/4 to a single existing favored enemy bonus (maximum bonus +1 per favored enemy).

.. _`advancedraceguide.featuredraces.hobgoblins#rogue`:

\ **Rogue**\ : Reduce the penalty for not being proficient with one weapon by 1. When the nonproficiency penalty for a weapon becomes 0 because of this ability, the rogue is treated as having the appropriate Martial or :ref:`Exotic Weapon Proficiency <corerulebook.feats#exotic_weapon_proficiency>`\  feat for that weapon.

.. _`advancedraceguide.featuredraces.hobgoblins#racial_archetypes`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#fell_rider_(cavalier)`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#brute_steed`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#rampage`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#dread_rider`:

\ **Dread Rider (Ex)**\ : At 4th level, a fell rider gains a bonus equal to 1/2 his level on :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks made while mounted. Once per round as a free action, he can make an :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  check to demoralize a foe he has trampled or charged while mounted. This ability replaces expert trainer.

.. _`advancedraceguide.featuredraces.hobgoblins#fell_presence`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#deadly_rampage`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#terror`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#unstoppable_rampage`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#ironskin_monk_(monk)`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#iron_skin`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#bonus_feat`:

\ **Bonus Feat**\ : At 1st level, an ironskin monk adds :ref:`Power Attack <corerulebook.feats#power_attack>`\  to his list of bonus feats. At 6th level, he adds Improved Sunder to the list. At 10th level, he adds Greater Sunder to the list. These bonus feat choices replace :ref:`Dodge <corerulebook.feats#dodge>`\ , Mobility, and Spring Attack on his bonus feat list.

.. _`advancedraceguide.featuredraces.hobgoblins#resilience`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#ki_pool`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#staggering_blow`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#tough_as_nails`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#evasion`:

\ **Evasion (Ex)**\ : At 9th level, an ironskin monk gains evasion. This ability replaces improved evasion.

.. _`advancedraceguide.featuredraces.hobgoblins#surefooted`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#unbreakable`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#new_racial_rules`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#hobgoblin_equipment`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#brewed_reek`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#fetters`:

\ **Fetters**\ : Fetters are manacles fitted around the ankles rather than the wrists, and use the same rules  for breaking, escape, and cost relative to size. A creature in fetters is entangled and can only move at half speed. In addition, a fettered creature must succeed at a DC 15 :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  check to move more than its (reduced) speed in a round. If it fails the check by 5 or more, the creature falls prone.

.. _`advancedraceguide.featuredraces.hobgoblins#hobgoblin_war_draught`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#manacle_barbs`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#unstable_accelerant`:
...
.. list-table:: Hobgoblin Equipment
   :header-rows: 1
...
.. _`advancedraceguide.featuredraces.hobgoblins#hobgoblin_feats`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#deafening_explosion`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#demoralizing_lash_(combat)`:
...
\ **Prerequisites**\ : Base attack bonus +1, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  1 rank, hobgoblin.

\ **Benefit**\ : To use this feat, you must use a whip (or another weapon in the flails fighter weapon group) to attack a foe demoralized by an :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  check. If the attack hits, you extend the duration the creature is shaken by 1 round. This feat has no effect on creatures whose shaken conditions are from sources other than :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks.

.. _`advancedraceguide.featuredraces.hobgoblins#focusing_blow_(teamwork)`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#hobgoblin_discipline`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#taskmaster_(combat)`:
...
\ **Prerequisites**\ : Demoralizing Lash, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  5 ranks, hobgoblin.

\ **Benefit**\ : As a standard action, you spur an ally, who must have fewer Hit Dice than yourself, to reckless effort. For 1 minute, the ally gains a +1 morale bonus on attack rolls, weapon damage rolls, and Will saves against mind-affecting effects. However, the ally also takes a –2 penalty to AC and on skill checks. To affect an unwilling ally, you must succeed at an :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  check with the same DC used to demoralize your ally.

\ **Special**\ : If you have 10 or more ranks in :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\ , the morale bonus increases to +2.

.. _`advancedraceguide.featuredraces.hobgoblins#terrorizing_display_(combat)`:
...
\ **Prerequisites**\ : Dazzling Display, Demoralizing Lash, Taskmaster, :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\ , :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  10 ranks, hobgoblin, proficiency with selected weapon.

.. _`advancedraceguide.featuredraces.hobgoblins#benefits`:

\ **Benefits**\ : When you use Dazzling Display, in addition to its normal effects, you can use it to spur allies within 30 feet as if you had used the Taskmaster feat. Use the same :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  check to determine the effects of Dazzling Display and this feat.

.. _`advancedraceguide.featuredraces.hobgoblins#hobgoblin_magic_items`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#cruel_(weapon_special_ability)`:
...
Faint necromancy; CL 5th; :ref:`Craft Magic Arms and Armor <corerulebook.feats#craft_magic_arms_and_armor>`\ , :ref:`cause fear <corerulebook.spells.causefear#cause_fear>`\ , :ref:`death knell <corerulebook.spells.deathknell#death_knell>`\ ; Price +1 bonus.

.. _`advancedraceguide.featuredraces.hobgoblins#deadly_(weapon_special_ability)`:
...
Faint necromancy; CL 5th; :ref:`Craft Magic Arms and Armor <corerulebook.feats#craft_magic_arms_and_armor>`\ , :ref:`inflict light wounds <corerulebook.spells.inflictlightwounds#inflict_light_wounds>`\ ; Price +1 bonus.

.. _`advancedraceguide.featuredraces.hobgoblins#hobgoblin_battle_standard`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#description`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#despair`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#ferocity`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#iron_resolve`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#construction`:

Construction
=============

\ **Requirements**\  :ref:`Craft Wondrous Item <corerulebook.feats#craft_wondrous_item>`\ , :ref:`crushing despair <corerulebook.spells.crushingdespair#crushing_despair>`\  (despair), :ref:`rage <corerulebook.spells.rage#rage>`\  (ferocity), :ref:`aid <corerulebook.spells.aid#aid>`\  and :ref:`bear's endurance <corerulebook.spells.bearsendurance#bear_s_endurance>`\  (iron resolve); \ **Cost**\  25,000 gp (despair), 30,000 gp (ferocity), 22,500 gp (iron resolve)

.. _`advancedraceguide.featuredraces.hobgoblins#horseshoes_of_crushing_blows`:
...
\ *Horseshoes of crushing blows*\  grant an enhancement bonus on attack and damage rolls made with hoof attacks; this bonus varies based on the item's price. Alternatively, as described for the :ref:`amulet of mighty fists <corerulebook.magicitems.wondrousitems#amulet_of_mighty_fists>`\ , they can grant melee weapon special abilities so long as they can be applied to unarmed attacks. \ *Horseshoes of crushing blows*\  cannot have a modified bonus (enhancement bonus plus special ability bonus equivalents) higher than +5. \ *Horseshoes of crushing blows*\  are crafted as sets of four, with each shoe in the set bearing the same enhancements. All four shoes must be worn by the same animal to be effective.
...
\ **Requirements**\  :ref:`Craft Magic Arms and Armor <corerulebook.feats#craft_magic_arms_and_armor>`\ , :ref:`Craft Wondrous Item <corerulebook.feats#craft_wondrous_item>`\ , creator's caster level must be at least three times the amulet's bonus, plus any requirements of the melee weapon special abilities; \ **Cost**\  2,000 gp (+1), 8,000 gp (+2), 18,000 gp (+3), 32,000 gp (+4), 50,000 gp (+5)

.. _`advancedraceguide.featuredraces.hobgoblins#shackles_of_durance_vile`:
...
These masterwork iron manacles sap the will of their wearer. When attached to a humanoid creature as their command word is spoken, they affect their prisoner with a :ref:`dominate person <corerulebook.spells.dominateperson#dominate_person>`\  spell, except that if the prisoner fails its saving throw, the effect lasts for as long as the shackles are attached. Removing or destroying the shackles immediately breaks the enchantment. The shackles can be so used once per day. \ *Shackles of durance vile*\  can only be activated against a helpless, restrained, or willing creature; if attached to a creature still able to resist they function only as manacles, albeit superior ones. \ *Shackles of durance vile*\  have hardness 15, 20 hit points, and a superior lock. They have a break DC of 30 and an :ref:`Escape Artist <corerulebook.skills.escapeartist#escape_artist>`\  DC of 35.

Construction
=============

\ **Requirements**\  :ref:`Craft Wondrous Item <corerulebook.feats#craft_wondrous_item>`\ , :ref:`dominate person <corerulebook.spells.dominateperson#dominate_person>`\ ; \ **Cost**\  8,200 gp

.. _`advancedraceguide.featuredraces.hobgoblins#wound_paste`:
...
Prized by slavers as an affordable way to stop a captive from bleeding to death, a dose of \ *wound paste*\  acts as a :ref:`stabilize <corerulebook.spells.stabilize#stabilize>`\  spell when slathered on a dying creature. Applying \ *wound paste*\  is a standard action that provokes an attack of opportunity. A pot of \ *wound paste*\  contains 5 doses.

Construction
=============

\ **Requirements**\  :ref:`Craft Wondrous Item <corerulebook.feats#craft_wondrous_item>`\ , :ref:`stabilize <corerulebook.spells.stabilize#stabilize>`\ ; \ **Cost**\  25 gp

.. _`advancedraceguide.featuredraces.hobgoblins#hobgoblin_spells`:
...
.. _`advancedraceguide.featuredraces.hobgoblins#agonizing_rebuke`:
