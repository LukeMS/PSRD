...
.. _`bestiary2.forlarren`:

.. contents:: \ 

.. _`bestiary2.forlarren#forlarren`:
...
\ **Spell-Like Abilities**\  (CL 4th; concentration +3)
 ...
 3/day—:ref:`heat metal <corerulebook.spells.heatmetal#heat_metal>`\  (DC 11)

.. _`bestiary2.forlarren#statistics`:
...
\ **Feats**\  :ref:`Skill Focus <corerulebook.feats#skill_focus>`\  (:ref:`Perception <corerulebook.skills.perception#perception>`\ ), :ref:`Weapon Finesse <corerulebook.feats#weapon_finesse>`

\ **Skills**\  :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  +9, :ref:`Perception <corerulebook.skills.perception#perception>`\  +11, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +9

\ **Languages**\  Common, Sylvan

.. _`bestiary2.forlarren#ecology`:
...
.. _`bestiary2.forlarren#special_abilities`:
...
The majority of forlarrens inherit little in the way of the magical abilities possessed by their fey mothers, but they do gain a small measure of the powers of their fiendish fathers. In most cases, this manifests as the ability to use :ref:`heat metal <corerulebook.spells.heatmetal#heat_metal>`\  three times per day, but some forlarren instead gain a different spell-like ability chosen from the following list: :ref:`chill metal <corerulebook.spells.chillmetal#chill_metal>`\ , :ref:`flame blade <corerulebook.spells.flameblade#flame_blade>`\ , :ref:`flaming sphere <corerulebook.spells.flamingsphere#flaming_sphere>`\ , :ref:`gust of wind <corerulebook.spells.gustofwind#gust_of_wind>`\ , :ref:`summon swarm <corerulebook.spells.summonswarm#summon_swarm>`\ , or :ref:`warp wood <corerulebook.spells.warpwood#warp_wood>`\ .
