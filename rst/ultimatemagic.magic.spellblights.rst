...
.. _`ultimatemagic.magic.spellblights`:

.. contents:: \ 

.. _`ultimatemagic.magic.spellblights#spellblights`:
...
.. _`ultimatemagic.magic.spellblights#gaining_spellblights`:

Gaining Spellblights
*********************

There are many ways a spellcaster can become afflicted with a spellblight. These conditions can be gained by way of a :ref:`bestow curse <corerulebook.spells.bestowcurse#bestow_curse>`\  or :ref:`major curse <ultimatemagic.spells.curse#curse_major>`\  spell, as well as spontaneously with a number of unusual circumstances, many of which are detailed below. 

.. _`ultimatemagic.magic.spellblights#areas_of_spellblight`:
...
.. _`ultimatemagic.magic.spellblights#curses_and_other_spells`:

\ **Curses and Other Spells**\ : All spellblights can be inflicted upon spellcasters with a :ref:`bestow curse <corerulebook.spells.bestowcurse#bestow_curse>`\  or :ref:`major curse <ultimatemagic.spells.curse#curse_major>`\  spell. :ref:`Bestow curse <corerulebook.spells.bestowcurse#bestow_curse>`\  can bestow any minor spellblight, while a :ref:`major curse <ultimatemagic.spells.curse#curse_major>`\  is required to afflict a spellcaster with a major spellblight. Other spells may inflict a specific spellblight or may allow the caster to select any spellblight as part of the spell. A successful saving throw against the spell prevents the spellblight from taking hold.

.. _`ultimatemagic.magic.spellblights#optional_ways_to_acquire_spellblights`:
...
.. _`ultimatemagic.magic.spellblights#antimagic_field`:

\ **Antimagic Field**\ : The first time a spellcaster attempts to cast a spell within an :ref:`antimagic field <corerulebook.spells.antimagicfield#antimagic_field>`\ , there is a chance she will spontaneously gain a major spellblight. The caster must succeed at a Will saving throw (DC 15 + the caster level of the :ref:`antimagic field <corerulebook.spells.antimagicfield#antimagic_field>`\  or DC 23 if there is no caster level for the effect).

.. _`ultimatemagic.magic.spellblights#arcane_spell_failure`:
...
.. _`ultimatemagic.magic.spellblights#crafting_magic_items`:
...
.. _`ultimatemagic.magic.spellblights#use_magic_device`:

\ **Use Magic Device**\ : When a spellcaster rolls a natural 1 while attempting to use a magic device with the :ref:`Use Magic Device <corerulebook.skills.usemagicdevice#use_magic_device>`\  skill, she can choose to risk gaining a minor spellblight instead of not being able to activate the item for 24 hours (Will negates DC 10 + item's caster level).

.. _`ultimatemagic.magic.spellblights#removing_spellblights`:

Removing Spellblights
**********************

While the most severe symptoms of a spellblight may manifest only episodically, the condition is often tenacious and difficult to remove. Each spellblight lists conditions for its removal, and can also be removed as if it were a curse (with :ref:`remove curse <corerulebook.spells.removecurse#remove_curse>`\ , :ref:`break enchantment <corerulebook.spells.breakenchantment#break_enchantment>`\ , and so on). The caster level check DC to remove a minor spellblights is 20; the DC to remove a major spellblight is 30. The DC to remove the spellblight is reduced by 1 with each day that passes (minimum DC 10). Using anything other than a curse-removing spell to remove a spellblight imposes a –5 penalty on the caster level check. Any spellblight can be removed automatically, without a caster level check, with :ref:`mage's disjunction <corerulebook.spells.magesdisjunction#mage_s_disjunction>`\ , :ref:`miracle <corerulebook.spells.miracle#miracle>`\ , or :ref:`wish <corerulebook.spells.wish#wish>`\ .
...
.. list-table:: Table: Random Minor Spellblights
   :header-rows: 1
...
.. list-table:: Table: Random Major Spellblights
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
   ...
   * - 9
     - Vertigo
   * - 10
     - Roll twice on the minor spellblight chart. The spellcaster is afflicted with both spellblights.

.. _`ultimatemagic.magic.spellblights#description_of_spellblights`:
...
.. _`ultimatemagic.magic.spellblights#minor_spellblights`:
...
.. _`ultimatemagic.magic.spellblights#caster_blank`:
...
.. _`ultimatemagic.magic.spellblights#caster_croak`:
...
A :ref:`heal <corerulebook.spells.heal#heal>`\  spell or similar effect cures this spellblight, as does casting the :ref:`shout <corerulebook.spells.shout#shout>`\  spell, though doing so is still affected by the spellblight's effects.

.. _`ultimatemagic.magic.spellblights#confounded_casting`:
...
.. _`ultimatemagic.magic.spellblights#disassociation`:
...
.. _`ultimatemagic.magic.spellblights#ebon_eyes`:
...
.. _`ultimatemagic.magic.spellblights#eldritch_ague`:
...
While a curse, eldritch ague acts much like a disease, and creatures with immunity to disease are also immune to eldritch ague. :ref:`Remove disease <corerulebook.spells.removedisease#remove_disease>`\  cures eldritch ague; unlike with most spellblights, using this spell to remove the spellblight does not impose a –5 caster level check penalty.

.. _`ultimatemagic.magic.spellblights#hemoculysis`:

\ **Hemoculysis**\ : A spellcaster with hemoculysis bleeds from her eyes whenever she casts a spell. The volume and duration of this flow depends on the level of the spell, lasting 1 round per level of the spell. While bleeding from the eyes, the spellcaster is considered dazzled and takes 1 point of bleed damage. Casting additional spells while the eyes are already bleeding resets the duration of existing hemoculysis by the spell level, provided it's greater than the current duration. The sight of the spellcaster's eyes bleeding is horrifying, and she gains a +2 circumstance bonus on :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  checks and a –4 penalty on :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  and :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  checks for the duration of the bleeding.

Hemoculysis can be cured by :ref:`heal <corerulebook.spells.heal#heal>`\  or :ref:`regenerate <corerulebook.spells.regenerate#regenerate>`\ .

.. _`ultimatemagic.magic.spellblights#lassitude`:
...
.. _`ultimatemagic.magic.spellblights#spell_addiction`:
...
.. _`ultimatemagic.magic.spellblights#major_spellblights`:
...
.. _`ultimatemagic.magic.spellblights#eldritch_cataracts`:

\ **Eldritch Cataracts**\ : Each time a spellcaster with this spellblight casts a spell, her vision becomes fuzzier and fuzzier until eventually she is blinded. Each time the spellcaster casts a spell, she must succeed at a Fortitude save with a DC equal to 15 + the spell's level. If she fails, she takes a –1 penalty on vision-based :ref:`Perception <corerulebook.skills.perception#perception>`\  checks until the spellblight is removed. Further failed saving throws increase the penalty by 1 until the character reaches a –4 penalty, at which point she becomes blinded instead. 
...
.. _`ultimatemagic.magic.spellblights#negated`:
...
.. _`ultimatemagic.magic.spellblights#restoration`:

:ref:`Restoration <corerulebook.spells.restoration#restoration>`\  suppresses the negated spellblight for one day.

.. _`ultimatemagic.magic.spellblights#obsessive_fixation`:
...
.. _`ultimatemagic.magic.spellblights#spell_sap`:
...
.. _`ultimatemagic.magic.spellblights#transference_block`:
...
Transference block can be cured by spending 1 hour in an :ref:`antimagic field <corerulebook.spells.antimagicfield#antimagic_field>`\ . 

.. _`ultimatemagic.magic.spellblights#vertigo`:

\ **Vertigo**\ : A spellcaster with vertigo becomes dizzy and lightheaded when she casts a spell. Each time she casts a spell or uses a spell-like ability, the world spins and shifts around her. She must succeed at a concentration check (with a DC equal to the 15 + twice the level of the spell being cast). If the spellcaster fails the check, she falls prone, and for 1d4 rounds takes a penalty on :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\ , :ref:`Climb <corerulebook.skills.climb#climb>`\ , :ref:`Ride <corerulebook.skills.ride#ride>`\ , :ref:`Stealth <corerulebook.skills.stealth#stealth>`\ , and :ref:`Swim <corerulebook.skills.swim#swim>`\  checks equal to 1 + the level of the spell. While the afflicted spellcaster takes those penalties,  she must also succeed at a DC 10 :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  check in order to stand up from prone. 

A :ref:`restoration <corerulebook.spells.restoration#restoration>`\  cast on the afflicted spellcaster suppresses this spellblight for 1 day.

.. _`ultimatemagic.magic.spellblights#optional:_benefits_of_harmful_conditions`:
...
.. _`ultimatemagic.magic.spellblights#bleed`:
...
.. _`ultimatemagic.magic.spellblights#blinded`:
...
.. _`ultimatemagic.magic.spellblights#confused`:

\ **Confused**\ : While confused (either temporarily, or permanently by way of an :ref:`insanity <corerulebook.spells.insanity#insanity>`\  spell or effect), a spellcaster can tap into that confusion during periods of lucidity. When a confused spellcaster can act normally, the DCs of her spells that give confusion or insanity effects are increased by 1. The caster also gains a +2 competence bonus on caster level checks made to bypass spell resistance with those spells. 

.. _`ultimatemagic.magic.spellblights#entangled`:
...
.. _`ultimatemagic.magic.spellblights#dazzled`:
...
.. _`ultimatemagic.magic.spellblights#deafened`:
...
.. _`ultimatemagic.magic.spellblights#disabled`:
...
.. _`ultimatemagic.magic.spellblights#grappled`:
...
.. _`ultimatemagic.magic.spellblights#nauseated`:
...
.. _`ultimatemagic.magic.spellblights#poisoned_or_sickened`:
...
.. _`ultimatemagic.magic.spellblights#shaken`:
...
.. _`ultimatemagic.magic.spellblights#staggered`:
