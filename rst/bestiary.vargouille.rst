...
.. _`bestiary.vargouille`:

.. contents:: \ 

.. _`bestiary.vargouille#vargouille`:
...
NE Small :ref:`outsider <bestiary.creaturetypes#outsider>`\  (:ref:`evil <bestiary.creaturetypes#evil_subtype>`\ , :ref:`extraplanar <bestiary.creaturetypes#extraplanar_subtype>`\ )

\ **Init**\  +1; \ **Senses**\  darkvision 60 ft.; :ref:`Perception <corerulebook.skills.perception#perception>`\  +7

.. _`bestiary.vargouille#defense`:
...
\ **Melee**\  bite +5 (1d4 plus :ref:`poison <bestiary.universalmonsterrules#poison>`\ )

\ **Special Attacks**\  kiss, :ref:`poison <bestiary.universalmonsterrules#poison>`\ , shriek

.. _`bestiary.vargouille#statistics`:
...
\ **Skills**\  :ref:`Fly <corerulebook.skills.fly#fly>`\  +13, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +5, :ref:`Perception <corerulebook.skills.perception#perception>`\  +7, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +8

\ **Languages**\  Infernal

.. _`bestiary.vargouille#ecology`:
...
.. _`bestiary.vargouille#special_abilities`:

Special Abilities
==================

\ **Kiss (Su)**\  A vargouille can kiss a helpless target by making a successful melee touch attack (this provokes attacks of opportunity). A kissed opponent must succeed on a DC 16 Fortitude save or begin a terrible transformation that changes the creature into a vargouille within 24 hours (and often much sooner; roll 1d6 separately for each phase of the transformation). First, over a period of 1d6 hours, all the victim's hair falls out. Within another 1d6 hours thereafter, the ears grow into leathery wings, tentacles sprout on the chin and scalp, and the teeth become long, pointed fangs. During the next 1d6 hours, the victim takes Intelligence :ref:`drain <bestiary.universalmonsterrules#ability_damage_and_drain>`\  and Charisma :ref:`drain <bestiary.universalmonsterrules#ability_damage_and_drain>`\  equal to 1 point per hour (to a minimum of 3). The transformation is complete 1d6 hours thereafter, when the victim's head breaks free of the body (which promptly dies) and becomes a vargouille. This transformation's progress is paused by sunlight or any light spell of 3rd level or higher, but stopping the transformation requires :ref:`remove disease <corerulebook.spells.removedisease#remove_disease>`\  or a similar effect. The transformation is a disease effect. The save DC is Constitution-based and includes a +4 racial bonus.
