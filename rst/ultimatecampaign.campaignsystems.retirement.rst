...
.. _`ultimatecampaign.campaignsystems.retirement`:

.. contents:: \ 

.. _`ultimatecampaign.campaignsystems.retirement#retirement`:
...
.. _`ultimatecampaign.campaignsystems.retirement#the_simple_life`:
...
.. _`ultimatecampaign.campaignsystems.retirement#relationship_to_the_pcs`:
...
Your retired PC isn't automatically best friends with your new character and shouldn't be the source of free gold, magic items, or spellcasting (but see the Lineage section for information about handling inheritance from earlier PCs). You should think of your retired PC as an allied NPC—to keep things fair, you need to make :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  checks to gain significant favors, and the GM is the final arbiter of how much assistance your old PC is willing to offer based on the needs of the campaign.

.. _`ultimatecampaign.campaignsystems.retirement#taking_a_different_path`:
...
.. _`ultimatecampaign.campaignsystems.retirement#betrayal`:
