...
.. _`corerulebook.magicitems.potions`:

.. contents:: \ 

.. _`corerulebook.magicitems.potions#potions`:

Potions
########

.. _`corerulebook.magicitems.potions#table_15_12_potions`:

.. list-table:: Table: Potions
   :header-rows: 1
...
\ **Physical Description**\ : A typical potion or oil consists of 1 ounce of liquid held in a ceramic or glass vial fitted with a tight stopper. The stoppered container is usually no more than 1 inch wide and 2 inches high. The vial has :ref:`AC <corerulebook.combat#armor_class>`\  13, 1 hit point, hardness 1, and a break DC of 12. 
...
A creature must be able to swallow a potion or smear on an oil. Because of this, :ref:`incorporeal <corerulebook.glossary#incorporeal>`\  creatures cannot use potions or oils. Any corporeal creature can imbibe a potion or use an oil.

A character can carefully administer a potion to an :ref:`unconscious <corerulebook.glossary#unconscious>`\  creature as a full-round action, trickling the liquid down the creature's throat. Likewise, it takes a full-round action to apply an oil to an :ref:`unconscious <corerulebook.glossary#unconscious>`\  creature.
