...
.. _`corerulebook.environment`:

.. contents:: \ 

.. _`corerulebook.environment#dungeons`:
...
.. _`corerulebook.environment#types_of_dungeons`:
...
.. _`corerulebook.environment#dungeon_terrain`:
...
.. _`corerulebook.environment#walls`:
...
.. _`corerulebook.environment#table_13_1_walls`:

.. list-table:: Table: Walls
   :header-rows: 1
...
.. _`corerulebook.environment#doors`:
...
.. _`corerulebook.environment#table_13_2_doors`:

.. list-table:: Table: Doors
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`corerulebook.environment#locks`:
...
.. _`corerulebook.environment#secret_doors`:
...
.. _`corerulebook.environment#portcullises`:
...
.. _`corerulebook.environment#walls_doors_and_detect_spells`:
...
.. _`corerulebook.environment#stairs`:
...
Characters in the bury zone of a cave-in take 8d6 points of damage, or half that amount if they make a DC 15 :ref:`Reflex <corerulebook.combat#reflex>`\  save. They are subsequently buried. Characters in the slide zone take 3d6 points of damage, or no damage at all if they make a DC 15 :ref:`Reflex <corerulebook.combat#reflex>`\  save. Characters in the slide zone who fail their saves are buried.

Characters take 1d6 points of nonlethal damage per minute while buried. If such a character falls :ref:`unconscious <corerulebook.glossary#unconscious>`\ , he must make a DC 15 :ref:`Constitution <corerulebook.gettingstarted#constitution>`\  check each minute. If it fails, he takes 1d6 points of lethal damage each minute until freed or dead.

Characters who aren't buried can dig out their friends. In 1 minute, using only her hands, a character can clear rocks and debris equal to five times her heavy load limit. The amount of loose stone that fills a 5-foot-by-5-foot area weighs 1 ton (2,000 pounds). Armed with an appropriate tool, such as a pick, crowbar, or shovel, a digger can clear loose stone twice as quickly as by hand. A buried character can attempt to free himself with a DC 25 Strength check.

.. _`corerulebook.environment#slimes_molds_and_fungi`:
...
.. _`corerulebook.environment#brown_mold`:
...
.. _`corerulebook.environment#green_slime`:
...
.. _`corerulebook.environment#shrieker`:
...
.. _`corerulebook.environment#yellow_mold`:

\ **Yellow Mold (CR 6)**\ : If disturbed, a 5-foot square of this mold bursts forth with a cloud of poisonous spores. All within 10 feet of the mold must make a DC 15 :ref:`Fortitude <corerulebook.combat#fortitude>`\  save or take 1d3 points of :ref:`Constitution <corerulebook.gettingstarted#constitution>`\  damage. Another DC 15 :ref:`Fortitude <corerulebook.combat#fortitude>`\  save is required once per round for the next 5 rounds, to avoid taking 1d3 points of :ref:`Constitution <corerulebook.gettingstarted#constitution>`\  damage each round. A successful :ref:`Fortitude <corerulebook.combat#fortitude>`\  save ends this effect. Fire destroys yellow mold, and sunlight renders it dormant.

.. _`corerulebook.environment#traps`:
...
.. _`corerulebook.environment#elements_of_a_trap`:
...
.. _`corerulebook.environment#type`:
...
Magic traps are further divided into spell traps and magic device traps. Magic device traps initiate spell effects when activated, just as wands, rods, rings, and other magic items do. Creating a magic device trap requires the :ref:`Craft Wondrous Item <corerulebook.feats#craft_wondrous_item>`\  feat.
...
.. _`corerulebook.environment#perception_and_disable_device_dcs`:
...
.. _`corerulebook.environment#trigger`:
...
.. _`corerulebook.environment#duration`:
...
.. _`corerulebook.environment#reset`:
...
.. _`corerulebook.environment#bypass`: `corerulebook.environment#bypass_(optional_element)`_

.. _`corerulebook.environment#bypass_(optional_element)`:
...
.. _`corerulebook.environment#effect`:
...
\ **Pits**\ : These are holes (covered or not) that characters can fall into, causing them to take damage. A pit needs no attack roll, but a successful :ref:`Reflex <corerulebook.combat#reflex>`\  save (DC set by the builder) avoids it. Other save-dependent mechanical traps also fall into this category. Falling into a pit deals 1d6 points of damage per 10 feet of depth.
...
Pit traps often have something nastier than just a hard floor at the bottom. A trap designer might put spikes, monsters, or a pool of acid, lava, or even water at the bottom. For rules on pit spikes and other such add-ons, see the :ref:`Miscellaneous Trap Features <corerulebook.environment#miscellaneous_trap_features>`\  section.
...
.. _`corerulebook.environment#miscellaneous_trap_features`:
...
.. _`corerulebook.environment#sample_traps`:
...
.. _`corerulebook.environment#arrow_trap`: `corerulebook.environment#arrow_trap_cr_1`_

.. _`corerulebook.environment#arrow_trap_cr_1`:
...
.. _`corerulebook.environment#effects`:
...
.. _`corerulebook.environment#pit_trap`: `corerulebook.environment#pit_trap_cr_1`_

.. _`corerulebook.environment#pit_trap_cr_1`:
...
\ **Effect**\ 20-ft.-deep pit (2d6 falling damage); DC 20 :ref:`Reflex <corerulebook.combat#reflex>`\  avoids; multiple targets (all targets in a 10-ft.-square area)

.. _`corerulebook.environment#poisoned_dart_trap`: `corerulebook.environment#poisoned_dart_trap_cr_1`_

.. _`corerulebook.environment#poisoned_dart_trap_cr_1`:
...
.. _`corerulebook.environment#swinging_axe_trap`: `corerulebook.environment#swinging_axe_trap_cr_1`_

.. _`corerulebook.environment#swinging_axe_trap_cr_1`:
...
.. _`corerulebook.environment#burning_hands_trap`: `corerulebook.environment#burning_hands_trap_cr_2`_

.. _`corerulebook.environment#burning_hands_trap_cr_2`:
...
\ **Effect**\ spell effect (\ *burning hands,*\ 2d4 fire damage, DC 11 :ref:`Reflex <corerulebook.combat#reflex>`\  save for half damage); multiple targets (all targets in a 15-ft. cone)

.. _`corerulebook.environment#javelin_trap`: `corerulebook.environment#javelin_trap_cr_2`_

.. _`corerulebook.environment#javelin_trap_cr_2`:
...
.. _`corerulebook.environment#spiked_pit_trap`: `corerulebook.environment#spiked_pit_trap_cr_2`_

.. _`corerulebook.environment#spiked_pit_trap_cr_2`:
...
\ **Effect**\ 10-ft.-deep pit (1d6 falling damage); pit spikes (Atk +10 melee, 1d4 spikes per target for 1d4+2 damage each); DC 20 :ref:`Reflex <corerulebook.combat#reflex>`\  avoids; multiple targets (all targets in a 10-ft.-square area)

.. _`corerulebook.environment#acid_arrow_trap`: `corerulebook.environment#acid_arrow_trap_cr_3`_

.. _`corerulebook.environment#acid_arrow_trap_cr_3`:
...
.. _`corerulebook.environment#camouflaged_pit_trap`: `corerulebook.environment#camouflaged_pit_trap_cr_3`_

.. _`corerulebook.environment#camouflaged_pit_trap_cr_3`:
...
\ **Effect**\ 30-ft.-deep pit (3d6 falling damage); DC 20 :ref:`Reflex <corerulebook.combat#reflex>`\  avoids; multiple targets (all targets in a 10-ft.-square area)

.. _`corerulebook.environment#electricity_arc_trap`: `corerulebook.environment#electricity_arc_trap_cr_4`_

.. _`corerulebook.environment#electricity_arc_trap_cr_4`:
...
\ **Effect**\ electricity arc (4d6 electricity damage, DC 20 :ref:`Reflex <corerulebook.combat#reflex>`\  save for half damage); multiple targets (all targets in a 30-ft. line)

.. _`corerulebook.environment#wall_scythe_trap`: `corerulebook.environment#wall_scythe_trap_cr_4`_

.. _`corerulebook.environment#wall_scythe_trap_cr_4`:
...
.. _`corerulebook.environment#falling_block_trap`: `corerulebook.environment#falling_block_trap_cr_5`_

.. _`corerulebook.environment#falling_block_trap_cr_5`:
...
.. _`corerulebook.environment#fireball_trap`: `corerulebook.environment#fireball_trap_cr_5`_

.. _`corerulebook.environment#fireball_trap_cr_5`:
...
\ **Effect**\ spell effect (\ *fireball,*\ 6d6 fire damage, DC 14 :ref:`Reflex <corerulebook.combat#reflex>`\  save for half damage); multiple targets (all targets in a 20-ft.-radius burst)

.. _`corerulebook.environment#flame_strike_trap`: `corerulebook.environment#flame_strike_trap_cr_6`_

.. _`corerulebook.environment#flame_strike_trap_cr_6`:
...
\ **Effect**\ spell effect (\ *flame strike,*\ 8d6 fire damage, DC 17 :ref:`Reflex <corerulebook.combat#reflex>`\  save for half damage); multiple targets (all targets in a 10-ft.-radius cylinder)

.. _`corerulebook.environment#wyvern_arrow_trap`: `corerulebook.environment#wyvern_arrow_trap_cr_6`_

.. _`corerulebook.environment#wyvern_arrow_trap_cr_6`:
...
.. _`corerulebook.environment#frost_fangs_trap`: `corerulebook.environment#frost_fangs_trap_cr_7`_

.. _`corerulebook.environment#frost_fangs_trap_cr_7`:
...
\ **Effect**\ jets of freezing water (3d6 cold damage, DC 20 :ref:`Reflex <corerulebook.combat#reflex>`\  save for half damage); multiple targets (all targets in a 40-ft.-square chamber)

.. _`corerulebook.environment#summon_monster_vi_trap`: `corerulebook.environment#summon_monster_vi_trap_cr_7`_

.. _`corerulebook.environment#summon_monster_vi_trap_cr_7`:
...
.. _`corerulebook.environment#camouflaged_spiked_pit_trap`: `corerulebook.environment#camouflaged_spiked_pit_trap_cr_8`_

.. _`corerulebook.environment#camouflaged_spiked_pit_trap_cr_8`:
...
\ **Effect**\ 50-ft.-deep pit (5d6 falling damage); pit spikes (Atk +15 melee, 1d4 spikes per target for 1d6+5 damage each); DC 20 :ref:`Reflex <corerulebook.combat#reflex>`\  avoids; multiple targets (all targets in a 10-ft.-square area)

.. _`corerulebook.environment#insanity_mist_trap`: `corerulebook.environment#insanity_mist_trap_cr_8`_

.. _`corerulebook.environment#insanity_mist_trap_cr_8`:
...
.. _`corerulebook.environment#hail_of_arrows_trap`: `corerulebook.environment#hail_of_arrows_trap_cr_9`_

.. _`corerulebook.environment#hail_of_arrows_trap_cr_9`:
...
.. _`corerulebook.environment#shocking_floor_trap`: `corerulebook.environment#shocking_floor_trap_cr_9`_

.. _`corerulebook.environment#shocking_floor_trap_cr_9`:
...
.. _`corerulebook.environment#energy_drain_trap`: `corerulebook.environment#energy_drain_trap_cr_10`_

.. _`corerulebook.environment#energy_drain_trap_cr_10`:
...
\ **Effect**\ spell effect (\ *energy drain,*\ Atk +10 ranged touch, 2d4 temporary negative levels\ *,*\ DC 23 :ref:`Fortitude <corerulebook.combat#fortitude>`\  negates after 24 hours)

.. _`corerulebook.environment#chamber_of_blades_trap`: `corerulebook.environment#chamber_of_blades_trap_cr_10`_

.. _`corerulebook.environment#chamber_of_blades_trap_cr_10`:
...
.. _`corerulebook.environment#cone_of_cold_trap`: `corerulebook.environment#cone_of_cold_trap_cr_11`_

.. _`corerulebook.environment#cone_of_cold_trap_cr_11`:
...
\ **Effect**\ spell effect (\ *cone of cold,*\ 15d6 cold damage, DC 17 :ref:`Reflex <corerulebook.combat#reflex>`\  save for half damage); multiple targets (all targets in a 60-ft. cone)

.. _`corerulebook.environment#poisoned_pit_trap`: `corerulebook.environment#poisoned_pit_trap_cr_12`_

.. _`corerulebook.environment#poisoned_pit_trap_cr_12`:
...
\ **Effect**\ 50-ft.-deep pit (5d6 falling damage); pit spikes (Atk +15 melee, 1d4 spikes per target for 1d6+5 damage each plus poison [shadow essence]); DC 25 :ref:`Reflex <corerulebook.combat#reflex>`\  avoids; multiple targets (all targets in a 10-ft.-square area)

.. _`corerulebook.environment#maximized_fireball_trap`: `corerulebook.environment#maximized_fireball_trap_cr_13`_

.. _`corerulebook.environment#maximized_fireball_trap_cr_13`:
...
\ **Effect**\ spell effect (\ *fireball,*\ 60 fire damage, DC 14 :ref:`Reflex <corerulebook.combat#reflex>`\  save for half damage); multiple targets (all targets in a 20-ft.-radius burst)

.. _`corerulebook.environment#harm_trap`: `corerulebook.environment#harm_trap_cr_14`_

.. _`corerulebook.environment#harm_trap_cr_14`:
...
\ **Effect**\ spell effect (\ *harm,*\ +6 melee touch, 130 damage, DC 19 :ref:`Will <corerulebook.combat#will>`\  save for half, cannot be reduced to less than 1 hit point)

.. _`corerulebook.environment#crushing_stone_trap`: `corerulebook.environment#crushing_stone_trap_cr_15`_

.. _`corerulebook.environment#crushing_stone_trap_cr_15`:
...
.. _`corerulebook.environment#empowered_disintegrate_trap`: `corerulebook.environment#empowered_disintegrate_trap_cr_16`_

.. _`corerulebook.environment#empowered_disintegrate_trap_cr_16`:
...
\ **Effect**\ spell effect (empowered \ *disintegrate,*\ +9 ranged touch, 30d6 damage plus 50%, DC 19 :ref:`Fort <corerulebook.combat#fortitude>`\  save reduces the damage to 5d6 plus 50%)

.. _`corerulebook.environment#lightning_bolt_gallery_trap`: `corerulebook.environment#lightning_bolt_gallery_trap_cr_17`_

.. _`corerulebook.environment#lightning_bolt_gallery_trap_cr_17`:
...
\ **Effect**\ spell effect (heightened \ *lightning bolt,*\ 8d6 electricity damage, DC 16 :ref:`Reflex <corerulebook.combat#reflex>`\  save for half); multiple targets (all targets in a 60-ft.-square chamber)

.. _`corerulebook.environment#deadly_spear_trap`: `corerulebook.environment#deadly_spear_trap_cr_18`_

.. _`corerulebook.environment#deadly_spear_trap_cr_18`:
...
.. _`corerulebook.environment#meteor_swarm_trap`: `corerulebook.environment#meteor_swarm_trap_cr_19`_

.. _`corerulebook.environment#meteor_swarm_trap_cr_19`:
...
\ **Effect**\ spell effect (meteor swarm\ *,*\ 4 meteors at separate targets, +9 ranged touch, 2d6 plus 6d6 fire [–4 save on a hit], DC 23 :ref:`Reflex <corerulebook.combat#reflex>`\  save for half fire damage, 18d6 fire damage from other meteors, DC 23 :ref:`Reflex <corerulebook.combat#reflex>`\  save for half damage); multiple targets (four targets, no two of which can be more than 40 ft. apart)

.. _`corerulebook.environment#destruction_trap`: `corerulebook.environment#destruction_trap_cr_20`_

.. _`corerulebook.environment#destruction_trap_cr_20`:
...
\ **Effect**\ spell effect (heightened \ *destruction,*\ 190 damage, DC 23 :ref:`Fortitude <corerulebook.combat#fortitude>`\  save reduces damage to 10d6)

.. _`corerulebook.environment#designing_a_trap`:
...
.. _`corerulebook.environment#table_13_3_cr_modifiers_for_mechanical_traps`:

.. list-table:: Table: CR Modifiers for Mechanical Traps
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
   ...
   * - Damage/Effect
     - 
   * - Average damage
     - +1 per 10 points of average damage
...
.. _`corerulebook.environment#table_13_4_cr_modifiers_for_magic_traps`:

.. list-table:: Table: CR Modifiers for Magic Traps
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
   ...
   * - Feature
     - CR Modifier
   * - Highest-level spell effect
     - + Spell level 
   * - Damaging spell effect
     - +1 per 10 points of  average damage

.. _`corerulebook.environment#table_13_5_cost_modifiers_for_magic_device_traps`:

.. list-table:: Table: Cost Modifiers for Magic Device Traps
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. list-table:: Table: Craft (Traps) DCs
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
\ **Magic Traps**\ : As with mechanical traps, decide what elements you want and then determine the CR of the resulting trap (see CR Modifiers for Magic Traps). If a player character wants to design and construct a magic trap, he, or an ally, must have the :ref:`Craft Wondrous Item <corerulebook.feats#craft_wondrous_item>`\  feat. In addition, he must be able to cast the spell or spells that the trap requires—or he must be able to hire an NPC to cast the spells for him.

.. _`corerulebook.environment#challenge_rating_of_a_trap`:
...
.. _`corerulebook.environment#mechanical_trap_cost`:
...
.. _`corerulebook.environment#magic_device_trap_cost`:
...
.. _`corerulebook.environment#craft_dcs_for_mechanical_traps`:
...
.. _`corerulebook.environment#wilderness`:
...
.. _`corerulebook.environment#getting_lost`:
...
.. _`corerulebook.environment#forest_terrain`:
...
.. list-table:: Table: Category of Forest
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`corerulebook.environment#trees`:

\ **Trees**\ : The most important terrain element in a forest is the trees, obviously. A creature standing in the same square as a tree gains partial cover, which grants a +2 bonus to :ref:`Armor Class <corerulebook.combat#armor_class>`\  and a +1 bonus on :ref:`Reflex <corerulebook.combat#reflex>`\  saves. The presence of a tree doesn't otherwise affect a creature's fighting space, because it's assumed that the creature is using the tree to its advantage when it can. The trunk of a typical tree has :ref:`AC <corerulebook.combat#armor_class>`\  4, hardness 5, and 150 hp. A DC 15 Climb check is sufficient to climb a tree. Medium and dense forests have massive trees as well. These trees take up an entire square and provide cover to anyone behind them. They have :ref:`AC <corerulebook.combat#armor_class>`\  3, hardness 5, and 600 hp. Like their smaller counterparts, it takes a DC 15 Climb check to climb them.

.. _`corerulebook.environment#undergrowth`:
...
.. _`corerulebook.environment#forest_canopy`:
...
.. _`corerulebook.environment#forest_fires`: `corerulebook.environment#forest_fires_(cr_6)`_

.. _`corerulebook.environment#forest_fires_(cr_6)`:
...
.. list-table:: Table: Marsh Category
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`corerulebook.environment#bogs`:
...
The water in a deep bog provides cover for Medium or larger creatures. Smaller creatures gain improved cover (+8 bonus to :ref:`AC <corerulebook.combat#armor_class>`\ , +4 bonus on :ref:`Reflex <corerulebook.combat#reflex>`\  saves). Medium or larger creatures can crouch as a move action to gain this improved cover. Creatures with this improved cover take a –10 penalty on attacks against creatures that aren't underwater.
...
.. _`corerulebook.environment#quicksand`:
...
\ *Effects of Quicksand*\ : Characters in quicksand must make a DC 10 Swim check every round to simply tread water in place, or a DC 15 Swim check to move 5 feet in whatever direction is desired. If a trapped character fails this check by 5 or more, he sinks below the surface and begins to drown whenever he can no longer hold his breath (see the Swim skill description in :ref:`Using Skills <corerulebook.usingskills>`\ )\ *.*
...
.. _`corerulebook.environment#hedgerows`:
...
.. _`corerulebook.environment#hills_terrain`:
...
.. list-table:: Table: Hills Category
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`corerulebook.environment#slopes`:
...
.. _`corerulebook.environment#mountain_terrain`:
...
.. list-table:: Table: Mountain Category
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`corerulebook.environment#cliff`:
...
.. _`corerulebook.environment#chasm`:
...
.. _`corerulebook.environment#scree`:
...
.. _`corerulebook.environment#dense_rubble`:
...
.. _`corerulebook.environment#rock_wall`:
...
.. _`corerulebook.environment#avalanches`: `corerulebook.environment#avalanches_(cr_7)`_

.. _`corerulebook.environment#avalanches_(cr_7)`:
...
.. _`corerulebook.environment#mountain_travel`:
...
.. _`corerulebook.environment#altitude_zones`:
...
.. list-table:: Table: Desert Category
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`corerulebook.environment#ice_sheet`:
...
.. _`corerulebook.environment#sand_dunes`:
...
.. _`corerulebook.environment#sandstorms`:
...
.. _`corerulebook.environment#plains_terrain`:
...
.. list-table:: Table: Plains Category
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`corerulebook.environment#trench`:
...
.. _`corerulebook.environment#berm`:
...
.. _`corerulebook.environment#fences`:
...
.. _`corerulebook.environment#aquatic_terrain_103`: `corerulebook.environment#aquatic_terrain`_

.. _`corerulebook.environment#aquatic_terrain`:
...
\ *Invisibility*\ : An :ref:`invisible <corerulebook.glossary#invisible>`\  creature displaces water and leaves a visible, body-shaped "bubble" where the water was displaced. The creature still has concealment (20% miss chance), but not total concealment (50% miss chance).

.. _`corerulebook.environment#underwater_combat`:
...
.. _`corerulebook.environment#table_13_7_combat_adjustments_underwater`:

.. list-table:: Table: Combat Adjustments Underwater
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto

   * - Condition
     - Attack/Dmg. Slashing or Bludgeoning
     - Attack/Dmg. Piercing
     - Movement
     - Off Balance?\ :sup:`1`
   * - \ *Freedom of movement*
...
\ **Attacks from Land**\ : Characters swimming, floating, or treading water on the surface, or wading in water at least chest deep, have improved cover (+8 bonus to :ref:`AC <corerulebook.combat#armor_class>`\ , +4 bonus on :ref:`Reflex <corerulebook.combat#reflex>`\  saves) from opponents on land. Land-bound opponents who have \ *freedom of movement*\ effects ignore this cover when making melee attacks against targets in the water. A completely submerged creature has total cover against opponents on land unless those opponents have \ *freedom of movement*\ effects. Magical effects are unaffected except for those that require attack rolls (which are treated like any other effects) and fire effects.
...
.. _`corerulebook.environment#urban_adventures`:
...
.. _`corerulebook.environment#weapon_and_spell_restrictions`:
...
.. _`corerulebook.environment#urban_features`:
...
.. _`corerulebook.environment#walls_and_gates`:

Walls and Gates
================

Many cities are surrounded by walls. A typical small city wall is a fortified stone wall 5 feet thick and 20 feet high. Such a wall is fairly smooth, requiring a DC 30 Climb check to scale. The walls are crenellated on one side to provide a low wall for the guards atop it, and there is just barely room for guards to walk along the top of the wall. A typical small city wall has :ref:`AC <corerulebook.combat#armor_class>`\  3, hardness 8, and 450 hp per 10-foot section.

A typical large city wall is 10 feet thick and 30 feet high, with crenellations on both sides for the guards on top of the wall. It is likewise smooth, requiring a DC 30 Climb check to scale. Such a wall has :ref:`AC <corerulebook.combat#armor_class>`\  3, hardness 8, and 720 hp per 10-foot section.

A typical metropolis wall is 15 feet thick and 40 feet tall. It has crenellations on both sides and often has a tunnel and small rooms running through its interior. Metropolis walls have :ref:`AC <corerulebook.combat#armor_class>`\  3, hardness 8, and 1,170 hp per 10-foot section.
...
.. _`corerulebook.environment#watchtowers`:
...
.. _`corerulebook.environment#guards_and_soldiers`:
...
.. _`corerulebook.environment#siege_engines`:
...
.. _`corerulebook.environment#table_13_8_siege_engines`:

.. list-table:: Table: Siege Engines
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. list-table:: Catapult Attack Modifiers
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`corerulebook.environment#catapult`:
...
.. _`corerulebook.environment#ballista`:
...
.. _`corerulebook.environment#ram`:

\ **Ram**\ : This heavy pole is sometimes suspended from a movable scaffold that allows the crew to swing it back and forth against objects. As a full-round action, the character closest to the front of the ram makes an attack roll against the :ref:`AC <corerulebook.combat#armor_class>`\  of the construction, applying the –4 penalty for lack of proficiency. It's not possible to be proficient with this device. In addition to the damage given on Table: Siege Engines, up to nine other characters holding the ram can add their Strength modifiers to the ram's damage, if they devote an attack action to doing so. It takes at least one Huge or larger creature, two Large creatures, four Medium creatures, or eight Small creatures to swing a ram.
...
.. _`corerulebook.environment#siege_tower`:
...
.. _`corerulebook.environment#city_streets`:
...
.. _`corerulebook.environment#above_and_beneath_the_streets`:

Above and Beneath the Streets
==============================

.. _`corerulebook.environment#rooftops`:

\ **Rooftops**\ : Getting to a roof usually requires climbing a :ref:`wall <corerulebook.environment#walls_and_gates>`\ , unless the character can reach a roof by jumping down from a higher window, balcony, or bridge. Flat roofs, common only in warm climates (as accumulated snow can cause a flat roof to collapse), are easy to run across. Moving along the peak of a pitched roof requires a DC 20 Acrobatics check. Moving on an angled roof surface without changing altitude (moving parallel to the peak, in other words) requires a DC 15 Acrobatics check. Moving up and down across the peak of a roof requires a DC 10 Acrobatics check.
...
.. _`corerulebook.environment#sewers`:
...
.. _`corerulebook.environment#city_buildings`:
...
.. _`corerulebook.environment#weather`:
...
.. _`corerulebook.environment#table_13_9_random_weather`:

.. list-table:: Table: Random Weather
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
   ...
   * - d%
     - Weather
     - Cold Climate
     - Temperate Climate\ :sup:`1`
     - Desert
   * - 01–70
     - Normal weather
     - Cold, calm
     - Normal for season\ :sup:`2`
     - Hot, calm
   * - 71–80
     - Abnormal weather
...
\ **Hot**\ : Between 85Â° and 110Â° Fahrenheit during the day, 10 to 20 degrees colder at night.

\ **Moderate**\ : Between 40Â° and 60Â° Fahrenheit during the day, 10 to 20 degrees colder at night.
...
\ **Warm**\ : Between 60Â° and 85Â° Fahrenheit during the day, 10 to 20 degrees colder at night.

\ **Windy**\ : Wind speeds are moderate to strong (10 to 30 mph); see Table: Wind Effects.

.. _`corerulebook.environment#rain_snow_sleet_and_hail`:
...
Most precipitation is rain, but in cold conditions it can manifest as snow, sleet, or hail. Precipitation of any kind followed by a cold snap in which the temperature dips from above freezing to 30Â° F or below might produce ice. 
...
.. _`corerulebook.environment#snow`:
...
.. _`corerulebook.environment#storms`:
...
.. _`corerulebook.environment#thunderstorm`:
...
.. _`corerulebook.environment#fog`:
...
.. _`corerulebook.environment#winds`:
...
.. _`corerulebook.environment#table_13_10_wind_effects`:

.. list-table:: Table: Wind Effects
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
   ...
   * - Wind Force
     - Wind Speed
     - Ranged Attacks Normal/Siege Weapons\ :sup:`1`
     - Checked Size\ :sup:`2`
     - Blown Away Size\ :sup:`3`
     - Fly Penalty
   * - Light
     - 0–10 mph
     - —/—
...
.. _`corerulebook.environment#material_plane`:
...
.. _`corerulebook.environment#astral_plane`:
...
.. _`corerulebook.environment#ethereal_plane`:
...
.. _`corerulebook.environment#shadow_plane`:
...
.. _`corerulebook.environment#elemental_planes`:
...
.. _`corerulebook.environment#energy_planes`:
...
.. _`corerulebook.environment#outer_planes`:
...
.. _`corerulebook.environment#layered_planes`:
...
.. _`corerulebook.environment#how_planes_interact`:
...
.. _`corerulebook.environment#environmental_rules`:

Environmental Rules
####################

Environmental hazards specific to one kind of terrain are described in the :ref:`Wilderness <corerulebook.environment#wilderness>`\  section. Environmental hazards common to more than one setting are detailed below.

.. _`corerulebook.environment#acid_effects`:
...
The fumes from most acids are inhaled poisons. Those who are adjacent to a large body of acid must make a DC 13 :ref:`Fortitude <corerulebook.combat#fortitude>`\  save or take 1 point of :ref:`Constitution <corerulebook.gettingstarted#constitution>`\  damage each round. This poison does not have a frequency, a creature is safe as soon as it moves away from the acid.

Creatures immune to acid's caustic properties might still drown in it if they are totally immersed (see Drowning).

.. _`corerulebook.environment#cold_dangers`:
...
An unprotected character in cold weather (below 40Â° F) must make a :ref:`Fortitude <corerulebook.combat#fortitude>`\  save each hour (DC 15, +1 per previous check) or take 1d6 points of nonlethal damage. A character who has the Survival skill may receive a bonus on this saving throw and might be able to apply this bonus to other characters as well (see the skill description).

In conditions of severe cold or exposure (below 0Â° F), an unprotected character must make a :ref:`Fortitude <corerulebook.combat#fortitude>`\  save once every 10 minutes (DC 15, +1 per previous check), taking 1d6 points of nonlethal damage on each failed save. A character who has the Survival skill may receive a bonus on this saving throw and might be able to apply this bonus to other characters as well. Characters wearing a cold weather outfit only need check once per hour for cold and exposure damage.

A character who takes any nonlethal damage from cold or exposure is beset by frostbite or hypothermia (treat her as :ref:`fatigued <corerulebook.glossary#fatigued>`\ ). These penalties end when the character recovers the nonlethal damage she took from the cold and exposure.

Extreme cold (below –20Â° F) deals 1d6 points of lethal damage per minute (no save). In addition, a character must make a :ref:`Fortitude <corerulebook.combat#fortitude>`\  save (DC 15, +1 per previous check) or take 1d4 points of nonlethal damage.

.. _`corerulebook.environment#ice_effects`:
...
.. _`corerulebook.environment#darkness`:
...
Blind creatures must make a DC 10 Acrobatics skill check to move faster than half speed. Creatures that fail this check fall :ref:`prone <corerulebook.glossary#prone>`\ . Blinded creatures can't run or charge.
...
A blinded creature loses its :ref:`Dexterity <corerulebook.gettingstarted#dexterity>`\  modifier to :ref:`AC <corerulebook.combat#armor_class>`\  (if positive) and takes a –2 penalty to :ref:`AC <corerulebook.combat#armor_class>`\ .

A blinded creature takes a –4 penalty on Perception checks and most Strength- and :ref:`Dexterity <corerulebook.gettingstarted#dexterity>`\ -based skill checks, including any with an armor check penalty. A creature blinded by darkness automatically fails any skill check relying on vision.
...
.. _`corerulebook.environment#falling`:

Falling
********

Creatures that fall take 1d6 points of damage per 10 feet fallen, to a maximum of 20d6. Creatures that take lethal damage from a fall land in a :ref:`prone <corerulebook.glossary#prone>`\  position.
...
.. _`corerulebook.environment#falling_into_water`:
...
.. _`corerulebook.environment#falling_objects`:

Falling Objects
****************
 

.. _`corerulebook.environment#table_13_11_damage_from_falling_objects`:

.. list-table:: Table: Damage from Falling Objects
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
Dropping an object on a creature requires a ranged touch attack. Such attacks generally have a range increment of 20 feet. If an object falls on a creature (instead of being thrown), that creature can make a DC 15 :ref:`Reflex <corerulebook.combat#reflex>`\  save to halve the damage if he is aware of the object. Falling objects that are part of a trap use the trap rules instead of these general guidelines.

.. _`corerulebook.environment#heat_dangers`:
...
A character in very hot conditions (above 90Â° F) must make a :ref:`Fortitude <corerulebook.combat#fortitude>`\  saving throw each hour (DC 15, +1 for each previous check) or take 1d4 points of nonlethal damage. Characters wearing heavy clothing or armor of any sort take a –4 penalty on their saves. A character with the Survival skill may receive a bonus on this saving throw and might be able to apply this bonus to other characters as well (see the skill description). Characters reduced to unconsciousness begin taking lethal damage (1d4 points per hour).

In severe heat (above 110Â° F), a character must make a :ref:`Fortitude <corerulebook.combat#fortitude>`\  save once every 10 minutes (DC 15, +1 for each previous check) or take 1d4 points of nonlethal damage. Characters wearing heavy clothing or armor of any sort take a –4 penalty on their saves. A character with the Survival skill may receive a bonus on this saving throw and might be able to apply this bonus to other characters as well (see the Survival skill in :ref:`Using Skills <corerulebook.usingskills>`\ ). Characters reduced to unconsciousness begin taking lethal damage (1d4 points per each 10-minute period).

A character who takes any nonlethal damage from heat exposure now suffers from heatstroke and is :ref:`fatigued <corerulebook.glossary#fatigued>`\ . These penalties end when the character recovers from the nonlethal damage she took from the heat.

Extreme heat (air temperature over 140Â° F, fire, boiling water, lava) deals lethal damage. Breathing air in these temperatures deals 1d6 points of fire damage per minute (no save). In addition, a character must make a :ref:`Fortitude <corerulebook.combat#fortitude>`\  save every 5 minutes (DC 15, +1 per previous check) or take 1d4 points of nonlethal damage. Those wearing heavy clothing or any sort of armor take a –4 penalty on their saves.

Boiling water deals 1d6 points of scalding damage, unless the character is fully immersed, in which case it deals 10d6 points of damage per round of exposure.

.. _`corerulebook.environment#catching_on_fire`:
...
Characters at risk of catching fire are allowed a DC 15 :ref:`Reflex <corerulebook.combat#reflex>`\  save to avoid this fate. If a character's clothes or hair catch fire, he takes 1d6 points of damage immediately. In each subsequent round, the burning character must make another :ref:`Reflex <corerulebook.combat#reflex>`\  saving throw. Failure means he takes another 1d6 points of damage that round. Success means that the fire has gone out—that is, once he succeeds on his saving throw, he's no longer on fire.

A character on fire may automatically extinguish the flames by jumping into enough water to douse himself. If no body of water is at hand, rolling on the ground or smothering the fire with cloaks or the like permits the character another save with a +4 bonus.

Those whose clothes or equipment catch fire must make DC 15 :ref:`Reflex <corerulebook.combat#reflex>`\  saves for each item. Flammable items that fail take the same amount of damage as the character.

.. _`corerulebook.environment#lava_effects`:
...
.. _`corerulebook.environment#smoke_effects`:
...
.. _`corerulebook.environment#starvation_and_thirst`:
...
A character can go without water for 1 day plus a number of hours equal to his :ref:`Constitution <corerulebook.gettingstarted#constitution>`\  score. After this time, the character must make a :ref:`Constitution <corerulebook.gettingstarted#constitution>`\  check each hour (DC 10, +1 for each previous check) or take 1d6 points of nonlethal damage. Characters that take an amount of nonlethal damage equal to their total hit points begin to take lethal damage instead.

A character can go without food for 3 days, in growing discomfort. After this time, the character must make a :ref:`Constitution <corerulebook.gettingstarted#constitution>`\  check each day (DC 10, +1 for each previous check) or take 1d6 points of nonlethal damage. Characters that take an amount of nonlethal damage equal to their total hit points begin to take lethal damage instead.

Characters who have taken nonlethal damage from lack of food or water are :ref:`fatigued <corerulebook.glossary#fatigued>`\ . Nonlethal damage from thirst or starvation cannot be recovered until the character gets food or water, as needed—not even magic that restores hit points heals this damage.

.. _`corerulebook.environment#suffocation`:

Suffocation
************

A character who has no air to breathe can hold her breath for 2 rounds per point of :ref:`Constitution <corerulebook.gettingstarted#constitution>`\ . If a character takes a standard or full-round action, the remaining duration that the character can hold her breath is reduced by 1 round. After this period of time, the character must make a DC 10 :ref:`Constitution <corerulebook.gettingstarted#constitution>`\  check in order to continue holding her breath. The check must be repeated each round, with the DC increasing by +1 for each previous success.

When the character fails one of these :ref:`Constitution <corerulebook.gettingstarted#constitution>`\  checks, she begins to suffocate. In the first round, she falls :ref:`unconscious <corerulebook.glossary#unconscious>`\  (0 hit points). In the following round, she drops to –1 hit points and is :ref:`dying <corerulebook.glossary#dying>`\ . In the third round, she suffocates.

\ **Slow Suffocation**\ : A Medium character can breathe easily for 6 hours in a sealed chamber measuring 10 feet on a side. After that time, the character takes 1d6 points of nonlethal damage every 15 minutes. Each additional Medium character or significant fire source (a torch, for example) proportionally reduces the time the air will last. Once rendered :ref:`unconscious <corerulebook.glossary#unconscious>`\  through the accumulation of nonlethal damage, the character begins to take lethal damage at the same rate. Small characters consume half as much air as Medium characters.

.. _`corerulebook.environment#water_dangers`:
...
Very deep water is not only generally pitch black, posing a navigational hazard, but worse, deals water pressure damage of 1d6 points per minute for every 100 feet the character is below the surface. A successful :ref:`Fortitude <corerulebook.combat#fortitude>`\  save (DC 15, +1 for each previous check) means the diver takes no damage in that minute. Very cold water deals 1d6 points of nonlethal damage from hypothermia per minute of exposure.

.. _`corerulebook.environment#drowning`:

Drowning
=========

Any character can hold her breath for a number of rounds equal to twice her :ref:`Constitution <corerulebook.gettingstarted#constitution>`\  score. If a character takes a standard or full-round action, the remaining duration that the character can hold her breath is reduced by 1 round. After this period of time, the character must make a DC 10 :ref:`Constitution <corerulebook.gettingstarted#constitution>`\  check every round in order to continue holding her breath. Each round, the DC increases by 1. 

When the character finally fails her :ref:`Constitution <corerulebook.gettingstarted#constitution>`\  check, she begins to drown. In the first round, she falls :ref:`unconscious <corerulebook.glossary#unconscious>`\  (0 hp). In the following round, she drops to –1 hit points and is :ref:`dying <corerulebook.glossary#dying>`\ . In the third round, she drowns.

:ref:`Unconscious <corerulebook.glossary#unconscious>`\  characters must begin making :ref:`Constitution <corerulebook.gettingstarted#constitution>`\  checks immediately upon being submerged (or upon becoming :ref:`unconscious <corerulebook.glossary#unconscious>`\  if the character was conscious when submerged). Once she fails one of these checks, she immediately drops to –1 (or loses 1 additional hit point, if her total is below –1). On the following round, she drowns.
