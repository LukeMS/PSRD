...
.. _`ultimatecombat.classarchetypes`:

.. contents:: \ 

.. _`ultimatecombat.classarchetypes#class_archetypes`:
...
:ref:`Alchemist <ultimatecombat.classarchetypes.alchemist>`\ : This section presents new discoveries, as well as the beastmorph and ragechemist archetypes.

.. _`ultimatecombat.classarchetypes#barbarian`:

:ref:`Barbarian <ultimatecombat.classarchetypes.barbarian>`\ : This section includes new rage powers, as well as the armored hulk, scarred rager, sea reaver, titan mauler, true primitive, urban barbarian, and wild rager.

.. _`ultimatecombat.classarchetypes#bard`:

:ref:`Bard <ultimatecombat.classarchetypes.bard>`\ : This section includes the archaeologist, daredevil, and dervish dancer.

.. _`ultimatecombat.classarchetypes#cavalier`:

:ref:`Cavalier <ultimatecombat.classarchetypes.cavalier>`\ : This section includes new cavalier orders, plus the beast rider, emissary, gendarme, honor guard, luring cavalier, musketeer, standard bearer, and strategist.

.. _`ultimatecombat.classarchetypes#cleric`:

:ref:`Cleric <ultimatecombat.classarchetypes.cleric>`\ : This section includes the crusader, divine strategist, evangelist, and merciful healer.

.. _`ultimatecombat.classarchetypes#druid`:

:ref:`Druid <ultimatecombat.classarchetypes.druid>`\ : This section includes the ape shaman, bat shaman, and boar shaman, as well as the world walker.

.. _`ultimatecombat.classarchetypes#fighter`:

:ref:`Fighter <ultimatecombat.classarchetypes.fighter>`\ : This section includes expanded weapon groups, plus the armor master, brawler, cad, dragoon, gladiator, tactician, thunderstriker, tower shield specialist, unarmed fighter, and unbreakable.

.. _`ultimatecombat.classarchetypes#gunslinger`:

:ref:`Gunslinger <ultimatecombat.classarchetypes.gunslinger>`\ : This section includes the gun tank, musket master, mysterious stranger, and pistolero.

.. _`ultimatecombat.classarchetypes#inquisitor`:

:ref:`Inquisitor <ultimatecombat.classarchetypes.inquisitor>`\ : This section includes new inquisitions, plus the iconoclast, spellbreaker, and witch hunter.

.. _`ultimatecombat.classarchetypes#magus`:

:ref:`Magus <ultimatecombat.classarchetypes.magus>`\ : This section includes new magus arcana, plus the kensai, myrmidarch, skirnir, and soul forger. 

.. _`ultimatecombat.classarchetypes#monk`:

:ref:`Monk <ultimatecombat.classarchetypes.monk>`\ : This section includes the flowing monk, maneuver master, martial artist, master of many styles, sensei, sohei, and tetori. 

.. _`ultimatecombat.classarchetypes#paladin`:

:ref:`Paladin <ultimatecombat.classarchetypes.paladin>`\ : This section includes the divine hunter, empyreal knight, holy gun, holy tactician, knight of the sepulcher, and sacred shield.

.. _`ultimatecombat.classarchetypes#ranger`:

:ref:`Ranger <ultimatecombat.classarchetypes.ranger>`\ : This section includes the battle scout, deep walker, falconer, trophy hunter, warden, and wild stalker.

.. _`ultimatecombat.classarchetypes#rogue`:

:ref:`Rogue <ultimatecombat.classarchetypes.rogue>`\ : This section includes new rogue talents, plus the bandit, chameleon, charlatan, driver, knife master, pirate, roof runner, sanctified rogue, and survivalist.

.. _`ultimatecombat.classarchetypes#wizard`:

:ref:`Wizard <ultimatecombat.classarchetypes.wizard>`\ : This section includes the arcane bomber, siege mage, and spellslinger.

.. _`ultimatecombat.classarchetypes#using_archetypes`:
...
.. _`ultimatecombat.classarchetypes#adapting_existing_characters`:
