...
.. _`bestiary2.slimemold`:

.. contents:: \ 

.. _`bestiary2.slimemold#slime_mold`:
...
N Large :ref:`ooze <bestiary.creaturetypes#ooze>`\  

\ **Init**\  –1; \ **Senses**\  :ref:`Perception <corerulebook.skills.perception#perception>`\  –5

.. _`bestiary2.slimemold#defense`:
...
\ **Immune**\  :ref:`ooze <bestiary.creaturetypes#ooze>`\  traits; \ **Resist**\  :ref:`fire <bestiary.creaturetypes#fire_subtype>`\  10

.. _`bestiary2.slimemold#offense`:
...
\ **Melee**\  slam +4 (1d6+4 plus :ref:`disease <bestiary.universalmonsterrules#disease_(ex_or_su)>`\ )

\ **Space**\  10 ft.; \ **Reach**\  10 ft.

\ **Special Attacks**\  :ref:`engulf <bestiary.universalmonsterrules#engulf>`\  (DC 14, 1d6+4 bludgeoning plus :ref:`disease <bestiary.universalmonsterrules#disease_(ex_or_su)>`\ )

.. _`bestiary2.slimemold#statistics`:
...
.. _`bestiary2.slimemold#special_abilities`:

Special Abilities
==================

:ref:`Disease <bestiary.universalmonsterrules#disease_(ex_or_su)>`\  (Ex) \ *Fungal rot*\ : Slam—contact; \ *save*\  Fortitude DC 16; \ *onset*\  1 day; frequency 1/day; \ *effect*\  1d2 Str damage and 1 Con damage and fatigue; \ *cure*\  1 save. Any creature that touches a slime mold with an unarmed strike or a natural attack is also exposed to this foul :ref:`disease <bestiary.universalmonsterrules#disease_(ex_or_su)>`\ . The save DC is Constitution-based.
