...
.. _`corerulebook.spells.sepiasnakesigil`:

.. contents:: \ 

.. _`corerulebook.spells.sepiasnakesigil#sepia_snake_sigil`:
...
While trapped in the amber field of force, the subject does not age, breathe, grow hungry, sleep, or regain spells. It is preserved in a state of suspended animation, unaware of its surroundings. It can be damaged by outside forces (and perhaps even killed), since the field provides no protection against physical injury. However, a :ref:`dying <corerulebook.glossary#dying>`\  subject does not lose hit points or become :ref:`stable <corerulebook.glossary#stable>`\  until the spell ends.

The hidden sigil cannot be detected by normal observation, and :ref:`detect magic <corerulebook.spells.detectmagic#detect_magic>`\  reveals only that the entire text is magical.

A :ref:`dispel magic <corerulebook.spells.dispelmagic#dispel_magic>`\  can remove the sigil. An \ *erase*\ spell destroys the entire page of text.

\ *Sepia snake sigil*\ can be cast in combination with other spells that hide or garble text, such as :ref:`secret page <corerulebook.spells.secretpage#secret_page>`\ .
