...
\ **Init**\  +2; \ **Senses**\  darkvision 60 ft., detect evil, detect good, low-light vision, :ref:`scent <bestiary.universalmonsterrules#scent>`\ ; :ref:`Perception <corerulebook.skills.perception#perception>`\  +11

.. _`bestiary.pegasus#defense`:
...
\ **Spell-Like Abilities**\ (CL 4th)
 ...
 Constant—:ref:`detect evil <corerulebook.spells.detectevil#detect_evil>`\  (60-ft. radius), :ref:`detect good <corerulebook.spells.detectgood#detect_good>`\  (60-ft. radius)

.. _`bestiary.pegasus#statistics`:
...
\ **Feats**\  :ref:`Flyby Attack <bestiary.monsterfeats#flyby_attack>`\ , :ref:`Iron Will <corerulebook.feats#iron_will>`

\ **Skills**\  :ref:`Fly <corerulebook.skills.fly#fly>`\  +5, :ref:`Perception <corerulebook.skills.perception#perception>`\  +11, :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  +7; \ **Racial Modifiers**\ +4 :ref:`Perception <corerulebook.skills.perception#perception>`

\ **Languages**\  Common (cannot speak)

.. _`bestiary.pegasus#ecology`:
