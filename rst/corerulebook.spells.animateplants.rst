...
.. _`corerulebook.spells.animateplants`:

.. contents:: \ 

.. _`corerulebook.spells.animateplants#animate_plants`:
...
\ *Entangle*\ : Alternatively, you may imbue all plants within range with a degree of mobility, which allows them to entwine around creatures in the area. This usage of the spell duplicates the effect of an :ref:`entangle <corerulebook.spells.entangle#entangle>`\  spell. :ref:`Spell resistance <corerulebook.glossary#spell_resistance>`\  does not keep creatures from being :ref:`entangled <corerulebook.glossary#entangled>`\ . This effect lasts 1 hour per caster level.
