...
.. _`advancedplayersguide.coreclasses.fighter`:

.. contents:: \ 

.. _`advancedplayersguide.coreclasses.fighter#fighter`:
...
.. _`advancedplayersguide.coreclasses.fighter#archer`:
...
.. _`advancedplayersguide.coreclasses.fighter#hawkeye`:

\ **Hawkeye (Ex)**\ : At 2nd level, an archer gains a +1 bonus on :ref:`Perception <corerulebook.skills.perception#perception>`\  checks, and the range increment for any bow he uses increases by 5 feet. These bonuses increase by +1 and 5 additional feet for every 4 levels beyond 2nd. This ability replaces bravery.

.. _`advancedplayersguide.coreclasses.fighter#trick_shot`:
...
.. _`advancedplayersguide.coreclasses.fighter#safe_shot`:
...
.. _`advancedplayersguide.coreclasses.fighter#evasive_archer`:
...
.. _`advancedplayersguide.coreclasses.fighter#volley`:
...
.. _`advancedplayersguide.coreclasses.fighter#ranged_defense`:

\ **Ranged Defense (Ex)**\ : At 19th level, an archer gains DR 5/— against ranged attacks. In addition, as an immediate action, he can catch an arrow fired at him and shoot it any target he chooses, as if he had the :ref:`Snatch Arrows <corerulebook.feats#snatch_arrows>`\  feat. This ability replaces armor mastery.

.. _`advancedplayersguide.coreclasses.fighter#weapon_mastery`:

\ **Weapon Mastery (Ex)**\ : An archer must choose a type of bow. 

.. _`advancedplayersguide.coreclasses.fighter#crossbowman`:
...
.. _`advancedplayersguide.coreclasses.fighter#deadshot`:
...
.. _`advancedplayersguide.coreclasses.fighter#crossbow_expert`:
...
.. _`advancedplayersguide.coreclasses.fighter#improved_deadshot`:
...
.. _`advancedplayersguide.coreclasses.fighter#quick_sniper`:

\ **Quick Sniper (Ex)**\ : At 9th level, a crossbowman gains a bonus equal to 1/2 his fighter level on :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  checks when sniping. When he is hit with a ranged attack, he can shoot his crossbow at his attacker as an immediate action if it is loaded. This ability replaces weapon training 2.

.. _`advancedplayersguide.coreclasses.fighter#greater_deadshot`:
...
.. _`advancedplayersguide.coreclasses.fighter#pinpoint_targeting`:

\ **Pinpoint Targeting**\ : At 15th level, a crossbowman gains:ref:` Pinpoint Targeting <corerulebook.feats#pinpoint_targeting>`\  as a bonus feat. This ability replaces armor training 4.

.. _`advancedplayersguide.coreclasses.fighter#meteor_shot`:
...
.. _`advancedplayersguide.coreclasses.fighter#penetrating_shot`:
...
.. _`advancedplayersguide.coreclasses.fighter#free_hand_fighter`:
...
.. _`advancedplayersguide.coreclasses.fighter#deceptive_strike`:

\ **Deceptive Strike (Ex)**\ : At 2nd level, a free hand fighter gains a +1 bonus to CMB and CMD on disarm checks and on :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  checks to feint or create a diversion to hide. This bonus increases by +1 for every four levels after 2nd. This ability replaces bravery.

.. _`advancedplayersguide.coreclasses.fighter#elusive`:
...
.. _`advancedplayersguide.coreclasses.fighter#singleton`:
...
.. _`advancedplayersguide.coreclasses.fighter#timely_tip`:
...
.. _`advancedplayersguide.coreclasses.fighter#interference`:
...
.. _`advancedplayersguide.coreclasses.fighter#reversal`:
...
.. _`advancedplayersguide.coreclasses.fighter#mobile_fighter`:
...
.. _`advancedplayersguide.coreclasses.fighter#agility`:
...
.. _`advancedplayersguide.coreclasses.fighter#leaping_attack`:
...
.. _`advancedplayersguide.coreclasses.fighter#rapid_attack`:
...
.. _`advancedplayersguide.coreclasses.fighter#fleet_footed`:

\ **Fleet Footed (Ex)**\ : At 15th level, the mobile fighter's speed increases by 10 feet. He can take 10 on :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  checks even while distracted or threatened, and can take 20 on an :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  check once per day for every five fighter levels he possesses. This ability replaces armor training 4.

.. _`advancedplayersguide.coreclasses.fighter#whirlwind_blitz`:

\ **Whirlwind Blitz (Ex)**\ : At 20th level, a mobile fighter can make a full-attack action as a standard action. He may also use the :ref:`Whirlwind Attack <corerulebook.feats#whirlwind_attack>`\  feat as a standard action. This ability replaces weapon mastery.

.. _`advancedplayersguide.coreclasses.fighter#phalanx_soldier`:
...
.. _`advancedplayersguide.coreclasses.fighter#stand_firm`:
...
.. _`advancedplayersguide.coreclasses.fighter#phalanx_fighting`:
...
.. _`advancedplayersguide.coreclasses.fighter#ready_pike`:
...
.. _`advancedplayersguide.coreclasses.fighter#deft_shield`:
...
.. _`advancedplayersguide.coreclasses.fighter#shield_ally`:
...
At 13th level, he can instead provide cover (+4 cover bonus to AC, +2 bonus on Reflex saves) and evasion (as a rogue) to one adjacent ally until the beginning of his next turn. This cover does not allow :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  checks. 
...
.. _`advancedplayersguide.coreclasses.fighter#irresistible_advance`:
...
.. _`advancedplayersguide.coreclasses.fighter#shielded_fortress`:
...
.. _`advancedplayersguide.coreclasses.fighter#polearm_master`:
...
.. _`advancedplayersguide.coreclasses.fighter#pole_fighting`:
...
.. _`advancedplayersguide.coreclasses.fighter#steadfast_pike`:
...
.. _`advancedplayersguide.coreclasses.fighter#polearm_training`:
...
.. _`advancedplayersguide.coreclasses.fighter#flexible_flanker`:
...
.. _`advancedplayersguide.coreclasses.fighter#sweeping_fend`:
...
.. _`advancedplayersguide.coreclasses.fighter#step_aside`:
...
.. _`advancedplayersguide.coreclasses.fighter#polearm_parry`:
...
.. _`advancedplayersguide.coreclasses.fighter#roughrider`:
...
.. _`advancedplayersguide.coreclasses.fighter#steadfast_mount`:
...
.. _`advancedplayersguide.coreclasses.fighter#armored_charger`:

\ **Armored Charger (Ex)**\ : At 3rd level, a roughrider no longer suffers armor check penalties on :ref:`Ride <corerulebook.skills.ride#ride>`\  skill checks. His mount's speed is not reduced when carrying a medium load or wearing medium barding. This ability replaces armor training 1.

.. _`advancedplayersguide.coreclasses.fighter#mounted_mettle`:
...
.. _`advancedplayersguide.coreclasses.fighter#leap_from_the_saddle`:

\ **Leap from the Saddle (Ex)**\ : At 7th level, after a roughrider's mount takes a single move, he may attempt a fast dismount (DC 20 :ref:`Ride <corerulebook.skills.ride#ride>`\  check). If he succeeds, he can take a full attack action. This ability replaces armor training 2.

.. _`advancedplayersguide.coreclasses.fighter#relentless_steed`:

\ **Relentless Steed (Ex)**\ : At 11th level, a roughrider's mount does not reduce its speed when wearing heavy barding or carrying a heavy load. The roughrider may also reroll a :ref:`Ride <corerulebook.skills.ride#ride>`\  skill check or a saving throw made by the mount once per day, but must use the second roll even if it is worse. This ability may be used one additional time per day for every four levels beyond 11th. This ability replaces armor training 3.

.. _`advancedplayersguide.coreclasses.fighter#ride_them_down`:

:ref:`Ride <corerulebook.skills.ride#ride>`\  Them Down (Ex): At 15th level, can spur his mount on while readying an attack. If a roughrider's mount takes a single move, the roughrider can make a full attack, taking his attacks at any point during his mount's movement. If he has the :ref:`Trample <corerulebook.feats#trample>`\  feat, he may substitute an overrun combat maneuver for each of his attacks. This movement provokes attacks of opportunity against the roughrider but not his mount. This ability replaces armor training 4.

.. _`advancedplayersguide.coreclasses.fighter#unavoidable_onslaught`:
...
.. _`advancedplayersguide.coreclasses.fighter#spark_of_life`:
...
.. _`advancedplayersguide.coreclasses.fighter#natural_savagery`:
...
.. _`advancedplayersguide.coreclasses.fighter#savage_charge`:
...
.. _`advancedplayersguide.coreclasses.fighter#careful_claw`:

\ **Careful Claw (Ex)**\ : At 13th level, when using a natural weapon to attack a creature using :ref:`fire shield <corerulebook.spells.fireshield#fire_shield>`\  or a similar effect that damages creatures attacking it (such as a barbed devil's barbed defense), a savage warrior reduces the damage from such effects by an amount equal to 1/2 his fighter level. This ability replaces weapon training 3.

.. _`advancedplayersguide.coreclasses.fighter#greater_savage_charge`:
...
.. _`advancedplayersguide.coreclasses.fighter#natural_weapon_mastery`:
...
.. _`advancedplayersguide.coreclasses.fighter#shielded_fighter`:
...
.. _`advancedplayersguide.coreclasses.fighter#active_defense`:

\ **Active Defense (Ex)**\ : At 3rd level, a shielded fighter gains a +1 dodge bonus to AC when wielding a shield and fighting defensively, using :ref:`Combat Expertise <corerulebook.feats#combat_expertise>`\ , or using total defense. This bonus increases by +1 for every four levels beyond 3rd. As a swift action, he may share this bonus with one adjacent ally, or half of the bonus (minimum +0) with all adjacent allies, until the beginning of his next turn. This ability replaces armor training 1, 2, 3, and 4.

.. _`advancedplayersguide.coreclasses.fighter#shield_fighter`:
...
.. _`advancedplayersguide.coreclasses.fighter#shield_buffet`:
...
.. _`advancedplayersguide.coreclasses.fighter#shield_guard`:
...
.. _`advancedplayersguide.coreclasses.fighter#two_handed_fighter`:
...
.. _`advancedplayersguide.coreclasses.fighter#shattering_strike`:
...
.. _`advancedplayersguide.coreclasses.fighter#overhand_chop`:
...
.. _`advancedplayersguide.coreclasses.fighter#piledriver`:
...
.. _`advancedplayersguide.coreclasses.fighter#greater_power_attack`:

Greater :ref:`Power Attack <corerulebook.feats#power_attack>`\  (Ex): At 15th level, when using :ref:`Power Attack <corerulebook.feats#power_attack>`\  with a two-handed melee weapon, the bonus damage from :ref:`Power Attack <corerulebook.feats#power_attack>`\  is doubled (+100%) instead of increased by half (+50%). This ability replaces armor training 4. 

.. _`advancedplayersguide.coreclasses.fighter#devastating_blow`:
...
.. _`advancedplayersguide.coreclasses.fighter#two_weapon_warrior`:
...
.. _`advancedplayersguide.coreclasses.fighter#defensive_flurry`:
...
.. _`advancedplayersguide.coreclasses.fighter#twin_blades`:
...
.. _`advancedplayersguide.coreclasses.fighter#doublestrike`:
...
.. _`advancedplayersguide.coreclasses.fighter#improved_balance`:
...
.. _`advancedplayersguide.coreclasses.fighter#equal_opportunity`:
...
.. _`advancedplayersguide.coreclasses.fighter#perfect_balance`:
...
.. _`advancedplayersguide.coreclasses.fighter#deft_doublestrike`:
...
.. _`advancedplayersguide.coreclasses.fighter#deadly_defense`:
...
.. _`advancedplayersguide.coreclasses.fighter#weapon_master`:
...
.. _`advancedplayersguide.coreclasses.fighter#weapon_guard`:

\ **Weapon Guard (Ex)**\ : At 2nd level, a weapon master gains a +1 bonus to CMD against disarm and sunder attempts while wielding his chosen weapon. This bonus also applies on saves against any effect that targets his chosen weapon (for example, :ref:`grease <corerulebook.spells.grease#grease>`\ , :ref:`heat metal <corerulebook.spells.heatmetal#heat_metal>`\ , :ref:`shatter <corerulebook.spells.shatter#shatter>`\ , :ref:`warp wood <corerulebook.spells.warpwood#warp_wood>`\ ). The bonus increases by +1 for every four levels beyond 2nd. This ability replaces bravery.
...
.. _`advancedplayersguide.coreclasses.fighter#reliable_strike`:
...
.. _`advancedplayersguide.coreclasses.fighter#mirror_move`:
...
.. _`advancedplayersguide.coreclasses.fighter#deadly_critical`:
...
.. _`advancedplayersguide.coreclasses.fighter#critical_specialist`:
...
.. _`advancedplayersguide.coreclasses.fighter#unstoppable_strike`:
