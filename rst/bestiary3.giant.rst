...
CN Large humanoid (:ref:`giant <bestiary.creaturetypes#giant_subtype>`\ )

\ **Init**\  +2; \ **Senses**\  low-light vision; :ref:`Perception <corerulebook.skills.perception#perception>`\  +8

.. _`bestiary3.giant#defense`:
...
\ **Defensive Abilities**\  rock catching; \ **Immune**\  :ref:`disease <bestiary.universalmonsterrules#disease_(ex_or_su)>`\ , :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`

.. _`bestiary3.giant#offense`:
...
\ **Ranged**\  rock +12 (1d8+16 plus :ref:`disease <bestiary.universalmonsterrules#disease_(ex_or_su)>`\ )

\ **Space**\  10 ft.; \ **Reach**\  10 ft.

\ **Special Attacks**\  :ref:`disease <bestiary.universalmonsterrules#disease_(ex_or_su)>`\ , rock throwing (120 ft.)

.. _`bestiary3.giant#statistics`:
...
\ **Feats**\  :ref:`Catch Off-Guard <corerulebook.feats#catch_off_guard>`\ , :ref:`Cleave <corerulebook.feats#cleave>`\ , :ref:`Great Cleave <corerulebook.feats#great_cleave>`\ , :ref:`Point-Blank Shot <corerulebook.feats#point_blank_shot>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`\ , :ref:`Precise Shot <corerulebook.feats#precise_shot>`\ , :ref:`Self-Sufficient <corerulebook.feats#self_sufficient>`

\ **Skills**\  :ref:`Climb <corerulebook.skills.climb#climb>`\  +14, :ref:`Heal <corerulebook.skills.heal#heal>`\  +7, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +6, :ref:`Perception <corerulebook.skills.perception#perception>`\  +8, :ref:`Survival <corerulebook.skills.survival#survival>`\  +9

\ **Languages**\  Common, :ref:`Giant <bestiary.creaturetypes#giant_subtype>`

\ **SQ**\  oversized weapon, vermin empathy +14

.. _`bestiary3.giant#ecology`:
...
\ **Organization**\  solitary, gang (2–5), band (6–9), raid (9–12 plus 1d4 :ref:`giant <bestiary.creaturetypes#giant_subtype>`\  vermin), or tribe (13–30 plus 35% noncombatants, plus 1 barbarian or fighter chief of 6th–8th level and 6–8 :ref:`giant <bestiary.creaturetypes#giant_subtype>`\  vermin)

\ **Treasure**\  standard (hide armor, Huge club, other treasure)

.. _`bestiary3.giant#special_abilities`:

Special Abilities
==================

\ **Disease (Su)**\  While ash giants are immune to :ref:`disease <bestiary.universalmonsterrules#disease_(ex_or_su)>`\ , they carry a contagious form of leprosy. Any creature struck by an ash :ref:`giant <bestiary.creaturetypes#giant_subtype>`\ 's attacks is exposed to this virulent sickness.
...
\ **Oversized Weapon (Ex)**\  An ash :ref:`giant <bestiary.creaturetypes#giant_subtype>`\  can wield Huge weapons without penalty.

\ **Vermin Empathy (Ex)**\ This ability functions as a druid's wild empathy ability, save that it works only on vermin. An ash giant uses its Hit Dice (14 for most ash giants) as its effective druid level. Vermin are normally mindless, but this empathic communication imparts upon them a modicum of implanted intelligence, allowing the ash :ref:`giant <bestiary.creaturetypes#giant_subtype>`\  to train vermin and use them as guardians (although it does not grant them skills or feats).
...
CE Large humanoid (:ref:`giant <bestiary.creaturetypes#giant_subtype>`\ )

\ **Init**\  +0; \ **Senses**\  darkvision 120 ft., low-light vision; :ref:`Perception <corerulebook.skills.perception#perception>`\  +5
...
\ **Feats**\  :ref:`Cleave <corerulebook.feats#cleave>`\ , :ref:`Improved Sunder <corerulebook.feats#improved_sunder>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`\ , :ref:`Vital Strike <corerulebook.feats#vital_strike>`\ , :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (battleaxe)

\ **Skills**\  :ref:`Climb <corerulebook.skills.climb#climb>`\  +7, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +7, :ref:`Perception <corerulebook.skills.perception#perception>`\  +5
...
.. _`bestiary3.giant#giant_desert`:
...
.. _`bestiary3.giant#desert_giant`:
...
LN Large humanoid (:ref:`giant <bestiary.creaturetypes#giant_subtype>`\ )
...
\ **Defensive Abilities**\  rock catching; \ **Immune**\  :ref:`fire <bestiary.creaturetypes#fire_subtype>`
...
\ **Feats**\  :ref:`Combat Reflexes <corerulebook.feats#combat_reflexes>`\ , :ref:`Dodge <corerulebook.feats#dodge>`\ , :ref:`Improved Critical <corerulebook.feats#improved_critical>`\  (scimitar), :ref:`Improved Two-Weapon Fighting <corerulebook.feats#improved_two_weapon_fighting>`\ , :ref:`Mobility <corerulebook.feats#mobility>`\ , :ref:`Two-Weapon Fighting <corerulebook.feats#two_weapon_fighting>`\ , :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (scimitar)

\ **Skills**\  :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  +16 (+24 when jumping), :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +11, :ref:`Perception <corerulebook.skills.perception#perception>`\  +9, :ref:`Survival <corerulebook.skills.survival#survival>`\  +17
...
\ **Organization**\  solitary, gang (2–4), band (5–8), raiding party (9–12 plus 1 fighter of 1st–3rd level), or tribe (10–30 plus 35% noncombatants, 1–3 clerics of 2nd–4th level, 2–4 fighters of 1st–3rd level, and 1 fighter sheik of 4th–6th level, 50% chance of 10–20 :ref:`human <bestiary.creaturetypes#human_subtype>`\  slaves)
...
\ **Sandwalking (Ex)**\  A desert :ref:`giant <bestiary.creaturetypes#giant_subtype>`\  travels at full speed across sand, rocky ground, or dust, and leaves no trail behind unless it chooses to.

\ **Scimitar Training (Ex)**\  All desert giants are proficient with scimitars, and can wield them as if they were light weapons. A desert :ref:`giant <bestiary.creaturetypes#giant_subtype>`\  adds its full Strength bonus to attacks made with a scimitar wielded in its off hand, and gains a +4 bonus to CMD versus disarm and sunder attempts when fighting with a scimitar in each hand.
...
.. _`bestiary3.giant#giant_jungle`:
...
.. _`bestiary3.giant#jungle_giant`:
...
N Huge humanoid (:ref:`giant <bestiary.creaturetypes#giant_subtype>`\ )

\ **Init**\  +4; \ **Senses**\  low-light vision; :ref:`Perception <corerulebook.skills.perception#perception>`\  +15
...
\ **Defensive Abilities**\  rock catching, spell storing, warding tattoos; \ **Immune**\  :ref:`disease <bestiary.universalmonsterrules#disease_(ex_or_su)>`\ , :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`
...
\ **Feats**\  :ref:`Deadly Aim <corerulebook.feats#deadly_aim>`\ , :ref:`Improved Critical <corerulebook.feats#improved_critical>`\  (longbow), :ref:`Improved Precise Shot <corerulebook.feats#improved_precise_shot>`\ , :ref:`Point-Blank Shot <corerulebook.feats#point_blank_shot>`\ , :ref:`Precise Shot <corerulebook.feats#precise_shot>`\ , :ref:`Rapid Shot <corerulebook.feats#rapid_shot>`\ , :ref:`Skill Focus <corerulebook.feats#skill_focus>`\  (:ref:`Stealth <corerulebook.skills.stealth#stealth>`\ ), :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (longbow)

\ **Skills**\  :ref:`Climb <corerulebook.skills.climb#climb>`\  +12, :ref:`Craft <corerulebook.skills.craft#craft>`\  (bows) +8, :ref:`Perception <corerulebook.skills.perception#perception>`\  +15, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +12 (+20 in forests), :ref:`Survival <corerulebook.skills.survival#survival>`\  +10; \ **Racial Modifiers**\  +4 :ref:`Climb <corerulebook.skills.climb#climb>`\ , +8 :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  in forests
...
\ **Archery Expert (Su)**\  A jungle :ref:`giant <bestiary.creaturetypes#giant_subtype>`\  is proficient with all bows, and does not provoke an attack of opportunity when firing a bow in melee combat.

\ **Spell Storing (Su)**\  Once per day as a immediate action, a jungle :ref:`giant <bestiary.creaturetypes#giant_subtype>`\  can absorb a targeted or ranged touch spell used against it, negating the effects against it but not against any other targets. It can retain this stored power for up to 1 minute, during which time its tattoos glow with blue :ref:`fire <bestiary.creaturetypes#fire_subtype>`\ . If it damages a target with a successful hit using a melee or ranged weapon, it can cast the spell on the target as a free action, as if it were using a :ref:`spell storing <corerulebook.magicitems.weapons#spell_storing>`\  weapon. This spell uses the caster level and DC of the original caster. This discharges the stored spell.

\ **Warding Tattoos (Su)**\  A jungle :ref:`giant <bestiary.creaturetypes#giant_subtype>`\ 's magical tattoos grant it a +4 deflection bonus to Armor Class. The :ref:`giant <bestiary.creaturetypes#giant_subtype>`\  loses this bonus if it wears armor.
