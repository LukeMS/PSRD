...
.. _`advancedplayersguide.spells.evolutionsurge`:

.. contents:: \ 

.. _`advancedplayersguide.spells.evolutionsurge#evolution_surge`:
...
This spell functions as :ref:`lesser evolution surge <advancedplayersguide.spells.evolutionsurge#evolution_surge_lesser>`\ , except that you can grant any evolution whose total cost does not exceed 4 evolution points.

.. _`advancedplayersguide.spells.evolutionsurge#evolution_surge_greater`:
...
This spell functions as :ref:`lesser evolution surge <advancedplayersguide.spells.evolutionsurge#evolution_surge_lesser>`\ , except that you can grant any two evolutions whose total cost does not exceed 6 evolution points.

.. _`advancedplayersguide.spells.evolutionsurge#evolution_surge_lesser`:
