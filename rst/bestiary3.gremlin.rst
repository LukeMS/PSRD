...
**CR 1** 
XP 400
CE Tiny fey (:ref:`aquatic <bestiary.creaturetypes#aquatic_subtype>`\ )
\ **Init**\  +5; \ **Senses**\  darkvision 120 ft., low-light vision; :ref:`Perception <corerulebook.skills.perception#perception>`\  +5

.. _`bestiary3.gremlin#defense`:
...
\ **hp**\  7 (1d6+4)
\ **Fort**\  +1, \ **Ref**\  +3, \ **Will**\  +3
\ **DR**\  5/cold iron; \ **Resist**\  :ref:`cold <bestiary.creaturetypes#cold_subtype>`\  10; \ **SR**\  12
\ **Weaknesses**\  vulnerable to :ref:`fire <bestiary.creaturetypes#fire_subtype>`\  and sunlight

.. _`bestiary3.gremlin#offense`:
...
\ **Ranged**\  dart +3 (1d2–2)
\ **Special Attacks**\  congeal :ref:`water <bestiary.creaturetypes#water_subtype>`
\ **Spell-Like Abilities**\  (CL 1st; concentration +0)
 At will—:ref:`create water <corerulebook.spells.createwater#create_water>`\ , :ref:`prestidigitation <corerulebook.spells.prestidigitation#prestidigitation>`
 1/day—:ref:`sleep <corerulebook.spells.sleep#sleep>`\  (DC 10)

.. _`bestiary3.gremlin#statistics`:

Statistics
===========
\ **Str**\  7, \ **Dex**\  13, \ **Con**\  12, \ **Int**\  10, \ **Wis**\  13, \ **Cha**\  8
\ **Base Atk**\  +0; \ **CMB**\  –1; \ **CMD**\  7
\ **Feats**\  :ref:`Improved Initiative <corerulebook.feats#improved_initiative>`\ , :ref:`Toughness <corerulebook.feats#toughness>`\ \ :sup:`B`\ , :ref:`Weapon Finesse <corerulebook.feats#weapon_finesse>`\ \ :sup:`B`
\ **Skills**\  :ref:`Climb <corerulebook.skills.climb#climb>`\  +9, :ref:`Escape Artist <corerulebook.skills.escapeartist#escape_artist>`\  +5, :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  +4, :ref:`Perception <corerulebook.skills.perception#perception>`\  +5, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +13, :ref:`Swim <corerulebook.skills.swim#swim>`\  +13, :ref:`Use Magic Device <corerulebook.skills.usemagicdevice#use_magic_device>`\  +3; \ **Racial Modifiers**\  +4 :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`
\ **Languages**\  Aquan
\ **SQ**\  amphibious

.. _`bestiary3.gremlin#ecology`:
...
.. _`bestiary3.gremlin#special_abilities`:

Special Abilities
==================
Congeal :ref:`Water <bestiary.creaturetypes#water_subtype>`\  (Su) Once per day, a fuath can surround a creature in a thin layer of magically viscous :ref:`water <bestiary.creaturetypes#water_subtype>`\  as a standard action at a range of 30 feet. A target that fails a DC 10 Reflex save becomes entangled and must hold its breath or risk drowning. The target or an adjacent creature can spend a full-round action on its turn scraping off the clinging fluid, allowing a new Reflex save with a +2 bonus; otherwise, the effect lasts for 1d4 minutes. A fuath can use this ability even if there is no source of :ref:`water <bestiary.creaturetypes#water_subtype>`\  nearby. The save DC is Charisma-based and includes a +1 racial bonus.
\ **Vulnerable to Sunlight (Ex)**\  A fuath takes 1 point of Constitution damage after every hour it is exposed to sunlight. :ref:`Water <bestiary.creaturetypes#water_subtype>`\  of a depth of at least 1 foot negates this harmful effect.
