...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender`:

.. contents:: \ 

.. _`advancedplayersguide.prestigeclasses.stalwartdefender#stalwart_defender`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#role`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#alignment`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#hit_die`:

\ **Hit Die**\ : d12.

.. _`advancedplayersguide.prestigeclasses.stalwartdefender#requirements`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#base_attack_bonus`:

\ **Base Attack Bonus**\ : +7.

.. _`advancedplayersguide.prestigeclasses.stalwartdefender#feats`:

\ **Feats**\ : :ref:`Dodge <corerulebook.feats#dodge>`\ , :ref:`Endurance <corerulebook.feats#endurance>`\ , :ref:`Toughness <corerulebook.feats#toughness>`\ .

\ **Special**\ : Proficiency with light and medium armor.

.. _`advancedplayersguide.prestigeclasses.stalwartdefender#class_skills`:

Class Skills
#############

The stalwart defender's class skills are :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  (Dex), :ref:`Climb <corerulebook.skills.climb#climb>`\  (Str), :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  (Cha), :ref:`Perception <corerulebook.skills.perception#perception>`\  (Wis), and :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  (Wis).

.. _`advancedplayersguide.prestigeclasses.stalwartdefender#skill_ranks_per_level`:

\ **Skill Ranks per Level**\ : 2 + Int modifier.

.. _`advancedplayersguide.prestigeclasses.stalwartdefender#table_6_8:_stalwart_defender`:

.. list-table:: Table:  Stalwart Defender
   :header-rows: 1
   ...
   * - 1st
     ...
     - +1
     - +1
     - :ref:`Defensive stance <advancedplayersguide.prestigeclasses.stalwartdefender#defensive_stance>`
   * - 2nd
     - +2
     - +1
     - +1
     - +1
     - +1
     - :ref:`Defensive power <advancedplayersguide.prestigeclasses.stalwartdefender#defensive_powers>`
   * - 3rd
     - +3
     - +2
     - +1
     - +2
     - +1
     - :ref:`Uncanny dodge <advancedplayersguide.prestigeclasses.stalwartdefender#uncanny_doge>`
   * - 4th
     - +4
     - +2
     - +1
   ...
   * - 5th
     ...
     - +3
     - +2
     - :ref:`Damage reduction <advancedplayersguide.prestigeclasses.stalwartdefender#damage_reduction>`\  1/—
   * - 6th
     - +6
     - +3
     - +2
   ...
   * - 7th
     ...
     - +4
     - +3
     - :ref:`Damage reduction <advancedplayersguide.prestigeclasses.stalwartdefender#damage_reduction>`\  3/—, :ref:`improved uncanny dodge <advancedplayersguide.prestigeclasses.stalwartdefender#improved_uncanny_dodge>`\  
   * - 8th
     - +8
     - +4
     - +3
   ...
   * - 9th
     ...
     - +5
     - +3
     - :ref:`Mobile defense <advancedplayersguide.prestigeclasses.stalwartdefender#mobile_defense>`
   * - 10th
     - +10
     - +5
     - +3
     - +5
     - +4
     - :ref:`Damage reduction <advancedplayersguide.prestigeclasses.stalwartdefender#damage_reduction>`\  5/—, :ref:`defensive power <advancedplayersguide.prestigeclasses.stalwartdefender#defensive_powers>`\ , :ref:`last word <advancedplayersguide.prestigeclasses.stalwartdefender#last_word>`

.. _`advancedplayersguide.prestigeclasses.stalwartdefender#class_features`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#weapon_and_armor_proficiency`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#ac_bonus`:
...
A defensive stance requires a level of emotional calm, and it may not be maintained by a character in a rage (such as from the rage class feature or the :ref:`rage <corerulebook.spells.rage#rage>`\  spell).

.. _`advancedplayersguide.prestigeclasses.stalwartdefender#defensive_powers`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#bulwark`:

\ *Bulwark (Ex)*\ : The defender adds his armor check penalty as a bonus to the DC of opponents attempting to :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  him and :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  checks to pass by him without provoking an attack of opportunity for moving through spaces he threatens.

.. _`advancedplayersguide.prestigeclasses.stalwartdefender#clear_mind`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#fearless_defense`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#halting_blow`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#immobile`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#increased_damage_reduction`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#intercept`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#internal_fortitude`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#mighty_resilience`:

\ *Mighty Resilience (Ex)*\ : The stalwart defender automatically negates the additional damage of one successful critical hit or sneak attack, as well as other abilities or effects that rely on a successful critical hit or sneak attack (such as blinding from :ref:`Blinding Critical <corerulebook.feats#blinding_critical>`\  or bleed from sneak attack). The stalwart defender takes only normal damage from the attack. This power may only be used once per defensive stance. The stalwart defender must be at least 6th level to select this power.

.. _`advancedplayersguide.prestigeclasses.stalwartdefender#renewed_defense`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#roused_defense`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#uncanny_dodge`:

Uncanny :ref:`Dodge <corerulebook.feats#dodge>`\  (Ex): At 3rd level, a stalwart defender gains the ability to react to danger before his senses would normally allow him to do so. He cannot be caught flatfooted, even if the attacker is invisible. He still loses his Dexterity bonus to AC if immobilized. A stalwart defender with this ability can still lose his Dexterity bonus to AC if an opponent successfully uses the feint action against him.

If the character gains uncanny dodge from a second class, he automatically gains improved uncanny dodge (see below).

.. _`advancedplayersguide.prestigeclasses.stalwartdefender#damage_reduction`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#improved_uncanny_dodge`:

Improved Uncanny :ref:`Dodge <corerulebook.feats#dodge>`\  (Ex): At 7th level, a stalwart defender can no longer be flanked. This defense denies rogues the ability to use flank attacks to sneak attack the stalwart defender. The exception to this defense is that a rogue at least four levels higher than the stalwart defender can flank him (and thus sneak attack him).
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#mobile_defense`:
...
.. _`advancedplayersguide.prestigeclasses.stalwartdefender#last_word`:
