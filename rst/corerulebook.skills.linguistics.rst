...
.. _`corerulebook.skills.linguistics`:

.. contents:: \ 

.. _`corerulebook.skills.linguistics#linguistics`:

Linguistics
############

.. _`corerulebook.skills.linguistics#(int;_trained_only)`:
...
\ **Check**\ : You can decipher writing in an unfamiliar language or a message written in an incomplete or archaic form. The base DC is 20 for the simplest messages, 25 for standard texts, and 30 or higher for intricate, exotic, or very old writing. If the check succeeds, you understand the general content of a piece of writing about one page long (or the equivalent). If the check fails, make a DC 5 :ref:`Wisdom <corerulebook.gettingstarted#wisdom>`\  check to see if you avoid drawing a false conclusion about the text. (Success means that you do not draw a false conclusion; failure means that you do.)

Both the Linguistics check and (if necessary) the :ref:`Wisdom <corerulebook.gettingstarted#wisdom>`\  check are made secretly by the GM, so that you can't tell whether the conclusion you draw is true or false.
...
.. _`corerulebook.skills.linguistics#create_or_detect_forgeries`:
...
.. _`corerulebook.skills.linguistics#learn_a_language`:
...
*  Common (humans and the core races from :ref:`Races <corerulebook.races>`\ )
