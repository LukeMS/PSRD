...
.. _`corerulebook.spells.chaoshammer`:

.. contents:: \ 

.. _`corerulebook.spells.chaoshammer#chaos_hammer`:
...
The spell deals 1d8 points of damage per two caster levels (maximum 5d8) to lawful creatures (or 1d6 points of damage per caster level, maximum 10d6, to lawful outsiders) and slows them for 1d6 rounds (see the :ref:`slow <corerulebook.spells.slow#slow>`\  spell). A successful :ref:`Will <corerulebook.combat#will>`\  save reduces the damage by half and negates the :ref:`slow <corerulebook.spells.slow#slow>`\  effect.

The spell deals only half damage against creatures who are neither lawful nor chaotic, and they are not slowed. Such a creature can reduce the damage by half again (down to one-quarter) with a successful :ref:`Will <corerulebook.combat#will>`\  save.
