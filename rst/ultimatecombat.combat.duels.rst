...
.. _`ultimatecombat.combat.duels`:

.. contents:: \ 

.. _`ultimatecombat.combat.duels#duels`:
...
.. _`ultimatecombat.combat.duels#starting_a_duel`:
...
.. _`ultimatecombat.combat.duels#duel_combat`:
...
At the start of the duel, each participant makes an initiative check, just like in standard combat. Because duels are always planned and expected, there is never a surprise round. Alternatively, some duels start off with each side facing off, waiting for the other to flinch or break resolve. In such cases, substitute a :ref:`Bluff <corerulebook.skills.bluff#bluff>`\ , :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\ , or :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  check in place of the standard initiative check. The skill used is decided by the individual participants and is reflective of their approach to the duel.
...
.. _`ultimatecombat.combat.duels#dueling_counter`:
...
When a dueling opponent tries to cast a spell, the targeted spellcaster can make a :ref:`Spellcraft <corerulebook.skills.spellcraft#spellcraft>`\  check (DC 15 + the spell's level) as a free action. If the check succeeds, she can identify her opponent's spell and can attempt a dueling counter. If it fails, she cannot attempt a dueling counter against that spell (although special actions are still available to her).
...
Alternatively, a spellcaster can use :ref:`dispel magic <corerulebook.spells.dispelmagic#dispel_magic>`\  or :ref:`greater dispel magic <corerulebook.spells.dispelmagic#dispel_magic_greater>`\  as a dueling counter. When a duelist spellcaster does so, he does not need to identify the spell being cast, can counter a spell of any level, and must succeed at a caster level check against a DC of 11 + the spell's caster level. When :ref:`dispel magic <corerulebook.spells.dispelmagic#dispel_magic>`\  is used as a dueling counter, it is not modified by any of the circumstances in the table below.

Because readying a counterspell is its own action, a dueling spellcaster can prepare to counterspell and make a dueling counter in the same round. This is only useful if the participant is facing multiple opponents, or someone with access to the :ref:`Quicken Spell <corerulebook.feats#quicken_spell>`\  feat or other abilities that allow casting two spells in the same round.

.. _`ultimatecombat.combat.duels#table_dueling_counter_modifiers`:

.. list-table:: Table: Dueling Counter Modifiers
   :header-rows: 1
...
.. _`ultimatecombat.combat.duels#dueling_dodge`:
...
.. _`ultimatecombat.combat.duels#dueling_parry`:
...
.. _`ultimatecombat.combat.duels#dueling_resolve`:
...
.. _`ultimatecombat.combat.duels#duels_and_performance_combat`:
...
.. _`ultimatecombat.combat.duels#duel_results`:
