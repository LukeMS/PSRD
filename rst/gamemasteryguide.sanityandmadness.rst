...
.. _`gamemasteryguide.sanityandmadness`:

.. contents:: \ 

.. _`gamemasteryguide.sanityandmadness#sanity_and_madness`:
...
.. _`gamemasteryguide.sanityandmadness#going_insane`:
...
Insanity can also be inflicted via magic. Consider allowing the spell :ref:`insanity <corerulebook.spells.insanity#insanity>`\  to merely inflict 1 randomly determined insanity per 5 caster levels on its victim rather than causing permanent confusion. :ref:`Bestow curse <corerulebook.spells.bestowcurse#bestow_curse>`\  can also inflict a single insanity on a foe, although in this case the insanity is also a curse.
...
.. _`gamemasteryguide.sanityandmadness#curing_insanity`:
...
.. _`gamemasteryguide.sanityandmadness#lesser_restoration`:

:ref:`Lesser restoration <corerulebook.spells.restoration#restoration_lesser>`\  has no effect on insanity, but :ref:`restoration <corerulebook.spells.restoration#restoration>`\  reduces the current DC of one insanity currently affecting a target by an amount equal to the caster's level. :ref:`Greater restoration <corerulebook.spells.restoration#restoration_greater>`\ , :ref:`heal <corerulebook.spells.heal#heal>`\ , :ref:`limited wish <corerulebook.spells.limitedwish#limited_wish>`\ , :ref:`miracle <corerulebook.spells.miracle#miracle>`\ , or :ref:`wish <corerulebook.spells.wish#wish>`\  immediately cures a target of all insanity.

.. _`gamemasteryguide.sanityandmadness#types_of_insanity`:
...
.. _`gamemasteryguide.sanityandmadness#amnesia`:

Amnesia
========

.. _`gamemasteryguide.sanityandmadness#type`:

\ **Type**\  insanity; \ **Save**\  Will DC 20

.. _`gamemasteryguide.sanityandmadness#onset`:

\ **Onset**\  immediate

.. _`gamemasteryguide.sanityandmadness#effect`:

\ **Effect**\  –4 penalty on Will saving throws and all skill checks; loss of memory (see below)

.. _`gamemasteryguide.sanityandmadness#description`:
...
.. _`gamemasteryguide.sanityandmadness#mania/phobia`:
...
.. _`gamemasteryguide.sanityandmadness#multiple_personality_disorder`:
...
.. _`gamemasteryguide.sanityandmadness#paranoia`:
...
.. _`gamemasteryguide.sanityandmadness#psychosis`:
...
\ **Effect**\  character becomes chaotic evil; gains +10 competence bonus on :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  checks to hide insanity
...
.. _`gamemasteryguide.sanityandmadness#schizophrenia`:
