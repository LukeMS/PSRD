...
.. _`bestiary2.krenshar`:

.. contents:: \ 

.. _`bestiary2.krenshar#krenshar`:
...
\ **Init**\  +6; \ **Senses**\  darkvision 60 ft., low-light vision, :ref:`scent <bestiary.universalmonsterrules#scent>`\ ; :ref:`Perception <corerulebook.skills.perception#perception>`\  +5

.. _`bestiary2.krenshar#defense`:
...
.. _`bestiary2.krenshar#statistics`:
...
\ **Skills**\  :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +1 (+5 to demoralize), :ref:`Perception <corerulebook.skills.perception#perception>`\  +5, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +10; \ **Racial Modifiers**\  +4 :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  to demoralize, +4 :ref:`Stealth <corerulebook.skills.stealth#stealth>`
\ **Languages**\  Sylvan (can't speak)

.. _`bestiary2.krenshar#ecology`:
...
.. _`bestiary2.krenshar#special_abilities`:

Special Abilities
==================
\ **Skullface (Su)**\  As a standard action, a krenshar can pull the skin back from its face, revealing the musculature and bony structures of its skull. This counts as using :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  to demoralize an opponent, and is an extraordinary ability. The krenshar can emit a loud screech while peeling back its skin, causing potent :ref:`fear <bestiary.universalmonsterrules#fear_(su_or_sp)>`\  in a single creature within 100 feet that can see the krenshar. The targeted creature must make a DC 12 Will save or become frightened (if the target has 6 or fewer Hit Dice) or shaken (if the target has more than 6 Hit Dice) for 1d4 rounds. A creature that successfully saves cannot be affected again by the same krenshar's skullface ability for 24 hours. This is a sonic, mind-affecting :ref:`fear <bestiary.universalmonsterrules#fear_(su_or_sp)>`\  effect. The save DC is Charisma-based.
