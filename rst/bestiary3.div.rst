...
NE Medium outsider (:ref:`div <bestiary.creaturetypes#div_subtype>`\ , :ref:`evil <bestiary.creaturetypes#evil_subtype>`\ , :ref:`extraplanar <bestiary.creaturetypes#extraplanar_subtype>`\ )

\ **Init**\  +2; \ **Senses**\  darkvision 60 ft., see in darkness; :ref:`Perception <corerulebook.skills.perception#perception>`\  +11

.. _`bestiary3.div#defense`:
...
\ **DR**\  5/cold iron or :ref:`good <bestiary.creaturetypes#good_subtype>`\ ; \ **Immune**\  :ref:`fire <bestiary.creaturetypes#fire_subtype>`\ , :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\ ; \ **Resist**\  acid 10, electricity 10; \ **SR**\  15

.. _`bestiary3.div#offense`:
...
\ **Special Attacks**\  cursed :ref:`gaze <bestiary.universalmonsterrules#gaze>`\ , sandstorm

\ **Spell-Like Abilities**\  (CL 6th; concentration +10)

 At will—:ref:`bestow curse <corerulebook.spells.bestowcurse#bestow_curse>`\  (DC 18), :ref:`detect good <corerulebook.spells.detectgood#detect_good>`\ , :ref:`detect magic <corerulebook.spells.detectmagic#detect_magic>`\ , :ref:`dimension door <corerulebook.spells.dimensiondoor#dimension_door>`\ , :ref:`minor image <corerulebook.spells.minorimage#minor_image>`\  (DC 16), :ref:`spectral hand <corerulebook.spells.spectralhand#spectral_hand>`

 1/day—:ref:`suggestion <corerulebook.spells.suggestion#suggestion>`\  (DC 17), summon (level 3, 1d2 dorus 25%) 

.. _`bestiary3.div#statistics`:
...
\ **Feats**\  :ref:`Alertness <corerulebook.feats#alertness>`\ , :ref:`Iron Will <corerulebook.feats#iron_will>`\ , :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (claw)

\ **Skills**\  :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  +10, :ref:`Disguise <corerulebook.skills.disguise#disguise>`\  +12, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +10, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana) +7, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (planes) +7, :ref:`Perception <corerulebook.skills.perception#perception>`\  +11, :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  +9, :ref:`Spellcraft <corerulebook.skills.spellcraft#spellcraft>`\  +9, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +10

\ **Languages**\  Abyssal, Celestial, Infernal; telepathy 100 ft.

.. _`bestiary3.div#ecology`:
...
.. _`bestiary3.div#special_abilities`:

Special Abilities
==================

\ **Cursed Gaze (Su)**\  Aghash's choice: confused for 1 round, shaken for 1 round, stunned for 1 round, or deals 1d4 points of damage, 30 feet, Fortitude DC 16 negates. Any creature under the effects of :ref:`protection from evil <corerulebook.spells.protectionfromevil#protection_from_evil>`\  is immune to an aghash's :ref:`gaze <bestiary.universalmonsterrules#gaze>`\ . The save DC is Charisma-based.
...
NE Gargantuan outsider (:ref:`div <bestiary.creaturetypes#div_subtype>`\ , :ref:`evil <bestiary.creaturetypes#evil_subtype>`\ , :ref:`extraplanar <bestiary.creaturetypes#extraplanar_subtype>`\ )

\ **Init**\  +12; \ **Senses**\  darkvision 60 ft., see in darkness, :ref:`true seeing <corerulebook.spells.trueseeing#true_seeing>`\ ; :ref:`Perception <corerulebook.skills.perception#perception>`\  +34
...
\ **DR**\  15/cold iron and :ref:`good <bestiary.creaturetypes#good_subtype>`\ ; \ **Immune**\  :ref:`fire <bestiary.creaturetypes#fire_subtype>`\ , :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\ ; \ **Resist**\  acid 10, electricity 10; \ **SR**\  31
...
\ **Special Attacks**\  create ghul, rend (2 claws, 2d6+18), shake faith, swallow whole (6d6+18 plus 4d6 energy damage, AC 25, 37 hp), torturous gullet, :ref:`trample <bestiary.universalmonsterrules#trample>`\  (2d8+18, DC 34)

\ **Spell-Like Abilities**\  (CL 20th; concentration +28)

 Constant—:ref:`true seeing <corerulebook.spells.trueseeing#true_seeing>`

 At will—:ref:`align weapon <corerulebook.spells.alignweapon#align_weapon>`\ , :ref:`detect magic <corerulebook.spells.detectmagic#detect_magic>`\ , :ref:`greater teleport <corerulebook.spells.teleport#teleport_greater>`\  (self plus armor and 50 lbs. of objects only), :ref:`magic circle against good <corerulebook.spells.magiccircleagainstgood#magic_circle_against_good>`\ , :ref:`telekinesis <corerulebook.spells.telekinesis#telekinesis>`\  (DC 23)

 3/day—:ref:`blasphemy <corerulebook.spells.blasphemy#blasphemy>`\  (DC 25), :ref:`disintegrate <corerulebook.spells.disintegrate#disintegrate>`\  (DC 24), :ref:`dispel magic <corerulebook.spells.dispelmagic#dispel_magic>`\ , :ref:`forcecage <corerulebook.spells.forcecage#forcecage>`\  (DC 25), :ref:`protection from energy <corerulebook.spells.protectionfromenergy#protection_from_energy>`

 1/day—:ref:`geas/quest <corerulebook.spells.geasquest#geas_quest>`\ , :ref:`plane shift <corerulebook.spells.planeshift#plane_shift>`\ , \ *summon*\  (level 6, 1d2 sepids 100%)
...
\ **Feats**\  :ref:`Awesome Blow <bestiary.monsterfeats#awesome_blow>`\ , :ref:`Cleave <corerulebook.feats#cleave>`\ , :ref:`Combat Reflexes <corerulebook.feats#combat_reflexes>`\ , :ref:`Critical Focus <corerulebook.feats#critical_focus>`\ , :ref:`Great Cleave <corerulebook.feats#great_cleave>`\ , :ref:`Improved Bull Rush <corerulebook.feats#improved_bull_rush>`\ , :ref:`Improved Initiative <corerulebook.feats#improved_initiative>`\ , :ref:`Improved Critical <corerulebook.feats#improved_critical>`\  (bite), :ref:`Multiattack <bestiary.monsterfeats#multiattack>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`\ ,  :ref:`Staggering Critical <corerulebook.feats#staggering_critical>`\ ,  :ref:`Stunning Critical <corerulebook.feats#stunning_critical>`

\ **Skills**\  :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  +28 (+36 when jumping), :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  +43, :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  +31, :ref:`Fly <corerulebook.skills.fly#fly>`\  +27, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +31, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana) +31, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (planes) +31, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (religion) +19, :ref:`Perception <corerulebook.skills.perception#perception>`\  +34, :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  +30, :ref:`Spellcraft <corerulebook.skills.spellcraft#spellcraft>`\  +19, :ref:`Use Magic Device <corerulebook.skills.usemagicdevice#use_magic_device>`\  +23; \ **Racial Modifiers**\  +8 :ref:`Bluff <corerulebook.skills.bluff#bluff>`
...
\ **Crumbling Earth**\ : A shaitan-hunting akvan prince shatters the strongest stone. It gains the stone glide ability, tremorsense 100 feet, and a burrow speed of 100 feet, and its natural attacks are treated as adamantine for the purposes of overcoming damage reduction. It also gains the following spell-like abilities: 3/day—quickened :ref:`stone shape <corerulebook.spells.stoneshape#stone_shape>`\ , :ref:`transmute mud to rock <corerulebook.spells.transmutemudtorock#transmute_mud_to_rock>`\ , :ref:`transmute rock to mud <corerulebook.spells.transmuterocktomud#transmute_rock_to_mud>`\ , :ref:`wish <corerulebook.spells.wish#wish>`\ .

\ **Dying Ember**\ : An efreet-hating akvan prince holds dominion over flame. It gains an efreeti's heat special attack (1d6 when struck, 6d6 when grappling or grappled), and the following spell-like abilities: at will—quickened :ref:`quench <corerulebook.spells.quench#quench>`\ , :ref:`scorching ray <corerulebook.spells.scorchingray#scorching_ray>`\ , :ref:`wall of fire <corerulebook.spells.walloffire#wall_of_fire>`\ ; 3/day—:ref:`wish <corerulebook.spells.wish#wish>`\ .

\ **Gasping Wind**\ : A djinn-hunting akvan prince gains power over the wind. It gains resist electricity 30 and the whirlwind ability, its fly speed increases to 120 feet (perfect maneuverability), and it gains the following spell-like abilities: at will—:ref:`invisibility <corerulebook.spells.invisibility#invisibility>`\ ; 3/day—:ref:`gaseous form <corerulebook.spells.gaseousform#gaseous_form>`\ , :ref:`wish <corerulebook.spells.wish#wish>`\ . 

\ **Thirsty Sea**\ : A marid-slaying akvan prince controls and poisons water. It gains a swim speed of 100 feet, a marid's water's fury special attack (8d6 points of damage, blinds and stuns for 1d6 rounds), and the following spell-like abilities: constant—:ref:`water breathing <corerulebook.spells.waterbreathing#water_breathing>`\ , :ref:`water walk <corerulebook.spells.waterwalk#water_walk>`\ ; at will—quickened :ref:`control water <corerulebook.spells.controlwater#control_water>`\ ; 3/day—:ref:`horrid wilting <corerulebook.spells.horridwilting#horrid_wilting>`\ , :ref:`wish <corerulebook.spells.wish#wish>`\ .

\ **Unbalanced Soul**\ : A jann-killing akvan prince spreads failure and defeat. It gains resist acid, cold, and electricity 20, and the following spell-like abilities: at will—:ref:`ethereal jaunt <corerulebook.spells.etherealjaunt#ethereal_jaunt>`\ , :ref:`invisibility <corerulebook.spells.invisibility#invisibility>`\ ; 3/day—:ref:`insanity <corerulebook.spells.insanity#insanity>`\ , :ref:`mage's disjunction <corerulebook.spells.magesdisjunction#mage_s_disjunction>`\ , :ref:`wish <corerulebook.spells.wish#wish>`\ .

.. _`bestiary3.div#div_doru`:
...
NE Tiny outsider (:ref:`div <bestiary.creaturetypes#div_subtype>`\ , :ref:`evil <bestiary.creaturetypes#evil_subtype>`\ , :ref:`extraplanar <bestiary.creaturetypes#extraplanar_subtype>`\ )

\ **Init**\  +3; \ **Senses**\  darkvision 60 ft., :ref:`detect good <corerulebook.spells.detectgood#detect_good>`\ , :ref:`detect magic <corerulebook.spells.detectmagic#detect_magic>`\ , see in darkness; :ref:`Perception <corerulebook.skills.perception#perception>`\  +7
...
\ **DR**\  10/cold iron or :ref:`good <bestiary.creaturetypes#good_subtype>`\ ; \ **Immune**\  :ref:`fire <bestiary.creaturetypes#fire_subtype>`\ , :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\ ; \ **Resist**\  acid 10, electricity 10; \ **SR**\  13
...
\ **Melee**\  bite +9 (1d4–1 plus :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\ )
...
\ **Spell-Like Abilities**\  (CL 6th; concentration +8)
 ...
 3/day—:ref:`charm person <corerulebook.spells.charmperson#charm_person>`\  (DC 13), :ref:`minor image <corerulebook.spells.minorimage#minor_image>`\  (DC 14)

 1/day—:ref:`suggestion <corerulebook.spells.suggestion#suggestion>`\  (DC 15)
...
\ **Skills**\  :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  +8, :ref:`Fly <corerulebook.skills.fly#fly>`\  +15, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana) +6, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (planes) +6, :ref:`Perception <corerulebook.skills.perception#perception>`\  +7, :ref:`Spellcraft <corerulebook.skills.spellcraft#spellcraft>`\  +6, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +17
...
NE Large outsider (:ref:`aquatic <bestiary.creaturetypes#aquatic_subtype>`\ , :ref:`div <bestiary.creaturetypes#div_subtype>`\ , :ref:`evil <bestiary.creaturetypes#evil_subtype>`\ , :ref:`extraplanar <bestiary.creaturetypes#extraplanar_subtype>`\ )

\ **Init**\  +6; \ **Senses**\  darkvision 60 ft., :ref:`detect good <corerulebook.spells.detectgood#detect_good>`\ , :ref:`detect magic <corerulebook.spells.detectmagic#detect_magic>`\ , see in darkness; :ref:`Perception <corerulebook.skills.perception#perception>`\  +19
...
\ **Defensive Abilities**\ rough hide; \ **DR**\  10/cold iron and :ref:`good <bestiary.creaturetypes#good_subtype>`\ ; \ **Immune**\  :ref:`fire <bestiary.creaturetypes#fire_subtype>`\ , :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\ ; \ **Resist**\  acid 10, electricity 10; \ **SR**\  21
...
\ **Melee**\  bite +21 (1d8+7/19â20), 2 claws +20 (1d6+7), sting +20 (1d6+7 plus poison) orspear +20/+15/+10 (2d6+10/x3 plus poison), bite +19 (1d8+3/19â20), sting +18 (1d6+3 plus poison)

\ **Ranged**\  spear +15 (2d6+7/×3 plus :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\ )
...
\ **Spell-Like Abilities**\  (CL 12th; concentration +14)
 ...
 At will—:ref:`control water <corerulebook.spells.controlwater#control_water>`\ , :ref:`curse water <corerulebook.spells.cursewater#curse_water>`\ , :ref:`deeper darkness <corerulebook.spells.deeperdarkness#deeper_darkness>`\ , :ref:`dimension door <corerulebook.spells.dimensiondoor#dimension_door>`

 3/day—:ref:`hallucinatory terrain <corerulebook.spells.hallucinatoryterrain#hallucinatory_terrain>`\  (DC 16), :ref:`stinking cloud <corerulebook.spells.stinkingcloud#stinking_cloud>`\  (DC 15), summon (level 6, 1 pairaka 60%), :ref:`quench <corerulebook.spells.quench#quench>`\  (DC 15)
...
\ **Feats**\  :ref:`Combat Reflexes <corerulebook.feats#combat_reflexes>`\ , :ref:`Improved Critical <corerulebook.feats#improved_critical>`\  (bite), :ref:`Improved Initiative <corerulebook.feats#improved_initiative>`\ , :ref:`Lightning Reflexes <corerulebook.feats#lightning_reflexes>`\ , :ref:`Multiattack <corerulebook.feats#multiattacks>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`\ , :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (bite)

\ **Skills**\  :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  +19, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (geography and planes) +18, :ref:`Perception <corerulebook.skills.perception#perception>`\  +19, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +15, :ref:`Survival <corerulebook.skills.survival#survival>`\  +19, :ref:`Swim <corerulebook.skills.swim#swim>`\  +32
...
\ **Boiling Sea (Su)**\  As a standard action, a ghawwas can cause the waters around it to boil. Any creature within 50 feet of the ghawwas, within the same body of :ref:`water <bestiary.creaturetypes#water_subtype>`\ , and at least half submerged takes 6d6 points of fire damage (DC 23 Fortitude save for half). The save DC is Constitution-based.
...
NE Medium outsider (:ref:`div <bestiary.creaturetypes#div_subtype>`\ , :ref:`evil <bestiary.creaturetypes#evil_subtype>`\ , :ref:`extraplanar <bestiary.creaturetypes#extraplanar_subtype>`\ , :ref:`shapechanger <bestiary.creaturetypes#shapechanger_subtype>`\ )

\ **Init**\  +9; \ **Senses**\  darkvision 60 ft., :ref:`detect good <corerulebook.spells.detectgood#detect_good>`\ , :ref:`detect magic <corerulebook.spells.detectmagic#detect_magic>`\ , see in darkness; :ref:`Perception <corerulebook.skills.perception#perception>`\  +16
...
\ **DR**\  10/cold iron or :ref:`good <bestiary.creaturetypes#good_subtype>`\ ; \ **Immune**\  :ref:`fire <bestiary.creaturetypes#fire_subtype>`\ , :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\ , :ref:`disease <bestiary.universalmonsterrules#disease_(ex_or_su)>`\ ; \ **Resist**\  acid 10, electricity 10; \ **SR**\  22
...
\ **Melee**\  2 claws +14 (1d6+3 plus :ref:`disease <bestiary.universalmonsterrules#disease_(ex_or_su)>`\ )
...
\ **Spell-Like Abilities**\  (CL 12th; concentration +19)
 ...
 At will—:ref:`charm monster <corerulebook.spells.charmmonster#charm_monster>`\  (DC 21), :ref:`dimension door <corerulebook.spells.dimensiondoor#dimension_door>`\  (self plus 50 lbs. of objects only), :ref:`misdirection <corerulebook.spells.misdirection#misdirection>`\  (DC 19)

 1/day—:ref:`insect plague <corerulebook.spells.insectplague#insect_plague>`\ , summon (level 3, 1d4 dorus 50%)
...
\ **Feats**\  :ref:`Deceitful <corerulebook.feats#deceitful>`\ , :ref:`Flyby Attack <bestiary.monsterfeats#flyby_attack>`\ , :ref:`Hover <bestiary.monsterfeats#hover>`\ , :ref:`Improved Initiative <corerulebook.feats#improved_initiative>`\ , :ref:`Weapon Finesse <corerulebook.feats#weapon_finesse>`

\ **Skills**\  :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  +20, :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  +18, :ref:`Disguise <corerulebook.skills.disguise#disguise>`\  +18, :ref:`Fly <corerulebook.skills.fly#fly>`\  +16, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +16, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (local) +13, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (planes) +13, :ref:`Perception <corerulebook.skills.perception#perception>`\  +16, :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  +13, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +17

\ **Languages**\  Abyssal, Celestial, Infernal; telepathy 100 ft.

\ **SQ**\  :ref:`change shape <bestiary.universalmonsterrules#change_shape>`\  (any Small or Medium animal or humanoid; :ref:`polymorph <corerulebook.spells.polymorph#polymorph>`\ )
...
.. _`bestiary3.div#bubonic_plague`:
...
NE Large outsider (:ref:`div <bestiary.creaturetypes#div_subtype>`\ , :ref:`evil <bestiary.creaturetypes#evil_subtype>`\ , :ref:`extraplanar <bestiary.creaturetypes#extraplanar_subtype>`\ )

\ **Init**\  +9; \ **Senses**\  darkvision 60 ft., see in darkness; :ref:`Perception <corerulebook.skills.perception#perception>`\  +22
...
\ **DR**\  10/cold iron and :ref:`good <bestiary.creaturetypes#good_subtype>`\ ; \ **Immune**\  :ref:`fire <bestiary.creaturetypes#fire_subtype>`\ , :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\ ; \ **Resist**\  acid 10, electricity 10; \ **SR**\  25
...
\ **Spell-Like Abilities**\  (CL 15th; concentration +21)
 ...
 At will—:ref:`comprehend languages <corerulebook.spells.comprehendlanguages#comprehend_languages>`\ , :ref:`deeper darkness <corerulebook.spells.deeperdarkness#deeper_darkness>`\ , :ref:`greater teleport <corerulebook.spells.teleport#teleport_greater>`\  (self plus 50 lbs. of objects only), :ref:`nondetection <corerulebook.spells.nondetection#nondetection>`\ , :ref:`speak with dead <corerulebook.spells.speakwithdead#speak_with_dead>`\  (DC 19)

 3/day—:ref:`blindness/deafness <corerulebook.spells.blindnessdeafness#blindness_deafness>`\  (DC 18), :ref:`fly <corerulebook.spells.fly>`\ , :ref:`ice storm <corerulebook.spells.icestorm#ice_storm>`\ , :ref:`invisibility <corerulebook.spells.invisibility#invisibility>`\ , :ref:`mirror image <corerulebook.spells.mirrorimage#mirror_image>`\ , :ref:`scorching ray <corerulebook.spells.scorchingray#scorching_ray>`\ , :ref:`touch of idiocy <corerulebook.spells.touchofidiocy#touch_of_idiocy>`\ , :ref:`true strike <corerulebook.spells.truestrike#true_strike>`

 1/day—:ref:`animate dead <corerulebook.spells.animatedead#animate_dead>`\ , :ref:`baleful polymorph <corerulebook.spells.balefulpolymorph#baleful_polymorph>`\  (DC 21), :ref:`bestow curse <corerulebook.spells.bestowcurse#bestow_curse>`\  (DC 20), :ref:`break enchantment <corerulebook.spells.breakenchantment#break_enchantment>`\ , :ref:`create undead <corerulebook.spells.createundead#create_undead>`\ , :ref:`disintegrate <corerulebook.spells.disintegrate#disintegrate>`\  (DC 22), :ref:`enervation <corerulebook.spells.enervation#enervation>`\ , :ref:`fireball <corerulebook.spells.fireball#fireball>`\  (DC 19), :ref:`hold monster <corerulebook.spells.holdmonster#hold_monster>`\  (DC 21), summon (level 4, 1 ghawwas or 1 shira 40%), :ref:`true seeing <corerulebook.spells.trueseeing#true_seeing>`
...
\ **Feats**\  :ref:`Cleave <corerulebook.feats#cleave>`\ , :ref:`Combat Reflexes <corerulebook.feats#combat_reflexes>`\ , :ref:`Deflect Arrows <corerulebook.feats#deflect_arrows>`\ \ :sup:`B`\ , :ref:`Improved Critical <corerulebook.feats#improved_critical>`\  (falchion), :ref:`Improved Initiative <corerulebook.feats#improved_initiative>`\ , :ref:`Iron Will <corerulebook.feats#iron_will>`\ , :ref:`Lightning Reflexes <corerulebook.feats#lightning_reflexes>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`\ , :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (falchion)

\ **Skills**\  :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  +24, :ref:`Fly <corerulebook.skills.fly#fly>`\  +15, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +24, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana) +19, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (planes) +22, :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (religion) +15, :ref:`Perception <corerulebook.skills.perception#perception>`\  +22, :ref:`Sense Motive <corerulebook.skills.sensemotive#sense_motive>`\  +20, :ref:`Spellcraft <corerulebook.skills.spellcraft#spellcraft>`\  +22, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +19, :ref:`Use Magic Device <corerulebook.skills.usemagicdevice#use_magic_device>`\  +24
...
\ **Init**\  +11; \ **Senses**\  darkvision 60 ft., see in darkness, :ref:`true seeing <corerulebook.spells.trueseeing#true_seeing>`\ ; :ref:`Perception <corerulebook.skills.perception#perception>`\  +21
...
\ **DR**\  10/cold iron and :ref:`good <bestiary.creaturetypes#good_subtype>`\ ; \ **Immune**\  :ref:`fire <bestiary.creaturetypes#fire_subtype>`\ , :ref:`poison <bestiary.universalmonsterrules#poison_(ex_or_su)>`\ ; \ **Resist**\  acid 10, electricity 10; \ **SR**\  23
...
\ **Melee**\  bite +21 (1d8+9/19–20), 2 claws +21 (1d8+9 plus :ref:`grab <bestiary.universalmonsterrules#grab>`\ )

\ **Space**\  10 ft.; \ **Reach**\  10 ft.

\ **Special Attacks**\  consume essence, dusty pelt, :ref:`rake <bestiary.universalmonsterrules#rake>`\  (2 claws +21, 1d8+9)
...
\ **Spell-Like Abilities**\  (CL 13th; concentration +18)
 ...
 3/day—:ref:`magic circle against good <corerulebook.spells.magiccircleagainstgood#magic_circle_against_good>`\ , :ref:`waves of fatigue <corerulebook.spells.wavesoffatigue#waves_of_fatigue>`
...
\ **Feats**\  :ref:`Improved Critical <corerulebook.feats#improved_critical>`\  (bite), :ref:`Improved Initiative <corerulebook.feats#improved_initiative>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`\ , :ref:`Run <corerulebook.feats#run>`\ , :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (claw), :ref:`Weapon Focus <corerulebook.feats#weapon_focus>`\  (bite)

\ **Skills**\  :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  +22 (+30 when jumping), :ref:`Bluff <corerulebook.skills.bluff#bluff>`\  +20, :ref:`Climb <corerulebook.skills.climb#climb>`\  +24, :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  +20, :ref:`Perception <corerulebook.skills.perception#perception>`\  +21, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +18, :ref:`Survival <corerulebook.skills.survival#survival>`\  +21
