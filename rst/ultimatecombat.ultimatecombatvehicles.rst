...
.. _`ultimatecombat.ultimatecombatvehicles#vehicle_basics`:
...
.. _`ultimatecombat.ultimatecombatvehicles#full_vehicle_rules`:
...
.. _`ultimatecombat.ultimatecombatvehicles#drivers`:
...
.. _`ultimatecombat.ultimatecombatvehicles#occupants`:
...
.. _`ultimatecombat.ultimatecombatvehicles#propulsion_and_driving_checks`:
...
.. _`ultimatecombat.ultimatecombatvehicles#alchemical`:

\ **Alchemical**\ : Rarely, an alchemical engine may propel a vehicle. Powered by steam or more volatile gases and reagents, a vehicle with an alchemical engine requires either a :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana) or :ref:`Craft <corerulebook.skills.craft#craft>`\  (alchemy) check to be driven. The base DC to drive an alchemical vehicle is 10 higher than normal. Alchemical engines can be extremely powerful, with the ability to propel vehicles hundreds of times their size. They can also be very fickle when driven by creatures uninitiated in the secrets of alchemy. 
...
.. _`ultimatecombat.ultimatecombatvehicles#current`:

\ **Current**\ : From canoes and large ships to winged gliders, vehicles propelled by currents typically manipulate an already existing power source within or outside of nature—an air current, a water current, or more exotic currents, like conduits of magical energy. Usually, manipulating a current-propelled vehicle requires a skill like :ref:`Fly <corerulebook.skills.fly#fly>`\ , :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nature), :ref:`Profession <corerulebook.skills.profession#profession>`\  (sailor), :ref:`Survival <corerulebook.skills.survival#survival>`\ , or even :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  or :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana), depending on the nature or makeup of the vehicle and the current the vehicle is manipulating.

.. _`ultimatecombat.ultimatecombatvehicles#water_current`:

 \ *Water Current*\ : Vehicles that only rely on currents of water for their propulsion are somewhat limited. These vehicles can only move in the direction and at the speed of a current unless they also employ some other means of propulsion or manipulation, and thus often have an additional form of propulsion, such as muscle in the case of a canoe, and wind in the case of a galley. A current-driven ship such as a river barge with a crew of two or more creatures requires either a :ref:`Profession <corerulebook.skills.profession#profession>`\  (sailor) or :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nature) check for the driving check, as ships require precision, discipline, and knowledge of the natural world. Smaller water-current vehicles, like canoes, use the :ref:`Survival <corerulebook.skills.survival#survival>`\  skill as the drive skill, as reading the terrain is a very important aspect of maintaining control over those types of vehicles.
...
.. _`ultimatecombat.ultimatecombatvehicles#air_current`:

 \ *Air Current*\ : Air-current vehicles are rather diverse. They can be sailing ships, airships, land ships, or even gliders. A vehicle propelled by air with a crew of two or more creatures requires a :ref:`Profession <corerulebook.skills.profession#profession>`\  (sailor) or :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nature) check as its driving check. Because of their complexity, air-current vehicles always have their driving check DCs increased by 10. Smaller air-current vehicles, such as gliders and wind sleds, use :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  or :ref:`Fly <corerulebook.skills.fly#fly>`\  instead. Much of their control depends on knowledge of flight or proper movements of the body to control the vehicle. 
...
.. _`ultimatecombat.ultimatecombatvehicles#weird_current`:
...
.. _`ultimatecombat.ultimatecombatvehicles#magic`:
...
.. _`ultimatecombat.ultimatecombatvehicles#muscle`:

\ **Muscle**\ : From a chariot to a slave ship filled with captive rowers, moving a vehicle powered by muscle is all about getting a creature or creatures to push, pull, or otherwise propel the vehicle. Based on the type and intelligence of the creatures moving the vehicle, checks for driving muscle-propelled vehicles can use a diverse number of skills, including, but not limited to, :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\ , :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\ , :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\ , and :ref:`Profession <corerulebook.skills.profession#profession>`\  (driver).
Muscle-propelled vehicles come in two forms: pulled and pushed.

.. _`ultimatecombat.ultimatecombatvehicles#pulled`:

 \ *Pulled*\ : This type of propulsion involves one or more creature pulling a vehicle. Unless the creature pulling the vehicle is intelligent (Intelligence score of 3 or higher), either :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  or :ref:`Profession <corerulebook.skills.profession#profession>`\  (driver) is used for the driving check (driver's choice). Intelligent creatures must be convinced with a :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  check (decrease the driving check by 5 if the creature or creatures have the helpful attitude), or forced with an :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  check. Forcing an intelligent creature to pull a vehicle increases the DC by 20.
...
.. _`ultimatecombat.ultimatecombatvehicles#pushed`:

 \ *Pushed*\ : Pushed vehicles are the exact opposite of pulled vehicles—vehicles that are pushed by muscle, usually using some form of device manipulated by crew members. Aquatic vehicles are the most likely to be pushed. Lines of rowers use their oars to push the vehicle forward, or a pair of cloud giants may churn a propeller at the aft end of a dirigible. Driving checks for pushed vehicles tend to be :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\ , :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\ , or :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\ , depending on the intelligence and attitude of the creatures supplying the muscle for the propulsion.

 For intelligent creatures, use :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  if the creatures providing the propulsion have an attitude of indifferent, friendly, or helpful. Decrease the :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  driving check by 5 if the creatures providing the propulsion are friendly. :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  is used for intelligent creatures with an attitude of unfriendly or hostile. :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  is used if the creatures providing the propulsion are not intelligent.
...
.. _`ultimatecombat.ultimatecombatvehicles#mixed_methods_of_propulsion`:
...
.. _`ultimatecombat.ultimatecombatvehicles#vehicle_size_and_space`:
...
.. _`ultimatecombat.ultimatecombatvehicles#size_conversion`:
...
.. _`ultimatecombat.ultimatecombatvehicles#driving_space`:
...
.. list-table:: Table: Vehicle Size by Squares
   :header-rows: 1
...
.. _`ultimatecombat.ultimatecombatvehicles#vehicle_facing_and_movement`:
...
.. _`ultimatecombat.ultimatecombatvehicles#facing`:
...
.. _`ultimatecombat.ultimatecombatvehicles#movement`:
...
.. _`ultimatecombat.ultimatecombatvehicles#driving_vehicles`:
...
.. _`ultimatecombat.ultimatecombatvehicles#driving_actions`:
...
.. _`ultimatecombat.ultimatecombatvehicles#accelerate_(standard_action)`:
...
.. _`ultimatecombat.ultimatecombatvehicles#decelerate_(standard_action)`:

 \ *Decelerate (standard action)*\ : With a successful driving check, the vehicle's current speed decreases by a rate up to its acceleration (in 5-foot increments; minimum 5 feet). On a failed check, the vehicle does not decelerate. Either way, the vehicle can move forward diagonally. If deceleration reduces a vehicle's speed to 0, some amount of inertia will continue to move the vehicle forward. The vehicle moves forward (either directly forward or forward diagonally) 1d4 × 5 feet before coming to a complete stop. Having the :ref:`Expert Driver <ultimatecombat.ultimatecombatfeats#expert_driver>`\  feat reduces this distance by 10 feet (minimum 0 feet). 

.. _`ultimatecombat.ultimatecombatvehicles#keep_it_going_(move_action)`:
...
.. _`ultimatecombat.ultimatecombatvehicles#reverse_(standard_action)`:
...
.. _`ultimatecombat.ultimatecombatvehicles#turn_(standard_action)`:
...
.. _`ultimatecombat.ultimatecombatvehicles#uncontrolled_(no_action)`:
...
.. _`ultimatecombat.ultimatecombatvehicles#driving_a_vehicle_outside_of_combat`:
...
.. _`ultimatecombat.ultimatecombatvehicles#driving_a_vehicle_with_magic_propulsion`:
...
.. _`ultimatecombat.ultimatecombatvehicles#driving_a_vehicle_without_the_proper_skill`:
...
.. _`ultimatecombat.ultimatecombatvehicles#vehicle_crews`:
...
.. _`ultimatecombat.ultimatecombatvehicles#vehicles_in_combat`:
...
.. _`ultimatecombat.ultimatecombatvehicles#initiative`:
...
.. _`ultimatecombat.ultimatecombatvehicles#threatening`:
...
.. _`ultimatecombat.ultimatecombatvehicles#line_of_sight_and_cover`:
...
.. _`ultimatecombat.ultimatecombatvehicles#jumping_on_or_off_a_vehicle`:

\ **Jumping On or Off a Vehicle**\ : Jumping on a vehicle is a normal jump of its distance assuming the vehicle has a deck or handholds within the character's height from the ground. Increase the DC of the :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  check by 5 for every 30 feet of the vehicle's current speed. If the jumping creature is on a moving vehicle, calculate the increase in  the :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  skill check DC by calculating the difference between the current speeds of the two vehicles. For every difference of 30 feet (round up), the DC increases by 5.
For example, jumping onto a vehicle with a current speed of 90 feet increases the DC by 15 if the jumper is not also on a moving vehicle. If the jumper is on a moving vehicle, and that vehicle is moving at the same current speed as the vehicle the jumper wants to jump to, there is no increase to the DC. If the difference between their speeds is less than 30 feet, the DC of the :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  check increases by 5. If it's between 30 and 60, it increases by 10, and so on. 
Jumping off a vehicle onto the ground is considered a fall, and treated as if the fall were an additional 10 feet farther for every 30 feet of the vehicle's movement for the purposes of determining damage. :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  can be used to soften this fall, and magic abilities such as :ref:`feather fall <corerulebook.spells.featherfall#feather_fall>`\  can be used to negate the effects of jumping off a vehicle.

.. _`ultimatecombat.ultimatecombatvehicles#taking_control_of_a_vehicle`:
...
.. _`ultimatecombat.ultimatecombatvehicles#attacks_against_vehicles`:
...
.. _`ultimatecombat.ultimatecombatvehicles#attacking_the_structure`:

 \ *Attacking the Structure*\ : This is an attack against the vehicle itself. If successful, the vehicle takes damage normally. 

.. _`ultimatecombat.ultimatecombatvehicles#attacking_an_occupant`:
...
.. _`ultimatecombat.ultimatecombatvehicles#attacking_propulsion`:
...
.. _`ultimatecombat.ultimatecombatvehicles#attacking_the_driving_device`:
...
.. _`ultimatecombat.ultimatecombatvehicles#attacking_conveyance`:
...
.. _`ultimatecombat.ultimatecombatvehicles#vehicle_combat_maneuvers`:
...
.. _`ultimatecombat.ultimatecombatvehicles#vehicular_overrun`:
...
.. _`ultimatecombat.ultimatecombatvehicles#damaging_a_vehicle`:
...
.. list-table:: Table: Vehicle Hit Points by Material
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto
...
.. _`ultimatecombat.ultimatecombatvehicles#broken_condition`:
...
.. _`ultimatecombat.ultimatecombatvehicles#wrecked_condition`:
...
.. _`ultimatecombat.ultimatecombatvehicles#sinking`:
...
.. _`ultimatecombat.ultimatecombatvehicles#destroyed`:
...
.. _`ultimatecombat.ultimatecombatvehicles#sudden_stops`:
...
.. _`ultimatecombat.ultimatecombatvehicles#repairing_a_vehicle`:

\ **Repairing a Vehicle**\ : The fastest and easiest way to repair a vehicle is with the :ref:`mending <corerulebook.spells.mending#mending>`\  and :ref:`make whole <corerulebook.spells.makewhole#make_whole>`\  spells, but more mundane methods can also be used. :ref:`Craft <corerulebook.skills.craft#craft>`\  (carpentry) can be used to repair most vehicles made of wood; because of their specialized construction, water vehicles require :ref:`Craft <corerulebook.skills.craft#craft>`\  (ships) to repair. Depending on the nature of the damage, such skills like :ref:`Craft <corerulebook.skills.craft#craft>`\  (cloth), :ref:`Craft <corerulebook.skills.craft#craft>`\  (alchemy), :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (engineering), and even various professions can be used to repair vehicles, if the GM approves. In general, a day's worth of work by a single person using the appropriate skill to repair a vehicle requires 10 gp of raw material and a DC 10 skill check, and repairs 10 points of damage on a success, or 5 hit points on a failure.

.. _`ultimatecombat.ultimatecombatvehicles#vehicle_statistics`:
...
.. _`ultimatecombat.ultimatecombatvehicles#name`:

\ **Name**\ : The name of the vehicle.

.. _`ultimatecombat.ultimatecombatvehicles#size_and_type`:

\ **Size and Type**\ : Divided into land, sea, and air.

.. _`ultimatecombat.ultimatecombatvehicles#squares`:
...
.. _`ultimatecombat.ultimatecombatvehicles#cost`:
...
.. _`ultimatecombat.ultimatecombatvehicles#ac_and_hardness`:
...
.. _`ultimatecombat.ultimatecombatvehicles#hp`:
...
.. _`ultimatecombat.ultimatecombatvehicles#base_save`:
...
.. _`ultimatecombat.ultimatecombatvehicles#maximum_speed`:
...
.. _`ultimatecombat.ultimatecombatvehicles#cmb_and_cmd`:

\ **CMB and CMD**\ : The CMB an CMD before the driver modifies it with his driving check modifier.

.. list-table:: Table: Vehicle AC and CMB Modifier by Size
   :header-rows: 1
   :class: contrast-reading-table
   :widths: auto

   * - Number of Vehicle Squares
     - AC
     - CMB Modifier
   * - Large vehicle
     - 9
...
.. _`ultimatecombat.ultimatecombatvehicles#acceleration`:
...
.. _`ultimatecombat.ultimatecombatvehicles#propulsion`:

\ **Propulsion**\ : The type and amount of propulsion required.

.. _`ultimatecombat.ultimatecombatvehicles#driving_check:`:

\ **Driving Check:**\  The skills typically used to make a vehicle driving check with this vehicle.

.. _`ultimatecombat.ultimatecombatvehicles#forward_facing`:

\ **Forward Facing**\ : The direction of the vehicle's forward facing.

.. _`ultimatecombat.ultimatecombatvehicles#driving_device`:
...
.. _`ultimatecombat.ultimatecombatvehicles#land_vehicles`:
...
.. _`ultimatecombat.ultimatecombatvehicles#carriage`:
...
.. _`ultimatecombat.ultimatecombatvehicles#defense`:
...
.. _`ultimatecombat.ultimatecombatvehicles#offense`:
...
.. _`ultimatecombat.ultimatecombatvehicles#description`:
...
\ **Driving Check**\  :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  or :ref:`Profession <corerulebook.skills.profession#profession>`\  (driver) (in the case of creatures with :ref:`animal <bestiary.creaturetypes#animal>`\  intelligence pulling the vehicle), :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  or :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  (in the case of intelligent creatures pulling the vehicle)
...
.. _`ultimatecombat.ultimatecombatvehicles#cart`:
...
.. _`ultimatecombat.ultimatecombatvehicles#chariot_light`:
...
.. _`ultimatecombat.ultimatecombatvehicles#chariot_medium`:
...
.. _`ultimatecombat.ultimatecombatvehicles#chariot_heavy`:
...
\ **Propulsion**\  muscle (pulled; 6 Medium creatures or 2 Large creatures) 
\ **Driving Check**\  :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  or :ref:`Profession <corerulebook.skills.profession#profession>`\  (driver) (in the case of creatures with :ref:`animal <bestiary.creaturetypes#animal>`\  intelligence pulling the vehicle), :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  or :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  (in the case of intelligent creatures)
\ **Forward Facing**\  toward the creatures pulling the vehicle
\ **Driving Device**\  reins
\ **Driving Space**\  the two most forward squares of the chariot
\ **Decks**\  1
...
.. _`ultimatecombat.ultimatecombatvehicles#sleigh`:
...
\ **Driving Check**\  :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  or :ref:`Profession <corerulebook.skills.profession#profession>`\  (driver) (in the case of creatures with :ref:`animal <bestiary.creaturetypes#animal>`\  intelligence), :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  or :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  (in the case of intelligent creatures pulling the vehicle), or :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  (in the case of air current; +10 to the DC)
...
.. _`ultimatecombat.ultimatecombatvehicles#steam_giant`:
...
\ **Driving Check**\  :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana) or :ref:`Craft <corerulebook.skills.craft#craft>`\  (alchemy) +10 to the DC
...
.. _`ultimatecombat.ultimatecombatvehicles#wagon_light`:
...
\ **Propulsion**\  muscle (pulled; 4 Medium creatures or 1 Large creature)
\ **Driving Check**\  :ref:`Handle Animal <corerulebook.skills.handleanimal#handle_animal>`\  or :ref:`Profession <corerulebook.skills.profession#profession>`\  (driver) (in the case of creatures with :ref:`animal <bestiary.creaturetypes#animal>`\  intelligence), :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  or :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  (in the case of intelligent creatures pulling the vehicle)
\ **Forward Facing**\  toward the creatures pulling the vehicle
\ **Driving Device**\  reins
\ **Driving Space**\  the two most forward squares of the wagon
\ **Decks**\  1

.. _`ultimatecombat.ultimatecombatvehicles#wagon_medium`:
...
.. _`ultimatecombat.ultimatecombatvehicles#wagon_heavy`:
...
.. _`ultimatecombat.ultimatecombatvehicles#water_vehicles`:
...
.. _`ultimatecombat.ultimatecombatvehicles#galley`:
...
\ **Driving Check**\  :ref:`Profession <corerulebook.skills.profession#profession>`\  (sailor) or :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nature) +10 to the DC
...
.. _`ultimatecombat.ultimatecombatvehicles#keelboat`:
...
\ **Driving Check**\  :ref:`Diplomacy <corerulebook.skills.diplomacy#diplomacy>`\  or :ref:`Intimidate <corerulebook.skills.intimidate#intimidate>`\  while rowed, or :ref:`Profession <corerulebook.skills.profession#profession>`\  (sailor) or :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (nature) +10 to the DC when sail is used
...
.. _`ultimatecombat.ultimatecombatvehicles#longship`:
...
.. _`ultimatecombat.ultimatecombatvehicles#rowboat`:
...
\ **Driving Check**\  :ref:`Survival <corerulebook.skills.survival#survival>`
\ **Forward Facing**\  boat's forward
\ **Driving Device**\  oars
\ **Driving Space**\  the center square of the rowboat
\ **Decks**\  1

.. _`ultimatecombat.ultimatecombatvehicles#sailing_ship`:
...
.. _`ultimatecombat.ultimatecombatvehicles#warship`:
...
.. _`ultimatecombat.ultimatecombatvehicles#air_vehicles`:
...
.. _`ultimatecombat.ultimatecombatvehicles#airship`:
...
.. _`ultimatecombat.ultimatecombatvehicles#alchemical_dragon`:
...
\ **Driving Check**\  :ref:`Craft <corerulebook.skills.craft#craft>`\  (alchemy) or :ref:`Knowledge <corerulebook.skills.knowledge#knowledge>`\  (arcana) +10 to the DC
\ **Forward Facing**\  the ship's forward
\ **Driving Device**\  steering wheel
\ **Driving Space**\  the nine squares around the steering wheel that sits at the front of the ship
\ **Crew**\  10
\ **Decks**\  1
\ **Weapons**\  Up to 6 Large direct-fire siege engines in banks of 3 positioned on the port and starboard sides of the alchemical :ref:`dragon <bestiary.creaturetypes#dragon>`\ , or up to 4 Huge direct-fire siege engines in banks of two on the port and starboard sides of the ship. The siege engines may only fire out the sides of the ship they are positioned on. They cannot be swiveled to fire toward the forward or aft sides of the ship.

.. _`ultimatecombat.ultimatecombatvehicles#glider`:
...
\ **Driving Check**\  :ref:`Fly <corerulebook.skills.fly#fly>`\  or :ref:`Acrobatics <corerulebook.skills.acrobatics#acrobatics>`\  +10 to the DC

.. _`ultimatecombat.ultimatecombatvehicles#maneuvering_a_vehicle`:
...
.. _`ultimatecombat.ultimatecombatvehicles#turning_a_vechicle`: `ultimatecombat.ultimatecombatvehicles#turning_a_vehicle`_

.. _`ultimatecombat.ultimatecombatvehicles#turning_a_vehicle`:
...
.. _`ultimatecombat.ultimatecombatvehicles#optional_rule_wide_turns`: `ultimatecombat.ultimatecombatvehicles#optional_rule:_wide_turns`_

.. _`ultimatecombat.ultimatecombatvehicles#optional_rule:_wide_turns`:
...
.. _`ultimatecombat.ultimatecombatvehicles#propulsion_devices`:
...
.. _`ultimatecombat.ultimatecombatvehicles#alchemical_engine`:
...
.. _`ultimatecombat.ultimatecombatvehicles#creature`:
...
.. _`ultimatecombat.ultimatecombatvehicles#dirigible`:
...
.. _`ultimatecombat.ultimatecombatvehicles#magic_item`:

\ **Magic Item**\ : Like a creature, a magic item uses its own item statistics.

.. _`ultimatecombat.ultimatecombatvehicles#sails`:
...
.. _`ultimatecombat.ultimatecombatvehicles#driving_devices`:
