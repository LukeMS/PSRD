...
.. _`ultimatecombat.classarchetypes.gunslinger#gunslinger`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#gun_tank_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#armor_proficiency`:

\ **Armor Proficiency**\ : A gun tank is proficient with all armors and shields, including tower shields. 

.. _`ultimatecombat.classarchetypes.gunslinger#deeds`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#gun_tanks_resolve`:

 \ *Gun Tank's Resolve (Ex)*\ : At 1st level, the gun tank can shrug off the most serious of attacks. When the gun tank is wearing medium or heavy armor and is subject to a critical hit or sneak attack, she can spend 1 grit point as an immediate action to attempt to negate the critical hit or sneak attack damage. At 1st level, she has a 25% chance of doing so. At 10th level, the chance increases to 50%. At 15th level, the chance increases to 75%. While a gun tank's resolve does not stack with the :ref:`fortification <corerulebook.magicitems.armor#armor_fortification>`\  armor special ability, it does work in concert with that armor special ability or similar effects, so a gun tank can use this ability even after the armor of :ref:`fortification <corerulebook.magicitems.armor#armor_fortification>`\  has failed to negate the critical hit or sneak attack damage. This deed replaces the gunslinger's dodge deed.

.. _`ultimatecombat.classarchetypes.gunslinger#gun_tanks_resilience`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#bullet_defection`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#armor_training`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#musket_master_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#weapon_proficiency`:

\ **Weapon Proficiency**\ : Instead of proficiency with all firearms, a musket master only gains proficiency with two-handed firearms. She must take the :ref:`Exotic Weapon Proficiency <corerulebook.feats#exotic_weapon_proficiency>`\  (firearm) feat to gain proficiency with one-handed firearms and firearm siege engines. 

.. _`ultimatecombat.classarchetypes.gunslinger#gunsmith`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#steady_aim`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#fast_musket`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#rapid_reloader`:

\ **Rapid Reloader**\ : At 1st level, a musket master gains :ref:`Rapid Reload <ultimatecombat.ultimatecombatfeats#rapid_reload_(combat)>`\  (muskets) as a bonus feat.

.. _`ultimatecombat.classarchetypes.gunslinger#musket_training`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#mysterious_stranger_(archetype)`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#grit`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#focused_aim`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#clipping_shot`:

 \ *Clipping Shot (Ex)*\ : At 11th level, when the mysterious stranger misses with a firearm attack, she can spend 1 grit point to deal half the damage that attack would have dealt if it were a hit (roll damage normally). She can decide to use this deed and spend the grit point after making the attack. This deed has no effect if the attack used the dead shot deed. The cost of using this deed cannot be reduced with the :ref:`Signature Deed <ultimatecombat.ultimatecombatfeats#signature_deed_(grit)>`\  feat, the true grit class feature, or any similar effect. This replaces the bleeding wound deed.

.. _`ultimatecombat.classarchetypes.gunslinger#lucky`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#strangers_fortune`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#pistolero_(archetype)`:
...
\ **Weapon Proficiency**\ : Instead of proficiency with all firearms, a pistolero only gains proficiency with one-handed firearms. She must take :ref:`Exotic Weapon Proficiency <corerulebook.feats#exotic_weapon_proficiency>`\  (firearm) to gain proficiency with two-handed firearms and firearm siege engines. 
...
.. _`ultimatecombat.classarchetypes.gunslinger#up_close_and_deadly`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#deadeye`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#twin_shot_knockdown`:
...
.. _`ultimatecombat.classarchetypes.gunslinger#pistol_training`:
