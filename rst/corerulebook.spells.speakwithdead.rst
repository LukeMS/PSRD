...
.. _`corerulebook.spells.speakwithdead`:

.. contents:: \ 

.. _`corerulebook.spells.speakwithdead#speak_with_dead`:
...
\ **Saving Throw**\ :ref:`Will <corerulebook.combat#will>`\  negates; see text; :ref:`Spell Resistance <corerulebook.glossary#spell_resistance>`\  no
...
If the dead creature's alignment was different from yours, the corpse gets a :ref:`Will <corerulebook.combat#will>`\  save to resist the spell as if it were alive. If successful, the corpse can refuse to answer your questions or attempt to deceive you, using Bluff. The soul can only speak about what it knew in life. It cannot answer any questions that pertain to events that occurred after its death.
