...
.. _`occultadventures.spells.dreamtravel`:

.. contents:: \ 

.. _`occultadventures.spells.dreamtravel#dream_travel`:
...
.. list-table::
   ...
   * - d6
     - Result
   * - 1
     - Creature contracts cackle fever or mindfire (equal chance of either).
   * - 2
     - Creature is cursed, as :ref:`bestow curse <corerulebook.spells.bestowcurse#bestow_curse>`\ ; if the creature is a spellcaster, it instead acquires a random minor spellblight.
   * - 3
     - Creature is attacked by a :ref:`phantasmal killer <corerulebook.spells.phantasmalkiller#phantasmal_killer>`\ , and is treated as having failed the initial saving throw to disbelieve it. The Fortitude save DC is equal to the Will save DC that the creature failed.
   * - 4
     - Creature is possessed as :ref:`possession <occultadventures.spells.possession#possession>`\  by an outsider (50% chance to be a creature from the destination plane; otherwise, it is a random hostile outsider).
   * - 5
     - Creature is affected as :ref:`feeblemind <corerulebook.spells.feeblemind#feeblemind>`\ .
   * - 6
     - Creature is affected as \ *insanity*\ .
