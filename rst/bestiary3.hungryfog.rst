...
.. _`bestiary3.hungryfog`:

.. contents:: \ 

.. _`bestiary3.hungryfog#hungry_fog`:
...
XP 2,400
N Huge ooze
\ **Init**\  –3; \ **Senses**\  blindsight 60 ft.; :ref:`Perception <corerulebook.skills.perception#perception>`\  –5
\ **Aura**\  bewitching brume (10 ft., DC 8)

.. _`bestiary3.hungryfog#defense`:
...
\ **hp**\  59 (7d8+28)
\ **Fort**\  +6, \ **Ref**\  –1, \ **Will**\  –3
\ **Defensive Abilities**\ gaseous, :ref:`negative energy affinity <bestiary.universalmonsterrules#negative_energy_affinity>`\ ; \ **DR**\  10/magic;\ **Immune**\  acid, electricity, ooze traits, sonic; \ **Resist**\  :ref:`cold <bestiary.creaturetypes#cold_subtype>`\  10
\ **Weaknesses**\  vulnerable to wind

.. _`bestiary3.hungryfog#offense`:
...
.. _`bestiary3.hungryfog#statistics`:
...
.. _`bestiary3.hungryfog#special_abilities`:
...
\ **Enveloping Mists (Ex)**\ A hungry fog can :ref:`engulf <bestiary.universalmonsterrules#engulf>`\  foes (see Universal Monster Rules in the Appendices). A creature engulfed by a hungry fog does not gain the pinned condition and may move normally—such a creature is not in danger of suffocating, but as long as it begins its turn engulfed, it is staggered in addition to the damage the attack causes. The save DC to avoid the enveloping mists is Constitution-based.
\ **Gaseous (Ex)**\ A hungry fog has a body composed of eerie mist. It can pass through small holes or narrow openings, even mere cracks, but cannot enter :ref:`water <bestiary.creaturetypes#water_subtype>`\  or other liquid. It has no Strength score, and cannot manipulate objects as a result.
