...
.. _`bestiary.linnorm#linnorm_crag`:
...
.. _`bestiary.linnorm#crag_linnorm`:
...
CE Gargantuan :ref:`dragon <bestiary.creaturetypes#dragon>`\  

\ **Init**\  +8; \ **Senses**\  darkvision 120 ft., low-light vision, :ref:`scent <bestiary.universalmonsterrules#scent>`\ , true seeing; :ref:`Perception <corerulebook.skills.perception#perception>`\  +22

.. _`bestiary.linnorm#defense`:
...
\ **hp**\  202 (15d12+105); :ref:`regeneration <bestiary.universalmonsterrules#regeneration>`\  10 (cold iron)
...
\ **Melee**\  bite +23 (2d8+12/19–20 plus :ref:`poison <bestiary.universalmonsterrules#poison>`\ ), 2 claws +23 (1d8+12), tail +18 (2d6+6 plus :ref:`grab <bestiary.universalmonsterrules#grab>`\ ) 

\ **Space**\  20 ft.; \ **Reach**\  20 ft.

\ **Special Attacks**\  :ref:`breath weapon <bestiary.universalmonsterrules#breath_weapon>`\ , :ref:`constrict <bestiary.universalmonsterrules#constrict>`\  (tail, 2d6+18), death curse

.. _`bestiary.linnorm#statistics`:
...
\ **Feats**\  :ref:`Blind-Fight <corerulebook.feats#blind_fight>`\ , :ref:`Cleave <corerulebook.feats#cleave>`\ , :ref:`Combat Reflexes <corerulebook.feats#combat_reflexes>`\ , :ref:`Improved Bull Rush <corerulebook.feats#improved_bull_rush>`\ , :ref:`Improved Critical <corerulebook.feats#improved_critical>`\  (bite), :ref:`Improved Initiative <corerulebook.feats#improved_initiative>`\ , :ref:`Lightning Reflexes <corerulebook.feats#lightning_reflexes>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`

\ **Skills**\  :ref:`Fly <corerulebook.skills.fly#fly>`\  +16, :ref:`Perception <corerulebook.skills.perception#perception>`\  +22, :ref:`Swim <corerulebook.skills.swim#swim>`\  +38

\ **Languages**\  Aklo, Draconic, Sylvan

.. _`bestiary.linnorm#ecology`:
...
.. _`bestiary.linnorm#special_abilities`:
...
\ **Freedom of Movement (Ex)**\  A crag linnorm is under the constant effect of :ref:`freedom of movement <corerulebook.spells.freedomofmovement#freedom_of_movement>`\ , as per the spell of the same name. This effect cannot be dispelled.
...
\ **True Seeing (Ex)**\  A crag linnorm has constant :ref:`true seeing <corerulebook.spells.trueseeing#true_seeing>`\ , as per the spell of the same name.
...
.. _`bestiary.linnorm#linnorm_ice`:
...
.. _`bestiary.linnorm#ice_linnorm`:
...
CE Colossal :ref:`dragon <bestiary.creaturetypes#dragon>`\  

\ **Init**\  +10; \ **Senses**\  darkvision 120 ft., low-light vision, :ref:`scent <bestiary.universalmonsterrules#scent>`\ , true seeing; :ref:`Perception <corerulebook.skills.perception#perception>`\  +26
...
\ **hp**\  279 (18d12+162); :ref:`regeneration <bestiary.universalmonsterrules#regeneration>`\  10 (cold iron)
...
\ **Melee**\  bite +24 (3d8+14/19–20 plus :ref:`poison <bestiary.universalmonsterrules#poison>`\ ), 2 claws +24 (2d6+14), tail +19 (3d6+7 plus :ref:`grab <bestiary.universalmonsterrules#grab>`\ ) 

\ **Space**\  30 ft.; \ **Reach**\  30 ft.

\ **Special**\  \ **Attacks**\  :ref:`breath weapon <bestiary.universalmonsterrules#breath_weapon>`\ , :ref:`constrict <bestiary.universalmonsterrules#constrict>`\  (tail, 3d6+21), death curse
...
\ **Feats**\  :ref:`Blind-Fight <corerulebook.feats#blind_fight>`\ , :ref:`Combat Reflexes <corerulebook.feats#combat_reflexes>`\ , :ref:`Improved Bull Rush <corerulebook.feats#improved_bull_rush>`\ , :ref:`Improved Critical <corerulebook.feats#improved_critical>`\  (bite), :ref:`Improved Initiative <corerulebook.feats#improved_initiative>`\ , :ref:`Improved Vital Strike <corerulebook.feats#improved_vital_strike>`\ , :ref:`Lightning Reflexes <corerulebook.feats#lightning_reflexes>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`\ , :ref:`Vital Strike <corerulebook.feats#vital_strike>`

\ **Skills**\  :ref:`Climb <corerulebook.skills.climb#climb>`\  +43, :ref:`Fly <corerulebook.skills.fly#fly>`\  +19, :ref:`Perception <corerulebook.skills.perception#perception>`\  +26, :ref:`Swim <corerulebook.skills.swim#swim>`\  +22
...
\ **Freedom of Movement (Ex)**\  An ice linnorm is under the constant effect of :ref:`freedom of movement <corerulebook.spells.freedomofmovement#freedom_of_movement>`\ , as per the spell of the same name. This effect cannot be dispelled.

\ **Poison (Su)**\ Bite—injury; \ *save*\  Fort DC 28; \ *frequency*\  1/round for 10 rounds; \ *effect*\  4d6 cold :ref:`damage <bestiary.universalmonsterrules#ability_damage_and_drain>`\  and 1d6 Con :ref:`drain <bestiary.universalmonsterrules#ability_damage_and_drain>`\ ; \ *cure*\  3 consecutive saves. The save DC is Constitution-based.

\ **True Seeing (Ex)**\  An ice linnorm has :ref:`true seeing <corerulebook.spells.trueseeing#true_seeing>`\ , as the spell of the same name. This effect cannot be dispelled.
...
.. _`bestiary.linnorm#linnorm_tarn`:
...
.. _`bestiary.linnorm#tarn_linnorm`:
...
CE Colossal :ref:`dragon <bestiary.creaturetypes#dragon>`\  (:ref:`aquatic <bestiary.creaturetypes#aquatic_subtype>`\ )

\ **Init**\  +12; \ **Senses**\  all-around vision, darkvision 120 ft., low-light vision, :ref:`scent <bestiary.universalmonsterrules#scent>`\ , true seeing; :ref:`Perception <corerulebook.skills.perception#perception>`\  +40
...
\ **hp**\  385 (22d12+242); :ref:`regeneration <bestiary.universalmonsterrules#regeneration>`\  15 (cold iron)
...
\ **Melee**\  2 bites +30 (3d8+16/19–20 plus :ref:`poison <bestiary.universalmonsterrules#poison>`\ ), 2 claws +30 (2d6+16), tail +25 (3d6+8 plus :ref:`grab <bestiary.universalmonsterrules#grab>`\ ) 

\ **Space**\  30 ft.; \ **Reach**\  30 ft.

\ **Special Attacks**\  :ref:`breath weapon <bestiary.universalmonsterrules#breath_weapon>`\ , :ref:`constrict <bestiary.universalmonsterrules#constrict>`\  (tail, 3d6+24), death curse
...
\ **Feats**\  :ref:`Awesome Blow <bestiary.monsterfeats#awesome_blow>`\ , :ref:`Blind-Fight <corerulebook.feats#blind_fight>`\ , :ref:`Combat Reflexes <corerulebook.feats#combat_reflexes>`\ , :ref:`Improved Bull Rush <corerulebook.feats#improved_bull_rush>`\ , :ref:`Improved Critical <corerulebook.feats#improved_critical>`\  (bite), :ref:`Improved Initiative <corerulebook.feats#improved_initiative>`\ , :ref:`Improved Overrun <corerulebook.feats#improved_overrun>`\ , :ref:`Improved Vital Strike <corerulebook.feats#improved_vital_strike>`\ , :ref:`Lightning Reflexes <corerulebook.feats#lightning_reflexes>`\ , :ref:`Power Attack <corerulebook.feats#power_attack>`\ , :ref:`Vital Strike <corerulebook.feats#vital_strike>`

\ **Skills**\  :ref:`Fly <corerulebook.skills.fly#fly>`\  +25, :ref:`Perception <corerulebook.skills.perception#perception>`\  +40, :ref:`Stealth <corerulebook.skills.stealth#stealth>`\  +17, :ref:`Swim <corerulebook.skills.swim#swim>`\  +49; \ **Racial Modifier**\  +8 :ref:`Perception <corerulebook.skills.perception#perception>`\  
...
\ **Freedom of Movement (Ex)**\  A tarn linnorm is under the constant effect of :ref:`freedom of movement <corerulebook.spells.freedomofmovement#freedom_of_movement>`\ , as the spell of the same name. This effect cannot be dispelled.

\ **Poison (Su)**\  Bite—injury; \ *save*\  Fort DC 32; \ *frequency*\  1/round for 10 rounds; \ *effect*\  6d6 acid :ref:`damage <bestiary.universalmonsterrules#ability_damage_and_drain>`\  and 1d8 Con :ref:`drain <bestiary.universalmonsterrules#ability_damage_and_drain>`\ ; \ *cure*\  3 consecutive saves. The save DC is Constitutuion-based.

\ **True Seeing (Ex)**\  A tarn linnorm has :ref:`true seeing <corerulebook.spells.trueseeing#true_seeing>`\ , as the spell of the same name. This effect cannot be dispelled.
